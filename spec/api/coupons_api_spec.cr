...
require "../spec_helper"
require "../../src/stripe/api/coupons_api"
...
describe "CouponsApi" do
  ...
  # @option opts [String] :duration Specifies how long the discount will be in effect if used on a subscription. Defaults to &#x60;once&#x60;.
