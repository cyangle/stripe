...
require "../spec_helper"
require "../../src/stripe/api/transfers_api"
...
describe "TransfersApi" do
  ...
  # @option opts [GetAccountsCreatedParameter] :created Only return transfers that were created during the given date interval.
  ...
  # @param currency Three-letter [ISO code for currency](https://www.iso.org/iso-4217-currency-codes.html) in lowercase. Must be a [supported currency](https://docs.stripe.com/currencies).
  # @param destination The ID of a connected Stripe account. &lt;a href&#x3D;\\\&quot;/docs/connect/separate-charges-and-transfers\\\&quot;&gt;See the Connect documentation&lt;/a&gt; for details.
  # @param [Hash] opts the optional parameters
  ...
  # @option opts [String] :transfer_group A string that identifies this transaction as part of a group. See the [Connect documentation](https://stripe.com/docs/connect/separate-charges-and-transfers#transfer-options) for details.
  # @return [Transfer]
  ...
  # @option opts [String] :description An arbitrary string which you can attach to a reversal object. This will be unset if you POST an empty value.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
