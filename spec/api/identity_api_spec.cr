...
require "../spec_helper"
require "../../src/stripe/api/identity_api"
...
describe "IdentityApi" do
  ...
  # @option opts [String] :client_reference_id A string to reference this user. This can be a customer ID, a session ID, or similar, and can be used to reconcile this verification with your internal systems.
  ...
  # @option opts [GetAccountsCreatedParameter] :created Only return VerificationReports that were created during the given date interval.
  ...
  # @option opts [Int32] :limit A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
  # @option opts [String] :client_reference_id A string to reference this user. This can be a customer ID, a session ID, or similar, and can be used to reconcile this verification with your internal systems.
  # @option opts [GetAccountsCreatedParameter] :created Only return VerificationSessions that were created during the given date interval.
  ...
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [String] :related_customer
  ...
  # @option opts [ProvidedDetailsParam] :provided_details
  # @option opts [String] :related_customer Token referencing a Customer resource.
  # @option opts [String] :return_url The URL that the user will be redirected to upon completing the verification flow.
  # @option opts [String] :_type The type of [verification check](https://stripe.com/docs/identity/verification-checks) to be performed. You must provide a &#x60;type&#x60; if not passing &#x60;verification_flow&#x60;.
  # @option opts [String] :verification_flow The ID of a Verification Flow from the Dashboard. See https://docs.stripe.com/identity/verification-flows.
  # @return [IdentityVerificationSession]
