...
require "../spec_helper"
require "../../src/stripe/api/disputes_api"
...
describe "DisputesApi" do
  ...
  # @option opts [GetAccountsCreatedParameter] :created Only return disputes that were created during the given date interval.
