...
require "../spec_helper"
require "../../src/stripe/api/credit_notes_api"
...
describe "CreditNotesApi" do
  ...
  # @option opts [GetAccountsCreatedParameter] :created Only return credit notes that were created during the given date interval.
  ...
  # @option opts [Int32] :effective_at The date when this credit note is in effect. Same as &#x60;created&#x60; unless overwritten. When defined, this value replaces the system-generated &#39;Date of issue&#39; printed on the credit note PDF.
  ...
  # @option opts [String] :email_type Type of email to send to the customer, one of &#x60;credit_note&#x60; or &#x60;none&#x60; and the default is &#x60;credit_note&#x60;.
  # @option opts [CreditNoteShippingCost] :shipping_cost When shipping_cost contains the shipping_rate from the invoice, the shipping_cost is included in the credit note.
  # @return [CreditNote]
  ...
  # @option opts [String] :refund ID of an existing refund to link this credit note to.
  # @option opts [Int32] :refund_amount The integer amount in cents (or local equivalent) representing the amount to refund. If set, a refund will be created for the charge associated with the invoice.
  # @option opts [CreditNoteShippingCost] :shipping_cost
  # @return [CreditNote]
