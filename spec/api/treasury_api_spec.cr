...
require "../spec_helper"
require "../../src/stripe/api/treasury_api"
...
describe "TreasuryApi" do
  ...
  # @option opts [GetAccountsCreatedParameter] :created Only return FinancialAccounts that were created during the given date interval.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  ...
  # @option opts [GetAccountsCreatedParameter] :created Only return OutboundPayments that were created during the given date interval.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  ...
  # @option opts [GetAccountsCreatedParameter] :created Only return TransactionEntries that were created during the given date interval.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  ...
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Hash(String, String)] :metadata
  # @option opts [String] :statement_descriptor Statement descriptor to be shown on the receiving end of an OutboundTransfer. Maximum 10 characters for &#x60;ach&#x60; transfers or 140 characters for &#x60;us_domestic_wire&#x60; transfers. The default value is \\\&quot;transfer\\\&quot;.
  # @return [TreasuryOutboundTransfer]
