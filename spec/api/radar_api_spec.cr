...
require "../spec_helper"
require "../../src/stripe/api/radar_api"
...
describe "RadarApi" do
  ...
  # @option opts [GetAccountsCreatedParameter] :created Only return early fraud warnings that were created during the given date interval.
  ...
  # @option opts [String] :starting_after A cursor for use in pagination. &#x60;starting_after&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.
  # @option opts [Int32] :limit A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
  # @option opts [GetAccountsCreatedParameter] :created Only return items that were created during the given date interval.
  ...
  # @option opts [GetAccountsCreatedParameter] :created Only return value lists that were created during the given date interval.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [String] :item_type Type of the items in the value list. One of &#x60;card_fingerprint&#x60;, &#x60;us_bank_account_fingerprint&#x60;, &#x60;sepa_debit_fingerprint&#x60;, &#x60;card_bin&#x60;, &#x60;email&#x60;, &#x60;ip_address&#x60;, &#x60;country&#x60;, &#x60;string&#x60;, &#x60;case_sensitive_string&#x60;, or &#x60;customer_id&#x60;. Use &#x60;string&#x60; if the item type is unknown or mixed.
