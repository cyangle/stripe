...
require "../spec_helper"
require "../../src/stripe/api/file_links_api"
...
describe "FileLinksApi" do
  ...
  # @option opts [Bool] :expired Filter links by their expiration status. By default, Stripe returns all links.
  # @option opts [String] :file Only return links for the given file.
  # @option opts [GetAccountsCreatedParameter] :created Only return links that were created during the given date interval.
