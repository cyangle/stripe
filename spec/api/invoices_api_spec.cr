...
require "../spec_helper"
require "../../src/stripe/api/invoices_api"
...
describe "InvoicesApi" do
  ...
  # @option opts [GetAccountsCreatedParameter] :created Only return invoices that were created during the given date interval.
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [Array(SubscriptionItemUpdateParams)] :subscription_items A list of up to 20 subscription items, each with an attached price. This field has been deprecated and will be removed in a future API version. Use &#x60;subscription_details.items&#x60; instead.
  # @option opts [GetInvoicesUpcomingSubscriptionCancelAtParameter] :subscription_cancel_at A timestamp at which the subscription should cancel. If set to a date before the current period ends, this will cause a proration if prorations have been enabled using &#x60;proration_behavior&#x60;. If set during a future period, this will always cause a proration for that period. This field has been deprecated and will be removed in a future API version. Use &#x60;subscription_details.cancel_at&#x60; instead.
  # @option opts [String] :preview_mode Customizes the types of values to include when calculating the invoice. Defaults to &#x60;next&#x60; if unspecified.
  # @option opts [Int32] :subscription_start_date Date a subscription is intended to start (can be future or past). This field has been deprecated and will be removed in a future API version. Use &#x60;subscription_details.start_date&#x60; instead.
  # @option opts [CustomerDetailsParam] :customer_details Details about the customer you want to invoice or overrides for an existing customer. If &#x60;automatic_tax&#x60; is enabled then one of &#x60;customer&#x60;, &#x60;customer_details&#x60;, &#x60;subscription&#x60;, or &#x60;schedule&#x60; must be set.
  ...
  # @option opts [String] :subscription_resume_at For paused subscriptions, setting &#x60;subscription_resume_at&#x60; to &#x60;now&#x60; will preview the invoice that will be generated if the subscription is resumed. This field has been deprecated and will be removed in a future API version. Use &#x60;subscription_details.resume_at&#x60; instead.
  ...
  # @option opts [GetInvoicesUpcomingSubscriptionTrialEndParameter] :subscription_trial_end If provided, the invoice returned will preview updating or creating a subscription with that trial end. If set, one of &#x60;subscription_items&#x60; or &#x60;subscription&#x60; is required. This field has been deprecated and will be removed in a future API version. Use &#x60;subscription_details.trial_end&#x60; instead.
  ...
  # @option opts [String] :customer The identifier of the customer whose upcoming invoice you&#39;d like to retrieve. If &#x60;automatic_tax&#x60; is enabled then one of &#x60;customer&#x60;, &#x60;customer_details&#x60;, &#x60;subscription&#x60;, or &#x60;schedule&#x60; must be set.
  # @option opts [String] :schedule The identifier of the schedule whose upcoming invoice you&#39;d like to retrieve. Cannot be used with subscription or subscription fields.
  # @option opts [String] :subscription The identifier of the subscription for which you&#39;d like to retrieve the upcoming invoice. If not provided, but a &#x60;subscription_details.items&#x60; is provided, you will preview creating a subscription with those items. If neither &#x60;subscription&#x60; nor &#x60;subscription_details.items&#x60; is provided, you will retrieve the next upcoming invoice from among the customer&#39;s subscriptions.
  # @option opts [ScheduleDetailsParams] :schedule_details The schedule creation or modification params to apply as a preview. Cannot be used with &#x60;subscription&#x60; or &#x60;subscription_&#x60; prefixed fields.
  # @option opts [SubscriptionDetailsParams] :subscription_details The subscription creation or modification params to apply as a preview. Cannot be used with &#x60;schedule&#x60; or &#x60;schedule_details&#x60; fields.
  # @option opts [Bool] :subscription_cancel_now This simulates the subscription being canceled or expired immediately. This field has been deprecated and will be removed in a future API version. Use &#x60;subscription_details.cancel_now&#x60; instead.
  # @return [Invoice]
  ...
  # @option opts [Bool] :auto_advance Controls whether Stripe performs [automatic collection](https://stripe.com/docs/invoicing/integration/automatic-advancement-collection) of the invoice. If &#x60;false&#x60;, the invoice&#39;s state doesn&#39;t automatically advance without an explicit action.
  ...
  # @option opts [Int32] :effective_at The date when this invoice is in effect. Same as &#x60;finalized_at&#x60; unless overwritten. When defined, this value replaces the system-generated &#39;Date of issue&#39; printed on the invoice PDF and receipt.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  ...
  # @option opts [String] :number Set the number for this invoice. If no number is present then a number will be assigned automatically when the invoice is finalized. In many markets, regulations require invoices to be unique, sequential and / or gapless. You are responsible for ensuring this is true across all your different invoicing systems in the event that you edit the invoice number using our API. If you use only Stripe for your invoices and do not change invoice numbers, Stripe handles this aspect of compliance for you automatically.
  # @option opts [String] :on_behalf_of The account (if any) for which the funds of the invoice payment are intended. If set, the invoice will be presented with the branding and support information of the specified account. See the [Invoices with Connect](https://stripe.com/docs/billing/invoices/connect) documentation for details.
  # @option opts [PaymentSettings] :payment_settings
  # @option opts [String] :pending_invoice_items_behavior How to handle pending invoice items on invoice creation. Defaults to &#x60;exclude&#x60; if the parameter is omitted.
  # @option opts [RenderingParam] :rendering
  # @option opts [ShippingCost] :shipping_cost
  # @option opts [RecipientShippingWithOptionalFieldsAddress] :shipping_details
  ...
  # @option opts [String] :subscription The ID of the subscription to invoice, if any. If set, the created invoice will only include pending invoice items for that subscription. The subscription&#39;s billing cycle and regular subscription events won&#39;t be affected.
  ...
  # @option opts [PostInvoicesRequestAccountTaxIds] :account_tax_ids
  # @option opts [Int32] :application_fee_amount A fee in cents (or local equivalent) that will be applied to the invoice and transferred to the application owner&#39;s Stripe account. The request must be made with an OAuth key or the Stripe-Account header in order to take an application fee. For more information, see the application fees [documentation](https://stripe.com/docs/billing/invoices/connect#collecting-fees).
  # @option opts [Bool] :auto_advance Controls whether Stripe performs [automatic collection](https://stripe.com/docs/invoicing/integration/automatic-advancement-collection) of the invoice.
  # @option opts [AutomaticTaxParam] :automatic_tax
  ...
  # @option opts [PostInvoicesInvoiceRequestEffectiveAt] :effective_at
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [String] :footer Footer to be displayed on the invoice.
  # @option opts [ConnectAccountReference] :issuer
  # @option opts [PostAccountsRequestMetadata] :metadata
  ...
  # @option opts [PostInvoicesInvoiceRequestShippingDetails] :shipping_details
  # @option opts [String] :statement_descriptor Extra information about a charge for the customer&#39;s credit card statement. It must contain at least one letter. If not specified and this invoice is part of a subscription, the default &#x60;statement_descriptor&#x60; will be set to the first subscription item&#39;s product&#39;s &#x60;statement_descriptor&#x60;.
