...
describe "DefaultApi" do
  ...
  # &lt;p&gt;With &lt;a href&#x3D;\&quot;/docs/connect\&quot;&gt;Connect&lt;/a&gt;, you can delete accounts you manage.&lt;/p&gt;  &lt;p&gt;Accounts created using test-mode keys can be deleted at any time. Custom or Express accounts created using live-mode keys can only be deleted once all balances are zero.&lt;/p&gt;  &lt;p&gt;If you want to delete your own account, use the &lt;a href&#x3D;\&quot;https://dashboard.stripe.com/account\&quot;&gt;account information tab in your account settings&lt;/a&gt; instead.&lt;/p&gt;
  ...
  # @return [AnyOfpaymentSourcedeletedPaymentSource]
  ...
  # unit tests for delete_recipients_id
  # &lt;p&gt;Permanently deletes a recipient. It cannot be undone.&lt;/p&gt;
  # @param id
  # @param [Hash] opts the optional parameters
  # @return [DeletedRecipient]
  describe "delete_recipients_id test" do
    it "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
    end
  end
  ...
  # unit tests for get3d_secure_three_d_secure
  # &lt;p&gt;Retrieves a 3D Secure object.&lt;/p&gt;
  # @param three_d_secure
  # @param [Hash] opts the optional parameters
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @return [ThreeDSecure]
  describe "get3d_secure_three_d_secure test" do
    it "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
    end
  end
  ...
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Int32] :limit A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
  # @option opts [AllPeopleRelationshipSpecs1] :relationship Filters on the list of people returned based on the person&#39;s relationship to the account&#39;s company.
  # @option opts [String] :starting_after A cursor for use in pagination. &#x60;starting_after&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.
  # @return [InlineResponse200]
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [AnyOfobjectinteger] :created
  # @option opts [String] :ending_before A cursor for use in pagination. &#x60;ending_before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with &#x60;obj_bar&#x60;, your subsequent call can include &#x60;ending_before&#x3D;obj_bar&#x60; in order to fetch the previous page of the list.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Int32] :limit A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
  # @option opts [String] :starting_after A cursor for use in pagination. &#x60;starting_after&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.
  ...
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Int32] :limit A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
  # @option opts [AllPeopleRelationshipSpecs2] :relationship Filters on the list of people returned based on the person&#39;s relationship to the account&#39;s company.
  # @option opts [String] :starting_after A cursor for use in pagination. &#x60;starting_after&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.
  # @return [InlineResponse200]
  ...
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Int32] :limit A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
  # @option opts [AllPeopleRelationshipSpecs3] :relationship Filters on the list of people returned based on the person&#39;s relationship to the account&#39;s company.
  # @option opts [String] :starting_after A cursor for use in pagination. &#x60;starting_after&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.
  # @return [InlineResponse200]
  ...
  # unit tests for get_bitcoin_receivers
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [Bool] :active Filter for active receivers.
  # @option opts [String] :ending_before A cursor for use in pagination. &#x60;ending_before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with &#x60;obj_bar&#x60;, your subsequent call can include &#x60;ending_before&#x3D;obj_bar&#x60; in order to fetch the previous page of the list.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Bool] :filled Filter for filled receivers.
  # @option opts [Int32] :limit A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
  # @option opts [String] :starting_after A cursor for use in pagination. &#x60;starting_after&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.
  # @option opts [Bool] :uncaptured_funds Filter for receivers with uncaptured funds.
  # @return [InlineResponse2004]
  describe "get_bitcoin_receivers test" do
    it "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
    end
  end

  # unit tests for get_bitcoin_receivers_id
  # &lt;p&gt;Retrieves the Bitcoin receiver with the given ID.&lt;/p&gt;
  # @param id
  # @param [Hash] opts the optional parameters
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @return [BitcoinReceiver]
  describe "get_bitcoin_receivers_id test" do
    it "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
    end
  end

  # unit tests for get_bitcoin_receivers_receiver_transactions
  # &lt;p&gt;List bitcoin transacitons for a given receiver.&lt;/p&gt;
  # @param receiver
  # @param [Hash] opts the optional parameters
  # @option opts [String] :customer Only return transactions for the customer specified by this customer ID.
  # @option opts [String] :ending_before A cursor for use in pagination. &#x60;ending_before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with &#x60;obj_bar&#x60;, your subsequent call can include &#x60;ending_before&#x3D;obj_bar&#x60; in order to fetch the previous page of the list.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Int32] :limit A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
  # @option opts [String] :starting_after A cursor for use in pagination. &#x60;starting_after&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.
  # @return [BitcoinTransactionList]
  describe "get_bitcoin_receivers_receiver_transactions test" do
    it "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
    end
  end

  # unit tests for get_bitcoin_transactions
  # &lt;p&gt;List bitcoin transacitons for a given receiver.&lt;/p&gt;
  # @param [Hash] opts the optional parameters
  # @option opts [String] :customer Only return transactions for the customer specified by this customer ID.
  # @option opts [String] :ending_before A cursor for use in pagination. &#x60;ending_before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with &#x60;obj_bar&#x60;, your subsequent call can include &#x60;ending_before&#x3D;obj_bar&#x60; in order to fetch the previous page of the list.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Int32] :limit A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
  # @option opts [String] :receiver
  # @option opts [String] :starting_after A cursor for use in pagination. &#x60;starting_after&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.
  # @return [BitcoinTransactionList]
  describe "get_bitcoin_transactions test" do
    it "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
    end
  end
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [AnyOfobjectinteger] :created A filter on the list, based on the object &#x60;created&#x60; field. The value can be a string with an integer Unix timestamp, or it can be a dictionary with a number of different query options.
  # @option opts [String] :ending_before A cursor for use in pagination. &#x60;ending_before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with &#x60;obj_bar&#x60;, your subsequent call can include &#x60;ending_before&#x3D;obj_bar&#x60; in order to fetch the previous page of the list.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Int32] :limit A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
  # @option opts [String] :starting_after A cursor for use in pagination. &#x60;starting_after&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [Int32] :amount The integer amount in %s representing the total amount of the credit note.
  # @option opts [Int32] :credit_amount The integer amount in %s representing the amount to credit the customer&#39;s balance, which will be automatically applied to their next invoice.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  ...
  # @option opts [Int32] :out_of_band_amount The integer amount in %s representing the amount that is credited outside of Stripe.
  ...
  # @option opts [Int32] :refund_amount The integer amount in %s representing the amount to refund. If set, a refund will be created for the charge associated with the invoice.
  # @return [CreditNote]
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @return [AnyOfcustomerdeletedCustomer]
  ...
  # @option opts [AnyOfobjectinteger] :due_date
  # @option opts [String] :ending_before A cursor for use in pagination. &#x60;ending_before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with &#x60;obj_bar&#x60;, your subsequent call can include &#x60;ending_before&#x3D;obj_bar&#x60; in order to fetch the previous page of the list.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Int32] :limit A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
  # @option opts [String] :starting_after A cursor for use in pagination. &#x60;starting_after&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.
  ...
  # @option opts [AnyOfarraystring] :discounts The coupons to redeem into discounts for the invoice preview. If not specified, inherits the discount from the customer or subscription. This only works for coupons directly applied to the invoice. To apply a coupon to a subscription, you must use the &#x60;coupon&#x60; parameter instead. Pass an empty string to avoid inheriting any discounts. To preview the upcoming invoice for a subscription that hasn&#39;t been created, use &#x60;coupon&#x60; instead.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  ...
  # @option opts [AnyOfstringinteger] :subscription_billing_cycle_anchor For new subscriptions, a future timestamp to anchor the subscription&#39;s [billing cycle](https://stripe.com/docs/subscriptions/billing-cycle). This is used to determine the date of the first full invoice, and, for plans with &#x60;month&#x60; or &#x60;year&#x60; intervals, the day of the month for subsequent invoices. For existing subscriptions, the value can only be set to &#x60;now&#x60; or &#x60;unchanged&#x60;.
  # @option opts [AnyOfintegerstring] :subscription_cancel_at Timestamp indicating when the subscription should be scheduled to cancel. Will prorate if within the current period and prorations have been enabled using &#x60;proration_behavior&#x60;.
  ...
  # @option opts [AnyOfarraystring] :subscription_default_tax_rates If provided, the invoice returned will preview updating or creating a subscription with these default tax rates. The default tax rates will apply to any line item that does not have &#x60;tax_rates&#x60; set.
  ...
  # @option opts [String] :subscription_proration_behavior Determines how to handle [prorations](https://stripe.com/docs/subscriptions/billing-cycle#prorations) when the billing cycle changes (e.g., when switching plans, resetting &#x60;billing_cycle_anchor&#x3D;now&#x60;, or starting a trial), or if an item&#39;s &#x60;quantity&#x60; changes. Valid values are &#x60;create_prorations&#x60;, &#x60;none&#x60;, or &#x60;always_invoice&#x60;.  Passing &#x60;create_prorations&#x60; will cause proration invoice items to be created when applicable. These proration items will only be invoiced immediately under [certain conditions](https://stripe.com/docs/subscriptions/upgrading-downgrading#immediate-payment). In order to always invoice immediately for prorations, pass &#x60;always_invoice&#x60;.  Prorations can be disabled by passing &#x60;none&#x60;.
  ...
  # @option opts [AnyOfstringinteger] :subscription_trial_end If provided, the invoice returned will preview updating or creating a subscription with that trial end. If set, one of &#x60;subscription_items&#x60; or &#x60;subscription&#x60; is required.
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [AutomaticTaxParam2] :automatic_tax Settings for automatic tax lookup for this invoice preview.
  # @option opts [String] :coupon The code of the coupon to apply. If &#x60;subscription&#x60; or &#x60;subscription_items&#x60; is provided, the invoice returned will preview updating or creating a subscription with that coupon. Otherwise, it will preview applying that coupon to the customer for the next upcoming invoice from among the customer&#39;s subscriptions. The invoice can be previewed without a coupon by passing this value as an empty string.
  # @option opts [String] :customer The identifier of the customer whose upcoming invoice you&#39;d like to retrieve.
  # @option opts [CustomerDetailsParam1] :customer_details Details about the customer you want to invoice or overrides for an existing customer.
  # @option opts [AnyOfarraystring] :discounts The coupons to redeem into discounts for the invoice preview. If not specified, inherits the discount from the customer or subscription. This only works for coupons directly applied to the invoice. To apply a coupon to a subscription, you must use the &#x60;coupon&#x60; parameter instead. Pass an empty string to avoid inheriting any discounts. To preview the upcoming invoice for a subscription that hasn&#39;t been created, use &#x60;coupon&#x60; instead.
  # @option opts [String] :ending_before A cursor for use in pagination. &#x60;ending_before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with &#x60;obj_bar&#x60;, your subsequent call can include &#x60;ending_before&#x3D;obj_bar&#x60; in order to fetch the previous page of the list.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Array(InvoiceItemPreviewParams)] :invoice_items List of invoice items to add or update in the upcoming invoice preview.
  ...
  # unit tests for get_issuer_fraud_records
  # &lt;p&gt;Returns a list of issuer fraud records.&lt;/p&gt;
  # @param [Hash] opts the optional parameters
  # @option opts [String] :charge Only return issuer fraud records for the charge specified by this charge ID.
  # @option opts [String] :ending_before A cursor for use in pagination. &#x60;ending_before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with &#x60;obj_bar&#x60;, your subsequent call can include &#x60;ending_before&#x3D;obj_bar&#x60; in order to fetch the previous page of the list.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Int32] :limit A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
  # @option opts [String] :starting_after A cursor for use in pagination. &#x60;starting_after&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.
  # @return [RadarIssuerFraudRecordList]
  describe "get_issuer_fraud_records test" do
    it "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
    end
  end

  # unit tests for get_issuer_fraud_records_issuer_fraud_record
  ...
  # @param issuer_fraud_record
  # @param [Hash] opts the optional parameters
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @return [IssuerFraudRecord]
  describe "get_issuer_fraud_records_issuer_fraud_record test" do
    it "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
    end
  end
  ...
  # @option opts [AnyOfobjectinteger] :created Only return authorizations that were created during the given date interval.
  # @option opts [String] :ending_before A cursor for use in pagination. &#x60;ending_before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with &#x60;obj_bar&#x60;, your subsequent call can include &#x60;ending_before&#x3D;obj_bar&#x60; in order to fetch the previous page of the list.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Int32] :limit A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
  # @option opts [String] :starting_after A cursor for use in pagination. &#x60;starting_after&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [AnyOfobjectinteger] :created Only return cardholders that were created during the given date interval.
  ...
  # @option opts [AnyOfobjectinteger] :created Only return cards that were issued during the given date interval.
  # @option opts [String] :ending_before A cursor for use in pagination. &#x60;ending_before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with &#x60;obj_bar&#x60;, your subsequent call can include &#x60;ending_before&#x3D;obj_bar&#x60; in order to fetch the previous page of the list.
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [AnyOfobjectinteger] :created Select Issuing disputes that were created during the given date interval.
  # @option opts [String] :ending_before A cursor for use in pagination. &#x60;ending_before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with &#x60;obj_bar&#x60;, your subsequent call can include &#x60;ending_before&#x3D;obj_bar&#x60; in order to fetch the previous page of the list.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Int32] :limit A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
  # @option opts [String] :starting_after A cursor for use in pagination. &#x60;starting_after&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [AnyOfobjectinteger] :created Only return issuing settlements that were created during the given date interval.
  # @option opts [String] :ending_before A cursor for use in pagination. &#x60;ending_before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with &#x60;obj_bar&#x60;, your subsequent call can include &#x60;ending_before&#x3D;obj_bar&#x60; in order to fetch the previous page of the list.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Int32] :limit A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
  # @option opts [String] :starting_after A cursor for use in pagination. &#x60;starting_after&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.
  ...
  # @option opts [AnyOfobjectinteger] :created Only return transactions that were created during the given date interval.
  # @option opts [String] :ending_before A cursor for use in pagination. &#x60;ending_before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with &#x60;obj_bar&#x60;, your subsequent call can include &#x60;ending_before&#x3D;obj_bar&#x60; in order to fetch the previous page of the list.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Int32] :limit A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
  # @option opts [String] :starting_after A cursor for use in pagination. &#x60;starting_after&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.
  ...
  # unit tests for get_order_returns
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [AnyOfobjectinteger] :created Date this return was created.
  # @option opts [String] :ending_before A cursor for use in pagination. &#x60;ending_before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with &#x60;obj_bar&#x60;, your subsequent call can include &#x60;ending_before&#x3D;obj_bar&#x60; in order to fetch the previous page of the list.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Int32] :limit A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
  # @option opts [String] :order The order to retrieve returns for.
  # @option opts [String] :starting_after A cursor for use in pagination. &#x60;starting_after&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.
  # @return [InlineResponse20021]
  describe "get_order_returns test" do
    it "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
    end
  end

  # unit tests for get_order_returns_id
  ...
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @return [OrderReturn]
  describe "get_order_returns_id test" do
    it "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
    end
  end
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [AnyOfobjectinteger] :created Date this order was created.
  # @option opts [String] :customer Only return orders for the given customer.
  # @option opts [String] :ending_before A cursor for use in pagination. &#x60;ending_before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with &#x60;obj_bar&#x60;, your subsequent call can include &#x60;ending_before&#x3D;obj_bar&#x60; in order to fetch the previous page of the list.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Array(String)] :ids Only return orders with the given IDs.
  # @option opts [Int32] :limit A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
  # @option opts [String] :starting_after A cursor for use in pagination. &#x60;starting_after&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.
  # @option opts [String] :status Only return orders that have the given status. One of &#x60;created&#x60;, &#x60;paid&#x60;, &#x60;fulfilled&#x60;, or &#x60;refunded&#x60;.
  # @option opts [OrderTimestampSpecs] :status_transitions Filter orders based on when they were paid, fulfilled, canceled, or returned.
  # @option opts [Array(String)] :upstream_ids Only return orders with the given upstream order IDs.
  # @return [OrdersLegacyResourceOrderList]
  ...
  # @param _type A required filter on the list, based on the object &#x60;type&#x60; field.
  # @param [Hash] opts the optional parameters
  # @option opts [String] :customer The ID of the customer whose PaymentMethods will be retrieved. If not provided, the response list will be empty.
  # @option opts [String] :ending_before A cursor for use in pagination. &#x60;ending_before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with &#x60;obj_bar&#x60;, your subsequent call can include &#x60;ending_before&#x3D;obj_bar&#x60; in order to fetch the previous page of the list.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Int32] :limit A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
  # @option opts [String] :starting_after A cursor for use in pagination. &#x60;starting_after&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [AnyOfobjectinteger] :arrival_date
  # @option opts [AnyOfobjectinteger] :created
  ...
  # @option opts [AnyOfobjectinteger] :created Only return products that were created during the given date interval.
  # @option opts [String] :ending_before A cursor for use in pagination. &#x60;ending_before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with &#x60;obj_bar&#x60;, your subsequent call can include &#x60;ending_before&#x3D;obj_bar&#x60; in order to fetch the previous page of the list.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Array(String)] :ids Only return products with the given IDs.
  # @option opts [Int32] :limit A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
  ...
  # @option opts [Int32] :limit A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
  # @option opts [String] :starting_after A cursor for use in pagination. &#x60;starting_after&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with &#x60;obj_foo&#x60;, your subsequent call can include &#x60;starting_after&#x3D;obj_foo&#x60; in order to fetch the next page of the list.
  # @option opts [String] :_type
  # @option opts [Bool] :verified Only return recipients that are verified or unverified.
  ...
  # unit tests for get_recipients_id
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @return [AnyOfrecipientdeletedRecipient]
  describe "get_recipients_id test" do
    it "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
    end
  end
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [AnyOfobjectinteger] :canceled_at Only return subscription schedules that were created canceled the given date interval.
  # @option opts [AnyOfobjectinteger] :completed_at Only return subscription schedules that completed during the given date interval.
  # @option opts [AnyOfobjectinteger] :created Only return subscription schedules that were created during the given date interval.
  # @option opts [String] :customer Only return subscription schedules for the given customer.
  # @option opts [String] :ending_before A cursor for use in pagination. &#x60;ending_before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with &#x60;obj_bar&#x60;, your subsequent call can include &#x60;ending_before&#x3D;obj_bar&#x60; in order to fetch the previous page of the list.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Int32] :limit A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
  # @option opts [AnyOfobjectinteger] :released_at Only return subscription schedules that were released during the given date interval.
  ...
  # @option opts [AnyOfobjectinteger] :created
  # @option opts [AnyOfobjectinteger] :current_period_end
  # @option opts [AnyOfobjectinteger] :current_period_start
  ...
  # @option opts [AnyOfobjectinteger] :created Optional range for filtering created date.
  # @option opts [String] :ending_before A cursor for use in pagination. &#x60;ending_before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with &#x60;obj_bar&#x60;, your subsequent call can include &#x60;ending_before&#x3D;obj_bar&#x60; in order to fetch the previous page of the list.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [AnyOfobjectinteger] :amount A positive integer representing how much to transfer.
  # @option opts [AnyOfobjectinteger] :created A filter on the list, based on the object &#x60;created&#x60; field. The value can be a string with an integer Unix timestamp, or it can be a dictionary with a number of different query options.
  # @option opts [String] :ending_before A cursor for use in pagination. &#x60;ending_before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with &#x60;obj_bar&#x60;, your subsequent call can include &#x60;ending_before&#x3D;obj_bar&#x60; in order to fetch the previous page of the list.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Int32] :limit A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
  ...
  # unit tests for post3d_secure
  # &lt;p&gt;Initiate 3D Secure authentication.&lt;/p&gt;
  # @param amount Amount of the charge that you will create when authentication completes.
  ...
  # @param return_url The URL that the cardholder&#39;s browser will be returned to when authentication completes.
  # @param [Hash] opts the optional parameters
  # @option opts [String] :card The ID of a card token, or the ID of a card belonging to the given customer.
  # @option opts [String] :customer The customer associated with this 3D secure authentication.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @return [ThreeDSecure]
  describe "post3d_secure test" do
    it "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
    end
  end
  ...
  # @option opts [AnyOfobjectstring] :bank_account Either a token, like the ones returned by [Stripe.js](https://stripe.com/docs/js), or a dictionary containing a user&#39;s bank account details.
  ...
  # @option opts [AnyOfmapstring] :metadata Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to &#x60;metadata&#x60;.
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [String] :redirect_url Where to redirect the user after they log out of their dashboard.
  # @return [LoginLink]
  ...
  # @option opts [AnyOfobjectstring] :dob The person&#39;s date of birth.
  ...
  # @option opts [AnyOfarraystring] :full_name_aliases A list of alternate names or aliases that the person is known by.
  ...
  # @param id
  # @param [Hash] opts the optional parameters
  # @option opts [Int32] :amount A positive integer, in _%s_, representing how much of this fee to refund. Can refund only up to the remaining unrefunded amount of the fee.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @return [FeeRefund]
  ...
  # @param features
  # @param [Hash] opts the optional parameters
  # @option opts [AnyOfstringstring] :default_return_url The default URL to redirect customers to when they click on the portal&#39;s link to return to your website. This can be [overriden](https://stripe.com/docs/api/customer_portal/sessions/create#create_portal_session-return_url) when creating the session.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @return [BillingPortalConfiguration]
  ...
  # @option opts [Int32] :application_fee_amount A fee in %s that will be applied to the charge and transferred to the application owner&#39;s Stripe account. The request must be made with an OAuth key or the &#x60;Stripe-Account&#x60; header in order to take an application fee. For more information, see the application fees [documentation](https://stripe.com/docs/connect/direct-charges#collecting-fees).
  ...
  # @option opts [AnyOfobjectstring] :card A token, like the ones returned by [Stripe.js](https://stripe.com/docs/js).
  ...
  # @option opts [AnyOfobjectstring] :destination
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [AnyOfmapstring] :metadata Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to &#x60;metadata&#x60;.
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [AnyOfmapstring] :metadata
  # @return [Refund]
  ...
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Int32] :expires_at The Epoch time in seconds at which the Checkout Session will expire. It can be anywhere from 1 to 24 hours after Checkout Session creation. By default, this value is 24 hours from creation.
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [AnyOfobjectstring] :address The customer&#39;s address.
  # @option opts [Int32] :balance An integer amount in %s that represents the customer&#39;s current balance, which affect the customer&#39;s future invoices. A negative amount represents a credit that decreases the amount due on an invoice; a positive amount increases the amount due on an invoice.
  ...
  # @option opts [AnyOfobjectstring] :shipping The customer&#39;s shipping information. Appears on invoices emailed to this customer.
  ...
  # @option opts [TaxParam] :tax
  # @option opts [String] :tax_exempt The customer&#39;s tax exemption. One of &#x60;none&#x60;, &#x60;exempt&#x60;, or &#x60;reverse&#x60;.
  # @option opts [AnyOfstringinteger] :trial_end Unix timestamp representing the end of the trial period the customer will get before being charged for the first time. This will always overwrite any trials that might apply via a subscribed plan. If set, trial_end will override the default trial period of the plan the customer is being subscribed to. The special value &#x60;now&#x60; can be provided to end the customer&#39;s trial immediately. Can be at most two years from &#x60;billing_cycle_anchor&#x60;.
  # @return [Customer]
  ...
  # @param customer
  # @param amount The integer amount in **%s** to apply to the customer&#39;s credit balance.
  ...
  # @return [AnyOfcardbankAccountsource]
  ...
  # @param customer
  # @param [Hash] opts the optional parameters
  # @option opts [Array(AddInvoiceItemEntry)] :add_invoice_items A list of prices and quantities that will generate invoice items appended to the first invoice for this subscription. You may pass up to 20 items.
  ...
  # @option opts [Int32] :billing_cycle_anchor A future timestamp to anchor the subscription&#39;s [billing cycle](https://stripe.com/docs/subscriptions/billing-cycle). This is used to determine the date of the first full invoice, and, for plans with &#x60;month&#x60; or &#x60;year&#x60; intervals, the day of the month for subsequent invoices.
  # @option opts [AnyOfobjectstring] :billing_thresholds Define thresholds at which an invoice will be sent, and the subscription advanced to a new billing period. Pass an empty string to remove previously-defined thresholds.
  ...
  # @option opts [AnyOfarraystring] :default_tax_rates The tax rates that will apply to any subscription item that does not have &#x60;tax_rates&#x60; set. Invoices created will have their &#x60;default_tax_rates&#x60; populated from the subscription.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  ...
  # @option opts [AnyOfobjectstring] :pending_invoice_item_interval Specifies an interval for how often to bill for any pending invoice items. It is analogous to calling [Create an invoice](https://stripe.com/docs/api#create_invoice) for the given subscription at the specified interval.
  ...
  # @option opts [AnyOfstringinteger] :trial_end Unix timestamp representing the end of the trial period the customer will get before being charged for the first time. This will always overwrite any trials that might apply via a subscribed plan. If set, trial_end will override the default trial period of the plan the customer is being subscribed to. The special value &#x60;now&#x60; can be provided to end the customer&#39;s trial immediately. Can be at most two years from &#x60;billing_cycle_anchor&#x60;. See [Using trial periods on subscriptions](https://stripe.com/docs/billing/subscriptions/trials) to learn more.
  ...
  # @option opts [AnyOfobjectstring] :billing_thresholds Define thresholds at which an invoice will be sent, and the subscription advanced to a new billing period. Pass an empty string to remove previously-defined thresholds.
  # @option opts [AnyOfintegerstring] :cancel_at A timestamp at which the subscription should cancel. If set to a date before the current period ends, this will cause a proration if prorations have been enabled using &#x60;proration_behavior&#x60;. If set during a future period, this will always cause a proration for that period.
  # @option opts [Bool] :cancel_at_period_end Boolean indicating whether this subscription should cancel at the end of the current period.
  # @option opts [String] :collection_method Either &#x60;charge_automatically&#x60;, or &#x60;send_invoice&#x60;. When charging automatically, Stripe will attempt to pay this subscription at the end of the cycle using the default source attached to the customer. When sending an invoice, Stripe will email your customer an invoice with payment instructions. Defaults to &#x60;charge_automatically&#x60;.
  # @option opts [String] :coupon The ID of the coupon to apply to this subscription. A coupon applied to a subscription will only affect invoices created for that particular subscription.
  # @option opts [Int32] :days_until_due Number of days a customer has to pay invoices generated by this subscription. Valid only for subscriptions where &#x60;collection_method&#x60; is set to &#x60;send_invoice&#x60;.
  # @option opts [String] :default_payment_method ID of the default payment method for the subscription. It must belong to the customer associated with the subscription. This takes precedence over &#x60;default_source&#x60;. If neither are set, invoices will use the customer&#39;s [invoice_settings.default_payment_method](https://stripe.com/docs/api/customers/object#customer_object-invoice_settings-default_payment_method) or [default_source](https://stripe.com/docs/api/customers/object#customer_object-default_source).
  # @option opts [String] :default_source ID of the default payment source for the subscription. It must belong to the customer associated with the subscription and be in a chargeable state. If &#x60;default_payment_method&#x60; is also set, &#x60;default_payment_method&#x60; will take precedence. If neither are set, invoices will use the customer&#39;s [invoice_settings.default_payment_method](https://stripe.com/docs/api/customers/object#customer_object-invoice_settings-default_payment_method) or [default_source](https://stripe.com/docs/api/customers/object#customer_object-default_source).
  # @option opts [AnyOfarraystring] :default_tax_rates The tax rates that will apply to any subscription item that does not have &#x60;tax_rates&#x60; set. Invoices created will have their &#x60;default_tax_rates&#x60; populated from the subscription. Pass an empty string to remove previously-defined tax rates.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Array(SubscriptionItemUpdateParams)] :items A list of up to 20 subscription items, each with an attached price.
  # @option opts [AnyOfmapstring] :metadata Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to &#x60;metadata&#x60;.
  # @option opts [Bool] :off_session Indicates if a customer is on or off-session while an invoice payment is attempted.
  # @option opts [AnyOfobjectstring] :pause_collection If specified, payment collection for this subscription will be paused.
  ...
  # @option opts [AnyOfobjectstring] :transfer_data If specified, the funds from the subscription&#39;s invoices will be transferred to the destination and the ID of the resulting transfers will be found on the resulting charges. This will be unset if you POST an empty value.
  # @option opts [AnyOfstringinteger] :trial_end Unix timestamp representing the end of the trial period the customer will get before being charged for the first time. This will always overwrite any trials that might apply via a subscribed plan. If set, trial_end will override the default trial period of the plan the customer is being subscribed to. The special value &#x60;now&#x60; can be provided to end the customer&#39;s trial immediately. Can be at most two years from &#x60;billing_cycle_anchor&#x60;.
  # @option opts [Bool] :trial_from_plan Indicates if a plan&#39;s &#x60;trial_period_days&#x60; should be applied to the subscription. Setting &#x60;trial_end&#x60; per subscription is preferred, and this defaults to &#x60;false&#x60;. Setting this flag to &#x60;true&#x60; together with &#x60;trial_end&#x60; is not allowed. See [Using trial periods on subscriptions](https://stripe.com/docs/billing/subscriptions/trials) to learn more.
  # @return [Subscription]
  ...
  # @param customer
  # @param _type Type of the tax ID, one of &#x60;ae_trn&#x60;, &#x60;au_abn&#x60;, &#x60;au_arn&#x60;, &#x60;br_cnpj&#x60;, &#x60;br_cpf&#x60;, &#x60;ca_bn&#x60;, &#x60;ca_gst_hst&#x60;, &#x60;ca_pst_bc&#x60;, &#x60;ca_pst_mb&#x60;, &#x60;ca_pst_sk&#x60;, &#x60;ca_qst&#x60;, &#x60;ch_vat&#x60;, &#x60;cl_tin&#x60;, &#x60;es_cif&#x60;, &#x60;eu_vat&#x60;, &#x60;gb_vat&#x60;, &#x60;ge_vat&#x60;, &#x60;hk_br&#x60;, &#x60;id_npwp&#x60;, &#x60;il_vat&#x60;, &#x60;in_gst&#x60;, &#x60;jp_cn&#x60;, &#x60;jp_rn&#x60;, &#x60;kr_brn&#x60;, &#x60;li_uid&#x60;, &#x60;mx_rfc&#x60;, &#x60;my_frp&#x60;, &#x60;my_itn&#x60;, &#x60;my_sst&#x60;, &#x60;no_vat&#x60;, &#x60;nz_gst&#x60;, &#x60;ru_inn&#x60;, &#x60;ru_kpp&#x60;, &#x60;sa_vat&#x60;, &#x60;sg_gst&#x60;, &#x60;sg_uen&#x60;, &#x60;th_vat&#x60;, &#x60;tw_vat&#x60;, &#x60;ua_vat&#x60;, &#x60;us_ein&#x60;, or &#x60;za_vat&#x60;
  ...
  # @param file The ID of the file. The file&#39;s &#x60;purpose&#x60; must be one of the following: &#x60;business_icon&#x60;, &#x60;business_logo&#x60;, &#x60;customer_signature&#x60;, &#x60;dispute_evidence&#x60;, &#x60;finance_report_run&#x60;, &#x60;identity_document_downloadable&#x60;, &#x60;pci_document&#x60;, &#x60;selfie&#x60;, &#x60;sigma_scheduled_query&#x60;, or &#x60;tax_document_user_upload&#x60;.
  # @param [Hash] opts the optional parameters
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [AnyOfstringintegerstring] :expires_at A future timestamp after which the link will no longer be usable, or &#x60;now&#x60; to expire the link immediately.
  # @option opts [AnyOfmapstring] :metadata Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to &#x60;metadata&#x60;.
  # @return [FileLink]
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [Int32] :amount The integer amount in %s of the charge to be applied to the upcoming invoice. Passing in a negative &#x60;amount&#x60; will reduce the &#x60;amount_due&#x60; on the invoice.
  # @option opts [String] :currency Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies).
  ...
  # @option opts [AnyOfarraystring] :discounts The coupons to redeem into discounts for the invoice item or invoice line item.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  ...
  # @option opts [Int32] :unit_amount The integer unit amount in %s of the charge to be applied to the upcoming invoice. This &#x60;unit_amount&#x60; will be multiplied by the quantity to get the full amount. Passing in a negative &#x60;unit_amount&#x60; will reduce the &#x60;amount_due&#x60; on the invoice.
  # @option opts [String] :unit_amount_decimal Same as &#x60;unit_amount&#x60;, but accepts a decimal value in %s with at most 12 decimal places. Only one of &#x60;unit_amount&#x60; and &#x60;unit_amount_decimal&#x60; can be set.
  # @return [Invoiceitem]
  ...
  # @param invoiceitem
  # @param [Hash] opts the optional parameters
  # @option opts [Int32] :amount The integer amount in %s of the charge to be applied to the upcoming invoice. If you want to apply a credit to the customer&#39;s account, pass a negative amount.
  # @option opts [String] :description An arbitrary string which you can attach to the invoice item. The description is displayed in the invoice for easy tracking.
  ...
  # @option opts [AnyOfarraystring] :discounts The coupons &amp; existing discounts which apply to the invoice item or invoice line item. Item discounts are applied before invoice discounts. Pass an empty string to remove previously-defined discounts.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [AnyOfmapstring] :metadata Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to &#x60;metadata&#x60;.
  # @option opts [Period1] :period
  # @option opts [String] :price The ID of the price object.
  # @option opts [OneTimePriceData1] :price_data
  # @option opts [Int32] :quantity Non-negative integer. The quantity of units for the invoice item.
  # @option opts [AnyOfarraystring] :tax_rates The tax rates which apply to the invoice item. When set, the &#x60;default_tax_rates&#x60; on the invoice do not apply to this invoice item. Pass an empty string to remove previously-defined tax rates.
  # @option opts [Int32] :unit_amount The integer unit amount in %s of the charge to be applied to the upcoming invoice. This unit_amount will be multiplied by the quantity to get the full amount. If you want to apply a credit to the customer&#39;s account, pass a negative unit_amount.
  # @option opts [String] :unit_amount_decimal Same as &#x60;unit_amount&#x60;, but accepts a decimal value in %s with at most 12 decimal places. Only one of &#x60;unit_amount&#x60; and &#x60;unit_amount_decimal&#x60; can be set.
  # @return [Invoiceitem]
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [AnyOfarraystring] :account_tax_ids The account tax IDs associated with the invoice. Only editable when the invoice is a draft.
  # @option opts [Int32] :application_fee_amount A fee in %s that will be applied to the invoice and transferred to the application owner&#39;s Stripe account. The request must be made with an OAuth key or the Stripe-Account header in order to take an application fee. For more information, see the application fees [documentation](https://stripe.com/docs/billing/invoices/connect#collecting-fees).
  ...
  # @option opts [AnyOfarraystring] :custom_fields A list of up to 4 custom fields to be displayed on the invoice.
  ...
  # @option opts [AnyOfarraystring] :discounts The coupons to redeem into discounts for the invoice. If not specified, inherits the discount from the invoice&#39;s customer. Pass an empty string to avoid inheriting any discounts.
  ...
  # @option opts [String] :subscription The ID of the subscription to invoice, if any. If not set, the created invoice will include all pending invoice items for the customer. If set, the created invoice will only include pending invoice items for that subscription and pending invoice items not associated with any subscription. The subscription&#39;s billing cycle and regular subscription events won&#39;t be affected.
  ...
  # @option opts [AnyOfarraystring] :custom_fields A list of up to 4 custom fields to be displayed on the invoice. If a value for &#x60;custom_fields&#x60; is specified, the list specified will replace the existing custom field list on this invoice. Pass an empty string to remove previously-defined fields.
  ...
  # @option opts [String] :default_payment_method ID of the default payment method for the invoice. It must belong to the customer associated with the invoice. If not set, defaults to the subscription&#39;s default payment method, if any, or to the default payment method in the customer&#39;s invoice settings.
  # @option opts [String] :default_source ID of the default payment source for the invoice. It must belong to the customer associated with the invoice and be in a chargeable state. If not set, defaults to the subscription&#39;s default source, if any, or to the customer&#39;s default source.
  # @option opts [AnyOfarraystring] :default_tax_rates The tax rates that will apply to any line item that does not have &#x60;tax_rates&#x60; set. Pass an empty string to remove previously-defined tax rates.
  # @option opts [String] :description An arbitrary string attached to the object. Often useful for displaying to users. Referenced as &#39;memo&#39; in the Dashboard.
  # @option opts [AnyOfarraystring] :discounts The discounts that will apply to the invoice. Pass an empty string to remove previously-defined discounts.
  ...
  # @option opts [String] :footer Footer to be displayed on the invoice.
  # @option opts [AnyOfmapstring] :metadata Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to &#x60;metadata&#x60;.
  # @option opts [AnyOfstringstring] :on_behalf_of The account (if any) for which the funds of the invoice payment are intended. If set, the invoice will be presented with the branding and support information of the specified account. See the [Invoices with Connect](https://stripe.com/docs/billing/invoices/connect) documentation for details.
  # @option opts [PaymentSettings1] :payment_settings
  # @option opts [String] :statement_descriptor Extra information about a charge for the customer&#39;s credit card statement. It must contain at least one letter. If not specified and this invoice is part of a subscription, the default &#x60;statement_descriptor&#x60; will be set to the first subscription item&#39;s product&#39;s &#x60;statement_descriptor&#x60;.
  # @option opts [AnyOfobjectstring] :transfer_data If specified, the funds from the invoice will be transferred to the destination and the ID of the resulting transfer will be found on the invoice&#39;s charge. This will be unset if you POST an empty value.
  # @return [Invoice]
  ...
  # @param billing
  # @param name The cardholder&#39;s name. This will be printed on cards issued to them. The maximum length of this field is 24 characters.
  ...
  # @param transaction The ID of the issuing transaction to create a dispute for.
  # @param [Hash] opts the optional parameters
  ...
  # @param currency Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies).
  # @param [Hash] opts the optional parameters
  # @option opts [String] :coupon A coupon code that represents a discount to be applied to this order. Must be one-time duration and in same currency as the order. An order can have multiple coupons.
  # @option opts [String] :customer The ID of an existing customer to use for this order. If provided, the customer email and shipping address will be used to create the order. Subsequently, the customer will also be charged to pay the order. If &#x60;email&#x60; or &#x60;shipping&#x60; are also provided, they will override the values retrieved from the customer object.
  # @option opts [String] :email The email address of the customer placing the order.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Array(OrderItemSpecs)] :items List of items constituting the order. An order can have up to 25 items.
  # @option opts [CustomerShipping] :shipping
  # @return [Order]
  ...
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [AnyOfmapstring] :metadata Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to &#x60;metadata&#x60;.
  # @option opts [String] :selected_shipping_method The shipping method to select for fulfilling this order. If specified, must be one of the &#x60;id&#x60;s of a shipping method in the &#x60;shipping_methods&#x60; array. If specified, will overwrite the existing selected shipping method, updating &#x60;items&#x60; as necessary.
  # @option opts [ShippingTrackingParams] :shipping
  # @option opts [String] :status Current order status. One of &#x60;created&#x60;, &#x60;paid&#x60;, &#x60;canceled&#x60;, &#x60;fulfilled&#x60;, or &#x60;returned&#x60;. More detail in the [Orders Guide](https://stripe.com/docs/orders/guide#understanding-order-statuses).
  # @return [Order]
  ...
  # unit tests for post_orders_id_pay
  # &lt;p&gt;Pay an order by providing a &lt;code&gt;source&lt;/code&gt; to create a payment.&lt;/p&gt;
  # @param id
  # @param [Hash] opts the optional parameters
  # @option opts [Int32] :application_fee A fee in %s that will be applied to the order and transferred to the application owner&#39;s Stripe account. The request must be made with an OAuth key or the &#x60;Stripe-Account&#x60; header in order to take an application fee. For more information, see the application fees [documentation](https://stripe.com/docs/connect/direct-charges#collecting-fees).
  # @option opts [String] :customer The ID of an existing customer that will be charged for this order. If no customer was attached to the order at creation, either &#x60;source&#x60; or &#x60;customer&#x60; is required. Otherwise, the specified customer will be charged instead of the one attached to the order.
  # @option opts [String] :email The email address of the customer placing the order. Required if not previously specified for the order.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [String] :source A [Token](https://stripe.com/docs/api#tokens)&#39;s or a [Source](https://stripe.com/docs/api#sources)&#39;s ID, as returned by [Elements](https://stripe.com/docs/elements). If no customer was attached to the order at creation, either &#x60;source&#x60; or &#x60;customer&#x60; is required. Otherwise, the specified source will be charged intead of the customer attached to the order.
  # @return [Order]
  describe "post_orders_id_pay test" do
    it "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
    end
  end

  # unit tests for post_orders_id_returns
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [AnyOfarraystring] :items List of items to return.
  # @return [OrderReturn]
  describe "post_orders_id_returns test" do
    it "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
    end
  end
  ...
  # @option opts [AnyOfbooleanstring] :off_session Set to &#x60;true&#x60; to indicate that the customer is not in your checkout flow during this payment attempt, and therefore is unable to authenticate. This parameter is intended for scenarios where you collect card details and [charge them later](https://stripe.com/docs/payments/cards/charging-saved-cards). This parameter can only be used with [&#x60;confirm&#x3D;true&#x60;](https://stripe.com/docs/api/payment_intents/create#create_payment_intent-confirm).
  ...
  # @option opts [PaymentMethodOptionsParam3] :payment_method_options
  # @option opts [Array(String)] :payment_method_types The list of payment method types (e.g. card) that this PaymentIntent is allowed to use. If this is not provided, defaults to [\\\&quot;card\\\&quot;].
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [Int32] :amount Amount intended to be collected by this PaymentIntent. A positive integer representing how much to charge in the [smallest currency unit](https://stripe.com/docs/currencies#zero-decimal) (e.g., 100 cents to charge $1.00 or 100 to charge ¥100, a zero-decimal currency). The minimum amount is $0.50 US or [equivalent in charge currency](https://stripe.com/docs/currencies#minimum-and-maximum-charge-amounts). The amount value supports up to eight digits (e.g., a value of 99999999 for a USD charge of $999,999.99).
  # @option opts [AnyOfintegerstring] :application_fee_amount The amount of the application fee (if any) that will be requested to be applied to the payment and transferred to the application owner&#39;s Stripe account. The amount of the application fee collected will be capped at the total payment amount. For more information, see the PaymentIntents [use case for connected accounts](https://stripe.com/docs/payments/connected-accounts).
  # @option opts [String] :currency Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies).
  # @option opts [String] :customer ID of the Customer this PaymentIntent belongs to, if one exists.  Payment methods attached to other Customers cannot be used with this PaymentIntent.  If present in combination with [setup_future_usage](https://stripe.com/docs/api#payment_intent_object-setup_future_usage), this PaymentIntent&#39;s payment method will be attached to the Customer after the PaymentIntent has been confirmed and any required actions from the user are complete.
  # @option opts [String] :description An arbitrary string attached to the object. Often useful for displaying to users.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  ...
  # @option opts [PaymentMethodDataParams] :payment_method_data
  # @option opts [PaymentMethodOptionsParam3] :payment_method_options
  # @option opts [Array(String)] :payment_method_types The list of payment method types (e.g. card) that this PaymentIntent is allowed to use.
  # @option opts [AnyOfstringstring] :receipt_email Email address that the receipt for the resulting payment will be sent to. If &#x60;receipt_email&#x60; is specified for a payment in live mode, a receipt will be sent regardless of your [email settings](https://dashboard.stripe.com/account/emails).
  # @option opts [String] :setup_future_usage Indicates that you intend to make future payments with this PaymentIntent&#39;s payment method.  Providing this parameter will [attach the payment method](https://stripe.com/docs/payments/save-during-payment) to the PaymentIntent&#39;s Customer, if present, after the PaymentIntent is confirmed and any required actions from the user are complete. If no Customer was provided, the payment method can still be [attached](https://stripe.com/docs/api/payment_methods/attach) to a Customer after the transaction completes.  When processing card payments, Stripe also uses &#x60;setup_future_usage&#x60; to dynamically optimize your payment flow and comply with regional legislation and network rules, such as [SCA](https://stripe.com/docs/strong-customer-authentication).  If &#x60;setup_future_usage&#x60; is already set and you are performing a request using a publishable key, you may only update the value from &#x60;on_session&#x60; to &#x60;off_session&#x60;.
  # @option opts [AnyOfobjectstring] :shipping Shipping information for this PaymentIntent.
  # @option opts [String] :statement_descriptor For non-card charges, you can use this value as the complete description that appears on your customers’ statements. Must contain at least one letter, maximum 22 characters.
  # @option opts [String] :statement_descriptor_suffix Provides information about a card payment that customers see on their statements. Concatenated with the prefix (shortened descriptor) or statement descriptor that’s set on the account to form the complete statement descriptor. Maximum 22 characters for the concatenated descriptor.
  ...
  # @option opts [AnyOfobjectobject] :mandate_data This hash contains details about the Mandate to create
  ...
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [Array(LineItemsCreateParams)] :line_items The line items representing what is being sold. Each line item represents an item being sold. Up to 20 line items are supported.
  # @option opts [String] :on_behalf_of The account on behalf of which to charge.
  # @option opts [Array(String)] :payment_method_types The list of payment method types (e.g., card) that customers can use. Only &#x60;card&#x60; is supported. If no value is passed, your [payment methods settings](https://dashboard.stripe.com/settings/payment_methods) will be used.
  ...
  # @param payment_link
  # @param [Hash] opts the optional parameters
  # @option opts [Bool] :active Whether the payment link&#39;s &#x60;url&#x60; is active. If &#x60;false&#x60;, customers visiting the url will be redirected.
  # @option opts [AfterCompletionParams] :after_completion
  # @option opts [Bool] :allow_promotion_codes Enables user redeemable promotion codes.
  # @option opts [AutomaticTaxParams1] :automatic_tax
  # @option opts [String] :billing_address_collection Configuration for collecting the customer&#39;s billing address.
  ...
  # @option opts [AnyOfarraystring] :payment_method_types The list of payment method types (e.g., card) that customers can use. Only &#x60;card&#x60; is supported. Pass an empty string to enable automatic payment methods that use your [payment methods settings](https://dashboard.stripe.com/settings/payment_methods).
  # @option opts [AnyOfobjectstring] :shipping_address_collection Configuration for collecting the customer&#39;s shipping address.
  # @return [PaymentLink]
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [PaymentMethodParam1] :acss_debit
  ...
  # @option opts [AnyOfobjectobject] :card If this is a &#x60;card&#x60; PaymentMethod, this hash contains the user&#39;s card details. For backwards compatibility, you can alternatively provide a Stripe token (e.g., for Apple Pay, Amex Express Checkout, or legacy Checkout) into the card hash with format &#x60;card: {token: \\\&quot;tok_visa\\\&quot;}&#x60;. When providing a card number, you must meet the requirements for [PCI compliance](https://stripe.com/docs/security#validating-pci-compliance). We strongly recommend using Stripe.js instead of interacting with this API directly.
  ...
  # @option opts [Int32] :amount A positive integer in %s (or 0 for a free plan) representing how much to charge on a recurring basis.
  ...
  # @option opts [AnyOfobjectstring] :product
  ...
  # @option opts [Int32] :unit_amount A positive integer in %s (or 0 for a free price) representing how much to charge.
  # @option opts [String] :unit_amount_decimal Same as &#x60;unit_amount&#x60;, but accepts a decimal value in %s with at most 12 decimal places. Only one of &#x60;unit_amount&#x60; and &#x60;unit_amount_decimal&#x60; can be set.
  # @return [Price]
  ...
  # @param name The product&#39;s name, meant to be displayable to the customer. Whenever this product is sold via a subscription, name will show up on associated invoice line item descriptions.
  # @param [Hash] opts the optional parameters
  ...
  # @option opts [String] :tax_code A [tax code](https://stripe.com/docs/tax/tax-codes) ID.
  ...
  # @option opts [String] :description The product&#39;s description, meant to be displayable to the customer. Use this field to optionally store a long form explanation of the product being sold for your own rendering purposes.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [AnyOfarraystring] :images A list of up to 8 URLs of images for this product, meant to be displayable to the customer.
  # @option opts [AnyOfmapstring] :metadata Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to &#x60;metadata&#x60;.
  # @option opts [String] :name The product&#39;s name, meant to be displayable to the customer. Whenever this product is sold via a subscription, name will show up on associated invoice line item descriptions.
  # @option opts [AnyOfobjectstring] :package_dimensions The dimensions of this product for shipping purposes.
  # @option opts [Bool] :shippable Whether this product is shipped (i.e., physical goods).
  # @option opts [String] :statement_descriptor An arbitrary string to be displayed on your customer&#39;s credit card or bank statement. While most banks display this information consistently, some may display it incorrectly or not at all.  This may be up to 22 characters. The statement description may not include &#x60;&lt;&#x60;, &#x60;&gt;&#x60;, &#x60;\\\\&#x60;, &#x60;\\\&quot;&#x60;, &#x60;&#39;&#x60; characters, and will appear on your customer&#39;s statement in capital letters. Non-ASCII characters are automatically stripped.  It must contain at least one letter. May only be set if &#x60;type&#x3D;service&#x60;.
  # @option opts [AnyOfstringstring] :tax_code A [tax code](https://stripe.com/docs/tax/tax-codes) ID.
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [AnyOfintegerstring] :application_fee_amount The amount of the application fee (if any) that will be requested to be applied to the payment and transferred to the application owner&#39;s Stripe account. There cannot be any line items with recurring prices when using this field.
  # @option opts [AnyOfnumberstring] :application_fee_percent A non-negative decimal between 0 and 100, with at most two decimal places. This represents the percentage of the subscription invoice subtotal that will be transferred to the application owner&#39;s Stripe account. There must be at least 1 line item with a recurring price to use this field.
  # @option opts [AutomaticTaxParam3] :automatic_tax
  ...
  # @option opts [AnyOfarraystring] :default_tax_rates The tax rates that will apply to any line item that does not have &#x60;tax_rates&#x60; set.
  ...
  # @option opts [AnyOfarraystring] :discounts The discounts applied to the quote. You can only set up to one discount.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  ...
  # @option opts [AnyOfstringstring] :on_behalf_of The account on behalf of which to charge.
  # @option opts [SubscriptionDataCreateParams] :subscription_data
  # @option opts [AnyOfobjectstring] :transfer_data The data with which to automatically create a Transfer for each of the invoices.
  # @return [Quote]
  ...
  # unit tests for post_recipients
  ...
  # @param name The recipient&#39;s full, legal name. For type &#x60;individual&#x60;, should be in the format &#x60;First Last&#x60;, &#x60;First Middle Last&#x60;, or &#x60;First M Last&#x60; (no prefixes or suffixes). For &#x60;corporation&#x60;, the full, incorporated name.
  # @param _type Type of the recipient: either &#x60;individual&#x60; or &#x60;corporation&#x60;.
  # @param [Hash] opts the optional parameters
  # @option opts [String] :bank_account A bank account to attach to the recipient. You can provide either a token, like the ones returned by [Stripe.js](https://stripe.com/docs/js), or a dictionary containing a user&#39;s bank account details, with the options described below.
  # @option opts [String] :card A U.S. Visa or MasterCard debit card (_not_ prepaid) to attach to the recipient. If the debit card is not valid, recipient creation will fail. You can provide either a token, like the ones returned by [Stripe.js](https://stripe.com/docs/js), or a dictionary containing a user&#39;s debit card details, with the options described below. Although not all information is required, the extra info helps prevent fraud.
  # @option opts [String] :description An arbitrary string which you can attach to a &#x60;Recipient&#x60; object. It is displayed alongside the recipient in the web interface.
  # @option opts [String] :email The recipient&#39;s email address. It is displayed alongside the recipient in the web interface, and can be useful for searching and tracking.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [AnyOfmapstring] :metadata Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to &#x60;metadata&#x60;.
  # @option opts [String] :tax_id The recipient&#39;s tax ID, as a string. For type &#x60;individual&#x60;, the full SSN; for type &#x60;corporation&#x60;, the full EIN.
  # @return [Recipient]
  describe "post_recipients test" do
    it "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
    end
  end

  # unit tests for post_recipients_id
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [String] :bank_account A bank account to attach to the recipient. You can provide either a token, like the ones returned by [Stripe.js](https://stripe.com/docs/js), or a dictionary containing a user&#39;s bank account details, with the options described below.
  # @option opts [String] :card A U.S. Visa or MasterCard debit card (not prepaid) to attach to the recipient. You can provide either a token, like the ones returned by [Stripe.js](https://stripe.com/docs/js), or a dictionary containing a user&#39;s debit card details, with the options described below. Passing &#x60;card&#x60; will create a new card, make it the new recipient default card, and delete the old recipient default (if one exists). If you want to add additional debit cards instead of replacing the existing default, use the [card creation API](https://stripe.com/docs/api#create_card). Whenever you attach a card to a recipient, Stripe will automatically validate the debit card.
  # @option opts [String] :default_card ID of the card to set as the recipient&#39;s new default for payouts.
  # @option opts [String] :description An arbitrary string which you can attach to a &#x60;Recipient&#x60; object. It is displayed alongside the recipient in the web interface.
  # @option opts [String] :email The recipient&#39;s email address. It is displayed alongside the recipient in the web interface, and can be useful for searching and tracking.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [AnyOfmapstring] :metadata Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to &#x60;metadata&#x60;.
  # @option opts [String] :name The recipient&#39;s full, legal name. For type &#x60;individual&#x60;, should be in the format &#x60;First Last&#x60;, &#x60;First Middle Last&#x60;, or &#x60;First M Last&#x60; (no prefixes or suffixes). For &#x60;corporation&#x60;, the full, incorporated name.
  # @option opts [String] :tax_id The recipient&#39;s tax ID, as a string. For type &#x60;individual&#x60;, the full SSN; for type &#x60;corporation&#x60;, the full EIN.
  # @return [Recipient]
  describe "post_recipients_id test" do
    it "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
    end
  end
  ...
  # @option opts [String] :description An arbitrary string attached to the object. Often useful for displaying to users.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [SecretKeyParam1] :mandate_data
  ...
  # @option opts [PaymentMethodOptionsParam4] :payment_method_options
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [DeliveryEstimate2] :delivery_estimate
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  ...
  # @option opts [String] :tax_code A [tax code](https://stripe.com/docs/tax/tax-codes) ID. The Shipping tax code is &#x60;txcd_92010001&#x60;.
  ...
  # @option opts [AnyOfmapstring] :metadata Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to &#x60;metadata&#x60;.
  # @option opts [AnyOfobjectstring] :package_dimensions The dimensions of this SKU for shipping purposes.
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [AnyOfobjectstring] :billing_thresholds Define thresholds at which an invoice will be sent, and the subscription advanced to a new billing period. When updating, pass an empty string to remove previously-defined thresholds.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [String] :payment_behavior Use &#x60;allow_incomplete&#x60; to transition the subscription to &#x60;status&#x3D;past_due&#x60; if a payment is required but cannot be paid. This allows you to manage scenarios where additional user actions are needed to pay a subscription&#39;s invoice. For example, SCA regulation may require 3DS authentication to complete payment. See the [SCA Migration Guide](https://stripe.com/docs/billing/migration/strong-customer-authentication) for Billing to learn more. This is the default behavior.  Use &#x60;default_incomplete&#x60; to transition the subscription to &#x60;status&#x3D;past_due&#x60; when payment is required and await explicit confirmation of the invoice&#39;s payment intent. This allows simpler management of scenarios where additional user actions are needed to pay a subscription’s invoice. Such as failed payments, [SCA regulation](https://stripe.com/docs/billing/migration/strong-customer-authentication), or collecting a mandate for a bank debit payment method.  Use &#x60;pending_if_incomplete&#x60; to update the subscription using [pending updates](https://stripe.com/docs/billing/subscriptions/pending-updates). When you use &#x60;pending_if_incomplete&#x60; you can only pass the parameters [supported by pending updates](https://stripe.com/docs/billing/pending-updates-reference#supported-attributes).  Use &#x60;error_if_incomplete&#x60; if you want Stripe to return an HTTP 402 status code if a subscription&#39;s invoice cannot be paid. For example, if a payment method requires 3DS authentication due to SCA regulation and further user action is needed, this parameter does not update the subscription and returns an error instead. This was the default behavior for API versions prior to 2019-03-14. See the [changelog](https://stripe.com/docs/upgrades#2019-03-14) to learn more.
  # @option opts [String] :price The ID of the price object.
  ...
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [AnyOfstringinteger] :timestamp The timestamp for the usage event. This timestamp must be within the current billing period of the subscription of the provided &#x60;subscription_item&#x60;, and must not be in the future. When passing &#x60;\\\&quot;now\\\&quot;&#x60;, Stripe records usage for the current time. Default is &#x60;\\\&quot;now\\\&quot;&#x60; if a value is not provided.
  # @return [UsageRecord]
  ...
  # @option opts [AnyOfintegerstring] :start_date When the subscription schedule starts. We recommend using &#x60;now&#x60; so that it starts the subscription immediately. You can also use a Unix timestamp to backdate the subscription so that it starts on a past date, or set a future date for the subscription to start on.
  # @return [SubscriptionSchedule]
  ...
  # @option opts [String] :proration_behavior If the update changes the current phase, indicates if the changes should be prorated. Possible values are &#x60;create_prorations&#x60; or &#x60;none&#x60;, and the default value is &#x60;create_prorations&#x60;.
  # @return [SubscriptionSchedule]
  ...
  # @option opts [AnyOfobjectstring] :card
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [Int32] :amount A positive integer in %s representing how much to transfer.
  # @option opts [String] :description An arbitrary string attached to the object. Often useful for displaying to users.
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  ...
  # @param id
  # @param [Hash] opts the optional parameters
  # @option opts [Int32] :amount A positive integer in %s representing how much of this transfer to reverse. Can only reverse up to the unreversed amount remaining of the transfer. Partial transfer reversals are only allowed for transfers to Stripe Accounts. Defaults to the entire transfer amount.
