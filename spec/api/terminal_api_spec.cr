...
require "../spec_helper"
require "../../src/stripe/api/terminal_api"
...
describe "TerminalApi" do
  ...
  # @option opts [String] :serial_number Filters readers by serial number
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  ...
  # @option opts [Array(String)] :expand Specifies which fields in the response should be expanded.
  # @option opts [String] :name Name of the configuration
  # @option opts [PostTerminalConfigurationsRequestOffline] :offline
  # @option opts [RebootWindow] :reboot_window
  # @option opts [StripeS700] :stripe_s700
  ...
  # @option opts [String] :name Name of the configuration
  # @option opts [PostTerminalConfigurationsRequestOffline] :offline
  # @option opts [PostTerminalConfigurationsConfigurationRequestRebootWindow] :reboot_window
  # @option opts [PostTerminalConfigurationsConfigurationRequestStripeS700] :stripe_s700
  # @option opts [PostTerminalConfigurationsRequestTipping] :tipping
