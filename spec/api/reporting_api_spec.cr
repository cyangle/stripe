...
require "../spec_helper"
require "../../src/stripe/api/reporting_api"
...
describe "ReportingApi" do
  ...
  # @option opts [GetAccountsCreatedParameter] :created Only return Report Runs that were created during the given date interval.
