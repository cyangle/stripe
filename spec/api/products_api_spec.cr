...
require "../spec_helper"
require "../../src/stripe/api/products_api"
...
describe "ProductsApi" do
  ...
  # @option opts [Array(Features)] :marketing_features A list of up to 15 marketing features for this product. These are displayed in [pricing tables](https://stripe.com/docs/payments/checkout/pricing-table).
  ...
  # @option opts [String] :unit_label A label that represents units of this product. When set, this will be included in customers&#39; receipts, invoices, Checkout, and the customer portal.
