...
# Unit tests for Stripe::SkuProduct
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::SkuProduct do
  describe "test an instance of SkuProduct" do
    it "should create an instance of SkuProduct" do
      # instance = Stripe::SkuProduct.new
      # expect(instance).to be_instance_of(Stripe::SkuProduct)
    end
  end
