...
# Unit tests for Stripe::CheckoutSessionPaymentLink
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
require "../spec_helper"
require "../../src/stripe/models/checkout_session_payment_link"

describe Stripe::CheckoutSessionPaymentLink do
  describe "test an instance of CheckoutSessionPaymentLink" do
    it "should create an instance of CheckoutSessionPaymentLink" do
      # instance = Stripe::CheckoutSessionPaymentLink.new
      # (instance).should be_a(Stripe::CheckoutSessionPaymentLink)
    end
  end
  ...
  describe "test attribute 'billing_address_collection'" do
    it "should work" do
      # instance = Stripe::CheckoutSessionPaymentLink.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::CheckoutSessionPaymentLink::ENUM_VALIDATOR_FOR_BILLING_ADDRESS_COLLECTION
  ...
  describe "test attribute 'customer_creation'" do
    it "should work" do
      # instance = Stripe::CheckoutSessionPaymentLink.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::CheckoutSessionPaymentLink::ENUM_VALIDATOR_FOR_CUSTOMER_CREATION
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'object'" do
    it "should work" do
      # instance = Stripe::CheckoutSessionPaymentLink.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::CheckoutSessionPaymentLink::ENUM_VALIDATOR_FOR_OBJECT
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'payment_method_collection'" do
    it "should work" do
      # instance = Stripe::CheckoutSessionPaymentLink.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::CheckoutSessionPaymentLink::ENUM_VALIDATOR_FOR_PAYMENT_METHOD_COLLECTION
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'payment_method_types'" do
    it "should work" do
      # instance = Stripe::CheckoutSessionPaymentLink.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::CheckoutSessionPaymentLink::ENUM_VALIDATOR_FOR_PAYMENT_METHOD_TYPES
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'submit_type'" do
    it "should work" do
      # instance = Stripe::CheckoutSessionPaymentLink.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::CheckoutSessionPaymentLink::ENUM_VALIDATOR_FOR_SUBMIT_TYPE
      # validator.allowable_values.each do |value|
