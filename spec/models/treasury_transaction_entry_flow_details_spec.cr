...
# Unit tests for Stripe::TreasuryTransactionEntryFlowDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::TreasuryTransactionEntryFlowDetails do
  describe "test an instance of TreasuryTransactionEntryFlowDetails" do
    it "should create an instance of TreasuryTransactionEntryFlowDetails" do
      # instance = Stripe::TreasuryTransactionEntryFlowDetails.new
      # expect(instance).to be_instance_of(Stripe::TreasuryTransactionEntryFlowDetails)
    end
  end
