...
# Unit tests for Stripe::UpdateParams1WechatPay
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::UpdateParams1WechatPay do
  describe "test an instance of UpdateParams1WechatPay" do
    it "should create an instance of UpdateParams1WechatPay" do
      # instance = Stripe::UpdateParams1WechatPay.new
      # expect(instance).to be_instance_of(Stripe::UpdateParams1WechatPay)
    end
  end
