...
# Unit tests for Stripe::Param13
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::Param13 do
  describe "test an instance of Param13" do
    it "should create an instance of Param13" do
      # instance = Stripe::Param13.new
      # expect(instance).to be_instance_of(Stripe::Param13)
    end
  end
