...
describe Stripe::PhaseConfigurationParams1 do
  describe "test an instance of PhaseConfigurationParams1" do
    it "should create an instance of PhaseConfigurationParams1" do
      ...
      # (instance).should be_a(Stripe::PhaseConfigurationParams1)
    end
  end
  ...
  describe "test attribute 'billing_cycle_anchor'" do
    it "should work" do
      # instance = Stripe::PhaseConfigurationParams1.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::PhaseConfigurationParams1::ENUM_VALIDATOR_FOR_BILLING_CYCLE_ANCHOR
  ...
  describe "test attribute 'collection_method'" do
    it "should work" do
      # instance = Stripe::PhaseConfigurationParams1.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::PhaseConfigurationParams1::ENUM_VALIDATOR_FOR_COLLECTION_METHOD
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'proration_behavior'" do
    it "should work" do
      # instance = Stripe::PhaseConfigurationParams1.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::PhaseConfigurationParams1::ENUM_VALIDATOR_FOR_PRORATION_BEHAVIOR
      # validator.allowable_values.each do |value|
