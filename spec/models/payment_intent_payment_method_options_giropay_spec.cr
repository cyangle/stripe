...
# Unit tests for Stripe::PaymentIntentPaymentMethodOptionsGiropay
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentIntentPaymentMethodOptionsGiropay do
  describe "test an instance of PaymentIntentPaymentMethodOptionsGiropay" do
    it "should create an instance of PaymentIntentPaymentMethodOptionsGiropay" do
      # instance = Stripe::PaymentIntentPaymentMethodOptionsGiropay.new
      # expect(instance).to be_instance_of(Stripe::PaymentIntentPaymentMethodOptionsGiropay)
    end
  end
