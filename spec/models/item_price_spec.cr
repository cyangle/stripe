...
describe Stripe::ItemPrice do
  describe "test an instance of ItemPrice" do
    it "should create an instance of ItemPrice" do
      # instance = Stripe::ItemPrice.new
      # expect(instance).to be_instance_of(Stripe::ItemPrice)
    end
  end
