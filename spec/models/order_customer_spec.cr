...
# Unit tests for Stripe::OrderCustomer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::OrderCustomer do
  describe "test an instance of OrderCustomer" do
    it "should create an instance of OrderCustomer" do
      # instance = Stripe::OrderCustomer.new
      # expect(instance).to be_instance_of(Stripe::OrderCustomer)
    end
  end
