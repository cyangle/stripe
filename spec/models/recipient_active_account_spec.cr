...
# Unit tests for Stripe::RecipientActiveAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::RecipientActiveAccount do
  describe "test an instance of RecipientActiveAccount" do
    it "should create an instance of RecipientActiveAccount" do
      # instance = Stripe::RecipientActiveAccount.new
      # expect(instance).to be_instance_of(Stripe::RecipientActiveAccount)
    end
  end
