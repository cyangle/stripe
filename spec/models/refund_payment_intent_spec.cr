...
# Unit tests for Stripe::RefundPaymentIntent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
require "../spec_helper"
require "../../src/stripe/models/refund_payment_intent"

describe Stripe::RefundPaymentIntent do
  describe "test an instance of RefundPaymentIntent" do
    it "should create an instance of RefundPaymentIntent" do
      # instance = Stripe::RefundPaymentIntent.new
      # (instance).should be_a(Stripe::RefundPaymentIntent)
    end
  end
  ...
  describe "test attribute 'cancellation_reason'" do
    it "should work" do
      # instance = Stripe::RefundPaymentIntent.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::RefundPaymentIntent::ENUM_VALIDATOR_FOR_CANCELLATION_REASON
  ...
  describe "test attribute 'capture_method'" do
    it "should work" do
      # instance = Stripe::RefundPaymentIntent.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::RefundPaymentIntent::ENUM_VALIDATOR_FOR_CAPTURE_METHOD
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'confirmation_method'" do
    it "should work" do
      # instance = Stripe::RefundPaymentIntent.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::RefundPaymentIntent::ENUM_VALIDATOR_FOR_CONFIRMATION_METHOD
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'object'" do
    it "should work" do
      # instance = Stripe::RefundPaymentIntent.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::RefundPaymentIntent::ENUM_VALIDATOR_FOR_OBJECT
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'setup_future_usage'" do
    it "should work" do
      # instance = Stripe::RefundPaymentIntent.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::RefundPaymentIntent::ENUM_VALIDATOR_FOR_SETUP_FUTURE_USAGE
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'status'" do
    it "should work" do
      # instance = Stripe::RefundPaymentIntent.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::RefundPaymentIntent::ENUM_VALIDATOR_FOR_STATUS
      # validator.allowable_values.each do |value|
