...
# Unit tests for Stripe::PaymentIntentPaymentMethodOptionsAcssDebit1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentIntentPaymentMethodOptionsAcssDebit1 do
  describe "test an instance of PaymentIntentPaymentMethodOptionsAcssDebit1" do
    it "should create an instance of PaymentIntentPaymentMethodOptionsAcssDebit1" do
      # instance = Stripe::PaymentIntentPaymentMethodOptionsAcssDebit1.new
      # expect(instance).to be_instance_of(Stripe::PaymentIntentPaymentMethodOptionsAcssDebit1)
    end
  end
