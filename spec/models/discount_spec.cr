...
# Unit tests for Stripe::Discount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
require "../spec_helper"
require "../../src/stripe/models/discount"

describe Stripe::Discount do
  describe "test an instance of Discount" do
    it "should create an instance of Discount" do
      # instance = Stripe::Discount.new
      # (instance).should be_a(Stripe::Discount)
    end
  end
  ...
  describe "test attribute 'object'" do
    it "should work" do
      # instance = Stripe::Discount.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::Discount::ENUM_VALIDATOR_FOR_OBJECT
