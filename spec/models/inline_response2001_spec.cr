...
# Unit tests for Stripe::InlineResponse2001
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::InlineResponse2001 do
  describe "test an instance of InlineResponse2001" do
    it "should create an instance of InlineResponse2001" do
      # instance = Stripe::InlineResponse2001.new
      # expect(instance).to be_instance_of(Stripe::InlineResponse2001)
    end
  end
