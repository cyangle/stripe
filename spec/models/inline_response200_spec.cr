...
# Unit tests for Stripe::InlineResponse200
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::InlineResponse200 do
  describe "test an instance of InlineResponse200" do
    it "should create an instance of InlineResponse200" do
      # instance = Stripe::InlineResponse200.new
      # expect(instance).to be_instance_of(Stripe::InlineResponse200)
    end
  end
