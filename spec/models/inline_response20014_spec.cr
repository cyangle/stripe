...
# Unit tests for Stripe::InlineResponse20014
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::InlineResponse20014 do
  describe "test an instance of InlineResponse20014" do
    it "should create an instance of InlineResponse20014" do
      # instance = Stripe::InlineResponse20014.new
      # expect(instance).to be_instance_of(Stripe::InlineResponse20014)
    end
  end
