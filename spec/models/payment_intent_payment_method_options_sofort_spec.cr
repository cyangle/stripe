...
# Unit tests for Stripe::PaymentIntentPaymentMethodOptionsSofort
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentIntentPaymentMethodOptionsSofort do
  describe "test an instance of PaymentIntentPaymentMethodOptionsSofort" do
    it "should create an instance of PaymentIntentPaymentMethodOptionsSofort" do
      # instance = Stripe::PaymentIntentPaymentMethodOptionsSofort.new
      # expect(instance).to be_instance_of(Stripe::PaymentIntentPaymentMethodOptionsSofort)
    end
  end
