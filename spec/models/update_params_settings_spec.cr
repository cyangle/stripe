...
# Unit tests for Stripe::UpdateParamsSettings
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::UpdateParamsSettings do
  describe "test an instance of UpdateParamsSettings" do
    it "should create an instance of UpdateParamsSettings" do
      # instance = Stripe::UpdateParamsSettings.new
      # (instance).should be_a(Stripe::UpdateParamsSettings)
    end
  end
  ...
  describe "test attribute 'payment_method_types'" do
    it "should work" do
      # instance = Stripe::UpdateParamsSettings.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::UpdateParamsSettings::ENUM_VALIDATOR_FOR_PAYMENT_METHOD_TYPES
