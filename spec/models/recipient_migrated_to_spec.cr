...
# Unit tests for Stripe::RecipientMigratedTo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::RecipientMigratedTo do
  describe "test an instance of RecipientMigratedTo" do
    it "should create an instance of RecipientMigratedTo" do
      # instance = Stripe::RecipientMigratedTo.new
      # expect(instance).to be_instance_of(Stripe::RecipientMigratedTo)
    end
  end
