...
# Unit tests for Stripe::PaymentIntentPaymentMethodOptionsAuBecsDebit1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentIntentPaymentMethodOptionsAuBecsDebit1 do
  describe "test an instance of PaymentIntentPaymentMethodOptionsAuBecsDebit1" do
    it "should create an instance of PaymentIntentPaymentMethodOptionsAuBecsDebit1" do
      # instance = Stripe::PaymentIntentPaymentMethodOptionsAuBecsDebit1.new
      # expect(instance).to be_instance_of(Stripe::PaymentIntentPaymentMethodOptionsAuBecsDebit1)
    end
  end
