...
require "../spec_helper"
require "../../src/stripe/models/bank_account_customer"

describe Stripe::BankAccountCustomer do
  describe "test an instance of BankAccountCustomer" do
    it "should create an instance of BankAccountCustomer" do
      # instance = Stripe::BankAccountCustomer.new
      # (instance).should be_a(Stripe::BankAccountCustomer)
    end
  end
  ...
  describe "test attribute 'object'" do
    it "should work" do
      # instance = Stripe::BankAccountCustomer.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::BankAccountCustomer::ENUM_VALIDATOR_FOR_OBJECT
  ...
  describe "test attribute 'tax_exempt'" do
    it "should work" do
      # instance = Stripe::BankAccountCustomer.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::BankAccountCustomer::ENUM_VALIDATOR_FOR_TAX_EXEMPT
      # validator.allowable_values.each do |value|
