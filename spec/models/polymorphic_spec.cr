...
# Unit tests for Stripe::Polymorphic
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::Polymorphic do
  describe "test an instance of Polymorphic" do
    it "should create an instance of Polymorphic" do
      # instance = Stripe::Polymorphic.new
      # expect(instance).to be_instance_of(Stripe::Polymorphic)
    end
  end
