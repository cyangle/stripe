...
# Unit tests for Stripe::PaymentIntentPaymentMethodOptionsAlipay
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentIntentPaymentMethodOptionsAlipay do
  describe "test an instance of PaymentIntentPaymentMethodOptionsAlipay" do
    it "should create an instance of PaymentIntentPaymentMethodOptionsAlipay" do
      # instance = Stripe::PaymentIntentPaymentMethodOptionsAlipay.new
      # expect(instance).to be_instance_of(Stripe::PaymentIntentPaymentMethodOptionsAlipay)
    end
  end
