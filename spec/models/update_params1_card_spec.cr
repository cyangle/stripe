...
describe Stripe::UpdateParams1Card do
  describe "test an instance of UpdateParams1Card" do
    it "should create an instance of UpdateParams1Card" do
      # instance = Stripe::UpdateParams1Card.new
      # expect(instance).to be_instance_of(Stripe::UpdateParams1Card)
    end
  end
