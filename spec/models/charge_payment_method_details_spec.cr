...
describe Stripe::ChargePaymentMethodDetails do
  describe "test an instance of ChargePaymentMethodDetails" do
    it "should create an instance of ChargePaymentMethodDetails" do
      # instance = Stripe::ChargePaymentMethodDetails.new
      # expect(instance).to be_instance_of(Stripe::ChargePaymentMethodDetails)
    end
  end
