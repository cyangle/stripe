...
# Unit tests for Stripe::UpdateParams1Klarna
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::UpdateParams1Klarna do
  describe "test an instance of UpdateParams1Klarna" do
    it "should create an instance of UpdateParams1Klarna" do
      # instance = Stripe::UpdateParams1Klarna.new
      # expect(instance).to be_instance_of(Stripe::UpdateParams1Klarna)
    end
  end
