...
# Unit tests for Stripe::PaymentIntentPaymentMethodOptionsOxxo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentIntentPaymentMethodOptionsOxxo do
  describe "test an instance of PaymentIntentPaymentMethodOptionsOxxo" do
    it "should create an instance of PaymentIntentPaymentMethodOptionsOxxo" do
      # instance = Stripe::PaymentIntentPaymentMethodOptionsOxxo.new
      # expect(instance).to be_instance_of(Stripe::PaymentIntentPaymentMethodOptionsOxxo)
    end
  end
