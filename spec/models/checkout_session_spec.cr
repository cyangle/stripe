...
require "../spec_helper"
require "../../src/stripe/models/checkout_session"
...
describe Stripe::CheckoutSession do
  ...
  describe "test attribute 'redirect_on_completion'" do
    it "should work" do
      # instance = Stripe::CheckoutSession.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::CheckoutSession::ENUM_VALIDATOR_FOR_REDIRECT_ON_COMPLETION
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'ui_mode'" do
    it "should work" do
      # instance = Stripe::CheckoutSession.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::CheckoutSession::ENUM_VALIDATOR_FOR_UI_MODE
      # validator.allowable_values.each do |value|
