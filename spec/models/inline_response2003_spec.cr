...
# Unit tests for Stripe::InlineResponse2003
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::InlineResponse2003 do
  describe "test an instance of InlineResponse2003" do
    it "should create an instance of InlineResponse2003" do
      # instance = Stripe::InlineResponse2003.new
      # expect(instance).to be_instance_of(Stripe::InlineResponse2003)
    end
  end
