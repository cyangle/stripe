...
# Unit tests for Stripe::InlineResponse20010
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::InlineResponse20010 do
  describe "test an instance of InlineResponse20010" do
    it "should create an instance of InlineResponse20010" do
      # instance = Stripe::InlineResponse20010.new
      # expect(instance).to be_instance_of(Stripe::InlineResponse20010)
    end
  end
