...
# Unit tests for Stripe::InlineResponse20029
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::InlineResponse20029 do
  describe "test an instance of InlineResponse20029" do
    it "should create an instance of InlineResponse20029" do
      # instance = Stripe::InlineResponse20029.new
      # expect(instance).to be_instance_of(Stripe::InlineResponse20029)
    end
  end
