...
# Unit tests for Stripe::PaymentIntentPaymentMethodOptionsCard1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentIntentPaymentMethodOptionsCard1 do
  describe "test an instance of PaymentIntentPaymentMethodOptionsCard1" do
    it "should create an instance of PaymentIntentPaymentMethodOptionsCard1" do
      # instance = Stripe::PaymentIntentPaymentMethodOptionsCard1.new
      # expect(instance).to be_instance_of(Stripe::PaymentIntentPaymentMethodOptionsCard1)
    end
  end
