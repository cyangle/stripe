...
# Unit tests for Stripe::SetupAttemptSetupIntent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
require "../spec_helper"
require "../../src/stripe/models/setup_attempt_setup_intent"

describe Stripe::SetupAttemptSetupIntent do
  describe "test an instance of SetupAttemptSetupIntent" do
    it "should create an instance of SetupAttemptSetupIntent" do
      # instance = Stripe::SetupAttemptSetupIntent.new
      # (instance).should be_a(Stripe::SetupAttemptSetupIntent)
    end
  end
  ...
  describe "test attribute 'cancellation_reason'" do
    it "should work" do
      # instance = Stripe::SetupAttemptSetupIntent.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::SetupAttemptSetupIntent::ENUM_VALIDATOR_FOR_CANCELLATION_REASON
  ...
  describe "test attribute 'flow_directions'" do
    it "should work" do
      # instance = Stripe::SetupAttemptSetupIntent.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::SetupAttemptSetupIntent::ENUM_VALIDATOR_FOR_FLOW_DIRECTIONS
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'object'" do
    it "should work" do
      # instance = Stripe::SetupAttemptSetupIntent.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::SetupAttemptSetupIntent::ENUM_VALIDATOR_FOR_OBJECT
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'status'" do
    it "should work" do
      # instance = Stripe::SetupAttemptSetupIntent.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::SetupAttemptSetupIntent::ENUM_VALIDATOR_FOR_STATUS
      # validator.allowable_values.each do |value|
