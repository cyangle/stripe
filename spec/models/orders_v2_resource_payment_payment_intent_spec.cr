...
# Unit tests for Stripe::OrdersV2ResourcePaymentPaymentIntent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::OrdersV2ResourcePaymentPaymentIntent do
  describe "test an instance of OrdersV2ResourcePaymentPaymentIntent" do
    it "should create an instance of OrdersV2ResourcePaymentPaymentIntent" do
      # instance = Stripe::OrdersV2ResourcePaymentPaymentIntent.new
      # expect(instance).to be_instance_of(Stripe::OrdersV2ResourcePaymentPaymentIntent)
    end
  end
