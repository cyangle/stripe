...
describe Stripe::TreasuryOutboundPayment do
  describe "test an instance of TreasuryOutboundPayment" do
    it "should create an instance of TreasuryOutboundPayment" do
      ...
      # expect(instance).to be_instance_of(Stripe::TreasuryOutboundPayment)
    end
  end
  ...
  describe "test attribute 'object'" do
    it "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = EnumValidator.new("String", ["treasury.outbound_payment"])
  ...
  describe "test attribute 'status'" do
    it "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = EnumValidator.new("String", ["canceled", "failed", "posted", "processing", "returned"])
      # validator.allowable_values.each do |value|
