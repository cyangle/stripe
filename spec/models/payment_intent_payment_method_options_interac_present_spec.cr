...
# Unit tests for Stripe::PaymentIntentPaymentMethodOptionsInteracPresent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentIntentPaymentMethodOptionsInteracPresent do
  describe "test an instance of PaymentIntentPaymentMethodOptionsInteracPresent" do
    it "should create an instance of PaymentIntentPaymentMethodOptionsInteracPresent" do
      # instance = Stripe::PaymentIntentPaymentMethodOptionsInteracPresent.new
      # expect(instance).to be_instance_of(Stripe::PaymentIntentPaymentMethodOptionsInteracPresent)
    end
  end
