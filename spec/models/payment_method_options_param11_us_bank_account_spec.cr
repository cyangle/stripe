...
# Unit tests for Stripe::PaymentMethodOptionsParam11UsBankAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentMethodOptionsParam11UsBankAccount do
  describe "test an instance of PaymentMethodOptionsParam11UsBankAccount" do
    it "should create an instance of PaymentMethodOptionsParam11UsBankAccount" do
      # instance = Stripe::PaymentMethodOptionsParam11UsBankAccount.new
      # expect(instance).to be_instance_of(Stripe::PaymentMethodOptionsParam11UsBankAccount)
    end
  end
