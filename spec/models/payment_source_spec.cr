...
# Unit tests for Stripe::PaymentSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentSource do
  describe "test an instance of PaymentSource" do
    it "should create an instance of PaymentSource" do
      # instance = Stripe::PaymentSource.new
      # expect(instance).to be_instance_of(Stripe::PaymentSource)
    end
  end
