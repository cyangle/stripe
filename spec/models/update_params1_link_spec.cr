...
# Unit tests for Stripe::UpdateParams1Link
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::UpdateParams1Link do
  describe "test an instance of UpdateParams1Link" do
    it "should create an instance of UpdateParams1Link" do
      # instance = Stripe::UpdateParams1Link.new
      # expect(instance).to be_instance_of(Stripe::UpdateParams1Link)
    end
  end
