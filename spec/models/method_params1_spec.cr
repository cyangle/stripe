...
# Unit tests for Stripe::MethodParams1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::MethodParams1 do
  describe "test an instance of MethodParams1" do
    it "should create an instance of MethodParams1" do
      # instance = Stripe::MethodParams1.new
      # expect(instance).to be_instance_of(Stripe::MethodParams1)
    end
  end
