...
# Unit tests for Stripe::IssuerFraudRecordCharge
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::IssuerFraudRecordCharge do
  describe "test an instance of IssuerFraudRecordCharge" do
    it "should create an instance of IssuerFraudRecordCharge" do
      # instance = Stripe::IssuerFraudRecordCharge.new
      # expect(instance).to be_instance_of(Stripe::IssuerFraudRecordCharge)
    end
  end
