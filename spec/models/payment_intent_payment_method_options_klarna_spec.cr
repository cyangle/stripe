...
# Unit tests for Stripe::PaymentIntentPaymentMethodOptionsKlarna
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentIntentPaymentMethodOptionsKlarna do
  describe "test an instance of PaymentIntentPaymentMethodOptionsKlarna" do
    it "should create an instance of PaymentIntentPaymentMethodOptionsKlarna" do
      # instance = Stripe::PaymentIntentPaymentMethodOptionsKlarna.new
      # expect(instance).to be_instance_of(Stripe::PaymentIntentPaymentMethodOptionsKlarna)
    end
  end
