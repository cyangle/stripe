...
# Unit tests for Stripe::PaymentIntentPaymentMethodOptionsEps1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentIntentPaymentMethodOptionsEps1 do
  describe "test an instance of PaymentIntentPaymentMethodOptionsEps1" do
    it "should create an instance of PaymentIntentPaymentMethodOptionsEps1" do
      # instance = Stripe::PaymentIntentPaymentMethodOptionsEps1.new
      # expect(instance).to be_instance_of(Stripe::PaymentIntentPaymentMethodOptionsEps1)
    end
  end
