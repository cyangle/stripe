...
# Unit tests for Stripe::PaymentMethodOptionsParam21UsBankAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentMethodOptionsParam21UsBankAccount do
  describe "test an instance of PaymentMethodOptionsParam21UsBankAccount" do
    it "should create an instance of PaymentMethodOptionsParam21UsBankAccount" do
      # instance = Stripe::PaymentMethodOptionsParam21UsBankAccount.new
      # expect(instance).to be_instance_of(Stripe::PaymentMethodOptionsParam21UsBankAccount)
    end
  end
