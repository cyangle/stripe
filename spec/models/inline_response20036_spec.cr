...
# Unit tests for Stripe::InlineResponse20036
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::InlineResponse20036 do
  describe "test an instance of InlineResponse20036" do
    it "should create an instance of InlineResponse20036" do
      # instance = Stripe::InlineResponse20036.new
      # expect(instance).to be_instance_of(Stripe::InlineResponse20036)
    end
  end
