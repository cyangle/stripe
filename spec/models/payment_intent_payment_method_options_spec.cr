...
# Unit tests for Stripe::PaymentIntentPaymentMethodOptions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
require "../spec_helper"
require "../../src/stripe/models/payment_intent_payment_method_options"

describe Stripe::PaymentIntentPaymentMethodOptions do
  describe "test an instance of PaymentIntentPaymentMethodOptions" do
    it "should create an instance of PaymentIntentPaymentMethodOptions" do
      # instance = Stripe::PaymentIntentPaymentMethodOptions.new
      # (instance).should be_a(Stripe::PaymentIntentPaymentMethodOptions)
    end
  end
