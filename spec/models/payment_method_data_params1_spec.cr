...
# Unit tests for Stripe::PaymentMethodDataParams1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentMethodDataParams1 do
  describe "test an instance of PaymentMethodDataParams1" do
    it "should create an instance of PaymentMethodDataParams1" do
      # instance = Stripe::PaymentMethodDataParams1.new
      # expect(instance).to be_instance_of(Stripe::PaymentMethodDataParams1)
    end
  end
  ...
  describe "test attribute '_type'" do
    it "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = EnumValidator.new("String", ["acss_debit", "affirm", "afterpay_clearpay", "alipay", "au_becs_debit", "bacs_debit", "bancontact", "boleto", "customer_balance", "eps", "fpx", "giropay", "grabpay", "ideal", "klarna", "konbini", "link", "oxxo", "p24", "paynow", "sepa_debit", "sofort", "us_bank_account", "wechat_pay"])
