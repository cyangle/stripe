...
# Unit tests for Stripe::InvoiceitemPrice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::InvoiceitemPrice do
  describe "test an instance of InvoiceitemPrice" do
    it "should create an instance of InvoiceitemPrice" do
      # instance = Stripe::InvoiceitemPrice.new
      # expect(instance).to be_instance_of(Stripe::InvoiceitemPrice)
    end
  end
