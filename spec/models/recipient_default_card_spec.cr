...
# Unit tests for Stripe::RecipientDefaultCard
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::RecipientDefaultCard do
  describe "test an instance of RecipientDefaultCard" do
    it "should create an instance of RecipientDefaultCard" do
      # instance = Stripe::RecipientDefaultCard.new
      # expect(instance).to be_instance_of(Stripe::RecipientDefaultCard)
    end
  end
