...
# Unit tests for Stripe::InlineResponse20019
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::InlineResponse20019 do
  describe "test an instance of InlineResponse20019" do
    it "should create an instance of InlineResponse20019" do
      # instance = Stripe::InlineResponse20019.new
      # expect(instance).to be_instance_of(Stripe::InlineResponse20019)
    end
  end
