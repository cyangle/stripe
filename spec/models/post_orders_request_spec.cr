...
# Unit tests for Stripe::PostOrdersRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PostOrdersRequest do
  describe "test an instance of PostOrdersRequest" do
    it "should create an instance of PostOrdersRequest" do
      # instance = Stripe::PostOrdersRequest.new
      # (instance).should be_a(Stripe::PostOrdersRequest)
    end
  end
