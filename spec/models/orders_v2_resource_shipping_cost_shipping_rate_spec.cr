...
# Unit tests for Stripe::OrdersV2ResourceShippingCostShippingRate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::OrdersV2ResourceShippingCostShippingRate do
  describe "test an instance of OrdersV2ResourceShippingCostShippingRate" do
    it "should create an instance of OrdersV2ResourceShippingCostShippingRate" do
      # instance = Stripe::OrdersV2ResourceShippingCostShippingRate.new
      # expect(instance).to be_instance_of(Stripe::OrdersV2ResourceShippingCostShippingRate)
    end
  end
