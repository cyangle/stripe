...
# Unit tests for Stripe::PaymentIntentPaymentMethodOptionsSepaDebit1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentIntentPaymentMethodOptionsSepaDebit1 do
  describe "test an instance of PaymentIntentPaymentMethodOptionsSepaDebit1" do
    it "should create an instance of PaymentIntentPaymentMethodOptionsSepaDebit1" do
      # instance = Stripe::PaymentIntentPaymentMethodOptionsSepaDebit1.new
      # expect(instance).to be_instance_of(Stripe::PaymentIntentPaymentMethodOptionsSepaDebit1)
    end
  end
