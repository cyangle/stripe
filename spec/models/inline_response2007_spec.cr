...
# Unit tests for Stripe::InlineResponse2007
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::InlineResponse2007 do
  describe "test an instance of InlineResponse2007" do
    it "should create an instance of InlineResponse2007" do
      # instance = Stripe::InlineResponse2007.new
      # expect(instance).to be_instance_of(Stripe::InlineResponse2007)
    end
  end
