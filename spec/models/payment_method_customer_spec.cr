...
# Unit tests for Stripe::PaymentMethodCustomer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentMethodCustomer do
  describe "test an instance of PaymentMethodCustomer" do
    it "should create an instance of PaymentMethodCustomer" do
      # instance = Stripe::PaymentMethodCustomer.new
      # expect(instance).to be_instance_of(Stripe::PaymentMethodCustomer)
    end
  end
