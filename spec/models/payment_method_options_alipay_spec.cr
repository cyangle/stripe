...
require "../spec_helper"
require "../../src/stripe/models/payment_method_options_alipay"
...
describe Stripe::PaymentMethodOptionsAlipay do
  describe "test an instance of PaymentMethodOptionsAlipay" do
    it "should create an instance of PaymentMethodOptionsAlipay" do
      ...
      # (instance).should be_a(Stripe::PaymentMethodOptionsAlipay)
    end
  end
  ...
  describe "test attribute 'setup_future_usage'" do
    it "should work" do
      ...
      # validator = Stripe::PaymentMethodOptionsAlipay::ENUM_VALIDATOR_FOR_SETUP_FUTURE_USAGE
