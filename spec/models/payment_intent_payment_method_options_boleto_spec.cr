...
# Unit tests for Stripe::PaymentIntentPaymentMethodOptionsBoleto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentIntentPaymentMethodOptionsBoleto do
  describe "test an instance of PaymentIntentPaymentMethodOptionsBoleto" do
    it "should create an instance of PaymentIntentPaymentMethodOptionsBoleto" do
      # instance = Stripe::PaymentIntentPaymentMethodOptionsBoleto.new
      # expect(instance).to be_instance_of(Stripe::PaymentIntentPaymentMethodOptionsBoleto)
    end
  end
