...
# Unit tests for Stripe::InlineResponse20012
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::InlineResponse20012 do
  describe "test an instance of InlineResponse20012" do
    it "should create an instance of InlineResponse20012" do
      # instance = Stripe::InlineResponse20012.new
      # expect(instance).to be_instance_of(Stripe::InlineResponse20012)
    end
  end
