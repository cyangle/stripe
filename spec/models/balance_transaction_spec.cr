...
describe Stripe::BalanceTransaction do
  describe "test an instance of BalanceTransaction" do
    it "should create an instance of BalanceTransaction" do
      ...
      # expect(instance).to be_instance_of(Stripe::BalanceTransaction)
    end
  end
  ...
  describe "test attribute 'object'" do
    it "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Petstore::EnumTest::EnumAttributeValidator.new("String", ["balance_transaction"])
