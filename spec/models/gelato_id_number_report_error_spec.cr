...
describe Stripe::GelatoIdNumberReportError do
  describe "test an instance of GelatoIdNumberReportError" do
    it "should create an instance of GelatoIdNumberReportError" do
      ...
      # expect(instance).to be_instance_of(Stripe::GelatoIdNumberReportError)
    end
  end
  ...
  describe "test attribute 'code'" do
    it "should work" do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new("String", ["id_number_insufficient_document_data", "id_number_mismatch", "id_number_unverified_other"])
