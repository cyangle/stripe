...
# Unit tests for Stripe::InlineResponse20013
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::InlineResponse20013 do
  describe "test an instance of InlineResponse20013" do
    it "should create an instance of InlineResponse20013" do
      # instance = Stripe::InlineResponse20013.new
      # expect(instance).to be_instance_of(Stripe::InlineResponse20013)
    end
  end
