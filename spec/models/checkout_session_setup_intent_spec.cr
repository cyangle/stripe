...
require "../spec_helper"
require "../../src/stripe/models/checkout_session_setup_intent"
...
describe Stripe::CheckoutSessionSetupIntent do
  describe "test an instance of CheckoutSessionSetupIntent" do
    it "should create an instance of CheckoutSessionSetupIntent" do
      ...
      # (instance).should be_a(Stripe::CheckoutSessionSetupIntent)
    end
  end
  ...
  describe "test attribute 'cancellation_reason'" do
    it "should work" do
      # instance = Stripe::CheckoutSessionSetupIntent.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::CheckoutSessionSetupIntent::ENUM_VALIDATOR_FOR_CANCELLATION_REASON
  ...
  describe "test attribute 'flow_directions'" do
    it "should work" do
      # instance = Stripe::CheckoutSessionSetupIntent.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::CheckoutSessionSetupIntent::ENUM_VALIDATOR_FOR_FLOW_DIRECTIONS
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'object'" do
    it "should work" do
      # instance = Stripe::CheckoutSessionSetupIntent.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::CheckoutSessionSetupIntent::ENUM_VALIDATOR_FOR_OBJECT
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'status'" do
    it "should work" do
      # instance = Stripe::CheckoutSessionSetupIntent.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::CheckoutSessionSetupIntent::ENUM_VALIDATOR_FOR_STATUS
      # validator.allowable_values.each do |value|
