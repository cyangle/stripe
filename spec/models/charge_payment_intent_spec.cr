...
require "../spec_helper"
require "../../src/stripe/models/charge_payment_intent"
...
describe Stripe::ChargePaymentIntent do
  describe "test an instance of ChargePaymentIntent" do
    it "should create an instance of ChargePaymentIntent" do
      ...
      # (instance).should be_a(Stripe::ChargePaymentIntent)
    end
  end
  ...
  describe "test attribute 'cancellation_reason'" do
    it "should work" do
      # instance = Stripe::ChargePaymentIntent.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::ChargePaymentIntent::ENUM_VALIDATOR_FOR_CANCELLATION_REASON
  ...
  describe "test attribute 'capture_method'" do
    it "should work" do
      # instance = Stripe::ChargePaymentIntent.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::ChargePaymentIntent::ENUM_VALIDATOR_FOR_CAPTURE_METHOD
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'confirmation_method'" do
    it "should work" do
      # instance = Stripe::ChargePaymentIntent.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::ChargePaymentIntent::ENUM_VALIDATOR_FOR_CONFIRMATION_METHOD
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'object'" do
    it "should work" do
      # instance = Stripe::ChargePaymentIntent.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::ChargePaymentIntent::ENUM_VALIDATOR_FOR_OBJECT
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'setup_future_usage'" do
    it "should work" do
      # instance = Stripe::ChargePaymentIntent.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::ChargePaymentIntent::ENUM_VALIDATOR_FOR_SETUP_FUTURE_USAGE
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'status'" do
    it "should work" do
      # instance = Stripe::ChargePaymentIntent.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::ChargePaymentIntent::ENUM_VALIDATOR_FOR_STATUS
      # validator.allowable_values.each do |value|
