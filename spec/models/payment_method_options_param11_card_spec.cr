...
# Unit tests for Stripe::PaymentMethodOptionsParam11Card
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentMethodOptionsParam11Card do
  describe "test an instance of PaymentMethodOptionsParam11Card" do
    it "should create an instance of PaymentMethodOptionsParam11Card" do
      # instance = Stripe::PaymentMethodOptionsParam11Card.new
      # expect(instance).to be_instance_of(Stripe::PaymentMethodOptionsParam11Card)
    end
  end
