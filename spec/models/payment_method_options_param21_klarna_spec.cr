...
# Unit tests for Stripe::PaymentMethodOptionsParam21Klarna
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentMethodOptionsParam21Klarna do
  describe "test an instance of PaymentMethodOptionsParam21Klarna" do
    it "should create an instance of PaymentMethodOptionsParam21Klarna" do
      # instance = Stripe::PaymentMethodOptionsParam21Klarna.new
      # expect(instance).to be_instance_of(Stripe::PaymentMethodOptionsParam21Klarna)
    end
  end
