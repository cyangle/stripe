...
# Unit tests for Stripe::SourceTypeCard
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
require "../spec_helper"
require "../../src/stripe/models/source_type_card"

describe Stripe::SourceTypeCard do
  describe "test an instance of SourceTypeCard" do
    it "should create an instance of SourceTypeCard" do
      # instance = Stripe::SourceTypeCard.new
      # (instance).should be_a(Stripe::SourceTypeCard)
    end
  end
