...
# Unit tests for Stripe::InlineResponse20035
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::InlineResponse20035 do
  describe "test an instance of InlineResponse20035" do
    it "should create an instance of InlineResponse20035" do
      # instance = Stripe::InlineResponse20035.new
      # expect(instance).to be_instance_of(Stripe::InlineResponse20035)
    end
  end
