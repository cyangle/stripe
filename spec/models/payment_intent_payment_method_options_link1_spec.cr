...
# Unit tests for Stripe::PaymentIntentPaymentMethodOptionsLink1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentIntentPaymentMethodOptionsLink1 do
  describe "test an instance of PaymentIntentPaymentMethodOptionsLink1" do
    it "should create an instance of PaymentIntentPaymentMethodOptionsLink1" do
      # instance = Stripe::PaymentIntentPaymentMethodOptionsLink1.new
      # expect(instance).to be_instance_of(Stripe::PaymentIntentPaymentMethodOptionsLink1)
    end
  end
