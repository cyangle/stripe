...
# Unit tests for Stripe::InlineResponse20037
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::InlineResponse20037 do
  describe "test an instance of InlineResponse20037" do
    it "should create an instance of InlineResponse20037" do
      # instance = Stripe::InlineResponse20037.new
      # expect(instance).to be_instance_of(Stripe::InlineResponse20037)
    end
  end
