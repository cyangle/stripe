...
# Unit tests for Stripe::IssuingTransactionCard
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
require "../spec_helper"
require "../../src/stripe/models/issuing_transaction_card"

describe Stripe::IssuingTransactionCard do
  describe "test an instance of IssuingTransactionCard" do
    it "should create an instance of IssuingTransactionCard" do
      # instance = Stripe::IssuingTransactionCard.new
      # (instance).should be_a(Stripe::IssuingTransactionCard)
    end
  end
  ...
  describe "test attribute 'cancellation_reason'" do
    it "should work" do
      # instance = Stripe::IssuingTransactionCard.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::IssuingTransactionCard::ENUM_VALIDATOR_FOR_CANCELLATION_REASON
  ...
  describe "test attribute 'object'" do
    it "should work" do
      # instance = Stripe::IssuingTransactionCard.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::IssuingTransactionCard::ENUM_VALIDATOR_FOR_OBJECT
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'replacement_reason'" do
    it "should work" do
      # instance = Stripe::IssuingTransactionCard.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::IssuingTransactionCard::ENUM_VALIDATOR_FOR_REPLACEMENT_REASON
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'status'" do
    it "should work" do
      # instance = Stripe::IssuingTransactionCard.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::IssuingTransactionCard::ENUM_VALIDATOR_FOR_STATUS
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute '_type'" do
    it "should work" do
      # instance = Stripe::IssuingTransactionCard.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::IssuingTransactionCard::ENUM_VALIDATOR_FOR__TYPE
      # validator.allowable_values.each do |value|
