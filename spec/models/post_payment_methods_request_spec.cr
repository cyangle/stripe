...
describe Stripe::PostPaymentMethodsRequest do
  describe "test an instance of PostPaymentMethodsRequest" do
    it "should create an instance of PostPaymentMethodsRequest" do
      ...
      # expect(instance).to be_instance_of(Stripe::PostPaymentMethodsRequest)
    end
  end
  ...
  describe "test attribute '_type'" do
    it "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = EnumValidator.new("String", ["acss_debit", "affirm", "afterpay_clearpay", "alipay", "au_becs_debit", "bacs_debit", "bancontact", "boleto", "card", "customer_balance", "eps", "fpx", "giropay", "grabpay", "ideal", "klarna", "konbini", "link", "oxxo", "p24", "paynow", "sepa_debit", "sofort", "us_bank_account", "wechat_pay"])
