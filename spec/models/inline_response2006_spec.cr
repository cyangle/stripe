...
# Unit tests for Stripe::InlineResponse2006
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::InlineResponse2006 do
  describe "test an instance of InlineResponse2006" do
    it "should create an instance of InlineResponse2006" do
      # instance = Stripe::InlineResponse2006.new
      # expect(instance).to be_instance_of(Stripe::InlineResponse2006)
    end
  end
