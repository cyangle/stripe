...
# Unit tests for Stripe::PaymentIntentPaymentMethodOptionsKonbini
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentIntentPaymentMethodOptionsKonbini do
  describe "test an instance of PaymentIntentPaymentMethodOptionsKonbini" do
    it "should create an instance of PaymentIntentPaymentMethodOptionsKonbini" do
      # instance = Stripe::PaymentIntentPaymentMethodOptionsKonbini.new
      # expect(instance).to be_instance_of(Stripe::PaymentIntentPaymentMethodOptionsKonbini)
    end
  end
