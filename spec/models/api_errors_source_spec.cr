...
# Unit tests for Stripe::ApiErrorsSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::ApiErrorsSource do
  describe "test an instance of ApiErrorsSource" do
    it "should create an instance of ApiErrorsSource" do
      # instance = Stripe::ApiErrorsSource.new
      # expect(instance).to be_instance_of(Stripe::ApiErrorsSource)
    end
  end
