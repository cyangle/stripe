...
# Unit tests for Stripe::PhaseConfigurationParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
require "../spec_helper"
require "../../src/stripe/models/phase_configuration_params"

describe Stripe::PhaseConfigurationParams do
  describe "test an instance of PhaseConfigurationParams" do
    it "should create an instance of PhaseConfigurationParams" do
      # instance = Stripe::PhaseConfigurationParams.new
      # (instance).should be_a(Stripe::PhaseConfigurationParams)
    end
  end
  ...
  describe "test attribute 'billing_cycle_anchor'" do
    it "should work" do
      # instance = Stripe::PhaseConfigurationParams.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::PhaseConfigurationParams::ENUM_VALIDATOR_FOR_BILLING_CYCLE_ANCHOR
  ...
  describe "test attribute 'collection_method'" do
    it "should work" do
      # instance = Stripe::PhaseConfigurationParams.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::PhaseConfigurationParams::ENUM_VALIDATOR_FOR_COLLECTION_METHOD
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'proration_behavior'" do
    it "should work" do
      # instance = Stripe::PhaseConfigurationParams.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::PhaseConfigurationParams::ENUM_VALIDATOR_FOR_PRORATION_BEHAVIOR
      # validator.allowable_values.each do |value|
