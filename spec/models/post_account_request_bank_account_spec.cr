...
# Unit tests for Stripe::PostAccountRequestBankAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PostAccountRequestBankAccount do
  describe "test an instance of PostAccountRequestBankAccount" do
    it "should create an instance of PostAccountRequestBankAccount" do
      # instance = Stripe::PostAccountRequestBankAccount.new
      # expect(instance).to be_instance_of(Stripe::PostAccountRequestBankAccount)
    end
  end
