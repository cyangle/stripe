...
# Unit tests for Stripe::PaymentIntentPaymentMethodOptionsIdeal
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentIntentPaymentMethodOptionsIdeal do
  describe "test an instance of PaymentIntentPaymentMethodOptionsIdeal" do
    it "should create an instance of PaymentIntentPaymentMethodOptionsIdeal" do
      # instance = Stripe::PaymentIntentPaymentMethodOptionsIdeal.new
      # expect(instance).to be_instance_of(Stripe::PaymentIntentPaymentMethodOptionsIdeal)
    end
  end
