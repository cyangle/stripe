...
# Unit tests for Stripe::SearchResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
require "../spec_helper"
require "../../src/stripe/models/search_result"

describe Stripe::SearchResult do
  describe "test an instance of SearchResult" do
    it "should create an instance of SearchResult" do
      # instance = Stripe::SearchResult.new
      # (instance).should be_a(Stripe::SearchResult)
    end
  end
  ...
  describe "test attribute 'object'" do
    it "should work" do
      # instance = Stripe::SearchResult.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::SearchResult::ENUM_VALIDATOR_FOR_OBJECT
