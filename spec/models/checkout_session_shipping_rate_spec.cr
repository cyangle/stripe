...
# Unit tests for Stripe::CheckoutSessionShippingRate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::CheckoutSessionShippingRate do
  describe "test an instance of CheckoutSessionShippingRate" do
    it "should create an instance of CheckoutSessionShippingRate" do
      # instance = Stripe::CheckoutSessionShippingRate.new
      # expect(instance).to be_instance_of(Stripe::CheckoutSessionShippingRate)
    end
  end
