...
# Unit tests for Stripe::PaymentIntentPaymentMethodOptionsAfterpayClearpay
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentIntentPaymentMethodOptionsAfterpayClearpay do
  describe "test an instance of PaymentIntentPaymentMethodOptionsAfterpayClearpay" do
    it "should create an instance of PaymentIntentPaymentMethodOptionsAfterpayClearpay" do
      # instance = Stripe::PaymentIntentPaymentMethodOptionsAfterpayClearpay.new
      # expect(instance).to be_instance_of(Stripe::PaymentIntentPaymentMethodOptionsAfterpayClearpay)
    end
  end
