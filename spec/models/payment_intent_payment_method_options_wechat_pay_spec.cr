...
# Unit tests for Stripe::PaymentIntentPaymentMethodOptionsWechatPay
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentIntentPaymentMethodOptionsWechatPay do
  describe "test an instance of PaymentIntentPaymentMethodOptionsWechatPay" do
    it "should create an instance of PaymentIntentPaymentMethodOptionsWechatPay" do
      # instance = Stripe::PaymentIntentPaymentMethodOptionsWechatPay.new
      # expect(instance).to be_instance_of(Stripe::PaymentIntentPaymentMethodOptionsWechatPay)
    end
  end
