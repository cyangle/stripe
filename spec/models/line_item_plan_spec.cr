...
# Unit tests for Stripe::LineItemPlan
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::LineItemPlan do
  describe "test an instance of LineItemPlan" do
    it "should create an instance of LineItemPlan" do
      # instance = Stripe::LineItemPlan.new
      # expect(instance).to be_instance_of(Stripe::LineItemPlan)
    end
  end
