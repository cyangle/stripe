...
# Unit tests for Stripe::InvoiceitemPlan
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::InvoiceitemPlan do
  describe "test an instance of InvoiceitemPlan" do
    it "should create an instance of InvoiceitemPlan" do
      # instance = Stripe::InvoiceitemPlan.new
      # expect(instance).to be_instance_of(Stripe::InvoiceitemPlan)
    end
  end
