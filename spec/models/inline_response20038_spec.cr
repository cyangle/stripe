...
# Unit tests for Stripe::InlineResponse20038
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::InlineResponse20038 do
  describe "test an instance of InlineResponse20038" do
    it "should create an instance of InlineResponse20038" do
      # instance = Stripe::InlineResponse20038.new
      # expect(instance).to be_instance_of(Stripe::InlineResponse20038)
    end
  end
