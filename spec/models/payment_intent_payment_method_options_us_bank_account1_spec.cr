...
# Unit tests for Stripe::PaymentIntentPaymentMethodOptionsUsBankAccount1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentIntentPaymentMethodOptionsUsBankAccount1 do
  describe "test an instance of PaymentIntentPaymentMethodOptionsUsBankAccount1" do
    it "should create an instance of PaymentIntentPaymentMethodOptionsUsBankAccount1" do
      # instance = Stripe::PaymentIntentPaymentMethodOptionsUsBankAccount1.new
      # expect(instance).to be_instance_of(Stripe::PaymentIntentPaymentMethodOptionsUsBankAccount1)
    end
  end
