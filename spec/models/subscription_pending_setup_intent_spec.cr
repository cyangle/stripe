...
# Unit tests for Stripe::SubscriptionPendingSetupIntent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
require "../spec_helper"
require "../../src/stripe/models/subscription_pending_setup_intent"

describe Stripe::SubscriptionPendingSetupIntent do
  describe "test an instance of SubscriptionPendingSetupIntent" do
    it "should create an instance of SubscriptionPendingSetupIntent" do
      # instance = Stripe::SubscriptionPendingSetupIntent.new
      # (instance).should be_a(Stripe::SubscriptionPendingSetupIntent)
    end
  end
  ...
  describe "test attribute 'cancellation_reason'" do
    it "should work" do
      # instance = Stripe::SubscriptionPendingSetupIntent.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::SubscriptionPendingSetupIntent::ENUM_VALIDATOR_FOR_CANCELLATION_REASON
  ...
  describe "test attribute 'flow_directions'" do
    it "should work" do
      # instance = Stripe::SubscriptionPendingSetupIntent.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::SubscriptionPendingSetupIntent::ENUM_VALIDATOR_FOR_FLOW_DIRECTIONS
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'object'" do
    it "should work" do
      # instance = Stripe::SubscriptionPendingSetupIntent.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::SubscriptionPendingSetupIntent::ENUM_VALIDATOR_FOR_OBJECT
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'status'" do
    it "should work" do
      # instance = Stripe::SubscriptionPendingSetupIntent.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::SubscriptionPendingSetupIntent::ENUM_VALIDATOR_FOR_STATUS
      # validator.allowable_values.each do |value|
