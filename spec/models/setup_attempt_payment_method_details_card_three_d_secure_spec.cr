...
# Unit tests for Stripe::SetupAttemptPaymentMethodDetailsCardThreeDSecure
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::SetupAttemptPaymentMethodDetailsCardThreeDSecure do
  describe "test an instance of SetupAttemptPaymentMethodDetailsCardThreeDSecure" do
    it "should create an instance of SetupAttemptPaymentMethodDetailsCardThreeDSecure" do
      # instance = Stripe::SetupAttemptPaymentMethodDetailsCardThreeDSecure.new
      # expect(instance).to be_instance_of(Stripe::SetupAttemptPaymentMethodDetailsCardThreeDSecure)
    end
  end
