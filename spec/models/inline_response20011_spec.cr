...
# Unit tests for Stripe::InlineResponse20011
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::InlineResponse20011 do
  describe "test an instance of InlineResponse20011" do
    it "should create an instance of InlineResponse20011" do
      # instance = Stripe::InlineResponse20011.new
      # expect(instance).to be_instance_of(Stripe::InlineResponse20011)
    end
  end
