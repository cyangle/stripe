...
# Unit tests for Stripe::PaymentIntentPaymentMethodOptionsPaynow
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentIntentPaymentMethodOptionsPaynow do
  describe "test an instance of PaymentIntentPaymentMethodOptionsPaynow" do
    it "should create an instance of PaymentIntentPaymentMethodOptionsPaynow" do
      # instance = Stripe::PaymentIntentPaymentMethodOptionsPaynow.new
      # expect(instance).to be_instance_of(Stripe::PaymentIntentPaymentMethodOptionsPaynow)
    end
  end
