...
# Unit tests for Stripe::InlineResponse2008
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::InlineResponse2008 do
  describe "test an instance of InlineResponse2008" do
    it "should create an instance of InlineResponse2008" do
      # instance = Stripe::InlineResponse2008.new
      # expect(instance).to be_instance_of(Stripe::InlineResponse2008)
    end
  end
