...
# Unit tests for Stripe::CheckoutSessionPaymentMethodOptions1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::CheckoutSessionPaymentMethodOptions1 do
  describe "test an instance of CheckoutSessionPaymentMethodOptions1" do
    it "should create an instance of CheckoutSessionPaymentMethodOptions1" do
      # instance = Stripe::CheckoutSessionPaymentMethodOptions1.new
      # expect(instance).to be_instance_of(Stripe::CheckoutSessionPaymentMethodOptions1)
    end
  end
