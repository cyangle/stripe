...
# Unit tests for Stripe::InlineResponse2005
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::InlineResponse2005 do
  describe "test an instance of InlineResponse2005" do
    it "should create an instance of InlineResponse2005" do
      # instance = Stripe::InlineResponse2005.new
      # expect(instance).to be_instance_of(Stripe::InlineResponse2005)
    end
  end
