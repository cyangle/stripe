...
# Unit tests for Stripe::ChargeDispute
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::ChargeDispute do
  describe "test an instance of ChargeDispute" do
    it "should create an instance of ChargeDispute" do
      # instance = Stripe::ChargeDispute.new
      # expect(instance).to be_instance_of(Stripe::ChargeDispute)
    end
  end
