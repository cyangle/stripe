...
# Unit tests for Stripe::SubscriptionSchedulePhaseConfiguration
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
require "../spec_helper"
require "../../src/stripe/models/subscription_schedule_phase_configuration"

describe Stripe::SubscriptionSchedulePhaseConfiguration do
  describe "test an instance of SubscriptionSchedulePhaseConfiguration" do
    it "should create an instance of SubscriptionSchedulePhaseConfiguration" do
      # instance = Stripe::SubscriptionSchedulePhaseConfiguration.new
      # (instance).should be_a(Stripe::SubscriptionSchedulePhaseConfiguration)
    end
  end
  ...
  describe "test attribute 'billing_cycle_anchor'" do
    it "should work" do
      # instance = Stripe::SubscriptionSchedulePhaseConfiguration.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::SubscriptionSchedulePhaseConfiguration::ENUM_VALIDATOR_FOR_BILLING_CYCLE_ANCHOR
  ...
  describe "test attribute 'collection_method'" do
    it "should work" do
      # instance = Stripe::SubscriptionSchedulePhaseConfiguration.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::SubscriptionSchedulePhaseConfiguration::ENUM_VALIDATOR_FOR_COLLECTION_METHOD
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'proration_behavior'" do
    it "should work" do
      # instance = Stripe::SubscriptionSchedulePhaseConfiguration.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::SubscriptionSchedulePhaseConfiguration::ENUM_VALIDATOR_FOR_PRORATION_BEHAVIOR
      # validator.allowable_values.each do |value|
