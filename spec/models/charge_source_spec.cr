...
# Unit tests for Stripe::ChargeSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::ChargeSource do
  describe "test an instance of ChargeSource" do
    it "should create an instance of ChargeSource" do
      # instance = Stripe::ChargeSource.new
      # expect(instance).to be_instance_of(Stripe::ChargeSource)
    end
  end
