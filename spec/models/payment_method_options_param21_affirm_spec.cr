...
# Unit tests for Stripe::PaymentMethodOptionsParam21Affirm
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentMethodOptionsParam21Affirm do
  describe "test an instance of PaymentMethodOptionsParam21Affirm" do
    it "should create an instance of PaymentMethodOptionsParam21Affirm" do
      # instance = Stripe::PaymentMethodOptionsParam21Affirm.new
      # expect(instance).to be_instance_of(Stripe::PaymentMethodOptionsParam21Affirm)
    end
  end
