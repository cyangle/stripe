...
# Unit tests for Stripe::AlipayAccountCustomer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::AlipayAccountCustomer do
  describe "test an instance of AlipayAccountCustomer" do
    it "should create an instance of AlipayAccountCustomer" do
      # instance = Stripe::AlipayAccountCustomer.new
      # expect(instance).to be_instance_of(Stripe::AlipayAccountCustomer)
    end
  end
