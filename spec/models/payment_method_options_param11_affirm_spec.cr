...
# Unit tests for Stripe::PaymentMethodOptionsParam11Affirm
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentMethodOptionsParam11Affirm do
  describe "test an instance of PaymentMethodOptionsParam11Affirm" do
    it "should create an instance of PaymentMethodOptionsParam11Affirm" do
      # instance = Stripe::PaymentMethodOptionsParam11Affirm.new
      # expect(instance).to be_instance_of(Stripe::PaymentMethodOptionsParam11Affirm)
    end
  end
