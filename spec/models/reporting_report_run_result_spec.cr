...
# Unit tests for Stripe::ReportingReportRunResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::ReportingReportRunResult do
  describe "test an instance of ReportingReportRunResult" do
    it "should create an instance of ReportingReportRunResult" do
      # instance = Stripe::ReportingReportRunResult.new
      # expect(instance).to be_instance_of(Stripe::ReportingReportRunResult)
    end
  end
