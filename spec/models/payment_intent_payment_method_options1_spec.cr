...
# Unit tests for Stripe::PaymentIntentPaymentMethodOptions1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PaymentIntentPaymentMethodOptions1 do
  describe "test an instance of PaymentIntentPaymentMethodOptions1" do
    it "should create an instance of PaymentIntentPaymentMethodOptions1" do
      # instance = Stripe::PaymentIntentPaymentMethodOptions1.new
      # expect(instance).to be_instance_of(Stripe::PaymentIntentPaymentMethodOptions1)
    end
  end
