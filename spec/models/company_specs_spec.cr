...
# Unit tests for Stripe::CompanySpecs
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
require "../spec_helper"
require "../../src/stripe/models/company_specs"

describe Stripe::CompanySpecs do
  describe "test an instance of CompanySpecs" do
    it "should create an instance of CompanySpecs" do
      # instance = Stripe::CompanySpecs.new
      # (instance).should be_a(Stripe::CompanySpecs)
    end
  end
  ...
  describe "test attribute 'structure'" do
    it "should work" do
      # instance = Stripe::CompanySpecs.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::CompanySpecs::ENUM_VALIDATOR_FOR_STRUCTURE
