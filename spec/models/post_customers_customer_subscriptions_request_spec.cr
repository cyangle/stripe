...
# Unit tests for Stripe::PostCustomersCustomerSubscriptionsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::PostCustomersCustomerSubscriptionsRequest do
  describe "test an instance of PostCustomersCustomerSubscriptionsRequest" do
    it "should create an instance of PostCustomersCustomerSubscriptionsRequest" do
      # instance = Stripe::PostCustomersCustomerSubscriptionsRequest.new
      # (instance).should be_a(Stripe::PostCustomersCustomerSubscriptionsRequest)
    end
  end
  ...
  describe "test attribute 'collection_method'" do
    it "should work" do
      # instance = Stripe::PostCustomersCustomerSubscriptionsRequest.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::PostCustomersCustomerSubscriptionsRequest::ENUM_VALIDATOR_FOR_COLLECTION_METHOD
  ...
  describe "test attribute 'payment_behavior'" do
    it "should work" do
      # instance = Stripe::PostCustomersCustomerSubscriptionsRequest.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::PostCustomersCustomerSubscriptionsRequest::ENUM_VALIDATOR_FOR_PAYMENT_BEHAVIOR
      # validator.allowable_values.each do |value|
  ...
  describe "test attribute 'proration_behavior'" do
    it "should work" do
      # instance = Stripe::PostCustomersCustomerSubscriptionsRequest.new
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
      # validator = Stripe::PostCustomersCustomerSubscriptionsRequest::ENUM_VALIDATOR_FOR_PRORATION_BEHAVIOR
      # validator.allowable_values.each do |value|
