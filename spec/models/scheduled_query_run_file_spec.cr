...
# Unit tests for Stripe::ScheduledQueryRunFile
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::ScheduledQueryRunFile do
  describe "test an instance of ScheduledQueryRunFile" do
    it "should create an instance of ScheduledQueryRunFile" do
      # instance = Stripe::ScheduledQueryRunFile.new
      # expect(instance).to be_instance_of(Stripe::ScheduledQueryRunFile)
    end
  end
