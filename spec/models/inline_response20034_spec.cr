...
# Unit tests for Stripe::InlineResponse20034
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::InlineResponse20034 do
  describe "test an instance of InlineResponse20034" do
    it "should create an instance of InlineResponse20034" do
      # instance = Stripe::InlineResponse20034.new
      # expect(instance).to be_instance_of(Stripe::InlineResponse20034)
    end
  end
