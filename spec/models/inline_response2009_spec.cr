...
# Unit tests for Stripe::InlineResponse2009
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::InlineResponse2009 do
  describe "test an instance of InlineResponse2009" do
    it "should create an instance of InlineResponse2009" do
      # instance = Stripe::InlineResponse2009.new
      # expect(instance).to be_instance_of(Stripe::InlineResponse2009)
    end
  end
