...
# Unit tests for Stripe::ItemProduct
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::ItemProduct do
  describe "test an instance of ItemProduct" do
    it "should create an instance of ItemProduct" do
      # instance = Stripe::ItemProduct.new
      # expect(instance).to be_instance_of(Stripe::ItemProduct)
    end
  end
