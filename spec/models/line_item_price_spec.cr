...
# Unit tests for Stripe::LineItemPrice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::LineItemPrice do
  describe "test an instance of LineItemPrice" do
    it "should create an instance of LineItemPrice" do
      # instance = Stripe::LineItemPrice.new
      # expect(instance).to be_instance_of(Stripe::LineItemPrice)
    end
  end
