...
# Unit tests for Stripe::ChargeDestination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Stripe::ChargeDestination do
  describe "test an instance of ChargeDestination" do
    it "should create an instance of ChargeDestination" do
      # instance = Stripe::ChargeDestination.new
      # expect(instance).to be_instance_of(Stripe::ChargeDestination)
    end
  end
