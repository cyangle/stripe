...
require "../models/default_settings_params"
require "../models/error"
require "../models/get_accounts_created_parameter"

require "../models/phase_configuration_params"
require "../models/post_accounts_request_metadata"
require "../models/post_subscription_schedules_request_start_date"
require "../models/subscription_schedule"
require "../models/subscription_schedules_resource_schedule_list"
  ...
  class SubscriptionSchedulesApi
    ...
    def build_api_request_for_post_subscription_schedules(
      *,
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(default_settings.to_json), "default_settings")) if !default_settings.nil?
      form_params << Tuple(String, Crest::ParamsValue).new("end_behavior", end_behavior.to_s) if !end_behavior.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(expand.to_json), "expand")) if !expand.nil?
      form_params << Tuple(String, Crest::ParamsValue).new("from_subscription", from_subscription.to_s) if !from_subscription.nil?
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(phases.to_json), "phases")) if !phases.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(start_date.to_json), "start_date")) if !start_date.nil?
    ...
    def build_api_request_for_post_subscription_schedules_schedule_release(
      *,
      ...
      form_params : Array(Tuple(String, Crest::ParamsValue)) | Nil = Array(Tuple(String, Crest::ParamsValue)).new
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(expand.to_json), "expand")) if !expand.nil?
      form_params << Tuple(String, Crest::ParamsValue).new("preserve_cancel_date", preserve_cancel_date.to_s) if !preserve_cancel_date.nil?
