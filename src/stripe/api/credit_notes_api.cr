  ...
  class CreditNotesApi
    ...
    def get_credit_notes_preview(
      *,
      ...
      data, _status_code, _headers = get_credit_notes_preview_with_http_info(invoice: invoice, refund: refund, lines: lines, reason: reason, metadata: metadata, expand: expand, memo: memo, effective_at: effective_at, out_of_band_amount: out_of_band_amount, credit_amount: credit_amount, refund_amount: refund_amount, amount: amount, email_type: email_type, shipping_cost: shipping_cost)
      data
    end
    ...
    def get_credit_notes_preview_with_http_info(
      *,
      ...
      request = build_api_request_for_get_credit_notes_preview(invoice: invoice, refund: refund, lines: lines, reason: reason, metadata: metadata, expand: expand, memo: memo, effective_at: effective_at, out_of_band_amount: out_of_band_amount, credit_amount: credit_amount, refund_amount: refund_amount, amount: amount, email_type: email_type, shipping_cost: shipping_cost)
    ...
    def build_api_request_for_post_credit_notes(
      *,
      ...
      form_params << Tuple(String, Crest::ParamsValue).new("refund", refund.to_s) if !refund.nil?
