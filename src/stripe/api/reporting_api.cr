...
require "../models/financial_reporting_finance_report_run_list"
require "../models/financial_reporting_finance_report_type_list"
require "../models/get_accounts_created_parameter"

require "../models/reporting_report_run"
require "../models/reporting_report_type"
require "../models/run_parameter_specs"
  ...
  class ReportingApi
    ...
    def get_reporting_report_runs(
      *,
      ...
      data, _status_code, _headers = get_reporting_report_runs_with_http_info(ending_before: ending_before, starting_after: starting_after, limit: limit, created: created, expand: expand)
      data
    end
    ...
    def get_reporting_report_runs_with_http_info(
      *,
      ...
      request = build_api_request_for_get_reporting_report_runs(ending_before: ending_before, starting_after: starting_after, limit: limit, created: created, expand: expand)
    ...
    def get_reporting_report_runs(
      *,
      ...
      build_api_request_for_get_reporting_report_runs(ending_before: ending_before, starting_after: starting_after, limit: limit, created: created, expand: expand).execute(&block)
    end
    ...
    def build_api_request_for_post_reporting_report_runs(
      *,
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(parameters.to_json), "parameters")) if !parameters.nil?
      form_params << Tuple(String, Crest::ParamsValue).new("report_type", report_type.to_s) if !report_type.nil?
