...
module Stripe
  class AccountsApi
    ...
    # @return [Stripe::DeletedPaymentSource]
    ...
    # @required @param account [String?]
    # @required @param id [String?]
    # @return [Tuple(Stripe::DeletedPaymentSource, Integer, Hash)] Stripe::DeletedPaymentSource, response status code and response headers
    def delete_accounts_account_external_accounts_id_with_http_info(
      *,
      account : String? = nil,
      id : String? = nil
    ) : Tuple(Stripe::DeletedPaymentSource, Int32, Hash(String, Array(String) | String))
      ...
      Tuple.new(Stripe::DeletedPaymentSource.from_json(body), status_code, headers)
    end
