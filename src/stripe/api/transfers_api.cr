...
require "../models/transfer_list"
require "../models/transfer_reversal"
require "../models/transfer_reversal_list"
...
module Stripe
  class TransfersApi
    ...
    # @optional @param created [Stripe::GetAccountsCreatedParameter?] Only return transfers that were created during the given date interval.
    ...
    def get_transfers(
      *,
      ...
      data, _status_code, _headers = get_transfers_with_http_info(ending_before: ending_before, starting_after: starting_after, limit: limit, destination: destination, created: created, transfer_group: transfer_group, expand: expand)
      data
    end
    ...
    def get_transfers_with_http_info(
      *,
      ...
      request = build_api_request_for_get_transfers(ending_before: ending_before, starting_after: starting_after, limit: limit, destination: destination, created: created, transfer_group: transfer_group, expand: expand)
    ...
    def get_transfers(
      *,
      ...
      build_api_request_for_get_transfers(ending_before: ending_before, starting_after: starting_after, limit: limit, destination: destination, created: created, transfer_group: transfer_group, expand: expand).execute(&block)
    end
    ...
    # @required @param currency [String?] Three-letter [ISO code for currency](https://www.iso.org/iso-4217-currency-codes.html) in lowercase. Must be a [supported currency](https://docs.stripe.com/currencies).
    # @required @param destination [String?] The ID of a connected Stripe account. <a href=\\\"/docs/connect/separate-charges-and-transfers\\\">See the Connect documentation</a> for details.
    ...
    # @optional @param transfer_group [String?] A string that identifies this transaction as part of a group. See the [Connect documentation](https://stripe.com/docs/connect/separate-charges-and-transfers#transfer-options) for details.
    # @return [Stripe::Transfer]
    def post_transfers(
      *,
      currency : String? = nil,
      ...
      data, _status_code, _headers = post_transfers_with_http_info(currency: currency, destination: destination, amount: amount, description: description, expand: expand, metadata: metadata, source_transaction: source_transaction, source_type: source_type, transfer_group: transfer_group)
      data
    end
    ...
    def post_transfers_with_http_info(
      *,
      ...
      request = build_api_request_for_post_transfers(currency: currency, destination: destination, amount: amount, description: description, expand: expand, metadata: metadata, source_transaction: source_transaction, source_type: source_type, transfer_group: transfer_group)
    ...
    def post_transfers(
      *,
      ...
      build_api_request_for_post_transfers(currency: currency, destination: destination, amount: amount, description: description, expand: expand, metadata: metadata, source_transaction: source_transaction, source_type: source_type, transfer_group: transfer_group).execute(&block)
    end
    ...
    def build_api_request_for_post_transfers(
      *,
      ...
      form_params << Tuple(String, Crest::ParamsValue).new("source_transaction", source_transaction.to_s) if !source_transaction.nil?
    ...
    # @optional @param description [String?] An arbitrary string which you can attach to a reversal object. This will be unset if you POST an empty value.
    # @optional @param expand [Array(String)?] Specifies which fields in the response should be expanded.
