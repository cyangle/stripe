...
module Stripe
  class WebhookEndpointsApi
    ...
    POST_WEBHOOK_ENDPOINTS_VALID_VALUES_FOR_DESCRIPTION    = String.static_array("")
      ...
      *,
      ...
      if client_side_validation?
        ...
        unless (_description = description).nil?
          OpenApi::EnumValidator.validate("description", _description, POST_WEBHOOK_ENDPOINTS_VALID_VALUES_FOR_DESCRIPTION)
        end
    ...
    POST_WEBHOOK_ENDPOINTS_WEBHOOK_ENDPOINT_VALID_VALUES_FOR_DESCRIPTION    = String.static_array("")
    ...
    def build_api_request_for_post_webhook_endpoints_webhook_endpoint(
      *,
      ...
      if client_side_validation?
        ...
        unless (_description = description).nil?
          OpenApi::EnumValidator.validate("description", _description, POST_WEBHOOK_ENDPOINTS_WEBHOOK_ENDPOINT_VALID_VALUES_FOR_DESCRIPTION)
        end
