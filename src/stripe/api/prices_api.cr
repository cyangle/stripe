...
module Stripe
  class PricesApi
    ...
    # @optional @param unit_amount_decimal [Float64?] Same as `unit_amount`, but accepts a decimal value in cents (or local equivalent) with at most 12 decimal places. Only one of `unit_amount` and `unit_amount_decimal` can be set.
    # @return [Tuple(Stripe::Price, Integer, Hash)] Stripe::Price, response status code and response headers
    def post_prices_with_http_info(*, currency : String? = nil, active : Bool? = nil, billing_scheme : String? = nil, custom_unit_amount : Stripe::CustomUnitAmount? = nil, expand : Array(String)? = nil, lookup_key : String? = nil, nickname : String? = nil, product : String? = nil, product_data : Stripe::InlineProductParams? = nil, recurring : Stripe::Recurring? = nil, tax_behavior : String? = nil, tiers : Array(Stripe::Tier)? = nil, tiers_mode : String? = nil, transfer_lookup_key : Bool? = nil, transform_quantity : Stripe::TransformUsageParam? = nil, unit_amount : Int64? = nil, unit_amount_decimal : Float64? = nil) : Tuple(Stripe::Price, Int32, Hash(String, Array(String) | String))
    ...
    # @optional @param unit_amount_decimal [Float64?] Same as `unit_amount`, but accepts a decimal value in cents (or local equivalent) with at most 12 decimal places. Only one of `unit_amount` and `unit_amount_decimal` can be set.
    # @return nil
    def post_prices(*, currency : String? = nil, active : Bool? = nil, billing_scheme : String? = nil, custom_unit_amount : Stripe::CustomUnitAmount? = nil, expand : Array(String)? = nil, lookup_key : String? = nil, nickname : String? = nil, product : String? = nil, product_data : Stripe::InlineProductParams? = nil, recurring : Stripe::Recurring? = nil, tax_behavior : String? = nil, tiers : Array(Stripe::Tier)? = nil, tiers_mode : String? = nil, transfer_lookup_key : Bool? = nil, transform_quantity : Stripe::TransformUsageParam? = nil, unit_amount : Int64? = nil, unit_amount_decimal : Float64? = nil, &block : Crest::Response ->) : Nil
