  ...
  class TaxRatesApi
    ...
    def post_tax_rates(
      *,
      ...
      data, _status_code, _headers = post_tax_rates_with_http_info(display_name: display_name, inclusive: inclusive, percentage: percentage, active: active, country: country, description: description, expand: expand, jurisdiction: jurisdiction, metadata: metadata, state: state, tax_type: tax_type)
      data
    end
    ...
    def post_tax_rates_with_http_info(
      *,
      ...
      request = build_api_request_for_post_tax_rates(display_name: display_name, inclusive: inclusive, percentage: percentage, active: active, country: country, description: description, expand: expand, jurisdiction: jurisdiction, metadata: metadata, state: state, tax_type: tax_type)
    ...
    def post_tax_rates(
      *,
      ...
      build_api_request_for_post_tax_rates(display_name: display_name, inclusive: inclusive, percentage: percentage, active: active, country: country, description: description, expand: expand, jurisdiction: jurisdiction, metadata: metadata, state: state, tax_type: tax_type).execute(&block)
    end
    ...
    def build_api_request_for_post_tax_rates(
      *,
      ...
      form_params << Tuple(String, Crest::ParamsValue).new("inclusive", inclusive.to_s) if !inclusive.nil?
      form_params << Tuple(String, Crest::ParamsValue).new("jurisdiction", jurisdiction.to_s) if !jurisdiction.nil?
      ...
      form_params << Tuple(String, Crest::ParamsValue).new("percentage", percentage.to_s) if !percentage.nil?
      form_params << Tuple(String, Crest::ParamsValue).new("state", state.to_s) if !state.nil?
      form_params << Tuple(String, Crest::ParamsValue).new("tax_type", tax_type.to_s) if !tax_type.nil?
