...
require "../models/deleted_radar_value_list"
require "../models/deleted_radar_value_list_item"
require "../models/error"
require "../models/get_accounts_created_parameter"

require "../models/radar_early_fraud_warning"
require "../models/radar_early_fraud_warning_list"
require "../models/radar_list_list_item_list"
require "../models/radar_list_list_list"
require "../models/radar_value_list"
require "../models/radar_value_list_item"
...
module Stripe
  class RadarApi
    ...
    # @optional @param created [Stripe::GetAccountsCreatedParameter?] Only return early fraud warnings that were created during the given date interval.
    ...
    def get_radar_early_fraud_warnings(
      *,
      ...
      data, _status_code, _headers = get_radar_early_fraud_warnings_with_http_info(ending_before: ending_before, starting_after: starting_after, limit: limit, payment_intent: payment_intent, charge: charge, created: created, expand: expand)
      data
    end
    ...
    def get_radar_early_fraud_warnings_with_http_info(
      *,
      ...
      request = build_api_request_for_get_radar_early_fraud_warnings(ending_before: ending_before, starting_after: starting_after, limit: limit, payment_intent: payment_intent, charge: charge, created: created, expand: expand)
    ...
    def get_radar_early_fraud_warnings(
      *,
      ...
      build_api_request_for_get_radar_early_fraud_warnings(ending_before: ending_before, starting_after: starting_after, limit: limit, payment_intent: payment_intent, charge: charge, created: created, expand: expand).execute(&block)
    end
    ...
    # @optional @param starting_after [String?] A cursor for use in pagination. `starting_after` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with `obj_foo`, your subsequent call can include `starting_after=obj_foo` in order to fetch the next page of the list.
    # @optional @param limit [Int32?] A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
    # @optional @param created [Stripe::GetAccountsCreatedParameter?] Only return items that were created during the given date interval.
    ...
    def get_radar_value_list_items(
      *,
      ...
      data, _status_code, _headers = get_radar_value_list_items_with_http_info(value_list: value_list, ending_before: ending_before, starting_after: starting_after, limit: limit, created: created, value: value, expand: expand)
      data
    end
    ...
    def get_radar_value_list_items_with_http_info(
      *,
      ...
      request = build_api_request_for_get_radar_value_list_items(value_list: value_list, ending_before: ending_before, starting_after: starting_after, limit: limit, created: created, value: value, expand: expand)
    ...
    def get_radar_value_list_items(
      *,
      ...
      build_api_request_for_get_radar_value_list_items(value_list: value_list, ending_before: ending_before, starting_after: starting_after, limit: limit, created: created, value: value, expand: expand).execute(&block)
    end
    ...
    # @optional @param created [Stripe::GetAccountsCreatedParameter?] Only return value lists that were created during the given date interval.
    # @optional @param expand [Array(Array(String))?] Specifies which fields in the response should be expanded.
    ...
    def get_radar_value_lists(
      *,
      ...
      data, _status_code, _headers = get_radar_value_lists_with_http_info(ending_before: ending_before, starting_after: starting_after, limit: limit, contains: contains, created: created, expand: expand, _alias: _alias)
      data
    end
    ...
    def get_radar_value_lists_with_http_info(
      *,
      ...
      request = build_api_request_for_get_radar_value_lists(ending_before: ending_before, starting_after: starting_after, limit: limit, contains: contains, created: created, expand: expand, _alias: _alias)
    ...
    def get_radar_value_lists(
      *,
      ...
      build_api_request_for_get_radar_value_lists(ending_before: ending_before, starting_after: starting_after, limit: limit, contains: contains, created: created, expand: expand, _alias: _alias).execute(&block)
    end
    ...
    def build_api_request_for_post_radar_value_list_items(
      *,
      ...
      form_params << Tuple(String, Crest::ParamsValue).new("value_list", value_list.to_s) if !value_list.nil?
    ...
    # @optional @param expand [Array(String)?] Specifies which fields in the response should be expanded.
    # @optional @param item_type [String?] Type of the items in the value list. One of `card_fingerprint`, `us_bank_account_fingerprint`, `sepa_debit_fingerprint`, `card_bin`, `email`, `ip_address`, `country`, `string`, `case_sensitive_string`, or `customer_id`. Use `string` if the item type is unknown or mixed.
    ...
    def post_radar_value_lists(
      *,
      ...
      data, _status_code, _headers = post_radar_value_lists_with_http_info(_alias: _alias, name: name, expand: expand, item_type: item_type, metadata: metadata)
      data
    end
    ...
    def post_radar_value_lists_with_http_info(
      *,
      ...
      request = build_api_request_for_post_radar_value_lists(_alias: _alias, name: name, expand: expand, item_type: item_type, metadata: metadata)
    ...
    def post_radar_value_lists(
      *,
      ...
      build_api_request_for_post_radar_value_lists(_alias: _alias, name: name, expand: expand, item_type: item_type, metadata: metadata).execute(&block)
    end
    ...
    def build_api_request_for_post_radar_value_lists(
      *,
      ...
      # form parameters
      form_params : Array(Tuple(String, Crest::ParamsValue)) | Nil = Array(Tuple(String, Crest::ParamsValue)).new
      form_params << Tuple(String, Crest::ParamsValue).new("alias", _alias.to_s) if !_alias.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(expand.to_json), "expand")) if !expand.nil?
      form_params << Tuple(String, Crest::ParamsValue).new("item_type", item_type.to_s) if !item_type.nil?
    ...
    def post_radar_value_lists_value_list(
      *,
      ...
      data, _status_code, _headers = post_radar_value_lists_value_list_with_http_info(value_list: value_list, _alias: _alias, expand: expand, metadata: metadata, name: name)
      data
    end
    ...
    def post_radar_value_lists_value_list_with_http_info(
      *,
      ...
      request = build_api_request_for_post_radar_value_lists_value_list(value_list: value_list, _alias: _alias, expand: expand, metadata: metadata, name: name)
    ...
    def post_radar_value_lists_value_list(
      *,
      ...
      build_api_request_for_post_radar_value_lists_value_list(value_list: value_list, _alias: _alias, expand: expand, metadata: metadata, name: name).execute(&block)
    end
