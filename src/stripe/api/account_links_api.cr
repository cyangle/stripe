...
require "../models/account_link"
require "../models/collection_options_params"
...
module Stripe
  class AccountLinksApi
    ...
    # @optional @param collect [String?] The collect parameter is deprecated. Use `collection_options` instead.
    # @optional @param collection_options [Stripe::CollectionOptionsParams?]
    ...
    def post_account_links(
      *,
      ...
      data, _status_code, _headers = post_account_links_with_http_info(account: account, _type: _type, collect: collect, collection_options: collection_options, expand: expand, refresh_url: refresh_url, return_url: return_url)
      data
    end
    ...
    def post_account_links_with_http_info(
      *,
      ...
      request = build_api_request_for_post_account_links(account: account, _type: _type, collect: collect, collection_options: collection_options, expand: expand, refresh_url: refresh_url, return_url: return_url)
    ...
    def post_account_links(
      *,
      ...
      build_api_request_for_post_account_links(account: account, _type: _type, collect: collect, collection_options: collection_options, expand: expand, refresh_url: refresh_url, return_url: return_url).execute(&block)
    end
      ...
      *,
      ...
      if client_side_validation?
        ...
        unless (_collection_options = collection_options).nil?
          _collection_options.validate if _collection_options.is_a?(OpenApi::Validatable)
        end
      end
      ...
      form_params << Tuple(String, Crest::ParamsValue).new("collect", collect.to_s) if !collect.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(collection_options.to_json), "collection_options")) if !collection_options.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(expand.to_json), "expand")) if !expand.nil?
      form_params << Tuple(String, Crest::ParamsValue).new("refresh_url", refresh_url.to_s) if !refresh_url.nil?
