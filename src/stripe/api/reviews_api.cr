...
require "../models/radar_review_list"
  ...
  class ReviewsApi
    ...
    def get_reviews(
      *,
      ...
      data, _status_code, _headers = get_reviews_with_http_info(ending_before: ending_before, starting_after: starting_after, limit: limit, created: created, expand: expand)
      data
    end
    ...
    def get_reviews_with_http_info(
      *,
      ...
      request = build_api_request_for_get_reviews(ending_before: ending_before, starting_after: starting_after, limit: limit, created: created, expand: expand)
    ...
    def get_reviews(
      *,
      ...
      build_api_request_for_get_reviews(ending_before: ending_before, starting_after: starting_after, limit: limit, created: created, expand: expand).execute(&block)
    end
