...
require "../models/billing_portal_configuration"
require "../models/billing_portal_session"
require "../models/business_profile_create_param"
require "../models/business_profile_update_param"
require "../models/error"
require "../models/features_creation_param"
require "../models/features_updating_param"
require "../models/flow_data_param"

require "../models/login_page_create_param"
...
module Stripe
  class BillingPortalApi
    ...
    # @return [Stripe::PortalPublicResourceConfigurationList]
    ...
    ) : Stripe::PortalPublicResourceConfigurationList
    ...
    def get_billing_portal_configurations_with_http_info(
      *,
      ...
      is_default : Bool? = nil,
      expand : Array(Array(String))? = nil
    ) : Tuple(Stripe::PortalPublicResourceConfigurationList, Int32, Hash(String, Array(String) | String))
      ...
      Tuple.new(Stripe::PortalPublicResourceConfigurationList.from_json(body), status_code, headers)
    end
    ...
    def post_billing_portal_configurations(
      *,
      ...
      data, _status_code, _headers = post_billing_portal_configurations_with_http_info(business_profile: business_profile, features: features, default_return_url: default_return_url, expand: expand, login_page: login_page, metadata: metadata)
      data
    end
    ...
    def post_billing_portal_configurations_with_http_info(
      *,
      ...
      request = build_api_request_for_post_billing_portal_configurations(business_profile: business_profile, features: features, default_return_url: default_return_url, expand: expand, login_page: login_page, metadata: metadata)
    ...
    def post_billing_portal_sessions(
      *,
      ...
      data, _status_code, _headers = post_billing_portal_sessions_with_http_info(customer: customer, configuration: configuration, expand: expand, flow_data: flow_data, locale: locale, on_behalf_of: on_behalf_of, return_url: return_url)
      data
    end
    ...
    def post_billing_portal_sessions_with_http_info(
      *,
      ...
      request = build_api_request_for_post_billing_portal_sessions(customer: customer, configuration: configuration, expand: expand, flow_data: flow_data, locale: locale, on_behalf_of: on_behalf_of, return_url: return_url)
    ...
    def post_billing_portal_sessions(
      *,
      ...
      build_api_request_for_post_billing_portal_sessions(customer: customer, configuration: configuration, expand: expand, flow_data: flow_data, locale: locale, on_behalf_of: on_behalf_of, return_url: return_url).execute(&block)
    end
    ...
    def build_api_request_for_post_billing_portal_sessions(
      *,
      ...
      # form parameters
      form_params : Array(Tuple(String, Crest::ParamsValue)) | Nil = Array(Tuple(String, Crest::ParamsValue)).new
      form_params << Tuple(String, Crest::ParamsValue).new("configuration", configuration.to_s) if !configuration.nil?
      form_params << Tuple(String, Crest::ParamsValue).new("customer", customer.to_s) if !customer.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(expand.to_json), "expand")) if !expand.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(flow_data.to_json), "flow_data")) if !flow_data.nil?
