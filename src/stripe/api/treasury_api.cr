...
require "../models/end_user_details_params"
require "../models/error"
require "../models/feature_access"
require "../models/financial_addresses"
require "../models/get_accounts_created_parameter"
require "../models/inbound_transfers"

require "../models/linked_flows_param"
require "../models/outbound_payments"
require "../models/outbound_transfers"
require "../models/payment_method_data"
require "../models/payment_method_options"
require "../models/platform_restrictions"
require "../models/status_transition_timestamp_specs"
require "../models/treasury_credit_reversal"
require "../models/treasury_debit_reversal"
require "../models/treasury_financial_account"
require "../models/treasury_financial_account_features"
require "../models/treasury_financial_accounts_resource_financial_account_list"
require "../models/treasury_inbound_transfer"
require "../models/treasury_inbound_transfers_resource_inbound_transfer_list"
require "../models/treasury_outbound_payment"
require "../models/treasury_outbound_payments_resource_outbound_payment_list"
require "../models/treasury_outbound_transfer"
require "../models/treasury_outbound_transfers_resource_outbound_transfer_list"
require "../models/treasury_received_credit"
require "../models/treasury_received_credits_resource_credit_reversal_list"
require "../models/treasury_received_credits_resource_received_credit_list"
require "../models/treasury_received_debit"
require "../models/treasury_received_debits_resource_debit_reversal_list"
require "../models/treasury_received_debits_resource_received_debit_list"
require "../models/treasury_transaction"
require "../models/treasury_transaction_entry"
require "../models/treasury_transactions_resource_transaction_entry_list"
require "../models/treasury_transactions_resource_transaction_list"
...
module Stripe
  class TreasuryApi
    ...
    # @optional @param created [Stripe::GetAccountsCreatedParameter?] Only return FinancialAccounts that were created during the given date interval.
    # @optional @param expand [Array(Array(String))?] Specifies which fields in the response should be expanded.
    ...
    def get_treasury_financial_accounts(
      *,
      ...
      data, _status_code, _headers = get_treasury_financial_accounts_with_http_info(limit: limit, ending_before: ending_before, starting_after: starting_after, created: created, expand: expand)
      data
    end
    ...
    def get_treasury_financial_accounts_with_http_info(
      *,
      ...
      request = build_api_request_for_get_treasury_financial_accounts(limit: limit, ending_before: ending_before, starting_after: starting_after, created: created, expand: expand)
    ...
    def get_treasury_financial_accounts(
      *,
      ...
      build_api_request_for_get_treasury_financial_accounts(limit: limit, ending_before: ending_before, starting_after: starting_after, created: created, expand: expand).execute(&block)
    end
    ...
    # @optional @param created [Stripe::GetAccountsCreatedParameter?] Only return OutboundPayments that were created during the given date interval.
    # @optional @param expand [Array(Array(String))?] Specifies which fields in the response should be expanded.
    ...
    def get_treasury_outbound_payments(
      *,
      ...
      data, _status_code, _headers = get_treasury_outbound_payments_with_http_info(financial_account: financial_account, ending_before: ending_before, starting_after: starting_after, limit: limit, customer: customer, status: status, created: created, expand: expand)
      data
    end
    ...
    def get_treasury_outbound_payments_with_http_info(
      *,
      ...
      request = build_api_request_for_get_treasury_outbound_payments(financial_account: financial_account, ending_before: ending_before, starting_after: starting_after, limit: limit, customer: customer, status: status, created: created, expand: expand)
    ...
    def get_treasury_outbound_payments(
      *,
      ...
      build_api_request_for_get_treasury_outbound_payments(financial_account: financial_account, ending_before: ending_before, starting_after: starting_after, limit: limit, customer: customer, status: status, created: created, expand: expand).execute(&block)
    end
    ...
    # @optional @param created [Stripe::GetAccountsCreatedParameter?] Only return TransactionEntries that were created during the given date interval.
    # @optional @param expand [Array(Array(String))?] Specifies which fields in the response should be expanded.
    ...
    def get_treasury_transaction_entries(
      *,
      ...
      data, _status_code, _headers = get_treasury_transaction_entries_with_http_info(financial_account: financial_account, ending_before: ending_before, starting_after: starting_after, limit: limit, transaction: transaction, created: created, expand: expand, order_by: order_by, effective_at: effective_at)
      data
    end
    ...
    def get_treasury_transaction_entries_with_http_info(
      *,
      ...
      request = build_api_request_for_get_treasury_transaction_entries(financial_account: financial_account, ending_before: ending_before, starting_after: starting_after, limit: limit, transaction: transaction, created: created, expand: expand, order_by: order_by, effective_at: effective_at)
    ...
    def get_treasury_transaction_entries(
      *,
      ...
      build_api_request_for_get_treasury_transaction_entries(financial_account: financial_account, ending_before: ending_before, starting_after: starting_after, limit: limit, transaction: transaction, created: created, expand: expand, order_by: order_by, effective_at: effective_at).execute(&block)
    end
    ...
    def get_treasury_transactions(
      *,
      ...
      data, _status_code, _headers = get_treasury_transactions_with_http_info(financial_account: financial_account, ending_before: ending_before, starting_after: starting_after, status_transitions: status_transitions, limit: limit, status: status, created: created, expand: expand, order_by: order_by)
      data
    end
    ...
    def get_treasury_transactions_with_http_info(
      *,
      ...
      request = build_api_request_for_get_treasury_transactions(financial_account: financial_account, ending_before: ending_before, starting_after: starting_after, status_transitions: status_transitions, limit: limit, status: status, created: created, expand: expand, order_by: order_by)
    ...
    def get_treasury_transactions(
      *,
      ...
      build_api_request_for_get_treasury_transactions(financial_account: financial_account, ending_before: ending_before, starting_after: starting_after, status_transitions: status_transitions, limit: limit, status: status, created: created, expand: expand, order_by: order_by).execute(&block)
    end
    ...
    def post_treasury_credit_reversals(
      *,
      ...
      data, _status_code, _headers = post_treasury_credit_reversals_with_http_info(received_credit: received_credit, expand: expand, metadata: metadata)
      data
    end
    ...
    def post_treasury_credit_reversals_with_http_info(
      *,
      ...
      request = build_api_request_for_post_treasury_credit_reversals(received_credit: received_credit, expand: expand, metadata: metadata)
    ...
    def post_treasury_credit_reversals(
      *,
      ...
      build_api_request_for_post_treasury_credit_reversals(received_credit: received_credit, expand: expand, metadata: metadata).execute(&block)
    end
    ...
    def build_api_request_for_post_treasury_credit_reversals(
      *,
      ...
      form_params << Tuple(String, Crest::ParamsValue).new("received_credit", received_credit.to_s) if !received_credit.nil?
    ...
    def post_treasury_debit_reversals(
      *,
      ...
      data, _status_code, _headers = post_treasury_debit_reversals_with_http_info(received_debit: received_debit, expand: expand, metadata: metadata)
      data
    end
    ...
    def post_treasury_debit_reversals_with_http_info(
      *,
      ...
      request = build_api_request_for_post_treasury_debit_reversals(received_debit: received_debit, expand: expand, metadata: metadata)
    ...
    def post_treasury_debit_reversals(
      *,
      ...
      build_api_request_for_post_treasury_debit_reversals(received_debit: received_debit, expand: expand, metadata: metadata).execute(&block)
    end
    ...
    def build_api_request_for_post_treasury_debit_reversals(
      *,
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(expand.to_json), "expand")) if !expand.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(metadata.to_json), "metadata")) if !metadata.nil?
      form_params << Tuple(String, Crest::ParamsValue).new("received_debit", received_debit.to_s) if !received_debit.nil?
    ...
    def post_treasury_financial_accounts(
      *,
      ...
      data, _status_code, _headers = post_treasury_financial_accounts_with_http_info(supported_currencies: supported_currencies, expand: expand, features: features, metadata: metadata, platform_restrictions: platform_restrictions)
      data
    end
    ...
    def post_treasury_financial_accounts_with_http_info(
      *,
      ...
      request = build_api_request_for_post_treasury_financial_accounts(supported_currencies: supported_currencies, expand: expand, features: features, metadata: metadata, platform_restrictions: platform_restrictions)
    ...
    def post_treasury_financial_accounts(
      *,
      ...
      build_api_request_for_post_treasury_financial_accounts(supported_currencies: supported_currencies, expand: expand, features: features, metadata: metadata, platform_restrictions: platform_restrictions).execute(&block)
    end
    ...
    def build_api_request_for_post_treasury_financial_accounts(
      *,
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(metadata.to_json), "metadata")) if !metadata.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(platform_restrictions.to_json), "platform_restrictions")) if !platform_restrictions.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(supported_currencies.to_json), "supported_currencies")) if !supported_currencies.nil?
    ...
    def post_treasury_financial_accounts_financial_account(
      *,
      ...
      data, _status_code, _headers = post_treasury_financial_accounts_financial_account_with_http_info(financial_account: financial_account, expand: expand, features: features, metadata: metadata, platform_restrictions: platform_restrictions)
      data
    end
    ...
    def post_treasury_financial_accounts_financial_account_with_http_info(
      *,
      ...
      request = build_api_request_for_post_treasury_financial_accounts_financial_account(financial_account: financial_account, expand: expand, features: features, metadata: metadata, platform_restrictions: platform_restrictions)
    ...
    def post_treasury_financial_accounts_financial_account(
      *,
      ...
      build_api_request_for_post_treasury_financial_accounts_financial_account(financial_account: financial_account, expand: expand, features: features, metadata: metadata, platform_restrictions: platform_restrictions).execute(&block)
    end
    ...
    def build_api_request_for_post_treasury_financial_accounts_financial_account_features(
      *,
      ...
      # form parameters
      form_params : Array(Tuple(String, Crest::ParamsValue)) | Nil = Array(Tuple(String, Crest::ParamsValue)).new
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(card_issuing.to_json), "card_issuing")) if !card_issuing.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(deposit_insurance.to_json), "deposit_insurance")) if !deposit_insurance.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(expand.to_json), "expand")) if !expand.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(financial_addresses.to_json), "financial_addresses")) if !financial_addresses.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(inbound_transfers.to_json), "inbound_transfers")) if !inbound_transfers.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(intra_stripe_flows.to_json), "intra_stripe_flows")) if !intra_stripe_flows.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(outbound_payments.to_json), "outbound_payments")) if !outbound_payments.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(outbound_transfers.to_json), "outbound_transfers")) if !outbound_transfers.nil?
    ...
    def post_treasury_inbound_transfers(
      *,
      ...
      data, _status_code, _headers = post_treasury_inbound_transfers_with_http_info(amount: amount, currency: currency, financial_account: financial_account, origin_payment_method: origin_payment_method, description: description, expand: expand, metadata: metadata, statement_descriptor: statement_descriptor)
      data
    end
    ...
    def post_treasury_inbound_transfers_with_http_info(
      *,
      ...
      request = build_api_request_for_post_treasury_inbound_transfers(amount: amount, currency: currency, financial_account: financial_account, origin_payment_method: origin_payment_method, description: description, expand: expand, metadata: metadata, statement_descriptor: statement_descriptor)
    ...
    def post_treasury_inbound_transfers(
      *,
      ...
      build_api_request_for_post_treasury_inbound_transfers(amount: amount, currency: currency, financial_account: financial_account, origin_payment_method: origin_payment_method, description: description, expand: expand, metadata: metadata, statement_descriptor: statement_descriptor).execute(&block)
    end
    ...
    def build_api_request_for_post_treasury_inbound_transfers(
      *,
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(metadata.to_json), "metadata")) if !metadata.nil?
      form_params << Tuple(String, Crest::ParamsValue).new("origin_payment_method", origin_payment_method.to_s) if !origin_payment_method.nil?
    ...
    def build_api_request_for_post_treasury_outbound_payments(
      *,
      ...
      form_params << Tuple(String, Crest::ParamsValue).new("description", description.to_s) if !description.nil?
      form_params << Tuple(String, Crest::ParamsValue).new("destination_payment_method", destination_payment_method.to_s) if !destination_payment_method.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(destination_payment_method_data.to_json), "destination_payment_method_data")) if !destination_payment_method_data.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(destination_payment_method_options.to_json), "destination_payment_method_options")) if !destination_payment_method_options.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(end_user_details.to_json), "end_user_details")) if !end_user_details.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(expand.to_json), "expand")) if !expand.nil?
      form_params << Tuple(String, Crest::ParamsValue).new("financial_account", financial_account.to_s) if !financial_account.nil?
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(metadata.to_json), "metadata")) if !metadata.nil?
      form_params << Tuple(String, Crest::ParamsValue).new("statement_descriptor", statement_descriptor.to_s) if !statement_descriptor.nil?
    ...
    # @optional @param expand [Array(String)?] Specifies which fields in the response should be expanded.
    # @optional @param metadata [Hash(String, String)?]
    # @optional @param statement_descriptor [String?] Statement descriptor to be shown on the receiving end of an OutboundTransfer. Maximum 10 characters for `ach` transfers or 140 characters for `us_domestic_wire` transfers. The default value is \\\"transfer\\\".
    # @return [Stripe::TreasuryOutboundTransfer]
    def post_treasury_outbound_transfers(
      *,
      ...
      data, _status_code, _headers = post_treasury_outbound_transfers_with_http_info(amount: amount, currency: currency, financial_account: financial_account, description: description, destination_payment_method: destination_payment_method, destination_payment_method_options: destination_payment_method_options, expand: expand, metadata: metadata, statement_descriptor: statement_descriptor)
      data
    end
    ...
    def post_treasury_outbound_transfers_with_http_info(
      *,
      ...
      request = build_api_request_for_post_treasury_outbound_transfers(amount: amount, currency: currency, financial_account: financial_account, description: description, destination_payment_method: destination_payment_method, destination_payment_method_options: destination_payment_method_options, expand: expand, metadata: metadata, statement_descriptor: statement_descriptor)
    ...
    def post_treasury_outbound_transfers(
      *,
      ...
      build_api_request_for_post_treasury_outbound_transfers(amount: amount, currency: currency, financial_account: financial_account, description: description, destination_payment_method: destination_payment_method, destination_payment_method_options: destination_payment_method_options, expand: expand, metadata: metadata, statement_descriptor: statement_descriptor).execute(&block)
    end
