  ...
  class CustomersApi
    ...
    def get_customers_customer_payment_methods(
      *,
      ...
      data, _status_code, _headers = get_customers_customer_payment_methods_with_http_info(customer: customer, ending_before: ending_before, starting_after: starting_after, limit: limit, _type: _type, expand: expand)
      data
    end
    ...
    def get_customers_customer_payment_methods_with_http_info(
      *,
      ...
      request = build_api_request_for_get_customers_customer_payment_methods(customer: customer, ending_before: ending_before, starting_after: starting_after, limit: limit, _type: _type, expand: expand)
    ...
    def get_customers_customer_payment_methods(
      *,
      ...
      build_api_request_for_get_customers_customer_payment_methods(customer: customer, ending_before: ending_before, starting_after: starting_after, limit: limit, _type: _type, expand: expand).execute(&block)
    end
