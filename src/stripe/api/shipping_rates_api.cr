...
require "../models/delivery_estimate"
require "../models/error"
require "../models/fixed_amount"
require "../models/fixed_amount_update"
require "../models/get_accounts_created_parameter"

require "../models/post_accounts_request_metadata"
require "../models/shipping_rate"
require "../models/shipping_resources_shipping_rate_list"
...
module Stripe
  class ShippingRatesApi
    ...
    # @optional @param _type [String?] The type of calculation to use on the shipping rate.
    # @return [Stripe::ShippingRate]
    def post_shipping_rates(
      *,
      ...
      data, _status_code, _headers = post_shipping_rates_with_http_info(display_name: display_name, delivery_estimate: delivery_estimate, expand: expand, fixed_amount: fixed_amount, metadata: metadata, tax_behavior: tax_behavior, tax_code: tax_code, _type: _type)
      data
    end
    ...
    def post_shipping_rates_with_http_info(
      *,
      ...
      request = build_api_request_for_post_shipping_rates(display_name: display_name, delivery_estimate: delivery_estimate, expand: expand, fixed_amount: fixed_amount, metadata: metadata, tax_behavior: tax_behavior, tax_code: tax_code, _type: _type)
    ...
    def post_shipping_rates(
      *,
      ...
      build_api_request_for_post_shipping_rates(display_name: display_name, delivery_estimate: delivery_estimate, expand: expand, fixed_amount: fixed_amount, metadata: metadata, tax_behavior: tax_behavior, tax_code: tax_code, _type: _type).execute(&block)
    end
    ...
    def build_api_request_for_post_shipping_rates(
      *,
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(delivery_estimate.to_json), "delivery_estimate")) if !delivery_estimate.nil?
      ...
      form_params.concat(Crest::ZeroEnumeratedFlatParamsEncoder.flatten_params(JSON.parse(fixed_amount.to_json), "fixed_amount")) if !fixed_amount.nil?
