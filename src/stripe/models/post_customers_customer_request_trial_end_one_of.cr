...
module Stripe
  class PostCustomersCustomerRequestTrialEndOneOf
    ...
    def self.from_json(value : JSON::PullParser) : PostCustomersCustomerRequestTrialEndOneOf
      new(value)
    end

    def self.to_json(value : PostCustomersCustomerRequestTrialEndOneOf, json : JSON::Builder) : Nil
      value.to_json(json)
    end
