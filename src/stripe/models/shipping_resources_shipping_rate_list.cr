...
module Stripe
  class ShippingResourcesShippingRateList
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(ShippingRate))]
    property data : Array(ShippingRate)
    ...
    def initialize(*, @data : Array(ShippingRate), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/shipping_rates/
      true
    end
