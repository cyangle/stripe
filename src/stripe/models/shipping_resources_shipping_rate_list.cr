...
module Stripe
  ...
  class ShippingResourcesShippingRateList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::ShippingRate)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::ShippingRate)? = nil
    ...
    PATTERN_FOR_URL    = /^\/v1\/shipping_rates/
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::ShippingRate)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(data : Array(Stripe::ShippingRate)?)
      if data.nil?
