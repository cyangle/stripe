...
module Stripe
  class PaymentIntentNextActionVerifyWithMicrodeposits
    ...
    @[NASON::Field(key: "hosted_verification_url", type: String)]
    property hosted_verification_url : String

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @arrival_date : Int64, @hosted_verification_url : String)
    end
    ...
    def hash
      [arrival_date, hosted_verification_url].hash
    end
