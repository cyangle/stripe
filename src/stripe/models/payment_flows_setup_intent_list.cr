...
module Stripe
  class PaymentFlowsSetupIntentList
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(SetupIntent))]
    property data : Array(SetupIntent)
    ...
    def initialize(*, @data : Array(SetupIntent), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/setup_intents/
      true
    end
