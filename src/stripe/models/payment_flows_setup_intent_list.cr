...
module Stripe
  ...
  class PaymentFlowsSetupIntentList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::SetupIntent)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::SetupIntent)? = nil
    ...
    PATTERN_FOR_URL    = /^\/v1\/setup_intents/
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::SetupIntent)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(data : Array(Stripe::SetupIntent)?)
      if data.nil?
