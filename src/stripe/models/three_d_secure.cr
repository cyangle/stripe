...
module Stripe
  ...
  class ThreeDSecure
    ...
    @[NASON::Field(key: "authenticated", type: Bool)]
    property authenticated : Bool

    @[NASON::Field(key: "card", type: Card)]
    property card : Card
    ...
    @[NASON::Field(key: "redirect_url", type: String? | Null, nillable: true)]
    property redirect_url : String? | Null
    ...
    def initialize(*, @amount : Int64, @authenticated : Bool, @card : Card, @created : Int64, @currency : String, @id : String, @livemode : Bool, @object : String, @status : String, @redirect_url : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@redirect_url.nil? && !@redirect_url.null? && @redirect_url.to_s.size > 5000
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new("String", ["three_d_secure"])
      return false unless object_validator.valid?(@object)
      return false if !@redirect_url.nil? && !@redirect_url.null? && @redirect_url.to_s.size > 5000
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["three_d_secure"])
    ...
    def hash
      [amount, authenticated, card, created, currency, id, livemode, object, redirect_url, status].hash
    end
