...
module Stripe
  ...
  class PortalFlowsFlowSubscriptionUpdateConfirm
    ...
    @[JSON::Field(key: "discounts", type: Array(Stripe::PortalFlowsSubscriptionUpdateConfirmDiscount)?, default: nil, required: true, nullable: true, emit_null: true)]
    getter discounts : Array(Stripe::PortalFlowsSubscriptionUpdateConfirmDiscount)? = nil

    # The [subscription item](https://stripe.com/docs/api/subscription_items) to be updated through this flow. Currently, only up to one may be specified and subscriptions with multiple items are not updatable.
    @[JSON::Field(key: "items", type: Array(Stripe::PortalFlowsSubscriptionUpdateConfirmItem)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter items : Array(Stripe::PortalFlowsSubscriptionUpdateConfirmItem)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @discounts : Array(Stripe::PortalFlowsSubscriptionUpdateConfirmDiscount)? = nil,
      @items : Array(Stripe::PortalFlowsSubscriptionUpdateConfirmItem)? = nil,
    ...
    def discounts=(new_value : Array(Stripe::PortalFlowsSubscriptionUpdateConfirmDiscount)?)
    ...
    def items=(new_value : Array(Stripe::PortalFlowsSubscriptionUpdateConfirmItem)?)
    ...
    def_equals_and_hash(@discounts, @items, @subscription)
  end
end
