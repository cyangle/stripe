...
module Stripe
  ...
  class GetBitcoinReceivers200Response
    ...
    # Required properties
    @[JSON::Field(key: "data", type: Array(BitcoinReceiver))]
    property data : Array(BitcoinReceiver)
    ...
    def initialize(*, @data : Array(BitcoinReceiver), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/bitcoin\/receivers/
      true
    end
