...
module Stripe
  #
  class GetBitcoinReceivers200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::BitcoinReceiver)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::BitcoinReceiver)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::BitcoinReceiver)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::BitcoinReceiver
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/bitcoin\/receivers/
      end
    ...
    def data=(data : Array(Stripe::BitcoinReceiver)?)
      if data.nil?
