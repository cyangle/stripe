...
module Stripe
  class TerminalLocationLocationList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::TerminalLocation)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::TerminalLocation)? = nil
    ...
    PATTERN_FOR_URL    = /^\/v1\/terminal\/locations/
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::TerminalLocation)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(data : Array(Stripe::TerminalLocation)?)
      if data.nil?
