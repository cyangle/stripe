...
module Stripe
  class TerminalLocationLocationList
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(TerminalLocation))]
    property data : Array(TerminalLocation)
    ...
    def initialize(*, @data : Array(TerminalLocation), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/terminal\/locations/
      true
    end
