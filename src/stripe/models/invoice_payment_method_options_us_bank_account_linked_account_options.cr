...
require "./invoice_payment_method_options_us_bank_account_linked_account_options_filters"
...
module Stripe
  ...
  class InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptions
    ...
    @[JSON::Field(key: "filters", type: Stripe::InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptionsFilters?, default: nil, required: false, nullable: false, emit_null: false)]
    getter filters : Stripe::InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptionsFilters? = nil
    ...
    def initialize(
      *,
      ...
      # Optional properties
      @filters : Stripe::InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptionsFilters? = nil,
    ...
    def filters=(new_value : Stripe::InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptionsFilters?)
      unless new_value.nil?
    ...
    def_equals_and_hash(@prefetch, @filters, @permissions)
  end
end
