...
module Stripe
  class AccountSettings
    ...
    # Required properties
    @[NASON::Field(key: "branding", type: AccountBrandingSettings)]
    property branding : AccountBrandingSettings

    @[NASON::Field(key: "card_payments", type: AccountCardPaymentsSettings)]
    property card_payments : AccountCardPaymentsSettings

    @[NASON::Field(key: "dashboard", type: AccountDashboardSettings)]
    property dashboard : AccountDashboardSettings

    @[NASON::Field(key: "payments", type: AccountPaymentsSettings)]
    property payments : AccountPaymentsSettings

    # Optional properties
    @[NASON::Field(key: "bacs_debit_payments", type: AccountBacsDebitPaymentsSettings?, nillable: true)]
    property bacs_debit_payments : AccountBacsDebitPaymentsSettings?

    @[NASON::Field(key: "card_issuing", type: AccountCardIssuingSettings?, nillable: true)]
    property card_issuing : AccountCardIssuingSettings?

    @[NASON::Field(key: "payouts", type: AccountPayoutSettings?, nillable: true)]
    property payouts : AccountPayoutSettings?

    @[NASON::Field(key: "sepa_debit_payments", type: AccountSepaDebitPaymentsSettings?, nillable: true)]
    ...
    def hash
      [bacs_debit_payments, branding, card_issuing, card_payments, dashboard, payments, payouts, sepa_debit_payments].hash
    end
