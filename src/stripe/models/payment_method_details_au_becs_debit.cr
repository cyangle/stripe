...
module Stripe
  class PaymentMethodDetailsAuBecsDebit
    ...
    @[NASON::Field(key: "bsb_number", type: String? | Null, nillable: true)]
    property bsb_number : String? | Null
    ...
    @[NASON::Field(key: "mandate", type: String?, nillable: true)]
    property mandate : String?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @bsb_number : String? | Null = nil, @fingerprint : String? | Null = nil, @last4 : String? | Null = nil, @mandate : String? = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@bsb_number.nil? && !@bsb_number.null? && @bsb_number.to_s.size > 5000
    ...
    def valid?
      return false if !@bsb_number.nil? && !@bsb_number.null? && @bsb_number.to_s.size > 5000
    ...
    def hash
      [bsb_number, fingerprint, last4, mandate].hash
    end
