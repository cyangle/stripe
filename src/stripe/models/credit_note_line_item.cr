...
module Stripe
  ...
  class CreditNoteLineItem
    ...
    def_equals_and_hash(@amount, @amount_excluding_tax, @description, @discount_amount, @discount_amounts, @id, @livemode, @object, @quantity, @tax_amounts, @tax_rates, @_type, @unit_amount, @unit_amount_decimal, @unit_amount_excluding_tax, @invoice_line_item)
  end
end
