...
module Stripe
  ...
  class CreditNoteLineItem
    ...
    def_equals_and_hash(@amount, @discount_amount, @discount_amounts, @id, @livemode, @object, @tax_amounts, @tax_rates, @_type, @description, @description_present, @invoice_line_item, @invoice_line_item_present, @quantity, @quantity_present, @unit_amount, @unit_amount_present, @unit_amount_decimal, @unit_amount_decimal_present)
  end
end
