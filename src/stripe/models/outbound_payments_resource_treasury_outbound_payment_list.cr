...
module Stripe
  ...
  class OutboundPaymentsResourceTreasuryOutboundPaymentList
    ...
    @[JSON::Field(key: "data", type: Array(TreasuryOutboundPayment))]
    property data : Array(TreasuryOutboundPayment)
    ...
    def initialize(*, @data : Array(TreasuryOutboundPayment), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/treasury\/outbound_payments/
      true
    end
