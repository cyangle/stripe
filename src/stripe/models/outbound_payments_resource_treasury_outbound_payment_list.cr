...
module Stripe
  #
  class OutboundPaymentsResourceTreasuryOutboundPaymentList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::TreasuryOutboundPayment)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::TreasuryOutboundPayment)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::TreasuryOutboundPayment)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::TreasuryOutboundPayment
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/treasury\/outbound_payments/
      end
    ...
    def data=(data : Array(Stripe::TreasuryOutboundPayment)?)
      if data.nil?
