  ...
  class SubscriptionSchedule1
    ...
    def initialize(
      *,
      # Required properties
      @created : Int64? = nil,
      @customer : SubscriptionScheduleCustomer? = nil,
      @default_settings : SubscriptionSchedulesResourceDefaultSettings? = nil,
      @end_behavior : String? = nil,
      @id : String? = nil,
      @livemode : Bool? = nil,
      @object : String? = nil,
      @phases : Array(SubscriptionSchedulePhaseConfiguration)? = nil,
      @status : String? = nil,
      # Optional properties
