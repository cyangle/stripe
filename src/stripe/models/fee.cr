...
module Stripe
  class Fee
    ...
    def initialize(*, @amount : Int64, @currency : String, @_type : String, @application : String? | Null = nil, @description : String? | Null = nil)
    end
    ...
    def hash
      [amount, application, currency, description, _type].hash
    end
