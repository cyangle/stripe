...
module Stripe
  #
  class GetIssuingSettlements200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::IssuingSettlement)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::IssuingSettlement)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::IssuingSettlement)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::IssuingSettlement
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/issuing\/settlements/
      end
    ...
    def data=(data : Array(Stripe::IssuingSettlement)?)
      if data.nil?
