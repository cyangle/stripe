...
module Stripe
  ...
  class Item
    ...
    @[NASON::Field(key: "discounts", type: Array(LineItemsDiscountAmount)?, nillable: true)]
    ...
    @[NASON::Field(key: "taxes", type: Array(LineItemsTaxAmount)?, nillable: true)]
    ...
    def initialize(*, @amount_subtotal : Int64, @amount_total : Int64, @currency : String, @description : String, @id : String, @object : String, @discounts : Array(LineItemsDiscountAmount)? = nil, @price : Price? | Null = nil, @quantity : Int64? | Null = nil, @taxes : Array(LineItemsTaxAmount)? = nil)
    end
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new("String", ["item"])
    ...
    def hash
      [amount_subtotal, amount_total, currency, description, discounts, id, object, price, quantity, taxes].hash
    end
