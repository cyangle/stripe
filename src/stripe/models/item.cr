...
module Stripe
  ...
  class Item
    ...
    def_equals_and_hash(@amount_discount, @amount_subtotal, @amount_tax, @amount_total, @currency, @description, @id, @object, @discounts, @price, @price_present, @quantity, @quantity_present, @taxes)
  end
end
