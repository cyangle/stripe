...
module Stripe
  ...
  class Item
    ...
    def_equals_and_hash(@amount_subtotal, @amount_total, @currency, @description, @id, @object, @amount_discount, @amount_discount_present, @amount_tax, @amount_tax_present, @discounts, @discounts_present, @price, @price_present, @product, @product_present, @quantity, @quantity_present, @taxes, @taxes_present)
  end
end
