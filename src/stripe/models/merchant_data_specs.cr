...
module Stripe
  class MerchantDataSpecs
    ...
    @[JSON::Field(key: "category", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "network_id", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "terminal_id", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    def_equals_and_hash(@category, @city, @country, @name, @network_id, @postal_code, @state, @terminal_id, @url)
  end
end
