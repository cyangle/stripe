...
require "./customer_update_updating_param"
require "./invoice_list_param"
require "./payment_method_update_param"
require "./subscription_cancel_updating_param"
require "./subscription_update_updating_param"
...
module Stripe
  class FeaturesUpdatingParam
    ...
    def customer_update=(new_value : Stripe::CustomerUpdateUpdatingParam?)
    ...
    def subscription_cancel=(new_value : Stripe::SubscriptionCancelUpdatingParam?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def subscription_update=(new_value : Stripe::SubscriptionUpdateUpdatingParam?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
