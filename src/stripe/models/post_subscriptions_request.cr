...
module Stripe
  class PostSubscriptionsRequest
    ...
    @[JSON::Field(key: "on_behalf_of", type: Stripe::PostSubscriptionsRequestOnBehalfOf?, default: nil, required: false, nullable: false, emit_null: false)]
    getter on_behalf_of : Stripe::PostSubscriptionsRequestOnBehalfOf? = nil
    ...
    def_equals_and_hash(@customer, @add_invoice_items, @application_fee_percent, @automatic_tax, @backdate_start_date, @billing_cycle_anchor, @billing_thresholds, @cancel_at, @cancel_at_period_end, @collection_method, @coupon, @currency, @days_until_due, @default_payment_method, @default_source, @default_tax_rates, @description, @expand, @items, @metadata, @off_session, @on_behalf_of, @payment_behavior, @payment_settings, @pending_invoice_item_interval, @promotion_code, @proration_behavior, @transfer_data, @trial_end, @trial_from_plan, @trial_period_days)
  end
end
