...
require "./billing_cycle_anchor_config_param"
...
require "./post_subscriptions_request_default_tax_rates"
require "./post_subscriptions_request_discounts"
require "./post_subscriptions_request_pending_invoice_item_interval"
require "./post_subscriptions_request_trial_end"
require "./subscription_item_create_params"
...
module Stripe
  class PostSubscriptionsRequest
    ...
    @[JSON::Field(key: "billing_cycle_anchor_config", type: Stripe::BillingCycleAnchorConfigParam?, default: nil, required: false, nullable: false, emit_null: false)]
    getter billing_cycle_anchor_config : Stripe::BillingCycleAnchorConfigParam? = nil
    ...
    @[JSON::Field(key: "default_tax_rates", type: Stripe::PostSubscriptionsRequestDefaultTaxRates?, default: nil, required: false, nullable: false, emit_null: false)]
    getter default_tax_rates : Stripe::PostSubscriptionsRequestDefaultTaxRates? = nil
    ...
    @[JSON::Field(key: "trial_end", type: Stripe::PostSubscriptionsRequestTrialEnd?, default: nil, required: false, nullable: false, emit_null: false)]
    getter trial_end : Stripe::PostSubscriptionsRequestTrialEnd? = nil
    ...
    def backdate_start_date=(new_value : Int64?)
      @backdate_start_date = new_value
    end
    ...
    def billing_cycle_anchor_config=(new_value : Stripe::BillingCycleAnchorConfigParam?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def default_tax_rates=(new_value : Stripe::PostSubscriptionsRequestDefaultTaxRates?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def items=(new_value : Array(Stripe::SubscriptionItemCreateParams)?)
      unless new_value.nil?
        OpenApi::ContainerValidator.validate(container: new_value) if new_value.is_a?(Array)
      end
    ...
    def trial_end=(new_value : Stripe::PostSubscriptionsRequestTrialEnd?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def_equals_and_hash(@customer, @add_invoice_items, @application_fee_percent, @automatic_tax, @backdate_start_date, @billing_cycle_anchor, @billing_cycle_anchor_config, @billing_thresholds, @cancel_at, @cancel_at_period_end, @collection_method, @coupon, @currency, @days_until_due, @default_payment_method, @default_source, @default_tax_rates, @description, @discounts, @expand, @invoice_settings, @items, @metadata, @off_session, @on_behalf_of, @payment_behavior, @payment_settings, @pending_invoice_item_interval, @promotion_code, @proration_behavior, @transfer_data, @trial_end, @trial_from_plan, @trial_period_days, @trial_settings)
  end
end
