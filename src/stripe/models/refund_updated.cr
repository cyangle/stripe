...
module Stripe
  ...
  class RefundUpdated
    ...
    @[JSON::Field(key: "object", type: Stripe::Refund?, default: nil, required: true, nullable: false, emit_null: false)]
    getter object : Stripe::Refund? = nil
    ...
    def object=(new_value : Stripe::Refund?)
