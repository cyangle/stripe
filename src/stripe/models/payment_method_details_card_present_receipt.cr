...
module Stripe
  class PaymentMethodDetailsCardPresentReceipt
    ...
    def valid?
      account_type_validator = EnumAttributeValidator.new("String", ["checking", "credit", "prepaid", "unknown"])
    ...
    def account_type=(account_type)
      validator = EnumAttributeValidator.new("String", ["checking", "credit", "prepaid", "unknown"])
