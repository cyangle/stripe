...
require "./business_profile_update_param"
require "./features_updating_param"
require "./login_page_update_param"
...
module Stripe
  class PostBillingPortalConfigurationsConfigurationRequest
    ...
    @[JSON::Field(key: "default_return_url", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_default_return_url = @default_return_url).nil?
        invalid_properties.push(ERROR_MESSAGE_FOR_DEFAULT_RETURN_URL) unless OpenApi::EnumValidator.valid?(_default_return_url, VALID_VALUES_FOR_DEFAULT_RETURN_URL)
      end
    ...
    def valid? : Bool
      ...
      unless (_default_return_url = @default_return_url).nil?
        return false unless OpenApi::EnumValidator.valid?(_default_return_url, VALID_VALUES_FOR_DEFAULT_RETURN_URL)
      end
    ...
    def default_return_url=(new_value : String?)
      unless new_value.nil?
        OpenApi::EnumValidator.validate("default_return_url", new_value, VALID_VALUES_FOR_DEFAULT_RETURN_URL)
      end
