...
module Stripe
  ...
  class PaymentPagesCheckoutSessionSavedPaymentMethodOptions
    ...
    @[JSON::Field(key: "allow_redisplay_filters", type: Array(String)?, default: nil, required: true, nullable: true, emit_null: true)]
    ...
    @[JSON::Field(key: "payment_method_remove", type: String?, default: nil, required: true, nullable: true, emit_null: true)]
    ...
    @[JSON::Field(key: "payment_method_save", type: String?, default: nil, required: true, nullable: true, emit_null: true)]
    ...
    def_equals_and_hash(@allow_redisplay_filters, @payment_method_remove, @payment_method_save)
  end
end
