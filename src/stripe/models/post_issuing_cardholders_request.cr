...
require "./authorization_controls_param_v2"
require "./billing_specs"
require "./company_param"
require "./individual_param"
...
module Stripe
  class PostIssuingCardholdersRequest
    ...
    def_equals_and_hash(@billing, @name, @company, @email, @expand, @individual, @metadata, @phone_number, @preferred_locales, @spending_controls, @status, @_type)
  end
end
