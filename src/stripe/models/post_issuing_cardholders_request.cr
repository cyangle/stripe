...
module Stripe
  ...
  class PostIssuingCardholdersRequest
    ...
    def_equals_and_hash(@billing, @name, @_type, @company, @company_present, @email, @email_present, @expand, @expand_present, @individual, @individual_present, @metadata, @metadata_present, @phone_number, @phone_number_present, @spending_controls, @spending_controls_present, @status, @status_present)
  end
end
