...
module Stripe
  ...
  class IssuingAuthorization
    ...
    def list_invalid_properties
      ...
      # This is a model card : Stripe::IssuingCard?
      ...
      # Container request_history array has values of Stripe::IssuingAuthorizationRequest

      invalid_properties.push(ENUM_VALIDATOR_FOR_STATUS.error_message) unless ENUM_VALIDATOR_FOR_STATUS.valid?(@status, false)
      invalid_properties.push("\"transactions\" is required and cannot be null") if @transactions.nil?
      # Container transactions array has values of Stripe::IssuingTransaction
      invalid_properties.push("\"verification_data\" is required and cannot be null") if @verification_data.nil?
      # This is a model verification_data : Stripe::IssuingAuthorizationVerificationData?
      # This is a model amount_details : Stripe::IssuingAuthorizationAmountDetails1?
      # This is a model cardholder : Stripe::IssuingAuthorizationCardholder?
      # This is a model pending_request : Stripe::IssuingAuthorizationPendingRequest1?
      # This is a model treasury : Stripe::IssuingAuthorizationTreasury1?
      if _wallet = @wallet
    ...
    def authorization_method=(authorization_method : String?)
      ...
      ENUM_VALIDATOR_FOR_AUTHORIZATION_METHOD.valid!(_authorization_method)
