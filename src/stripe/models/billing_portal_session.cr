...
module Stripe
  ...
  class BillingPortalSession
    ...
    def configuration=(configuration : Stripe::BillingPortalSessionConfiguration?)
      ...
      _configuration.validate if _configuration.is_a?(OpenApi::Validatable)
    ...
    def flow=(flow : Stripe::BillingPortalSessionFlow?)
      if flow.nil?
        return @flow = nil
      end
      _flow = flow.not_nil!
      _flow.validate if _flow.is_a?(OpenApi::Validatable)
      @flow = _flow
    end
