...
module Stripe
  class OrdersLegacyResourceOrderList
    include NASON::Serializable

    # Required properties
    @[NASON::Field(key: "data", type: Array(Order))]
    property data : Array(Order)
    ...
    def initialize(*, @data : Array(Order), @has_more : Bool, @object : String, @url : String)
    end
