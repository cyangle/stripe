...
module Stripe
  class IssuingTransactionFuelData
    ...
    @[NASON::Field(key: "unit", type: String)]
    property unit : String

    # The cost in cents per each unit of fuel, represented as a decimal string with at most 12 decimal places.
    @[NASON::Field(key: "unit_cost_decimal", type: String)]
    property unit_cost_decimal : String

    # Optional properties
    # The volume of the fuel that was pumped, represented as a decimal string with at most 12 decimal places.
    @[NASON::Field(key: "volume_decimal", type: String? | Null, nillable: true)]
    property volume_decimal : String? | Null

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @_type : String, @unit : String, @unit_cost_decimal : String, @volume_decimal : String? | Null = nil)
    end
    ...
    def hash
      [_type, unit, unit_cost_decimal, volume_decimal].hash
    end
