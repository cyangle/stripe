...
module Stripe
  class PaymentMethodDetailsAchCreditTransfer
    ...
    def initialize(*, @account_number : String? | Null = nil, @bank_name : String? | Null = nil, @routing_number : String? | Null = nil, @swift_code : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@account_number.nil? && !@account_number.null? && @account_number.to_s.size > 5000
      ...
      if !@swift_code.nil? && !@swift_code.null? && @swift_code.to_s.size > 5000
    ...
    def valid?
      return false if !@account_number.nil? && !@account_number.null? && @account_number.to_s.size > 5000
      ...
      return false if !@swift_code.nil? && !@swift_code.null? && @swift_code.to_s.size > 5000
      true
    end
    ...
    def hash
      [account_number, bank_name, routing_number, swift_code].hash
    end
