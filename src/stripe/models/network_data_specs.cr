...
module Stripe
  class NetworkDataSpecs
    ...
    @[JSON::Field(key: "acquiring_institution_id", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    def_equals_and_hash(@acquiring_institution_id)
  end
end
