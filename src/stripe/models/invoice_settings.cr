...
require "./invoice_settings_account_tax_ids"
...
module Stripe
  class InvoiceSettings
    ...
    @[JSON::Field(key: "account_tax_ids", type: Stripe::InvoiceSettingsAccountTaxIds?, default: nil, required: false, nullable: false, emit_null: false)]
    getter account_tax_ids : Stripe::InvoiceSettingsAccountTaxIds? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @account_tax_ids : Stripe::InvoiceSettingsAccountTaxIds? = nil,
    ...
    def account_tax_ids=(new_value : Stripe::InvoiceSettingsAccountTaxIds?)
