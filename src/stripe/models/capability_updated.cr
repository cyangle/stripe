...
module Stripe
  ...
  class CapabilityUpdated
    ...
    @[JSON::Field(key: "object", type: Stripe::Capability?, default: nil, required: true, nullable: false, emit_null: false)]
    getter object : Stripe::Capability? = nil
    ...
    def object=(new_value : Stripe::Capability?)
