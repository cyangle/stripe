...
module Stripe
  ...
  class Customer
    ...
    def_hash(@address, @balance, @cash_balance, @created, @currency, @default_source, @delinquent, @description, @discount, @email, @id, @invoice_prefix, @invoice_settings, @livemode, @metadata, @name, @next_invoice_sequence, @object, @phone, @preferred_locales, @shipping, @sources, @subscriptions, @tax, @tax_exempt, @tax_ids, @test_clock)
  end
end
