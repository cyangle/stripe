...
module Stripe
  ...
  class Customer
    ...
    def_equals_and_hash(@created, @id, @livemode, @object, @address, @address_present, @balance, @balance_present, @cash_balance, @cash_balance_present, @currency, @currency_present, @default_source, @default_source_present, @delinquent, @delinquent_present, @description, @description_present, @discount, @discount_present, @email, @email_present, @invoice_prefix, @invoice_prefix_present, @invoice_settings, @invoice_settings_present, @metadata, @metadata_present, @name, @name_present, @next_invoice_sequence, @next_invoice_sequence_present, @phone, @phone_present, @preferred_locales, @preferred_locales_present, @shipping, @shipping_present, @sources, @sources_present, @subscriptions, @subscriptions_present, @tax, @tax_present, @tax_exempt, @tax_exempt_present, @tax_ids, @tax_ids_present, @test_clock, @test_clock_present)
  end
end
