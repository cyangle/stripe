...
module Stripe
  ...
  class PaymentMethodDetailsAfterpayClearpay
    ...
    @[JSON::Field(key: "order_id", type: String?, default: nil, required: true, nullable: true, emit_null: true)]
    getter order_id : String? = nil
    MAX_LENGTH_FOR_ORDER_ID = 5000
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_order_id = @order_id).nil?
        if max_length_error = OpenApi::PrimitiveValidator.max_length_error("order_id", _order_id.to_s.size, MAX_LENGTH_FOR_ORDER_ID)
    ...
    def valid? : Bool
      unless (_order_id = @order_id).nil?
        return false if _order_id.to_s.size > MAX_LENGTH_FOR_ORDER_ID
      end
    ...
    # @param [Object] order_id Object to be assigned
    def order_id=(new_value : String?)
      unless new_value.nil?
        OpenApi::PrimitiveValidator.validate_max_length("order_id", new_value.to_s.size, MAX_LENGTH_FOR_ORDER_ID)
      end
    ...
    def_equals_and_hash(@order_id, @reference)
  end
end
