...
module Stripe
  ...
  class PaymentMethodDetailsSofort
    ...
    ENUM_VALIDATOR_FOR_PREFERRED_LANGUAGE = EnumValidator.new("preferred_language", "String", ["de", "en", "es", "fr", "it", "nl", "pl", "null"])
    ...
    def initialize(*, @bank_code : String?, @bank_name : String?, @bic : String?, @country : String?, @generated_sepa_debit : PaymentMethodDetailsBancontactGeneratedSepaDebit?, @generated_sepa_debit_mandate : PaymentMethodDetailsBancontactGeneratedSepaDebitMandate?, @iban_last4 : String?, @preferred_language : String?, @verified_name : String?)
    end
    ...
    def_hash(@bank_code, @bank_name, @bic, @country, @generated_sepa_debit, @generated_sepa_debit_mandate, @iban_last4, @preferred_language, @verified_name)
  end
end
