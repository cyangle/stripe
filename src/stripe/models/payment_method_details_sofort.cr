...
module Stripe
  class PaymentMethodDetailsSofort
    ...
    def initialize(*, @bank_code : String? | Null = nil, @bank_name : String? | Null = nil, @bic : String? | Null = nil, @country : String? | Null = nil, @generated_sepa_debit : String | PaymentMethod? | Null = nil, @generated_sepa_debit_mandate : String | Mandate? | Null = nil, @iban_last4 : String? | Null = nil, @preferred_language : String? | Null = nil, @verified_name : String? | Null = nil)
    end
    ...
    def valid?
      ...
      preferred_language_validator = EnumAttributeValidator.new("String", ["de", "en", "es", "fr", "it", "nl", "pl"])
    ...
    def preferred_language=(preferred_language)
      validator = EnumAttributeValidator.new("String", ["de", "en", "es", "fr", "it", "nl", "pl"])
    ...
    def hash
      [bank_code, bank_name, bic, country, generated_sepa_debit, generated_sepa_debit_mandate, iban_last4, preferred_language, verified_name].hash
    end
