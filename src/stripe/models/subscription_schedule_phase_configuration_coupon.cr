...
module Stripe
  ...
  class SubscriptionSchedulePhaseConfigurationCoupon
    ...
    def_equals_and_hash(@amount_off, @created, @currency, @duration, @duration_in_months, @id, @livemode, @max_redemptions, @metadata, @name, @object, @percent_off, @redeem_by, @times_redeemed, @valid, @deleted, @applies_to, @currency_options)
  end
end
