...
module Stripe
  ...
  class PostInvoicesInvoicePayRequest
    ...
    def initialize(*, @expand : Array(String)? = nil, @forgive : Bool? = nil, @off_session : Bool? = nil, @paid_out_of_band : Bool? = nil, @payment_method : String? = nil, @source : String? = nil)
    end
    ...
    def_hash(@expand, @forgive, @off_session, @paid_out_of_band, @payment_method, @source)
  end
end
