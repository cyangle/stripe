...
module Stripe
  class UpdateParamsSettingsPaymentMethodOptions
    ...
    @[JSON::Field(key: "acss_debit", type: Stripe::UpdateParamsSettingsPaymentMethodOptionsAcssDebit?, default: nil, required: false, nullable: false, emit_null: false)]
    getter acss_debit : Stripe::UpdateParamsSettingsPaymentMethodOptionsAcssDebit? = nil
    ...
    def acss_debit=(acss_debit : Stripe::UpdateParamsSettingsPaymentMethodOptionsAcssDebit?)
      if acss_debit.nil?
    ...
    def afterpay_clearpay=(afterpay_clearpay : Stripe::UpdateParamsSettingsPaymentMethodOptionsAfterpayClearpay?)
    ...
    def card=(card : Stripe::UpdateParamsSettingsPaymentMethodOptionsCard?)
      if card.nil?
        return @card = nil
      end
      _card = card.not_nil!
    ...
    def customer_balance=(customer_balance : Stripe::UpdateParamsSettingsPaymentMethodOptionsCustomerBalance?)
    ...
    def link=(link : Stripe::UpdateParamsSettingsPaymentMethodOptionsLink?)
      if link.nil?
        return @link = nil
      end
      _link = link.not_nil!
    ...
    def sepa_debit=(sepa_debit : Stripe::UpdateParamsSettingsPaymentMethodOptionsSepaDebit?)
      if sepa_debit.nil?
