...
module Stripe
  ...
  class SubscriptionUpdateCreationParam
    ...
    def initialize(
      *,
      # Required properties
      @default_allowed_updates : SubscriptionUpdateCreationParamDefaultAllowedUpdates,
      @enabled : Bool,
      @products : SubscriptionUpdateCreationParamProducts,
      # Optional properties
    ...
    def_equals_and_hash(@default_allowed_updates, @enabled, @products, @proration_behavior, @proration_behavior_present)
  end
end
