...
module Stripe
  class PaymentMethodDetailsAcssDebit
    ...
    def initialize(*, @bank_name : String? | Null = nil, @fingerprint : String? | Null = nil, @institution_number : String? | Null = nil, @last4 : String? | Null = nil, @mandate : String? = nil, @transit_number : String? | Null = nil)
    end
    ...
    def hash
      [bank_name, fingerprint, institution_number, last4, mandate, transit_number].hash
    end
