...
module Stripe
  ...
  class ReceivedDebitsResourceTreasuryReceivedDebitList
    ...
    @[JSON::Field(key: "data", type: Array(TreasuryReceivedDebit))]
    property data : Array(TreasuryReceivedDebit)
    ...
    def initialize(*, @data : Array(TreasuryReceivedDebit), @has_more : Bool, @object : String, @url : String)
    end
