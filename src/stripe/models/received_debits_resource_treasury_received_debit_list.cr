...
module Stripe
  #
  class ReceivedDebitsResourceTreasuryReceivedDebitList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::TreasuryReceivedDebit)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::TreasuryReceivedDebit)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::TreasuryReceivedDebit)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::TreasuryReceivedDebit
    ...
    def data=(data : Array(Stripe::TreasuryReceivedDebit)?)
      if data.nil?
