...
module Stripe
  ...
  class CustomerBalanceTransactionList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::CustomerBalanceTransaction)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::CustomerBalanceTransaction)? = nil
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::CustomerBalanceTransaction
    ...
    def data=(data : Array(Stripe::CustomerBalanceTransaction)?)
      if data.nil?
