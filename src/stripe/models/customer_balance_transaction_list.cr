...
module Stripe
  class CustomerBalanceTransactionList
    ...
    @[NASON::Field(key: "data", type: Array(CustomerBalanceTransaction))]
    property data : Array(CustomerBalanceTransaction)
    ...
    def initialize(*, @data : Array(CustomerBalanceTransaction), @has_more : Bool, @object : String, @url : String)
    end
