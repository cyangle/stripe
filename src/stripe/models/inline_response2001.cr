...
module Stripe
  class InlineResponse2001
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(Account))]
    property data : Array(Account)
    ...
    def initialize(*, @data : Array(Account), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/accounts/
      true
    end
