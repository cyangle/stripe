...
module Stripe
  class InlineResponse20030
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(Review))]
    property data : Array(Review)
    ...
    def initialize(*, @data : Array(Review), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/reviews/
      true
    end
