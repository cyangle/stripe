...
module Stripe
  ...
  class PostProductsRequest
    ...
    def_equals_and_hash(@name, @active, @active_present, @default_price_data, @default_price_data_present, @description, @description_present, @expand, @expand_present, @id, @id_present, @images, @images_present, @metadata, @metadata_present, @package_dimensions, @package_dimensions_present, @shippable, @shippable_present, @statement_descriptor, @statement_descriptor_present, @tax_code, @tax_code_present, @unit_label, @unit_label_present, @url, @url_present)
  end
end
