...
module Stripe
  class PaymentMethodDetailsCardChecks
    ...
    @[NASON::Field(key: "address_postal_code_check", type: String? | Null, nillable: true)]
    property address_postal_code_check : String? | Null
    ...
    def initialize(*, @address_line1_check : String? | Null = nil, @address_postal_code_check : String? | Null = nil, @cvc_check : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@address_postal_code_check.nil? && !@address_postal_code_check.null? && @address_postal_code_check.to_s.size > 5000
    ...
    def valid?
      ...
      return false if !@address_postal_code_check.nil? && !@address_postal_code_check.null? && @address_postal_code_check.to_s.size > 5000
    ...
    def hash
      [address_line1_check, address_postal_code_check, cvc_check].hash
    end
