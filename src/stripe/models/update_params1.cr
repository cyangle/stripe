...
module Stripe
  ...
  class UpdateParams1
    ...
    @[JSON::Field(key: "settings", type: Stripe::UpdateParams1?, default: nil, required: true, nullable: false, emit_null: false)]
    getter settings : Stripe::UpdateParams1? = nil
    ...
    def initialize(
      *,
      # Required properties
      @settings : Stripe::UpdateParams1? = nil
    )
    end
    ...
    def settings=(settings : Stripe::UpdateParams1?)
      if settings.nil?
