...
module Stripe
  class BitcoinTransaction
    ...
    @[NASON::Field(key: "receiver", type: String)]
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new("String", ["bitcoin_transaction"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["bitcoin_transaction"])
    ...
    def hash
      [amount, bitcoin_amount, created, currency, id, object, receiver].hash
    end
