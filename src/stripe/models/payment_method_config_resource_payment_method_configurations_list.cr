...
require "./payment_method_configuration"
...
module Stripe
  class PaymentMethodConfigResourcePaymentMethodConfigurationsList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::PaymentMethodConfiguration)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::PaymentMethodConfiguration)? = nil
    ...
    PATTERN_FOR_URL    = /^\/v1\/payment_method_configurations/
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::PaymentMethodConfiguration)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(new_value : Array(Stripe::PaymentMethodConfiguration)?)
