...
module Stripe
  class AccountRequirementsAlternative
    ...
    @[NASON::Field(key: "alternative_fields_due", type: Array(String))]
    property alternative_fields_due : Array(String)

    # Fields that are due and can be satisfied by providing all fields in `alternative_fields_due`.
    @[NASON::Field(key: "original_fields_due", type: Array(String))]
    ...
    def hash
      [alternative_fields_due, original_fields_due].hash
    end
