...
module Stripe
  class ClimateRemovalsSuppliersList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::ClimateSupplier)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::ClimateSupplier)? = nil
    ...
    PATTERN_FOR_URL    = /^\/v1\/climate\/suppliers/
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::ClimateSupplier)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(new_value : Array(Stripe::ClimateSupplier)?)
