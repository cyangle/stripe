...
module Stripe
  ...
  class SubscriptionScheduleConfigurationItemPrice
    ...
    def_hash(@active, @billing_scheme, @created, @currency, @id, @livemode, @lookup_key, @metadata, @nickname, @object, @product, @recurring, @tax_behavior, @tiers, @tiers_mode, @transform_quantity, @_type, @unit_amount, @unit_amount_decimal, @deleted)
  end
end
