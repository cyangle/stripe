...
module Stripe
  ...
  class SubscriptionScheduleConfigurationItemPrice
    ...
    def_equals_and_hash(@active, @billing_scheme, @created, @currency, @id, @livemode, @metadata, @object, @product, @_type, @deleted, @lookup_key, @nickname, @recurring, @tax_behavior, @tiers, @tiers_mode, @transform_quantity, @unit_amount, @unit_amount_decimal)
  end
end
