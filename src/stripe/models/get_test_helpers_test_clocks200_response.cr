...
module Stripe
  #
  class GetTestHelpersTestClocks200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::TestHelpersTestClock)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::TestHelpersTestClock)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::TestHelpersTestClock)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::TestHelpersTestClock
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/test_helpers\/test_clocks/
      end
    ...
    def data=(data : Array(Stripe::TestHelpersTestClock)?)
      if data.nil?
