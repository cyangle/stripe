...
module Stripe
  ...
  class GetTestHelpersTestClocks200Response
    ...
    # Required properties
    @[JSON::Field(key: "data", type: Array(TestHelpersTestClock))]
    property data : Array(TestHelpersTestClock)
    ...
    def initialize(*, @data : Array(TestHelpersTestClock), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/test_helpers\/test_clocks/
      true
    end
