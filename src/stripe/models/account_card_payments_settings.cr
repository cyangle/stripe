...
module Stripe
  class AccountCardPaymentsSettings
    ...
    # Optional properties
    @[NASON::Field(key: "decline_on", type: AccountDeclineChargeOn?, nillable: true)]
    property decline_on : AccountDeclineChargeOn?

    # The default text that appears on credit card statements when a charge is made. This field prefixes any dynamic `statement_descriptor` specified on the charge. `statement_descriptor_prefix` is useful for maximizing descriptor space for the dynamic portion.
    @[NASON::Field(key: "statement_descriptor_prefix", type: String? | Null, nillable: true)]
    property statement_descriptor_prefix : String? | Null

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @decline_on : AccountDeclineChargeOn? = nil, @statement_descriptor_prefix : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@statement_descriptor_prefix.nil? && !@statement_descriptor_prefix.null? && @statement_descriptor_prefix.to_s.size > 5000
    ...
    def valid?
      return false if !@statement_descriptor_prefix.nil? && !@statement_descriptor_prefix.null? && @statement_descriptor_prefix.to_s.size > 5000
      true
    end
    ...
    def hash
      [decline_on, statement_descriptor_prefix].hash
    end
