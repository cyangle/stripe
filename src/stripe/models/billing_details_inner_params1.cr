...
module Stripe
  ...
  class BillingDetailsInnerParams1
    ...
    @[JSON::Field(key: "email", type: Stripe::BusinessProfileSpecsSupportUrl?, default: nil, required: false, nullable: false, emit_null: false)]
    getter email : Stripe::BusinessProfileSpecsSupportUrl? = nil
    ...
    def initialize(
      *,
      ...
      @email : Stripe::BusinessProfileSpecsSupportUrl? = nil,
      @name : String? = nil,
      @phone : String? = nil
    )
    end
    ...
    def list_invalid_properties : Array(String)
      ...
      if _email = @email
        if _email.is_a?(OpenApi::Validatable)
          invalid_properties.concat(_email.list_invalid_properties_for("email"))
        end
      end
      if _name = @name
    ...
    def valid? : Bool
      ...
      if _email = @email
        if _email.is_a?(OpenApi::Validatable)
          return false unless _email.valid?
        end
      end
      if _name = @name
    ...
    def address=(address : Stripe::BillingDetailsInnerParamsAddress?)
      if address.nil?
        return @address = nil
      end
    ...
    def email=(email : Stripe::BusinessProfileSpecsSupportUrl?)
      if email.nil?
        return @email = nil
      end
