...
module Stripe
  class ApiMethodRefundList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::Refund)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::Refund)? = nil
    ...
    def data=(data : Array(Stripe::Refund)?)
      if data.nil?
