...
module Stripe
  ...
  class PostRefundsRequest
    ...
    def_equals_and_hash(@amount, @amount_present, @charge, @charge_present, @expand, @expand_present, @instructions_email, @instructions_email_present, @metadata, @metadata_present, @payment_intent, @payment_intent_present, @reason, @reason_present, @refund_application_fee, @refund_application_fee_present, @reverse_transfer, @reverse_transfer_present)
  end
end
