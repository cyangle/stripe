...
module Stripe
  class PostRefundsRequest
    ...
    def_equals_and_hash(@amount, @charge, @currency, @customer, @expand, @instructions_email, @metadata, @origin, @payment_intent, @reason, @refund_application_fee, @reverse_transfer)
  end
end
