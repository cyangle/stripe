...
require "./account_features_param"
...
module Stripe
  class AccountConfigParam
    ...
    @[JSON::Field(key: "features", type: Stripe::AccountFeaturesParam?, default: nil, required: false, nullable: false, emit_null: false)]
    getter features : Stripe::AccountFeaturesParam? = nil
    ...
    def initialize(
      *,
      ...
      @enabled : Bool? = nil,
      # Optional properties
      @features : Stripe::AccountFeaturesParam? = nil
    )
    end
    ...
    def features=(new_value : Stripe::AccountFeaturesParam?)
