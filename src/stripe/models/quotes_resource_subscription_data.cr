...
module Stripe
  ...
  class QuotesResourceSubscriptionData
    ...
    @[JSON::Field(key: "effective_date", type: Int64?, presence: true, ignore_serialize: effective_date.nil? && !effective_date_present?)]
    property effective_date : Int64?
    ...
    def_equals_and_hash(@effective_date, @effective_date_present, @trial_period_days, @trial_period_days_present)
  end
end
