...
module Stripe
  class InlineResponse20032
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(Sku))]
    property data : Array(Sku)
    ...
    def initialize(*, @data : Array(Sku), @has_more : Bool, @object : String, @url : String)
    end
