...
module Stripe
  ...
  class SetupAttemptPaymentMethodDetailsIdeal
    ...
    def initialize(*, @bank : String?, @bic : String?, @generated_sepa_debit : SetupAttemptPaymentMethodDetailsBancontactGeneratedSepaDebit?, @generated_sepa_debit_mandate : SetupAttemptPaymentMethodDetailsBancontactGeneratedSepaDebitMandate?, @iban_last4 : String?, @verified_name : String?)
    end
    ...
    def_hash(@bank, @bic, @generated_sepa_debit, @generated_sepa_debit_mandate, @iban_last4, @verified_name)
  end
end
