...
module Stripe
  class SourceTypeCard
    ...
    def initialize(*, @address_line1_check : String? | Null = nil, @address_zip_check : String? | Null = nil, @brand : String? | Null = nil, @country : String? | Null = nil, @cvc_check : String? | Null = nil, @dynamic_last4 : String? | Null = nil, @exp_month : Int64? | Null = nil, @exp_year : Int64? | Null = nil, @fingerprint : String? = nil, @funding : String? | Null = nil, @last4 : String? | Null = nil, @name : String? | Null = nil, @three_d_secure : String? = nil, @tokenization_method : String? | Null = nil)
    end
    ...
    def hash
      [address_line1_check, address_zip_check, brand, country, cvc_check, dynamic_last4, exp_month, exp_year, fingerprint, funding, last4, name, three_d_secure, tokenization_method].hash
    end
