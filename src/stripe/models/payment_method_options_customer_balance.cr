...
module Stripe
  ...
  class PaymentMethodOptionsCustomerBalance
    ...
    def initialize(*, @funding_type : String?, @bank_transfer : PaymentMethodOptionsCustomerBalanceBankTransfer? = nil, @setup_future_usage : String? = nil)
    end
    ...
    def_hash(@bank_transfer, @funding_type, @setup_future_usage)
  end
end
