...
module Stripe
  ...
  class PaymentPagesCheckoutSessionTotalDetails
    ...
    @[JSON::Field(key: "amount_shipping", type: Int64?, default: nil, required: true, nullable: true, emit_null: true)]
    ...
    def_equals_and_hash(@amount_discount, @amount_shipping, @amount_tax, @breakdown)
  end
end
