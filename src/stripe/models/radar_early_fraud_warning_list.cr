...
module Stripe
  ...
  class RadarEarlyFraudWarningList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::RadarEarlyFraudWarning)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::RadarEarlyFraudWarning)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::RadarEarlyFraudWarning)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::RadarEarlyFraudWarning
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/radar\/early_fraud_warnings/
      end
    ...
    def data=(data : Array(Stripe::RadarEarlyFraudWarning)?)
      if data.nil?
