...
module Stripe
  class RadarEarlyFraudWarningList
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(RadarEarlyFraudWarning))]
    property data : Array(RadarEarlyFraudWarning)
    ...
    def initialize(*, @data : Array(RadarEarlyFraudWarning), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/radar\/early_fraud_warnings/
      true
    end
