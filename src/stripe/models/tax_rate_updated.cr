...
module Stripe
  ...
  class TaxRateUpdated
    ...
    @[JSON::Field(key: "object", type: Stripe::TaxRate?, default: nil, required: true, nullable: false, emit_null: false)]
    getter object : Stripe::TaxRate? = nil
    ...
    def object=(new_value : Stripe::TaxRate?)
