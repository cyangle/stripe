...
module Stripe
  ...
  class BankConnectionsResourceAccountholderCustomer
    ...
    def_equals_and_hash(@created, @id, @livemode, @object, @address, @balance, @cash_balance, @currency, @default_source, @delinquent, @description, @discount, @email, @invoice_prefix, @invoice_settings, @metadata, @name, @next_invoice_sequence, @phone, @preferred_locales, @shipping, @sources, @subscriptions, @tax, @tax_exempt, @tax_ids, @test_clock)
  end
end
