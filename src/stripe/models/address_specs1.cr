...
module Stripe
  ...
  class AddressSpecs1
    ...
    def list_invalid_properties : Array(String)
      ...
      if _city = @city
        if max_length_error = OpenApi::PrimitiveValidator.max_length_error("city", _city.to_s.size, 100)
      ...
      if _line1 = @line1
        if max_length_error = OpenApi::PrimitiveValidator.max_length_error("line1", _line1.to_s.size, 200)
          invalid_properties.push(max_length_error)
        end
      end
      if _line2 = @line2
        if max_length_error = OpenApi::PrimitiveValidator.max_length_error("line2", _line2.to_s.size, 200)
          invalid_properties.push(max_length_error)
        end
      end
    ...
    def valid? : Bool
      if _city = @city
        return false if _city.to_s.size > 100
      end
      ...
      if _line1 = @line1
        return false if _line1.to_s.size > 200
      end

      if _line2 = @line2
        return false if _line2.to_s.size > 200
      end
