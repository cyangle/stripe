...
module Stripe
  ...
  class ChargeSucceeded
    ...
    @[JSON::Field(key: "object", type: Stripe::Charge?, default: nil, required: true, nullable: false, emit_null: false)]
    getter object : Stripe::Charge? = nil
    ...
    def object=(new_value : Stripe::Charge?)
