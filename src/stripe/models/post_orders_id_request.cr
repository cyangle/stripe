...
module Stripe
  ...
  class PostOrdersIdRequest
    ...
    @[JSON::Field(key: "discounts", type: PostOrdersIdRequestDiscounts?, presence: true, ignore_serialize: discounts.nil? && !discounts_present?)]
    property discounts : PostOrdersIdRequestDiscounts?
    ...
    @[JSON::Field(key: "line_items", type: Array(UpdateParams)?, presence: true, ignore_serialize: line_items.nil? && !line_items_present?)]
    property line_items : Array(UpdateParams)?
    ...
    @[JSON::Field(key: "payment", type: UpdateParams1?, presence: true, ignore_serialize: payment.nil? && !payment_present?)]
    property payment : UpdateParams1?
    ...
    def initialize(*, @automatic_tax : AutomaticTax1? = nil, @billing_details : PostOrdersRequestBillingDetails? = nil, @currency : String? = nil, @customer : String? = nil, @description : String? = nil, @discounts : PostOrdersIdRequestDiscounts? = nil, @expand : Array(String)? = nil, @ip_address : String? = nil, @line_items : Array(UpdateParams)? = nil, @metadata : IndividualSpecsMetadata? = nil, @payment : UpdateParams1? = nil, @shipping_cost : PostOrdersRequestShippingCost? = nil, @shipping_details : PostOrdersRequestShippingDetails? = nil, @tax_details : TaxDetails? = nil)
    end
