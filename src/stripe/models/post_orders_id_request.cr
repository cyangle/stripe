...
module Stripe
  ...
  class PostOrdersIdRequest
    ...
    def_equals_and_hash(@automatic_tax, @automatic_tax_present, @billing_details, @billing_details_present, @currency, @currency_present, @customer, @customer_present, @description, @description_present, @discounts, @discounts_present, @expand, @expand_present, @ip_address, @ip_address_present, @line_items, @line_items_present, @metadata, @metadata_present, @payment, @payment_present, @shipping_cost, @shipping_cost_present, @shipping_details, @shipping_details_present, @tax_details, @tax_details_present)
  end
end
