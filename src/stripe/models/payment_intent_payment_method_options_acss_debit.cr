...
module Stripe
  ...
  class PaymentIntentPaymentMethodOptionsAcssDebit
    ...
    def initialize(*, @mandate_options : PaymentIntentPaymentMethodOptionsMandateOptionsAcssDebit? = nil, @setup_future_usage : String? = nil, @verification_method : String? = nil)
    end
