...
module Stripe
  #
  class GetBillingPortalConfigurations200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::BillingPortalConfiguration)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::BillingPortalConfiguration)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::BillingPortalConfiguration)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::BillingPortalConfiguration
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/billing_portal\/configurations/
      end
    ...
    def data=(data : Array(Stripe::BillingPortalConfiguration)?)
      if data.nil?
