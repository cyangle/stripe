...
module Stripe
  ...
  class GetBillingPortalConfigurations200Response
    ...
    # Required properties
    @[JSON::Field(key: "data", type: Array(BillingPortalConfiguration))]
    property data : Array(BillingPortalConfiguration)
    ...
    def initialize(*, @data : Array(BillingPortalConfiguration), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/billing_portal\/configurations/
      true
    end
