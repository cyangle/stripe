...
module Stripe
  class PaymentMethodDetailsSepaCreditTransfer
    ...
    @[NASON::Field(key: "bank_name", type: String | Null, nillable: false)]
    property bank_name : String | Null

    # Bank Identifier Code of the bank associated with the bank account.
    @[NASON::Field(key: "bic", type: String | Null, nillable: false)]
    property bic : String | Null

    # IBAN of the bank account to transfer funds to.
    @[NASON::Field(key: "iban", type: String | Null, nillable: false)]
    property iban : String | Null

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @bank_name : String | Null, @bic : String | Null, @iban : String | Null)
    end
    ...
    def valid?
      return false if !@bank_name.null? && @bank_name.to_s.size > 5000
      return false if !@bic.null? && @bic.to_s.size > 5000
      return false if !@iban.null? && @iban.to_s.size > 5000
      true
    end
