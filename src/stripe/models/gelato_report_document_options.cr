...
module Stripe
  class GelatoReportDocumentOptions
    ...
    @[NASON::Field(key: "allowed_types", type: Array(String)?, nillable: true)]
    property allowed_types : Array(String)?

    # Collect an ID number and perform an [ID number check](https://stripe.com/docs/identity/verification-checks?type=id-number) with the document’s extracted name and date of birth.
    @[NASON::Field(key: "require_id_number", type: Bool?, nillable: true)]
    property require_id_number : Bool?

    # Disable image uploads, identity document images have to be captured using the device’s camera.
    @[NASON::Field(key: "require_live_capture", type: Bool?, nillable: true)]
    property require_live_capture : Bool?

    # Capture a face image and perform a [selfie check](https://stripe.com/docs/identity/verification-checks?type=selfie) comparing a photo ID and a picture of your user’s face. [Learn more](https://stripe.com/docs/identity/selfie).
    @[NASON::Field(key: "require_matching_selfie", type: Bool?, nillable: true)]
    ...
    def hash
      [allowed_types, require_id_number, require_live_capture, require_matching_selfie].hash
    end
