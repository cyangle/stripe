...
require "./settings_terms_of_service_specs_user_agent"
...
module Stripe
  class SettingsTermsOfServiceSpecs
    ...
    @[JSON::Field(key: "user_agent", type: Stripe::SettingsTermsOfServiceSpecsUserAgent?, default: nil, required: false, nullable: false, emit_null: false)]
    getter user_agent : Stripe::SettingsTermsOfServiceSpecsUserAgent? = nil
    ...
    def initialize(
      *,
      ...
      @date : Int64? = nil,
      @ip : String? = nil,
      @user_agent : Stripe::SettingsTermsOfServiceSpecsUserAgent? = nil
    )
    end
    ...
    def user_agent=(new_value : Stripe::SettingsTermsOfServiceSpecsUserAgent?)
