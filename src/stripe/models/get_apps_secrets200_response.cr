...
module Stripe
  #
  class GetAppsSecrets200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::AppsSecret)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::AppsSecret)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::AppsSecret)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::AppsSecret
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/apps\/secrets/
      end
    ...
    def data=(data : Array(Stripe::AppsSecret)?)
      if data.nil?
