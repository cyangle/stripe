...
module Stripe
  ...
  class GetAppsSecrets200Response
    ...
    # Required properties
    @[JSON::Field(key: "data", type: Array(AppsSecret))]
    property data : Array(AppsSecret)
    ...
    def initialize(*, @data : Array(AppsSecret), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/apps\/secrets/
      true
    end
