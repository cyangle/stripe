...
module Stripe
  class BaseConfigParam
    ...
    @[JSON::Field(key: "features", type: JSON::Any?, default: nil, required: false, nullable: false, emit_null: false)]
    getter features : JSON::Any? = nil
    ...
    def features=(new_value : JSON::Any?)
      @features = new_value
    end
