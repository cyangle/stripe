...
module Stripe
  class PostCustomersCustomerRequest
    ...
    def_equals_and_hash(@address, @balance, @cash_balance, @coupon, @default_source, @description, @email, @expand, @invoice_prefix, @invoice_settings, @metadata, @name, @next_invoice_sequence, @phone, @preferred_locales, @promotion_code, @shipping, @source, @tax, @tax_exempt, @validate)
  end
end
