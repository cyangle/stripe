...
module Stripe
  ...
  class PostDisputesDisputeRequest
    ...
    def initialize(*, @evidence : DisputeEvidenceParams? = nil, @expand : Array(String)? = nil, @metadata : IndividualSpecsMetadata? = nil, @submit : Bool? = nil)
    end
    ...
    def_hash(@evidence, @expand, @metadata, @submit)
  end
end
