...
module Stripe
  ...
  class SetupIntentNextAction
    ...
    def_equals_and_hash(@_type, @redirect_to_url, @redirect_to_url_present, @use_stripe_sdk, @use_stripe_sdk_present, @verify_with_microdeposits, @verify_with_microdeposits_present)
  end
end
