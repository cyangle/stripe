...
module Stripe
  ...
  class SetupIntent
    ...
    @[NASON::Field(key: "last_setup_error", type: ApiErrors? | Null, nillable: true)]
    property last_setup_error : ApiErrors? | Null

    # The most recent SetupAttempt for this SetupIntent.
    @[NASON::Field(key: "latest_attempt", type: String | SetupAttempt? | Null, nillable: true)]
    property latest_attempt : String | SetupAttempt? | Null

    # ID of the multi use Mandate generated by the SetupIntent.
    @[NASON::Field(key: "mandate", type: String | Mandate? | Null, nillable: true)]
    property mandate : String | Mandate? | Null
    ...
    @[NASON::Field(key: "next_action", type: SetupIntentNextAction? | Null, nillable: true)]
    property next_action : SetupIntentNextAction? | Null
    ...
    @[NASON::Field(key: "payment_method_options", type: SetupIntentPaymentMethodOptions? | Null, nillable: true)]
    property payment_method_options : SetupIntentPaymentMethodOptions? | Null

    # ID of the single_use Mandate generated by the SetupIntent.
    @[NASON::Field(key: "single_use_mandate", type: String | Mandate? | Null, nillable: true)]
    property single_use_mandate : String | Mandate? | Null
    ...
    def initialize(*, @created : Int64, @id : String, @livemode : Bool, @object : String, @payment_method_types : Array(String), @status : String, @usage : String, @application : String | Application? | Null = nil, @cancellation_reason : String? | Null = nil, @client_secret : String? | Null = nil, @customer : String | Customer | Nil | Null = nil, @description : String? | Null = nil, @last_setup_error : ApiErrors? | Null = nil, @latest_attempt : String | SetupAttempt? | Null = nil, @mandate : String | Mandate? | Null = nil, @metadata : Hash(String, String)? | Null = nil, @next_action : SetupIntentNextAction? | Null = nil, @on_behalf_of : String | Account? | Null = nil, @payment_method : String | PaymentMethod? | Null = nil, @payment_method_options : SetupIntentPaymentMethodOptions? | Null = nil, @single_use_mandate : String | Mandate? | Null = nil)
    end
    ...
    def valid?
      cancellation_reason_validator = EnumAttributeValidator.new("String", ["abandoned", "duplicate", "requested_by_customer"])
      ...
      object_validator = EnumAttributeValidator.new("String", ["setup_intent"])
      return false unless object_validator.valid?(@object)
      status_validator = EnumAttributeValidator.new("String", ["canceled", "processing", "requires_action", "requires_confirmation", "requires_payment_method", "succeeded"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["setup_intent"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new("String", ["canceled", "processing", "requires_action", "requires_confirmation", "requires_payment_method", "succeeded"])
    ...
    def hash
      [application, cancellation_reason, client_secret, created, customer, description, id, last_setup_error, latest_attempt, livemode, mandate, metadata, next_action, object, on_behalf_of, payment_method, payment_method_options, payment_method_types, single_use_mandate, status, usage].hash
    end
