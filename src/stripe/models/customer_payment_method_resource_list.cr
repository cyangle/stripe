...
module Stripe
  class CustomerPaymentMethodResourceList
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(PaymentMethod))]
    property data : Array(PaymentMethod)
    ...
    def initialize(*, @data : Array(PaymentMethod), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/customers\/:customer\/payment_methods/
      true
    end
