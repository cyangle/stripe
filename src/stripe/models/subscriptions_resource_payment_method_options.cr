...
module Stripe
  ...
  class SubscriptionsResourcePaymentMethodOptions
    ...
    @[JSON::Field(key: "card", type: Stripe::SubscriptionPaymentMethodOptionsCard?, default: nil, required: true, nullable: true, emit_null: true)]
    getter card : Stripe::SubscriptionPaymentMethodOptionsCard? = nil
    ...
    def initialize(
      *,
      ...
      @card : Stripe::SubscriptionPaymentMethodOptionsCard? = nil,
    ...
    def card=(new_value : Stripe::SubscriptionPaymentMethodOptionsCard?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
