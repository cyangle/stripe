...
module Stripe
  ...
  class RadarValueListItem
    ...
    @[NASON::Field(key: "value_list", type: String)]
    property value_list : String
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new("String", ["radar.value_list_item"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["radar.value_list_item"])
    ...
    def hash
      [created, created_by, id, livemode, object, value, value_list].hash
    end
