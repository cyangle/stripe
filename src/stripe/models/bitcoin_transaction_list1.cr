...
module Stripe
  ...
  class BitcoinTransactionList1
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::BitcoinTransaction)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::BitcoinTransaction)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::BitcoinTransaction)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::BitcoinTransaction
    ...
    def data=(data : Array(Stripe::BitcoinTransaction)?)
      if data.nil?
