...
module Stripe
  ...
  class BitcoinTransactionList1
    ...
    @[NASON::Field(key: "data", type: Array(BitcoinTransaction))]
    property data : Array(BitcoinTransaction)
    ...
    def initialize(*, @data : Array(BitcoinTransaction), @has_more : Bool, @object : String, @url : String)
    end
