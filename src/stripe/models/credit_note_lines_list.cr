...
module Stripe
  class CreditNoteLinesList
    ...
    @[NASON::Field(key: "data", type: Array(CreditNoteLineItem))]
    property data : Array(CreditNoteLineItem)
    ...
    def initialize(*, @data : Array(CreditNoteLineItem), @has_more : Bool, @object : String, @url : String)
    end
