...
module Stripe
  ...
  class PostTreasuryFinancialAccountsFinancialAccountRequest
    ...
    def initialize(*, @expand : Array(String)? = nil, @features : FeatureAccess1? = nil, @metadata : Hash(String, String)? = nil, @platform_restrictions : PlatformRestrictions? = nil)
    end
    ...
    def_hash(@expand, @features, @metadata, @platform_restrictions)
  end
end
