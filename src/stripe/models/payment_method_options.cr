...
module Stripe
  ...
  class PaymentMethodOptions
    ...
    @[JSON::Field(key: "card", type: PaymentMethodOptionsCard?, presence: true, ignore_serialize: card.nil? && !card_present?)]
    property card : PaymentMethodOptionsCard?
    ...
    def initialize(*, @acss_debit : PaymentMethodOptionsAcssDebit? = nil, @bancontact : PaymentMethodOptionsBancontact1? = nil, @card : PaymentMethodOptionsCard? = nil, @customer_balance : PaymentMethodOptionsCustomerBalance1? = nil, @konbini : PaymentMethodOptionsKonbini1? = nil, @us_bank_account : PaymentMethodOptionsUsBankAccount? = nil)
    end
