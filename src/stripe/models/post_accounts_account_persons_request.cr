...
module Stripe
  class PostAccountsAccountPersonsRequest
    ...
    def person_token=(new_value : String?)
      unless new_value.nil?
        OpenApi::PrimitiveValidator.validate_max_length("person_token", new_value.to_s.size, MAX_LENGTH_FOR_PERSON_TOKEN)
      end

      @person_token = new_value
    end
