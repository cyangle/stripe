...
module Stripe
  class PostAccountsAccountPersonsRequest
    ...
    def dob=(dob : Stripe::PostAccountsAccountPersonsRequestDob?)
      if dob.nil?
        return @dob = nil
      end
      _dob = dob.not_nil!
    ...
    def full_name_aliases=(full_name_aliases : Stripe::PostAccountsAccountPersonsRequestFullNameAliases?)
