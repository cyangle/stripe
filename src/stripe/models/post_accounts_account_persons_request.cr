...
module Stripe
  ...
  class PostAccountsAccountPersonsRequest
    include JSON::Serializable
    include JSON::Serializable::Unmapped

    # Optional properties
    @[JSON::Field(key: "address", type: AddressSpecs4?, presence: true, ignore_serialize: address.nil? && !address_present?)]
    property address : AddressSpecs4?

    @[JSON::Field(ignore: true)]
    property? address_present : Bool = false

    @[JSON::Field(key: "address_kana", type: JapanAddressKanaSpecs2?, presence: true, ignore_serialize: address_kana.nil? && !address_kana_present?)]
    property address_kana : JapanAddressKanaSpecs2?

    @[JSON::Field(ignore: true)]
    property? address_kana_present : Bool = false

    @[JSON::Field(key: "address_kanji", type: JapanAddressKanjiSpecs2?, presence: true, ignore_serialize: address_kanji.nil? && !address_kanji_present?)]
    property address_kanji : JapanAddressKanjiSpecs2?

    @[JSON::Field(ignore: true)]
    property? address_kanji_present : Bool = false

    @[JSON::Field(key: "dob", type: PostAccountsAccountPersonsRequestDob?, presence: true, ignore_serialize: dob.nil? && !dob_present?)]
    property dob : PostAccountsAccountPersonsRequestDob?
    ...
    @[JSON::Field(key: "full_name_aliases", type: PostAccountsAccountPersonsRequestFullNameAliases?, presence: true, ignore_serialize: full_name_aliases.nil? && !full_name_aliases_present?)]
    property full_name_aliases : PostAccountsAccountPersonsRequestFullNameAliases?
    ...
    @[JSON::Field(key: "registered_address", type: AddressSpecs5?, presence: true, ignore_serialize: registered_address.nil? && !registered_address_present?)]
    property registered_address : AddressSpecs5?
    ...
    def initialize(*, @address : AddressSpecs4? = nil, @address_kana : JapanAddressKanaSpecs2? = nil, @address_kanji : JapanAddressKanjiSpecs2? = nil, @dob : PostAccountsAccountPersonsRequestDob? = nil, @documents : PersonDocumentsSpecs? = nil, @email : String? = nil, @expand : Array(String)? = nil, @first_name : String? = nil, @first_name_kana : String? = nil, @first_name_kanji : String? = nil, @full_name_aliases : PostAccountsAccountPersonsRequestFullNameAliases? = nil, @gender : String? = nil, @id_number : String? = nil, @id_number_secondary : String? = nil, @last_name : String? = nil, @last_name_kana : String? = nil, @last_name_kanji : String? = nil, @maiden_name : String? = nil, @metadata : IndividualSpecsMetadata? = nil, @nationality : String? = nil, @person_token : String? = nil, @phone : String? = nil, @political_exposure : String? = nil, @registered_address : AddressSpecs5? = nil, @relationship : RelationshipSpecs? = nil, @ssn_last_4 : String? = nil, @verification : PersonVerificationSpecs1? = nil)
    end
