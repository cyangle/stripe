...
module Stripe
  ...
  class GetAccountsAccountPersons200Response
    include JSON::Serializable
    include JSON::Serializable::Unmapped

    # Required properties
    @[JSON::Field(key: "data", type: Array(Person))]
    property data : Array(Person)
    ...
    def initialize(*, @data : Array(Person), @has_more : Bool, @object : String, @url : String)
    end
