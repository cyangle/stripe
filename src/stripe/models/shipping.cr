...
module Stripe
  class Shipping
    ...
    def initialize(*, @address : Address? = nil, @carrier : String? | Null = nil, @name : String? | Null = nil, @phone : String? | Null = nil, @tracking_number : String? | Null = nil)
    end
    ...
    def hash
      [address, carrier, name, phone, tracking_number].hash
    end
