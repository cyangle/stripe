  ...
  class BalanceTransactionSource
    ...
    def initialize(
      *,
      ...
      @evidence_details : DisputeEvidenceDetails? = nil,
      @is_charge_refundable : Bool? = nil,
      @reason : String = nil,
      @fee : FeeRefundFee? = nil,
      @approved : Bool? = nil,
      @authorization_method : String? = nil,
      @card : IssuingTransactionCard? = nil,
      @merchant_amount : Int64? = nil,
      @merchant_currency : String? = nil,
      @merchant_data : IssuingAuthorizationMerchantData? = nil,
      @request_history : Array(IssuingAuthorizationRequest)? = nil,
      @transactions : Array(IssuingTransaction)? = nil,
      @verification_data : IssuingAuthorizationVerificationData? = nil,
    ...
    def_equals_and_hash(@account, @amount, @amount_refunded, @application, @charge, @created, @currency, @id, @livemode, @object, @refunded, @refunds, @amount_captured, @billing_details, @captured, @disputed, @metadata, @paid, @status, @transfer, @destination, @balance_transactions, @evidence, @evidence_details, @is_charge_refundable, @reason, @fee, @approved, @authorization_method, @card, @merchant_amount, @merchant_currency, @merchant_data, @request_history, @transactions, @verification_data, @transaction, @_type, @arrival_date, @automatic, @method, @source_type, @source_transaction, @period_end, @period_start, @tax_deduction_account_number, @source, @amount_reversed, @reversals, @reversed, @balance_transaction, @originating_transaction, @application_fee, @application_fee_amount, @calculated_statement_descriptor, @customer, @description, @failure_balance_transaction, @failure_code, @failure_message, @fraud_details, @invoice, @on_behalf_of, @outcome, @payment_intent, @payment_method, @payment_method_details, @radar_options, @receipt_email, @receipt_number, @receipt_url, @review, @shipping, @source_transfer, @statement_descriptor, @statement_descriptor_suffix, @transfer_data, @transfer_group, @amount_details, @cardholder, @pending_request, @treasury, @wallet, @authorization, @dispute, @purchase_details, @original_payout, @reversed_by, @failure_reason, @instructions_email, @next_action, @source_transfer_reversal, @transfer_reversal, @expected_availability_date, @destination_payment, @destination_payment_refund, @source_refund)
  end
end
