...
module Stripe
  class IssuingDisputeServiceNotAsDescribedEvidence
    ...
    def initialize(*, @additional_documentation : String | File? | Null = nil, @canceled_at : Int64? | Null = nil, @cancellation_reason : String? | Null = nil, @explanation : String? | Null = nil, @received_at : Int64? | Null = nil)
    end
    ...
    def hash
      [additional_documentation, canceled_at, cancellation_reason, explanation, received_at].hash
    end
