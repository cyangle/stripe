...
module Stripe
  ...
  class TerminalLocation
    ...
    def initialize(*, @address : Address, @display_name : String, @id : String, @livemode : Bool, @metadata : Hash(String, String), @object : String)
    end
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new("String", ["terminal.location"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["terminal.location"])
    ...
    def hash
      [address, display_name, id, livemode, metadata, object].hash
    end
