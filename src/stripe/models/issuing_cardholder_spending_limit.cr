...
module Stripe
  ...
  class IssuingCardholderSpendingLimit
    ...
    VALID_VALUES_FOR_INTERVAL  = String.static_array("all_time", "daily", "monthly", "per_authorization", "weekly", "yearly")
    ...
    def_equals_and_hash(@amount, @categories, @interval)
  end
end
