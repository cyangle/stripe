...
module Stripe
  ...
  class IssuingCardholderSpendingLimit
    ...
    ENUM_VALIDATOR_FOR_INTERVAL = OpenApi::EnumValidator.new("interval", "String", ["all_time", "daily", "monthly", "per_authorization", "weekly", "yearly"])
