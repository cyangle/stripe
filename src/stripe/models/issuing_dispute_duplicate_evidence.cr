...
require "./issuing_dispute_duplicate_evidence_card_statement"
require "./issuing_dispute_duplicate_evidence_cash_receipt"
require "./issuing_dispute_duplicate_evidence_check_image"
...
module Stripe
  ...
  class IssuingDisputeDuplicateEvidence
    ...
    @[JSON::Field(key: "card_statement", type: Stripe::IssuingDisputeDuplicateEvidenceCardStatement?, default: nil, required: true, nullable: true, emit_null: true)]
    getter card_statement : Stripe::IssuingDisputeDuplicateEvidenceCardStatement? = nil

    @[JSON::Field(key: "cash_receipt", type: Stripe::IssuingDisputeDuplicateEvidenceCashReceipt?, default: nil, required: true, nullable: true, emit_null: true)]
    getter cash_receipt : Stripe::IssuingDisputeDuplicateEvidenceCashReceipt? = nil

    @[JSON::Field(key: "check_image", type: Stripe::IssuingDisputeDuplicateEvidenceCheckImage?, default: nil, required: true, nullable: true, emit_null: true)]
    ...
    @[JSON::Field(key: "original_transaction", type: String?, default: nil, required: true, nullable: true, emit_null: true)]
    ...
    def card_statement=(new_value : Stripe::IssuingDisputeDuplicateEvidenceCardStatement?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def cash_receipt=(new_value : Stripe::IssuingDisputeDuplicateEvidenceCashReceipt?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def check_image=(new_value : Stripe::IssuingDisputeDuplicateEvidenceCheckImage?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
