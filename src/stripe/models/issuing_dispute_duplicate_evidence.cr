...
module Stripe
  class IssuingDisputeDuplicateEvidence
    ...
    @[NASON::Field(key: "card_statement", type: String | File? | Null, nillable: true)]
    property card_statement : String | File? | Null

    # (ID of a [file upload](https://stripe.com/docs/guides/file-upload)) Copy of the receipt showing that the product had been paid for in cash.
    @[NASON::Field(key: "cash_receipt", type: String | File? | Null, nillable: true)]
    property cash_receipt : String | File? | Null

    # (ID of a [file upload](https://stripe.com/docs/guides/file-upload)) Image of the front and back of the check that was used to pay for the product.
    @[NASON::Field(key: "check_image", type: String | File? | Null, nillable: true)]
    property check_image : String | File? | Null
    ...
    @[NASON::Field(key: "original_transaction", type: String? | Null, nillable: true)]
    property original_transaction : String? | Null

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @additional_documentation : String | File? | Null = nil, @card_statement : String | File? | Null = nil, @cash_receipt : String | File? | Null = nil, @check_image : String | File? | Null = nil, @explanation : String? | Null = nil, @original_transaction : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@original_transaction.nil? && !@original_transaction.null? && @original_transaction.to_s.size > 5000
    ...
    def valid?
      ...
      return false if !@original_transaction.nil? && !@original_transaction.null? && @original_transaction.to_s.size > 5000
      true
    end
    ...
    def hash
      [additional_documentation, card_statement, cash_receipt, check_image, explanation, original_transaction].hash
    end
