...
module Stripe
  ...
  class TerminalReaderRetrieveReader
    ...
    # A list of readers
    @[JSON::Field(key: "data", type: Array(Stripe::TerminalReader)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::TerminalReader)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::TerminalReader)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::TerminalReader
    ...
    def data=(data : Array(Stripe::TerminalReader)?)
      if data.nil?
