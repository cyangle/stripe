...
module Stripe
  ...
  class BankConnectionsResourceLinkAccountSessionFilters
    ...
    @[JSON::Field(key: "account_subcategories", type: Array(String)?, default: nil, required: true, nullable: true, emit_null: true)]
    ...
    @[JSON::Field(key: "countries", type: Array(String)?, default: nil, required: true, nullable: true, emit_null: true)]
