...
module Stripe
  ...
  class PostCustomersCustomerBankAccountsIdRequest
    ...
    def_equals_and_hash(@account_holder_name, @account_holder_name_present, @account_holder_type, @account_holder_type_present, @address_city, @address_city_present, @address_country, @address_country_present, @address_line1, @address_line1_present, @address_line2, @address_line2_present, @address_state, @address_state_present, @address_zip, @address_zip_present, @exp_month, @exp_month_present, @exp_year, @exp_year_present, @expand, @expand_present, @metadata, @metadata_present, @name, @name_present, @owner, @owner_present)
  end
end
