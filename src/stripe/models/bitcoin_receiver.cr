...
module Stripe
  class BitcoinReceiver
    ...
    def initialize(*, @active : Bool, @amount : Int64, @amount_received : Int64, @bitcoin_amount : Int64, @bitcoin_amount_received : Int64, @bitcoin_uri : String, @created : Int64, @currency : String, @filled : Bool, @id : String, @inbound_address : String, @livemode : Bool, @object : String, @uncaptured_funds : Bool, @customer : String? | Null = nil, @description : String? | Null = nil, @email : String? | Null = nil, @metadata : Hash(String, String)? | Null = nil, @payment : String? | Null = nil, @refund_address : String? | Null = nil, @transactions : BitcoinTransactionList1? = nil, @used_for_payment : Bool? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@customer.nil? && !@customer.null? && @customer.to_s.size > 5000
    ...
    def valid?
      ...
      return false if !@customer.nil? && !@customer.null? && @customer.to_s.size > 5000
      ...
      object_validator = EnumAttributeValidator.new("String", ["bitcoin_receiver"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["bitcoin_receiver"])
    ...
    def hash
      [active, amount, amount_received, bitcoin_amount, bitcoin_amount_received, bitcoin_uri, created, currency, customer, description, email, filled, id, inbound_address, livemode, metadata, object, payment, refund_address, transactions, uncaptured_funds, used_for_payment].hash
    end
