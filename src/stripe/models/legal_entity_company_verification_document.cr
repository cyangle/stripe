...
require "./legal_entity_company_verification_document_back"
require "./legal_entity_company_verification_document_front"
...
module Stripe
  ...
  class LegalEntityCompanyVerificationDocument
    ...
    @[JSON::Field(key: "back", type: Stripe::LegalEntityCompanyVerificationDocumentBack?, default: nil, required: true, nullable: true, emit_null: true)]
    ...
    @[JSON::Field(key: "front", type: Stripe::LegalEntityCompanyVerificationDocumentFront?, default: nil, required: true, nullable: true, emit_null: true)]
    ...
    def back=(new_value : Stripe::LegalEntityCompanyVerificationDocumentBack?)
    ...
    def front=(new_value : Stripe::LegalEntityCompanyVerificationDocumentFront?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
