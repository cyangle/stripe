...
require "./payment_intent_next_action_swish_qr_code"
...
module Stripe
  ...
  class PaymentIntentNextActionSwishHandleRedirectOrDisplayQrCode
    ...
    @[JSON::Field(key: "qr_code", type: Stripe::PaymentIntentNextActionSwishQrCode?, default: nil, required: true, nullable: false, emit_null: false)]
    getter qr_code : Stripe::PaymentIntentNextActionSwishQrCode? = nil
    ...
    def initialize(
      *,
      ...
      @qr_code : Stripe::PaymentIntentNextActionSwishQrCode? = nil
    )
    end
    ...
    def qr_code=(new_value : Stripe::PaymentIntentNextActionSwishQrCode?)
