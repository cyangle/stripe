...
require "./payments_features_param"
...
module Stripe
  class PaymentsConfigParam
    ...
    @[JSON::Field(key: "features", type: Stripe::PaymentsFeaturesParam?, default: nil, required: false, nullable: false, emit_null: false)]
    getter features : Stripe::PaymentsFeaturesParam? = nil
    ...
    def initialize(
      *,
      ...
      @enabled : Bool? = nil,
      # Optional properties
      @features : Stripe::PaymentsFeaturesParam? = nil
    )
    end
    ...
    def features=(new_value : Stripe::PaymentsFeaturesParam?)
