...
module Stripe
  class IssuingNetworkTokenList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::IssuingToken)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::IssuingToken)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::IssuingToken)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(new_value : Array(Stripe::IssuingToken)?)
