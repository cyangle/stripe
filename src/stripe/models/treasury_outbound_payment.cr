...
module Stripe
  ...
  class TreasuryOutboundPayment
    ...
    ENUM_VALIDATOR_FOR_OBJECT = OpenApi::EnumValidator.new("object", "String", ["treasury.outbound_payment"])
    ...
    ENUM_VALIDATOR_FOR_STATUS = OpenApi::EnumValidator.new("status", "String", ["canceled", "failed", "posted", "processing", "returned"])
