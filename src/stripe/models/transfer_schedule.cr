...
module Stripe
  class TransferSchedule
    ...
    @[NASON::Field(key: "delay_days", type: Int64)]
    ...
    @[NASON::Field(key: "monthly_anchor", type: Int64?, nillable: true)]
    property monthly_anchor : Int64?

    # The day of the week funds will be paid out, of the style 'monday', 'tuesday', etc. Only shown if `interval` is weekly.
    @[NASON::Field(key: "weekly_anchor", type: String?, nillable: true)]
    property weekly_anchor : String?
    ...
    def hash
      [delay_days, interval, monthly_anchor, weekly_anchor].hash
    end
