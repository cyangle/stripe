...
module Stripe
  ...
  class IssuingDispute
    ...
    @[NASON::Field(key: "balance_transactions", type: Array(BalanceTransaction)? | Null, nillable: true)]
    ...
    def initialize(*, @amount : Int64, @created : Int64, @currency : String, @evidence : IssuingDisputeEvidence, @id : String, @livemode : Bool, @metadata : Hash(String, String), @object : String, @status : String, @transaction : String | IssuingTransaction | Null, @balance_transactions : Array(BalanceTransaction)? | Null = nil)
    end
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new("String", ["issuing.dispute"])
      return false unless object_validator.valid?(@object)
      status_validator = EnumAttributeValidator.new("String", ["expired", "lost", "submitted", "unsubmitted", "won"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["issuing.dispute"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new("String", ["expired", "lost", "submitted", "unsubmitted", "won"])
    ...
    def hash
      [amount, balance_transactions, created, currency, evidence, id, livemode, metadata, object, status, transaction].hash
    end
