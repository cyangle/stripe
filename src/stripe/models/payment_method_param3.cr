...
module Stripe
  ...
  class PaymentMethodParam3
    ...
    def_equals_and_hash(@account_holder_type, @account_holder_type_present, @account_number, @account_number_present, @account_type, @account_type_present, @financial_connections_account, @financial_connections_account_present, @routing_number, @routing_number_present)
  end
end
