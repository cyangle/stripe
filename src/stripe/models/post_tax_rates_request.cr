...
module Stripe
  ...
  class PostTaxRatesRequest
    ...
    def_equals_and_hash(@display_name, @inclusive, @percentage, @active, @active_present, @country, @country_present, @description, @description_present, @expand, @expand_present, @jurisdiction, @jurisdiction_present, @metadata, @metadata_present, @state, @state_present, @tax_type, @tax_type_present)
  end
end
