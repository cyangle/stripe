...
module Stripe
  ...
  class GetPaymentLinks200Response
    ...
    # Required properties
    @[JSON::Field(key: "data", type: Array(PaymentLink))]
    property data : Array(PaymentLink)
    ...
    def initialize(*, @data : Array(PaymentLink), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/payment_links/
      true
    end
