...
module Stripe
  #
  class GetPaymentLinks200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::PaymentLink)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::PaymentLink)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::PaymentLink)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::PaymentLink
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/payment_links/
      end
    ...
    def data=(data : Array(Stripe::PaymentLink)?)
      if data.nil?
