...
module Stripe
  ...
  class InvoicesResourceFromInvoice
    ...
    @[JSON::Field(key: "invoice", type: Stripe::InvoicesResourceFromInvoiceInvoice?, default: nil, required: true, nullable: false, emit_null: false)]
    getter invoice : Stripe::InvoicesResourceFromInvoiceInvoice? = nil
    ...
    def initialize(
      *,
      # Required properties
      @action : String? = nil,
      @invoice : Stripe::InvoicesResourceFromInvoiceInvoice? = nil
    )
    end
    ...
    def invoice=(new_value : Stripe::InvoicesResourceFromInvoiceInvoice?)
