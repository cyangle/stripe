...
module Stripe
  ...
  class SetupAttemptPaymentMethodDetailsCard
    ...
    def_equals_and_hash(@brand, @checks, @country, @exp_month, @exp_year, @funding, @last4, @network, @three_d_secure, @wallet, @description, @description_present, @fingerprint, @fingerprint_present, @iin, @iin_present, @issuer, @issuer_present)
  end
end
