...
module Stripe
  ...
  class AccountBrandingSettings
    ...
    def initialize(*, @icon : AccountBrandingSettingsIcon?, @logo : AccountBrandingSettingsLogo?, @primary_color : String?, @secondary_color : String?)
    end
    ...
    def valid?
      return false if @primary_color.to_s.size > 5000
      return false if @secondary_color.to_s.size > 5000
      true
    end
