...
require "./cash_balance_param"
require "./customer_param"
require "./data_params"
...
module Stripe
  class PostCustomersRequest
    ...
    def tax_id_data=(new_value : Array(Stripe::DataParams)?)
      unless new_value.nil?
        OpenApi::ContainerValidator.validate(container: new_value) if new_value.is_a?(Array)
      end

      @tax_id_data = new_value
    end
    ...
    def_equals_and_hash(@address, @balance, @cash_balance, @coupon, @description, @email, @expand, @invoice_prefix, @invoice_settings, @metadata, @name, @next_invoice_sequence, @payment_method, @phone, @preferred_locales, @promotion_code, @shipping, @source, @tax, @tax_exempt, @tax_id_data, @test_clock, @validate)
  end
end
