...
module Stripe
  ...
  class Topup
    ...
    def_equals_and_hash(@amount, @created, @currency, @id, @livemode, @metadata, @object, @source, @status, @balance_transaction, @balance_transaction_present, @description, @description_present, @expected_availability_date, @expected_availability_date_present, @failure_code, @failure_code_present, @failure_message, @failure_message_present, @statement_descriptor, @statement_descriptor_present, @transfer_group, @transfer_group_present)
  end
end
