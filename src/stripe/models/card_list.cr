...
module Stripe
  ...
  class CardList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::Card)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::Card)? = nil
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::Card
    ...
    def data=(data : Array(Stripe::Card)?)
      if data.nil?
