...
module Stripe
  class TaxProductRegistrationsResourceTaxRegistrationList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::TaxRegistration)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::TaxRegistration)? = nil
    ...
    PATTERN_FOR_URL    = /^\/v1\/tax\/registrations/
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::TaxRegistration)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(new_value : Array(Stripe::TaxRegistration)?)
