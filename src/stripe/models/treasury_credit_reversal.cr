...
module Stripe
  ...
  class TreasuryCreditReversal
    ...
    def_equals_and_hash(@amount, @currency, @financial_account, @id, @livemode, @metadata, @network, @object, @received_credit, @status, @status_transitions, @hosted_regulatory_receipt_url, @hosted_regulatory_receipt_url_present, @transaction, @transaction_present)
  end
end
