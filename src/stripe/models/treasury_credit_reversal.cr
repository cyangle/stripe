...
require "./treasury_received_credits_resource_status_transitions"
...
module Stripe
  ...
  class TreasuryCreditReversal
    ...
    def status_transitions=(new_value : Stripe::TreasuryReceivedCreditsResourceStatusTransitions?)
    ...
    def_equals_and_hash(@amount, @created, @currency, @financial_account, @hosted_regulatory_receipt_url, @id, @livemode, @metadata, @network, @object, @received_credit, @status, @status_transitions, @transaction)
  end
end
