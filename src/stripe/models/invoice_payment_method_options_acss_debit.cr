...
module Stripe
  ...
  class InvoicePaymentMethodOptionsAcssDebit
    ...
    def initialize(
      *,
      # Optional properties
      @mandate_options : InvoicePaymentMethodOptionsAcssDebitMandateOptions? = nil,
    ...
    def_equals_and_hash(@mandate_options, @mandate_options_present, @verification_method, @verification_method_present)
  end
end
