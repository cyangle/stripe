...
module Stripe
  ...
  class GetPromotionCodes200Response
    ...
    # Required properties
    @[JSON::Field(key: "data", type: Array(PromotionCode))]
    property data : Array(PromotionCode)
    ...
    def initialize(*, @data : Array(PromotionCode), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/promotion_codes/
      true
    end
