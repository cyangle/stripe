...
module Stripe
  #
  class GetPromotionCodes200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::PromotionCode)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::PromotionCode)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::PromotionCode)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::PromotionCode
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/promotion_codes/
      end
    ...
    def data=(data : Array(Stripe::PromotionCode)?)
      if data.nil?
