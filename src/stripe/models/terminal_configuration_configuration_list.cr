...
module Stripe
  ...
  class TerminalConfigurationConfigurationList
    ...
    # Required properties
    @[JSON::Field(key: "data", type: Array(TerminalConfiguration))]
    property data : Array(TerminalConfiguration)
    ...
    def initialize(*, @data : Array(TerminalConfiguration), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/terminal\/configurations/
      true
    end
