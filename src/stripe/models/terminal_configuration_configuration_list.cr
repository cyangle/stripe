...
module Stripe
  class TerminalConfigurationConfigurationList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::TerminalConfiguration)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::TerminalConfiguration)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::TerminalConfiguration)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(data : Array(Stripe::TerminalConfiguration)?)
      if data.nil?
