...
module Stripe
  ...
  class PaymentMethodAcssDebit
    ...
    def initialize(*, @bank_name : String?, @fingerprint : String?, @institution_number : String?, @last4 : String?, @transit_number : String?)
    end
    ...
    def_hash(@bank_name, @fingerprint, @institution_number, @last4, @transit_number)
  end
end
