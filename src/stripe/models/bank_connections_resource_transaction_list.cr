...
require "./financial_connections_transaction"
...
module Stripe
  class BankConnectionsResourceTransactionList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::FinancialConnectionsTransaction)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::FinancialConnectionsTransaction)? = nil
    ...
    PATTERN_FOR_URL    = /^\/v1\/financial_connections\/transactions/
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::FinancialConnectionsTransaction)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(new_value : Array(Stripe::FinancialConnectionsTransaction)?)
