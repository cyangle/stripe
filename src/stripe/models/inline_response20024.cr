...
module Stripe
  class InlineResponse20024
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(Quote))]
    property data : Array(Quote)
    ...
    def initialize(*, @data : Array(Quote), @has_more : Bool, @object : String, @url : String)
    end
