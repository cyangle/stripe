...
module Stripe
  ...
  class Capability
    ...
    def_equals_and_hash(@account, @id, @object, @requested, @status, @future_requirements, @future_requirements_present, @requested_at, @requested_at_present, @requirements, @requirements_present)
  end
end
