...
module Stripe
  class LinkedFlowsParam
    ...
    def source_flow_type=(new_value : String?)
      raise ArgumentError.new("\"source_flow_type\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
        OpenApi::EnumValidator.validate("source_flow_type", new_value, VALID_VALUES_FOR_SOURCE_FLOW_TYPE)
      end
