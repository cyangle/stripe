...
module Stripe
  ...
  class RadarEarlyFraudWarning
    ...
    def initialize(*, @actionable : Bool, @charge : String | Charge | Null, @created : Int64, @fraud_type : String, @id : String, @livemode : Bool, @object : String, @payment_intent : String | PaymentIntent? | Null = nil)
    end
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new("String", ["radar.early_fraud_warning"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["radar.early_fraud_warning"])
    ...
    def hash
      [actionable, charge, created, fraud_type, id, livemode, object, payment_intent].hash
    end
