...
require "./payment_links_resource_completion_behavior_confirmation_page"
require "./payment_links_resource_completion_behavior_redirect"
...
module Stripe
  ...
  class PaymentLinksResourceAfterCompletion
    ...
    def hosted_confirmation=(new_value : Stripe::PaymentLinksResourceCompletionBehaviorConfirmationPage?)
      unless new_value.nil?
    ...
    def redirect=(new_value : Stripe::PaymentLinksResourceCompletionBehaviorRedirect?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
