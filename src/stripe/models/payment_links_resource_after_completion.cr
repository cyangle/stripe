...
module Stripe
  class PaymentLinksResourceAfterCompletion
    ...
    # Optional properties
    @[NASON::Field(key: "hosted_confirmation", type: PaymentLinksResourceCompletionBehaviorConfirmationPage?, nillable: true)]
    property hosted_confirmation : PaymentLinksResourceCompletionBehaviorConfirmationPage?

    @[NASON::Field(key: "redirect", type: PaymentLinksResourceCompletionBehaviorRedirect?, nillable: true)]
    property redirect : PaymentLinksResourceCompletionBehaviorRedirect?
    ...
    def valid?
      _type_validator = EnumAttributeValidator.new("String", ["hosted_confirmation", "redirect"])
    ...
    def _type=(_type)
      validator = EnumAttributeValidator.new("String", ["hosted_confirmation", "redirect"])
    ...
    def hash
      [hosted_confirmation, redirect, _type].hash
    end
