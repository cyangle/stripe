...
module Stripe
  #
  class GetIssuingCards200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::IssuingCard)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::IssuingCard)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::IssuingCard)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::IssuingCard
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/issuing\/cards/
      end
    ...
    def data=(data : Array(Stripe::IssuingCard)?)
      if data.nil?
