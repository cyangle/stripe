...
module Stripe
  ...
  class GetIssuingCards200Response
    ...
    # Required properties
    @[JSON::Field(key: "data", type: Array(IssuingCard))]
    property data : Array(IssuingCard)
    ...
    def initialize(*, @data : Array(IssuingCard), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/issuing\/cards/
      true
    end
