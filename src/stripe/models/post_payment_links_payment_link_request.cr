...
require "./invoice_creation_update_params"
require "./line_items_update_params"
require "./payment_intent_data_update_params"
require "./post_payment_links_payment_link_request_custom_fields"
require "./post_payment_links_payment_link_request_payment_method_types"
require "./post_payment_links_payment_link_request_restrictions"
require "./post_payment_links_payment_link_request_shipping_address_collection"
require "./subscription_data_update_params"
...
module Stripe
  class PostPaymentLinksPaymentLinkRequest
    ...
    @[JSON::Field(key: "custom_fields", type: Stripe::PostPaymentLinksPaymentLinkRequestCustomFields?, default: nil, required: false, nullable: false, emit_null: false)]
    getter custom_fields : Stripe::PostPaymentLinksPaymentLinkRequestCustomFields? = nil
    ...
    @[JSON::Field(key: "invoice_creation", type: Stripe::InvoiceCreationUpdateParams?, default: nil, required: false, nullable: false, emit_null: false)]
    getter invoice_creation : Stripe::InvoiceCreationUpdateParams? = nil
    ...
    @[JSON::Field(key: "payment_intent_data", type: Stripe::PaymentIntentDataUpdateParams?, default: nil, required: false, nullable: false, emit_null: false)]
    getter payment_intent_data : Stripe::PaymentIntentDataUpdateParams? = nil
    ...
    @[JSON::Field(key: "restrictions", type: Stripe::PostPaymentLinksPaymentLinkRequestRestrictions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter restrictions : Stripe::PostPaymentLinksPaymentLinkRequestRestrictions? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_inactive_message = @inactive_message).nil?
        invalid_properties.push(ERROR_MESSAGE_FOR_INACTIVE_MESSAGE) unless OpenApi::EnumValidator.valid?(_inactive_message, VALID_VALUES_FOR_INACTIVE_MESSAGE)
      end
    ...
    def valid? : Bool
      ...
      unless (_inactive_message = @inactive_message).nil?
        return false unless OpenApi::EnumValidator.valid?(_inactive_message, VALID_VALUES_FOR_INACTIVE_MESSAGE)
      end
    ...
    def custom_fields=(new_value : Stripe::PostPaymentLinksPaymentLinkRequestCustomFields?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def inactive_message=(new_value : String?)
      unless new_value.nil?
        OpenApi::EnumValidator.validate("inactive_message", new_value, VALID_VALUES_FOR_INACTIVE_MESSAGE)
      end
    ...
    def invoice_creation=(new_value : Stripe::InvoiceCreationUpdateParams?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def line_items=(new_value : Array(Stripe::LineItemsUpdateParams)?)
      unless new_value.nil?
    ...
    def payment_intent_data=(new_value : Stripe::PaymentIntentDataUpdateParams?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def payment_method_types=(new_value : Stripe::PostPaymentLinksPaymentLinkRequestPaymentMethodTypes?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def restrictions=(new_value : Stripe::PostPaymentLinksPaymentLinkRequestRestrictions?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def shipping_address_collection=(new_value : Stripe::PostPaymentLinksPaymentLinkRequestShippingAddressCollection?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def_equals_and_hash(@active, @after_completion, @allow_promotion_codes, @automatic_tax, @billing_address_collection, @custom_fields, @custom_text, @customer_creation, @expand, @inactive_message, @invoice_creation, @line_items, @metadata, @payment_intent_data, @payment_method_collection, @payment_method_types, @restrictions, @shipping_address_collection, @subscription_data, @tax_id_collection)
  end
end
