...
module Stripe
  class PostPaymentLinksPaymentLinkRequest
    ...
    def_equals_and_hash(@active, @after_completion, @allow_promotion_codes, @automatic_tax, @billing_address_collection, @custom_text, @customer_creation, @expand, @line_items, @metadata, @payment_method_collection, @payment_method_types, @shipping_address_collection)
  end
end
