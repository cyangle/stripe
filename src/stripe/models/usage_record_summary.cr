...
module Stripe
  class UsageRecordSummary
    ...
    @[NASON::Field(key: "period", type: Period)]
    property period : Period

    # The ID of the subscription item this summary is describing.
    @[NASON::Field(key: "subscription_item", type: String)]
    property subscription_item : String

    # The total usage within this usage period.
    @[NASON::Field(key: "total_usage", type: Int64)]
    ...
    def initialize(*, @id : String, @livemode : Bool, @object : String, @period : Period, @subscription_item : String, @total_usage : Int64, @invoice : String? | Null = nil)
    end
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new("String", ["usage_record_summary"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["usage_record_summary"])
    ...
    def hash
      [id, invoice, livemode, object, period, subscription_item, total_usage].hash
    end
