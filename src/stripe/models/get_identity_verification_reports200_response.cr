...
module Stripe
  #
  class GetIdentityVerificationReports200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::IdentityVerificationReport)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::IdentityVerificationReport)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::IdentityVerificationReport)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::IdentityVerificationReport
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/identity\/verification_reports/
      end
    ...
    def data=(data : Array(Stripe::IdentityVerificationReport)?)
      if data.nil?
