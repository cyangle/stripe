...
module Stripe
  ...
  class GetTreasuryFinancialAccounts200Response
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::TreasuryFinancialAccount
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/treasury\/financial_accounts/
      end
    ...
    def data=(data : Array(Stripe::TreasuryFinancialAccount)?)
      if data.nil?
