...
module Stripe
  ...
  class GetTreasuryFinancialAccounts200Response
    include JSON::Serializable
    include JSON::Serializable::Unmapped

    # Required properties
    @[JSON::Field(key: "data", type: Array(TreasuryFinancialAccount))]
    property data : Array(TreasuryFinancialAccount)
    ...
    def initialize(*, @data : Array(TreasuryFinancialAccount), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/treasury\/financial_accounts/
      true
    end
