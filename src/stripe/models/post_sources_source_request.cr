...
module Stripe
  ...
  class PostSourcesSourceRequest
    ...
    def_equals_and_hash(@amount, @amount_present, @expand, @expand_present, @mandate, @mandate_present, @metadata, @metadata_present, @owner, @owner_present, @source_order, @source_order_present)
  end
end
