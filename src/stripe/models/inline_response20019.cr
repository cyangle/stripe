...
module Stripe
  class InlineResponse20019
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(IssuingSettlement))]
    property data : Array(IssuingSettlement)
    ...
    def initialize(*, @data : Array(IssuingSettlement), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/issuing\/settlements/
      true
    end
