...
module Stripe
  ...
  class QuoteCanceled
    ...
    @[JSON::Field(key: "object", type: Stripe::Quote?, default: nil, required: true, nullable: false, emit_null: false)]
    getter object : Stripe::Quote? = nil
    ...
    def object=(new_value : Stripe::Quote?)
