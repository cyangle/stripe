...
module Stripe
  ...
  class ChargeTransferData
    ...
    @[JSON::Field(key: "destination", type: Stripe::ChargeTransferDataDestination?, default: nil, required: true, nullable: false, emit_null: false)]
    getter destination : Stripe::ChargeTransferDataDestination? = nil
    ...
    def initialize(
      *,
      # Required properties
      @amount : Int64? = nil,
      @destination : Stripe::ChargeTransferDataDestination? = nil
    )
    end
    ...
    def destination=(new_value : Stripe::ChargeTransferDataDestination?)
