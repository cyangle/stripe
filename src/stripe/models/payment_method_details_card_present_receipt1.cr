...
module Stripe
  ...
  class PaymentMethodDetailsCardPresentReceipt1
    ...
    def initialize(*, @application_cryptogram : String?, @application_preferred_name : String?, @authorization_code : String?, @authorization_response_code : String?, @cardholder_verification_method : String?, @dedicated_file_name : String?, @terminal_verification_results : String?, @transaction_status_information : String?, @account_type : String? = nil)
    end
    ...
    def list_invalid_properties
      ...
      if @application_cryptogram.to_s.size > 5000
      ...
      if @application_preferred_name.to_s.size > 5000
      ...
      if @cardholder_verification_method.to_s.size > 5000
      ...
      if @transaction_status_information.to_s.size > 5000
    ...
    def valid?
      ...
      return false if @application_cryptogram.to_s.size > 5000
      return false if @application_preferred_name.to_s.size > 5000
      return false if @authorization_code.to_s.size > 5000
      return false if @authorization_response_code.to_s.size > 5000
      return false if @cardholder_verification_method.to_s.size > 5000
      return false if @dedicated_file_name.to_s.size > 5000
      return false if @terminal_verification_results.to_s.size > 5000
      return false if @transaction_status_information.to_s.size > 5000
      _any_of_found = false
    ...
    def_hash(@account_type, @application_cryptogram, @application_preferred_name, @authorization_code, @authorization_response_code, @cardholder_verification_method, @dedicated_file_name, @terminal_verification_results, @transaction_status_information)
  end
end
