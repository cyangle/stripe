...
module Stripe
  class PhaseConfigurationParams
    ...
    def default_tax_rates=(new_value : Stripe::GetInvoicesUpcomingSubscriptionDefaultTaxRatesParameter?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def invoice_settings=(new_value : Stripe::SubscriptionSchedulesParam?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def trial_end=(new_value : Stripe::PhaseConfigurationParamsEndDate?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
