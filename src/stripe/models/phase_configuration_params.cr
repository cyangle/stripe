...
module Stripe
  ...
  class PhaseConfigurationParams
    ...
    def_hash(@add_invoice_items, @application_fee_percent, @automatic_tax, @billing_cycle_anchor, @billing_thresholds, @collection_method, @coupon, @default_payment_method, @default_tax_rates, @end_date, @invoice_settings, @items, @iterations, @metadata, @proration_behavior, @transfer_data, @trial, @trial_end)
  end
end
