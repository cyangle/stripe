...
module Stripe
  ...
  class PaymentPagesCheckoutSessionShippingCost
    ...
    @[JSON::Field(key: "shipping_rate", type: Stripe::PaymentPagesCheckoutSessionShippingCostShippingRate?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: shipping_rate.nil? && !shipping_rate_present?)]
    ...
    def shipping_rate=(shipping_rate : Stripe::PaymentPagesCheckoutSessionShippingCostShippingRate?)
