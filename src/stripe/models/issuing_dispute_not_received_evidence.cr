...
module Stripe
  class IssuingDisputeNotReceivedEvidence
    ...
    def initialize(*, @additional_documentation : String | File? | Null = nil, @expected_at : Int64? | Null = nil, @explanation : String? | Null = nil, @product_description : String? | Null = nil, @product_type : String? | Null = nil)
    end
    ...
    def hash
      [additional_documentation, expected_at, explanation, product_description, product_type].hash
    end
