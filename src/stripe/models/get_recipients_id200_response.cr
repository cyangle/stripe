...
module Stripe
  ...
  class GetRecipientsId200Response
    ...
    def_equals_and_hash(@created, @id, @livemode, @metadata, @object, @_type, @deleted, @active_account, @cards, @default_card, @description, @email, @migrated_to, @name, @rolled_back_from)
  end
end
