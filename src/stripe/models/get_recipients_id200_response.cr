...
module Stripe
  ...
  class GetRecipientsId200Response
    ...
    def_hash(@active_account, @cards, @created, @default_card, @description, @email, @id, @livemode, @metadata, @migrated_to, @name, @object, @rolled_back_from, @_type, @verified, @deleted)
  end
end
