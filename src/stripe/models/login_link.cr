...
module Stripe
  class LoginLink
    ...
    def initialize(*, @created : Int64, @object : String, @url : String)
    end
    ...
    def valid?
      object_validator = EnumAttributeValidator.new("String", ["login_link"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["login_link"])
