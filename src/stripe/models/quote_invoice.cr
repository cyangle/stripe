...
module Stripe
  ...
  class QuoteInvoice
    ...
    def_equals_and_hash(@amount_due, @amount_paid, @amount_remaining, @attempt_count, @attempted, @automatic_tax, @collection_method, @created, @currency, @default_tax_rates, @id, @lines, @livemode, @object, @paid, @paid_out_of_band, @payment_settings, @period_end, @period_start, @post_payment_credit_notes_amount, @pre_payment_credit_notes_amount, @starting_balance, @status_transitions, @subtotal, @total, @total_tax_amounts, @deleted, @account_country, @account_name, @account_tax_ids, @application, @application_fee_amount, @auto_advance, @billing_reason, @charge, @custom_fields, @customer, @customer_address, @customer_email, @customer_name, @customer_phone, @customer_shipping, @customer_tax_exempt, @customer_tax_ids, @default_payment_method, @default_source, @description, @discount, @discounts, @due_date, @ending_balance, @footer, @hosted_invoice_url, @invoice_pdf, @last_finalization_error, @metadata, @next_payment_attempt, @number, @on_behalf_of, @payment_intent, @quote, @receipt_number, @statement_descriptor, @status, @subscription, @subscription_proration_date, @tax, @test_clock, @threshold_reason, @total_discount_amounts, @transfer_data, @webhooks_delivered_at)
  end
end
