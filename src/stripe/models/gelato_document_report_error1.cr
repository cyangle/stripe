...
module Stripe
  ...
  class GelatoDocumentReportError1
    ...
    ENUM_VALIDATOR_FOR_CODE = EnumValidator.new("code", "String", ["document_expired", "document_type_not_supported", "document_unverified_other", "null"])
