...
module Stripe
  ...
  class GetIssuingAuthorizations200Response
    ...
    # Required properties
    @[JSON::Field(key: "data", type: Array(IssuingAuthorization))]
    property data : Array(IssuingAuthorization)
    ...
    def initialize(*, @data : Array(IssuingAuthorization), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/issuing\/authorizations/
      true
    end
