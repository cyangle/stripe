...
module Stripe
  #
  class GetIssuingAuthorizations200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::IssuingAuthorization)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::IssuingAuthorization)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::IssuingAuthorization)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::IssuingAuthorization
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/issuing\/authorizations/
      end
    ...
    def data=(data : Array(Stripe::IssuingAuthorization)?)
      if data.nil?
