...
module Stripe
  ...
  class AccountUpdated
    ...
    @[JSON::Field(key: "object", type: Stripe::Account?, default: nil, required: true, nullable: false, emit_null: false)]
    getter object : Stripe::Account? = nil
    ...
    def object=(new_value : Stripe::Account?)
