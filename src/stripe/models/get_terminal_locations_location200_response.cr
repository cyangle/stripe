...
module Stripe
  ...
  class GetTerminalLocationsLocation200Response
    ...
    def initialize(*, @address : Address, @display_name : String, @id : String, @livemode : Bool, @metadata : Hash(String, String), @object : String, @deleted : Bool, @configuration_overrides : String? = nil)
    end
    ...
    def_hash(@address, @configuration_overrides, @display_name, @id, @livemode, @metadata, @object, @deleted)
  end
end
