...
module Stripe
  ...
  class PaymentPagesCheckoutSessionList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::CheckoutSession)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::CheckoutSession)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::CheckoutSession)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::CheckoutSession
    ...
    def data=(data : Array(Stripe::CheckoutSession)?)
      if data.nil?
