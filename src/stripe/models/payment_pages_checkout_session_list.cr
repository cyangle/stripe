...
module Stripe
  class PaymentPagesCheckoutSessionList
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(CheckoutSession))]
    property data : Array(CheckoutSession)
    ...
    def initialize(*, @data : Array(CheckoutSession), @has_more : Bool, @object : String, @url : String)
    end
