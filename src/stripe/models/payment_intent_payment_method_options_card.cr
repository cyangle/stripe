...
module Stripe
  ...
  class PaymentIntentPaymentMethodOptionsCard
    ...
    def_equals_and_hash(@capture_method, @capture_method_present, @installments, @installments_present, @mandate_options, @mandate_options_present, @network, @network_present, @request_three_d_secure, @request_three_d_secure_present, @setup_future_usage, @setup_future_usage_present)
  end
end
