...
module Stripe
  ...
  class OrdersV2ResourceOrderList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::Order)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::Order)? = nil
    ...
    def data=(data : Array(Stripe::Order)?)
      if data.nil?
