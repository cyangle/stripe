...
module Stripe
  ...
  class ChargeDisputeFundsReinstated
    ...
    @[JSON::Field(key: "object", type: Stripe::Dispute?, default: nil, required: true, nullable: false, emit_null: false)]
    getter object : Stripe::Dispute? = nil
    ...
    def object=(new_value : Stripe::Dispute?)
