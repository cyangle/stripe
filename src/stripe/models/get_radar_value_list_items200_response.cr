...
module Stripe
  ...
  class GetRadarValueListItems200Response
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::RadarValueListItem)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::RadarValueListItem
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/radar\/value_list_items/
      end
    ...
    def data=(data : Array(Stripe::RadarValueListItem)?)
      if data.nil?
