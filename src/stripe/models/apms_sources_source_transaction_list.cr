...
module Stripe
  class ApmsSourcesSourceTransactionList
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(SourceTransaction))]
    property data : Array(SourceTransaction)
    ...
    def initialize(*, @data : Array(SourceTransaction), @has_more : Bool, @object : String, @url : String)
    end
