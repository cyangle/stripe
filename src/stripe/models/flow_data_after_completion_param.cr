...
require "./after_completion_hosted_confirmation_param"
require "./after_completion_redirect_param"
...
module Stripe
  class FlowDataAfterCompletionParam
    ...
    @[JSON::Field(key: "hosted_confirmation", type: Stripe::AfterCompletionHostedConfirmationParam?, default: nil, required: false, nullable: false, emit_null: false)]
    getter hosted_confirmation : Stripe::AfterCompletionHostedConfirmationParam? = nil

    @[JSON::Field(key: "redirect", type: Stripe::AfterCompletionRedirectParam?, default: nil, required: false, nullable: false, emit_null: false)]
    getter redirect : Stripe::AfterCompletionRedirectParam? = nil
    ...
    def initialize(
      *,
      ...
      @_type : String? = nil,
      # Optional properties
      @hosted_confirmation : Stripe::AfterCompletionHostedConfirmationParam? = nil,
      @redirect : Stripe::AfterCompletionRedirectParam? = nil
    )
    end
    ...
    def hosted_confirmation=(new_value : Stripe::AfterCompletionHostedConfirmationParam?)
      unless new_value.nil?
    ...
    def redirect=(new_value : Stripe::AfterCompletionRedirectParam?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
