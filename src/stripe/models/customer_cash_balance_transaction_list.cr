...
module Stripe
  ...
  class CustomerCashBalanceTransactionList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::CustomerCashBalanceTransaction)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::CustomerCashBalanceTransaction)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::CustomerCashBalanceTransaction)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::CustomerCashBalanceTransaction
    ...
    def data=(data : Array(Stripe::CustomerCashBalanceTransaction)?)
      if data.nil?
