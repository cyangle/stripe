...
module Stripe
  ...
  class IssuingAuthorizationFleetCardholderPromptData
    ...
    @[JSON::Field(key: "alphanumeric_id", type: String?, default: nil, required: true, nullable: true, emit_null: true)]
    ...
    def_equals_and_hash(@alphanumeric_id, @driver_id, @odometer, @unspecified_id, @user_id, @vehicle_number)
  end
end
