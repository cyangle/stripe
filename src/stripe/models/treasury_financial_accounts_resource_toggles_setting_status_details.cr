...
module Stripe
  ...
  class TreasuryFinancialAccountsResourceTogglesSettingStatusDetails
    ...
    @[JSON::Field(key: "resolution", type: String?, default: nil, required: true, nullable: true, emit_null: true)]
    ...
    def resolution=(new_value : String?)
      unless new_value.nil?
        OpenApi::EnumValidator.validate("resolution", new_value, VALID_VALUES_FOR_RESOLUTION)
      end
