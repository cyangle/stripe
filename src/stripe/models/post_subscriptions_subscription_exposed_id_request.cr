...
module Stripe
  ...
  class PostSubscriptionsSubscriptionExposedIdRequest
    ...
    @[JSON::Field(key: "items", type: Array(SubscriptionItemUpdateParams)?, presence: true, ignore_serialize: items.nil? && !items_present?)]
    property items : Array(SubscriptionItemUpdateParams)?
