...
module Stripe
  class InvoiceSettingCustomerSetting
    ...
    def initialize(*, @custom_fields : Array(InvoiceSettingCustomField)? | Null = nil, @default_payment_method : String | PaymentMethod? | Null = nil, @footer : String? | Null = nil)
    end
    ...
    def hash
      [custom_fields, default_payment_method, footer].hash
    end
