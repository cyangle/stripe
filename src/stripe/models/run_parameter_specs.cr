  ...
  class RunParameterSpecs
    ...
    def list_invalid_properties : Array(String)
      ...
      if _reporting_category = @reporting_category
        invalid_properties.push(OpenApi::EnumValidator.error_message("reporting_category", VALID_VALUES_FOR_REPORTING_CATEGORY)) unless OpenApi::EnumValidator.valid?(_reporting_category, VALID_VALUES_FOR_REPORTING_CATEGORY)
      end
      if _timezone = @timezone
        invalid_properties.push(OpenApi::EnumValidator.error_message("timezone", VALID_VALUES_FOR_TIMEZONE)) unless OpenApi::EnumValidator.valid?(_timezone, VALID_VALUES_FOR_TIMEZONE)
      end
      invalid_properties
    end
