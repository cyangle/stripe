...
module Stripe
  ...
  class SubscriptionScheduleAddInvoiceItemPrice
    ...
    def_equals_and_hash(@deleted, @id, @object, @active, @billing_scheme, @created, @currency, @custom_unit_amount, @livemode, @lookup_key, @metadata, @nickname, @product, @recurring, @tax_behavior, @tiers_mode, @transform_quantity, @_type, @unit_amount, @unit_amount_decimal, @currency_options, @tiers)
  end
end
