...
require "./eu_bank_transfer_params"
...
module Stripe
  class BankTransferParam
    ...
    ERROR_MESSAGE_FOR_REQUESTED_ADDRESS_TYPES = "invalid value for \"requested_address_types\", must be one of [aba, iban, sepa, sort_code, spei, swift, zengin]."
    VALID_VALUES_FOR_REQUESTED_ADDRESS_TYPES  = String.static_array("aba", "iban", "sepa", "sort_code", "spei", "swift", "zengin")
    ...
    def eu_bank_transfer=(new_value : Stripe::EuBankTransferParams?)
      unless new_value.nil?
