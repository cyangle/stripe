...
module Stripe
  #
  class ReceivedCreditsResourceTreasuryReceivedCreditList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::TreasuryReceivedCredit)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::TreasuryReceivedCredit)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::TreasuryReceivedCredit)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::TreasuryReceivedCredit
    ...
    def data=(data : Array(Stripe::TreasuryReceivedCredit)?)
      if data.nil?
