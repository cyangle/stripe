...
module Stripe
  ...
  class ReceivedCreditsResourceTreasuryReceivedCreditList
    ...
    @[JSON::Field(key: "data", type: Array(TreasuryReceivedCredit))]
    property data : Array(TreasuryReceivedCredit)
    ...
    def initialize(*, @data : Array(TreasuryReceivedCredit), @has_more : Bool, @object : String, @url : String)
    end
