...
module Stripe
  ...
  class GetCountrySpecs200Response
    ...
    # Required properties
    @[JSON::Field(key: "data", type: Array(CountrySpec))]
    property data : Array(CountrySpec)
    ...
    def initialize(*, @data : Array(CountrySpec), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/country_specs/
      true
    end
