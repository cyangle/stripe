...
module Stripe
  #
  class GetCountrySpecs200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::CountrySpec)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::CountrySpec)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::CountrySpec)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::CountrySpec
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/country_specs/
      end
    ...
    def data=(data : Array(Stripe::CountrySpec)?)
      if data.nil?
