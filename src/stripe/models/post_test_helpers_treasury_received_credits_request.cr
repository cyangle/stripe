...
module Stripe
  ...
  class PostTestHelpersTreasuryReceivedCreditsRequest
    ...
    def initialize(*, @amount : Int64, @currency : String, @financial_account : String, @network : String, @description : String? = nil, @expand : Array(String)? = nil, @initiating_payment_method_details : SourceParams? = nil)
    end
    ...
    def_hash(@amount, @currency, @description, @expand, @financial_account, @initiating_payment_method_details, @network)
  end
end
