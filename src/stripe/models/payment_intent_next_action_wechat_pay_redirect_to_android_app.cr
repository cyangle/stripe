...
module Stripe
  class PaymentIntentNextActionWechatPayRedirectToAndroidApp
    ...
    @[NASON::Field(key: "app_id", type: String)]
    property app_id : String

    # nonce_str is a random string
    @[NASON::Field(key: "nonce_str", type: String)]
    property nonce_str : String

    # package is static value
    @[NASON::Field(key: "package", type: String)]
    property package : String

    # an unique merchant ID assigned by Wechat Pay
    @[NASON::Field(key: "partner_id", type: String)]
    property partner_id : String

    # an unique trading ID assigned by Wechat Pay
    @[NASON::Field(key: "prepay_id", type: String)]
    property prepay_id : String

    # A signature
    @[NASON::Field(key: "sign", type: String)]
    property sign : String

    # Specifies the current time in epoch format
    @[NASON::Field(key: "timestamp", type: String)]
    ...
    def hash
      [app_id, nonce_str, package, partner_id, prepay_id, sign, timestamp].hash
    end
