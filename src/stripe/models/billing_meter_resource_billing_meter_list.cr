...
module Stripe
  class BillingMeterResourceBillingMeterList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::BillingMeter)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::BillingMeter)? = nil
    ...
    PATTERN_FOR_URL    = /^\/v1\/billing\/meters/
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::BillingMeter)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(new_value : Array(Stripe::BillingMeter)?)
