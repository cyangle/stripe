...
module Stripe
  ...
  class CreditNotesList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::CreditNote)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::CreditNote)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::CreditNote)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::CreditNote
    ...
    def data=(data : Array(Stripe::CreditNote)?)
      if data.nil?
