...
module Stripe
  ...
  class AccountLink
    ...
    def initialize(*, @created : Int64, @expires_at : Int64, @object : String, @url : String)
    end
    ...
    def valid?
      object_validator = EnumAttributeValidator.new("String", ["account_link"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["account_link"])
    ...
    def hash
      [created, expires_at, object, url].hash
    end
