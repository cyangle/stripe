...
module Stripe
  class PostPaymentMethodsRequest
    ...
    def_equals_and_hash(@acss_debit, @affirm, @afterpay_clearpay, @alipay, @allow_redisplay, @amazon_pay, @au_becs_debit, @bacs_debit, @bancontact, @billing_details, @blik, @boleto, @card, @cashapp, @customer, @customer_balance, @eps, @expand, @fpx, @giropay, @grabpay, @ideal, @interac_present, @klarna, @konbini, @link, @metadata, @mobilepay, @multibanco, @oxxo, @p24, @payment_method, @paynow, @paypal, @pix, @promptpay, @radar_options, @revolut_pay, @sepa_debit, @sofort, @swish, @twint, @_type, @us_bank_account, @wechat_pay, @zip)
  end
end
