...
module Stripe
  ...
  class FundingInstructionsBankTransfer
    ...
    def initialize(*, @country : String, @financial_addresses : Array(FundingInstructionsBankTransferFinancialAddress), @_type : String)
    end
    ...
    def_hash(@country, @financial_addresses, @_type)
  end
end
