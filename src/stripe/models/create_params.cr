...
module Stripe
  class CreateParams
    ...
    @[JSON::Field(key: "settings", type: Stripe::CreateParams?, default: nil, required: true, nullable: false, emit_null: false)]
    getter settings : Stripe::CreateParams? = nil
    ...
    def initialize(
      *,
      # Required properties
      @settings : Stripe::CreateParams? = nil
    )
    end
    ...
    def settings=(settings : Stripe::CreateParams?)
      if settings.nil?
