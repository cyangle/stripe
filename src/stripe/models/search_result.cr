...
module Stripe
  class SearchResult
    ...
    @[JSON::Field(key: "next_page", type: String?, default: nil, required: true, nullable: true, emit_null: true)]
    ...
    VALID_VALUES_FOR_OBJECT  = String.static_array("search_result")
    ...
    def data=(new_value : Array(Stripe::Subscription)?)
    ...
    def next_page=(new_value : String?)
      unless new_value.nil?
        OpenApi::PrimitiveValidator.validate_max_length("next_page", new_value.to_s.size, MAX_LENGTH_FOR_NEXT_PAGE)
      end
    ...
    def total_count=(new_value : Int64?)
    ...
    def_equals_and_hash(@data, @has_more, @next_page, @object, @url, @total_count)
  end
end
