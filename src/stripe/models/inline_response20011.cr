...
module Stripe
  class InlineResponse20011
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(FileLink))]
    property data : Array(FileLink)
    ...
    def initialize(*, @data : Array(FileLink), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/file_links/
      true
    end
