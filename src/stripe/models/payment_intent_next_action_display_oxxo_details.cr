...
module Stripe
  class PaymentIntentNextActionDisplayOxxoDetails
    ...
    @[NASON::Field(key: "expires_after", type: Int64? | Null, nillable: true)]
    property expires_after : Int64? | Null
    ...
    def initialize(*, @expires_after : Int64? | Null = nil, @hosted_voucher_url : String? | Null = nil, @number : String? | Null = nil)
    end
    ...
    def hash
      [expires_after, hosted_voucher_url, number].hash
    end
