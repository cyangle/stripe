...
module Stripe
  ...
  class PaymentMethodDetailsBancontact
    ...
    def initialize(*, @bank_code : String?, @bank_name : String?, @bic : String?, @generated_sepa_debit : PaymentMethodDetailsBancontactGeneratedSepaDebit?, @generated_sepa_debit_mandate : PaymentMethodDetailsBancontactGeneratedSepaDebitMandate?, @iban_last4 : String?, @preferred_language : String?, @verified_name : String?)
    end
