...
module Stripe
  class PlatformTaxFee
    ...
    @[NASON::Field(key: "source_transaction", type: String)]
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new("String", ["platform_tax_fee"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["platform_tax_fee"])
    ...
    def hash
      [account, id, object, source_transaction, _type].hash
    end
