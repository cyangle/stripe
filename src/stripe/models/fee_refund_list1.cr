...
module Stripe
  ...
  class FeeRefundList1
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::FeeRefund)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::FeeRefund)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::FeeRefund)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::FeeRefund
    ...
    def data=(data : Array(Stripe::FeeRefund)?)
      if data.nil?
