...
require "./payment_method_details_paypal_seller_protection"
...
module Stripe
  ...
  class PaymentMethodDetailsPaypal
    ...
    @[JSON::Field(key: "seller_protection", type: Stripe::PaymentMethodDetailsPaypalSellerProtection?, default: nil, required: true, nullable: true, emit_null: true)]
    getter seller_protection : Stripe::PaymentMethodDetailsPaypalSellerProtection? = nil
    ...
    def initialize(
      *,
      ...
      @seller_protection : Stripe::PaymentMethodDetailsPaypalSellerProtection? = nil,
    ...
    def seller_protection=(new_value : Stripe::PaymentMethodDetailsPaypalSellerProtection?)
      unless new_value.nil?
