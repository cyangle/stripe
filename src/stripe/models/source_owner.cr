...
module Stripe
  class SourceOwner
    ...
    @[NASON::Field(key: "verified_address", type: Address? | Null, nillable: true)]
    property verified_address : Address? | Null

    # Verified owner's email address. Verified values are verified or provided by the payment method directly (and if supported) at the time of authorization or settlement. They cannot be set or mutated.
    @[NASON::Field(key: "verified_email", type: String? | Null, nillable: true)]
    property verified_email : String? | Null
    ...
    @[NASON::Field(key: "verified_phone", type: String? | Null, nillable: true)]
    property verified_phone : String? | Null

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @address : Address? | Null = nil, @email : String? | Null = nil, @name : String? | Null = nil, @phone : String? | Null = nil, @verified_address : Address? | Null = nil, @verified_email : String? | Null = nil, @verified_name : String? | Null = nil, @verified_phone : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@verified_email.nil? && !@verified_email.null? && @verified_email.to_s.size > 5000
      ...
      if !@verified_phone.nil? && !@verified_phone.null? && @verified_phone.to_s.size > 5000
    ...
    def valid?
      ...
      return false if !@verified_email.nil? && !@verified_email.null? && @verified_email.to_s.size > 5000
      return false if !@verified_name.nil? && !@verified_name.null? && @verified_name.to_s.size > 5000
      return false if !@verified_phone.nil? && !@verified_phone.null? && @verified_phone.to_s.size > 5000
      true
    end
    ...
    def hash
      [address, email, name, phone, verified_address, verified_email, verified_name, verified_phone].hash
    end
