...
module Stripe
  class AccountPaymentsSettings
    ...
    @[NASON::Field(key: "statement_descriptor_kana", type: String? | Null, nillable: true)]
    property statement_descriptor_kana : String? | Null

    # The Kanji variation of the default text that appears on credit card statements when a charge is made (Japan only)
    @[NASON::Field(key: "statement_descriptor_kanji", type: String? | Null, nillable: true)]
    property statement_descriptor_kanji : String? | Null

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @statement_descriptor : String? | Null = nil, @statement_descriptor_kana : String? | Null = nil, @statement_descriptor_kanji : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@statement_descriptor_kana.nil? && !@statement_descriptor_kana.null? && @statement_descriptor_kana.to_s.size > 5000
        invalid_properties.push("invalid value for \"statement_descriptor_kana\", the character length must be smaller than or equal to 5000.")
      end

      if !@statement_descriptor_kanji.nil? && !@statement_descriptor_kanji.null? && @statement_descriptor_kanji.to_s.size > 5000
        invalid_properties.push("invalid value for \"statement_descriptor_kanji\", the character length must be smaller than or equal to 5000.")
      end
    ...
    def valid?
      ...
      return false if !@statement_descriptor_kana.nil? && !@statement_descriptor_kana.null? && @statement_descriptor_kana.to_s.size > 5000
      return false if !@statement_descriptor_kanji.nil? && !@statement_descriptor_kanji.null? && @statement_descriptor_kanji.to_s.size > 5000
      true
    end
    ...
    def hash
      [statement_descriptor, statement_descriptor_kana, statement_descriptor_kanji].hash
    end
