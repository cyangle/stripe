...
module Stripe
  ...
  class AccountPaymentsSettings
    ...
    def initialize(*, @statement_descriptor : String?, @statement_descriptor_kana : String?, @statement_descriptor_kanji : String?)
    end
    ...
    def list_invalid_properties
      ...
      if @statement_descriptor_kana.to_s.size > 5000
      ...
      if @statement_descriptor_kanji.to_s.size > 5000
    ...
    def valid?
      ...
      return false if @statement_descriptor_kana.to_s.size > 5000
      return false if @statement_descriptor_kanji.to_s.size > 5000
      true
    end
