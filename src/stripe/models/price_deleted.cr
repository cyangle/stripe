...
module Stripe
  ...
  class PriceDeleted
    ...
    @[JSON::Field(key: "object", type: Stripe::Price?, default: nil, required: true, nullable: false, emit_null: false)]
    getter object : Stripe::Price? = nil
    ...
    def object=(new_value : Stripe::Price?)
