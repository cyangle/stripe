...
module Stripe
  ...
  class BalanceAvailable
    ...
    @[JSON::Field(key: "object", type: Stripe::Balance?, default: nil, required: true, nullable: false, emit_null: false)]
    getter object : Stripe::Balance? = nil
    ...
    def object=(new_value : Stripe::Balance?)
