...
module Stripe
  ...
  class IssuingTransactionAmountDetails
    ...
    @[JSON::Field(key: "atm_fee", type: Int64?, default: nil, required: true, nullable: true, emit_null: true)]
    getter atm_fee : Int64? = nil

    # The amount of cash requested by the cardholder.
    @[JSON::Field(key: "cashback_amount", type: Int64?, default: nil, required: true, nullable: true, emit_null: true)]
