...
module Stripe
  ...
  class PaymentIntentPaymentMethodOptionsParam6
    ...
    def_equals_and_hash(@financial_connections, @financial_connections_present, @networks, @networks_present, @setup_future_usage, @setup_future_usage_present, @verification_method, @verification_method_present)
  end
end
