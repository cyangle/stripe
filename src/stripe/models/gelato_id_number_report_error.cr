...
module Stripe
  class GelatoIdNumberReportError
    ...
    def valid?
      code_validator = EnumAttributeValidator.new("String", ["id_number_insufficient_document_data", "id_number_mismatch", "id_number_unverified_other"])
    ...
    def code=(code)
      validator = EnumAttributeValidator.new("String", ["id_number_insufficient_document_data", "id_number_mismatch", "id_number_unverified_other"])
