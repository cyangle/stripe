...
module Stripe
  ...
  class GelatoSelfieReportError1
    ...
    ENUM_VALIDATOR_FOR_CODE = EnumValidator.new("code", "String", ["selfie_document_missing_photo", "selfie_face_mismatch", "selfie_manipulated", "selfie_unverified_other", "null"])
