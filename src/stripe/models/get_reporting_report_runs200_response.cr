...
module Stripe
  #
  class GetReportingReportRuns200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::ReportingReportRun)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::ReportingReportRun)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::ReportingReportRun)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::ReportingReportRun
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/reporting\/report_runs/
      end
    ...
    def data=(data : Array(Stripe::ReportingReportRun)?)
      if data.nil?
