...
module Stripe
  ...
  class GetReportingReportRuns200Response
    ...
    # Required properties
    @[JSON::Field(key: "data", type: Array(ReportingReportRun))]
    property data : Array(ReportingReportRun)
    ...
    def initialize(*, @data : Array(ReportingReportRun), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/reporting\/report_runs/
      true
    end
