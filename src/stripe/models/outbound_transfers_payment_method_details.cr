...
require "./outbound_transfers_payment_method_details_us_bank_account"
...
module Stripe
  ...
  class OutboundTransfersPaymentMethodDetails
    ...
    def us_bank_account=(new_value : Stripe::OutboundTransfersPaymentMethodDetailsUsBankAccount?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
