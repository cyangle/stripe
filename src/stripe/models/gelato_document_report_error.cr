...
module Stripe
  class GelatoDocumentReportError
    ...
    def valid?
      code_validator = EnumAttributeValidator.new("String", ["document_expired", "document_type_not_supported", "document_unverified_other"])
    ...
    def code=(code)
      validator = EnumAttributeValidator.new("String", ["document_expired", "document_type_not_supported", "document_unverified_other"])
