...
module Stripe
  class RadarReviewResourceSession
    ...
    @[NASON::Field(key: "browser", type: String? | Null, nillable: true)]
    property browser : String? | Null

    # Information about the device used for the browser session (e.g., `Samsung SM-G930T`).
    @[NASON::Field(key: "device", type: String? | Null, nillable: true)]
    property device : String? | Null

    # The platform for the browser session (e.g., `Macintosh`).
    @[NASON::Field(key: "platform", type: String? | Null, nillable: true)]
    property platform : String? | Null
    ...
    def initialize(*, @browser : String? | Null = nil, @device : String? | Null = nil, @platform : String? | Null = nil, @version : String? | Null = nil)
    end
    ...
    def valid?
      return false if !@browser.nil? && !@browser.null? && @browser.to_s.size > 5000
      return false if !@device.nil? && !@device.null? && @device.to_s.size > 5000
      return false if !@platform.nil? && !@platform.null? && @platform.to_s.size > 5000
      return false if !@version.nil? && !@version.null? && @version.to_s.size > 5000
      true
    end
    ...
    def hash
      [browser, device, platform, version].hash
    end
