...
module Stripe
  class InlineResponse2005
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(Charge))]
    property data : Array(Charge)
    ...
    def initialize(*, @data : Array(Charge), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/charges/
      true
    end
