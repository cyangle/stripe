...
module Stripe
  class CustomFieldTextParam
    ...
    MAX_LENGTH_FOR_DEFAULT_VALUE = 255

    # The maximum character length constraint for the customer's input.
    @[JSON::Field(key: "maximum_length", type: Int64?, default: nil, required: false, nullable: false, emit_null: false)]
    getter maximum_length : Int64? = nil

    # The minimum character length requirement for the customer's input.
    @[JSON::Field(key: "minimum_length", type: Int64?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    def_equals_and_hash(@default_value, @maximum_length, @minimum_length)
  end
end
