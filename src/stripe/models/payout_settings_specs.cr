...
module Stripe
  ...
  class PayoutSettingsSpecs
    ...
    property? debit_negative_balances_present : Bool = false

    @[JSON::Field(key: "schedule", type: TransferScheduleSpecs?, presence: true, ignore_serialize: schedule.nil? && !schedule_present?)]
    property schedule : TransferScheduleSpecs?
    ...
    def_equals_and_hash(@debit_negative_balances, @debit_negative_balances_present, @schedule, @schedule_present, @statement_descriptor, @statement_descriptor_present)
  end
end
