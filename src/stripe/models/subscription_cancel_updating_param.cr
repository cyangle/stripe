...
module Stripe
  ...
  class SubscriptionCancelUpdatingParam
    ...
    def_equals_and_hash(@cancellation_reason, @cancellation_reason_present, @enabled, @enabled_present, @mode, @mode_present, @proration_behavior, @proration_behavior_present)
  end
end
