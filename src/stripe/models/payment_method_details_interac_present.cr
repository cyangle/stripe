...
module Stripe
  ...
  class PaymentMethodDetailsInteracPresent
    ...
    def_equals_and_hash(@brand, @cardholder_name, @country, @emv_auth_data, @exp_month, @exp_year, @fingerprint, @funding, @generated_card, @last4, @network, @network_transaction_id, @preferred_locales, @read_method, @receipt, @description, @description_present, @iin, @iin_present, @issuer, @issuer_present)
  end
end
