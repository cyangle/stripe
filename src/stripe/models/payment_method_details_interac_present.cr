...
module Stripe
  class PaymentMethodDetailsInteracPresent
    ...
    @[NASON::Field(key: "receipt", type: PaymentMethodDetailsInteracPresentReceipt? | Null, nillable: true)]
    property receipt : PaymentMethodDetailsInteracPresentReceipt? | Null
    ...
    def initialize(*, @exp_month : Int64, @exp_year : Int64, @brand : String? | Null = nil, @cardholder_name : String? | Null = nil, @country : String? | Null = nil, @emv_auth_data : String? | Null = nil, @fingerprint : String? | Null = nil, @funding : String? | Null = nil, @generated_card : String? | Null = nil, @last4 : String? | Null = nil, @network : String? | Null = nil, @preferred_locales : Array(String)? | Null = nil, @read_method : String? | Null = nil, @receipt : PaymentMethodDetailsInteracPresentReceipt? | Null = nil)
    end
    ...
    def hash
      [brand, cardholder_name, country, emv_auth_data, exp_month, exp_year, fingerprint, funding, generated_card, last4, network, preferred_locales, read_method, receipt].hash
    end
