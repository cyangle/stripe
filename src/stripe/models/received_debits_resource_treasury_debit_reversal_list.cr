...
module Stripe
  #
  class ReceivedDebitsResourceTreasuryDebitReversalList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::TreasuryDebitReversal)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::TreasuryDebitReversal)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::TreasuryDebitReversal)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::TreasuryDebitReversal
    ...
    def data=(data : Array(Stripe::TreasuryDebitReversal)?)
      if data.nil?
