...
module Stripe
  ...
  class ReceivedDebitsResourceTreasuryDebitReversalList
    ...
    @[JSON::Field(key: "data", type: Array(TreasuryDebitReversal))]
    property data : Array(TreasuryDebitReversal)
    ...
    def initialize(*, @data : Array(TreasuryDebitReversal), @has_more : Bool, @object : String, @url : String)
    end
