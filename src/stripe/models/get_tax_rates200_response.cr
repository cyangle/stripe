...
module Stripe
  ...
  class GetTaxRates200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::TaxRate)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::TaxRate)? = nil
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::TaxRate
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/tax_rates/
      end
    ...
    def data=(data : Array(Stripe::TaxRate)?)
      if data.nil?
