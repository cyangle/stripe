...
module Stripe
  #
  class GetWebhookEndpoints200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::WebhookEndpoint)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::WebhookEndpoint)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::WebhookEndpoint)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::WebhookEndpoint
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/webhook_endpoints/
      end
    ...
    def data=(data : Array(Stripe::WebhookEndpoint)?)
      if data.nil?
