...
module Stripe
  ...
  class GetWebhookEndpoints200Response
    ...
    # Required properties
    @[JSON::Field(key: "data", type: Array(WebhookEndpoint))]
    property data : Array(WebhookEndpoint)
    ...
    def initialize(*, @data : Array(WebhookEndpoint), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/webhook_endpoints/
      true
    end
