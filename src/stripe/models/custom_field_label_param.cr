...
module Stripe
  class CustomFieldLabelParam
    ...
    @[JSON::Field(key: "custom", type: String?, default: nil, required: true, nullable: false, emit_null: false)]
    getter custom : String? = nil
    MAX_LENGTH_FOR_CUSTOM = 50
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"custom\" is required and cannot be null") if @custom.nil?
    ...
    def custom=(new_value : String?)
      raise ArgumentError.new("\"custom\" is required and cannot be null") if new_value.nil?
