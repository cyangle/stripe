...
module Stripe
  ...
  class ReceivedCreditsResourceTreasuryCreditReversalList
    ...
    @[JSON::Field(key: "data", type: Array(TreasuryCreditReversal))]
    property data : Array(TreasuryCreditReversal)
    ...
    def initialize(*, @data : Array(TreasuryCreditReversal), @has_more : Bool, @object : String, @url : String)
    end
