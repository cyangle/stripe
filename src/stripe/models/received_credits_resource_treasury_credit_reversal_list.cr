...
module Stripe
  #
  class ReceivedCreditsResourceTreasuryCreditReversalList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::TreasuryCreditReversal)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::TreasuryCreditReversal)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::TreasuryCreditReversal)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::TreasuryCreditReversal
    ...
    def data=(data : Array(Stripe::TreasuryCreditReversal)?)
      if data.nil?
