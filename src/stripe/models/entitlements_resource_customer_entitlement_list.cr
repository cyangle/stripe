...
require "./entitlements_active_entitlement"
...
module Stripe
  class EntitlementsResourceCustomerEntitlementList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::EntitlementsActiveEntitlement)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::EntitlementsActiveEntitlement)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::EntitlementsActiveEntitlement)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(new_value : Array(Stripe::EntitlementsActiveEntitlement)?)
