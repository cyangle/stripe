...
module Stripe
  class PayoutList
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(Payout))]
    property data : Array(Payout)
    ...
    def initialize(*, @data : Array(Payout), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/payouts/
      true
    end
