...
module Stripe
  class PayoutList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::Payout)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::Payout)? = nil
    ...
    def data=(data : Array(Stripe::Payout)?)
      if data.nil?
