...
module Stripe
  ...
  class OrdersV2ResourceLineItemList1
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::Item)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::Item)? = nil
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::Item
    ...
    def data=(data : Array(Stripe::Item)?)
      if data.nil?
