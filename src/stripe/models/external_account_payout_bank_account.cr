...
module Stripe
  ...
  class ExternalAccountPayoutBankAccount
    ...
    def_equals_and_hash(@account_number, @country, @account_holder_name, @account_holder_name_present, @account_holder_type, @account_holder_type_present, @account_type, @account_type_present, @currency, @currency_present, @object, @object_present, @routing_number, @routing_number_present)
  end
end
