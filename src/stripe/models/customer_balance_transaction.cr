...
module Stripe
  ...
  class CustomerBalanceTransaction
    ...
    @[NASON::Field(key: "ending_balance", type: Int64)]
    ...
    @[NASON::Field(key: "credit_note", type: String | CreditNote? | Null, nillable: true)]
    property credit_note : String | CreditNote? | Null
    ...
    def initialize(*, @amount : Int64, @created : Int64, @currency : String, @customer : String | Customer | Null, @ending_balance : Int64, @id : String, @livemode : Bool, @object : String, @_type : String, @credit_note : String | CreditNote? | Null = nil, @description : String? | Null = nil, @invoice : String | Invoice? | Null = nil, @metadata : Hash(String, String)? | Null = nil)
    end
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new("String", ["customer_balance_transaction"])
      return false unless object_validator.valid?(@object)
      _type_validator = EnumAttributeValidator.new("String", ["adjustment", "applied_to_invoice", "credit_note", "initial", "invoice_too_large", "invoice_too_small", "migration", "unapplied_from_invoice", "unspent_receiver_credit"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["customer_balance_transaction"])
    ...
    def _type=(_type)
      validator = EnumAttributeValidator.new("String", ["adjustment", "applied_to_invoice", "credit_note", "initial", "invoice_too_large", "invoice_too_small", "migration", "unapplied_from_invoice", "unspent_receiver_credit"])
    ...
    def hash
      [amount, created, credit_note, currency, customer, description, ending_balance, id, invoice, livemode, metadata, object, _type].hash
    end
