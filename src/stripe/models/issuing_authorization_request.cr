...
module Stripe
  ...
  class IssuingAuthorizationRequest
    ...
    VALID_VALUES_FOR_REASON  = String.static_array("account_disabled", "card_active", "card_inactive", "cardholder_inactive", "cardholder_verification_required", "insufficient_funds", "not_allowed", "spending_controls", "suspected_fraud", "verification_failed", "webhook_approved", "webhook_declined", "webhook_error", "webhook_timeout")
    ...
    def reason_message=(reason_message : String?)
      if reason_message.nil?
        return @reason_message = nil
      end
      _reason_message = reason_message.not_nil!
      OpenApi::PrimitiveValidator.validate_max_length("reason_message", _reason_message.to_s.size, MAX_LENGTH_FOR_REASON_MESSAGE)
    ...
    def_equals_and_hash(@amount, @approved, @created, @currency, @merchant_amount, @merchant_currency, @reason, @amount_details, @amount_details_present, @reason_message, @reason_message_present)
  end
end
