...
require "./connect_embedded_payouts_features"

module Stripe
  #
  class ConnectEmbeddedPayoutsConfigClaim
    ...
    @[JSON::Field(key: "features", type: Stripe::ConnectEmbeddedPayoutsFeatures?, default: nil, required: true, nullable: false, emit_null: false)]
    getter features : Stripe::ConnectEmbeddedPayoutsFeatures? = nil
    ...
    def initialize(
      *,
      # Required properties
      @enabled : Bool? = nil,
      @features : Stripe::ConnectEmbeddedPayoutsFeatures? = nil
    )
    end
    ...
    def features=(new_value : Stripe::ConnectEmbeddedPayoutsFeatures?)
