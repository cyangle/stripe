...
module Stripe
  ...
  class PostPaymentIntentsIntentCaptureRequest
    ...
    def_equals_and_hash(@amount_to_capture, @amount_to_capture_present, @application_fee_amount, @application_fee_amount_present, @expand, @expand_present, @statement_descriptor, @statement_descriptor_present, @statement_descriptor_suffix, @statement_descriptor_suffix_present, @transfer_data, @transfer_data_present)
  end
end
