...
require "./transfer_data_update_params"
...
module Stripe
  class PostPaymentIntentsIntentCaptureRequest
    ...
    @[JSON::Field(key: "final_capture", type: Bool?, default: nil, required: false, nullable: false, emit_null: false)]
    getter final_capture : Bool? = nil
    ...
    def amount_to_capture=(new_value : Int64?)
      @amount_to_capture = new_value
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] final_capture Object to be assigned
    def final_capture=(new_value : Bool?)
      @final_capture = new_value
    end
    ...
    def_equals_and_hash(@amount_to_capture, @application_fee_amount, @expand, @final_capture, @metadata, @statement_descriptor, @statement_descriptor_suffix, @transfer_data)
  end
end
