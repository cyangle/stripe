...
module Stripe
  class InlineResponse20021
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(OrderReturn))]
    property data : Array(OrderReturn)
    ...
    def initialize(*, @data : Array(OrderReturn), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/order_returns/
      true
    end
