...
require "./billing_meter_event_summary"
...
module Stripe
  class BillingMeterResourceBillingMeterEventSummaryList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::BillingMeterEventSummary)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::BillingMeterEventSummary)? = nil
    ...
    PATTERN_FOR_URL    = /^\/v1\/billing\/meters\/[^\/]+\/event_summaries/
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::BillingMeterEventSummary)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(new_value : Array(Stripe::BillingMeterEventSummary)?)
