...
module Stripe
  ...
  class TransactionsResourceTreasuryTransactionEntryList1
    ...
    @[JSON::Field(key: "data", type: Array(TreasuryTransactionEntry))]
    property data : Array(TreasuryTransactionEntry)
    ...
    def initialize(*, @data : Array(TreasuryTransactionEntry), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/treasury\/transaction_entries/
      true
    end
