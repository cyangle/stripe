...
module Stripe
  ...
  class BankConnectionsResourceLinkedAccountList1
    ...
    @[JSON::Field(key: "data", type: Array(FinancialConnectionsAccount))]
    property data : Array(FinancialConnectionsAccount)
    ...
    def initialize(*, @data : Array(FinancialConnectionsAccount), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/financial_connections\/accounts/
      true
    end
