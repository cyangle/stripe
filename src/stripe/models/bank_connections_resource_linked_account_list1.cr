...
module Stripe
  ...
  class BankConnectionsResourceLinkedAccountList1
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::FinancialConnectionsAccount)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::FinancialConnectionsAccount)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::FinancialConnectionsAccount)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::FinancialConnectionsAccount
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/financial_connections\/accounts/
      end
    ...
    def data=(data : Array(Stripe::FinancialConnectionsAccount)?)
      if data.nil?
