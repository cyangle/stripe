...
module Stripe
  class ConnectCollectionTransfer
    ...
    def initialize(*, @amount : Int64, @currency : String, @destination : String | Account | Null, @id : String, @livemode : Bool, @object : String)
    end
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new("String", ["connect_collection_transfer"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["connect_collection_transfer"])
    ...
    def hash
      [amount, currency, destination, id, livemode, object].hash
    end
