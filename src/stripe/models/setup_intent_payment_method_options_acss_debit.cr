...
module Stripe
  ...
  class SetupIntentPaymentMethodOptionsAcssDebit
    ...
    def list_invalid_properties
      ...
      # This is a model mandate_options : Stripe::SetupIntentPaymentMethodOptionsMandateOptionsAcssDebit?
    ...
    def mandate_options=(mandate_options : Stripe::SetupIntentPaymentMethodOptionsMandateOptionsAcssDebit?)
    ...
    def_equals_and_hash(@currency, @currency_present, @mandate_options, @verification_method)
  end
end
