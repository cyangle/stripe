...
module Stripe
  ...
  class SetupIntentPaymentMethodOptionsAcssDebit
    ...
    ENUM_VALIDATOR_FOR_CURRENCY = EnumValidator.new("currency", "String", ["cad", "usd", "null"])

    # Optional properties
    @[JSON::Field(key: "mandate_options", type: SetupIntentPaymentMethodOptionsMandateOptionsAcssDebit?, presence: true, ignore_serialize: mandate_options.nil? && !mandate_options_present?)]
    ...
    def initialize(*, @currency : String?, @mandate_options : SetupIntentPaymentMethodOptionsMandateOptionsAcssDebit? = nil, @verification_method : String? = nil)
    end
