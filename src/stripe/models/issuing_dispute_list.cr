...
module Stripe
  class IssuingDisputeList
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(IssuingDispute))]
    property data : Array(IssuingDispute)
    ...
    def initialize(*, @data : Array(IssuingDispute), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/issuing\/disputes/
      true
    end
