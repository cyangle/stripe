...
module Stripe
  ...
  class IssuingDisputeList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::IssuingDispute)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::IssuingDispute)? = nil
    ...
    PATTERN_FOR_URL    = /^\/v1\/issuing\/disputes/
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::IssuingDispute)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(data : Array(Stripe::IssuingDispute)?)
      if data.nil?
