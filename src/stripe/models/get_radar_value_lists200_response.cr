...
module Stripe
  #
  class GetRadarValueLists200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::RadarValueList)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::RadarValueList)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::RadarValueList)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::RadarValueList
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/radar\/value_lists/
      end
    ...
    def data=(data : Array(Stripe::RadarValueList)?)
      if data.nil?
