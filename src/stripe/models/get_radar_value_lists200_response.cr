...
module Stripe
  ...
  class GetRadarValueLists200Response
    ...
    # Required properties
    @[JSON::Field(key: "data", type: Array(RadarValueList))]
    property data : Array(RadarValueList)
    ...
    def initialize(*, @data : Array(RadarValueList), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/radar\/value_lists/
      true
    end
