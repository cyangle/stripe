...
module Stripe
  class AccountPayoutSettings
    ...
    @[NASON::Field(key: "debit_negative_balances", type: Bool)]
    property debit_negative_balances : Bool

    @[NASON::Field(key: "schedule", type: TransferSchedule)]
    ...
    def initialize(*, @debit_negative_balances : Bool, @schedule : TransferSchedule, @statement_descriptor : String? | Null = nil)
    end
    ...
    def hash
      [debit_negative_balances, schedule, statement_descriptor].hash
    end
