...
module Stripe
  ...
  class GetAccounts200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::Account)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::Account)? = nil
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::Account
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/accounts/
      end
    ...
    def data=(data : Array(Stripe::Account)?)
      if data.nil?
