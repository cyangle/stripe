...
module Stripe
  ...
  class PaymentMethodOptionsParam28
    ...
    def initialize(*, @acss_debit : SetupIntentPaymentMethodOptionsParam? = nil, @card : SetupIntentParam? = nil, @link : SetupIntentPaymentMethodOptionsParam1? = nil, @sepa_debit : SetupIntentPaymentMethodOptionsParam2? = nil, @us_bank_account : SetupIntentPaymentMethodOptionsParam3? = nil)
    end
