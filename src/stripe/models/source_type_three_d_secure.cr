...
module Stripe
  class SourceTypeThreeDSecure
    ...
    @[NASON::Field(key: "authenticated", type: Bool? | Null, nillable: true)]
    property authenticated : Bool? | Null

    @[NASON::Field(key: "brand", type: String? | Null, nillable: true)]
    property brand : String? | Null

    @[NASON::Field(key: "card", type: String? | Null, nillable: true)]
    property card : String? | Null

    @[NASON::Field(key: "country", type: String? | Null, nillable: true)]
    property country : String? | Null

    @[NASON::Field(key: "customer", type: String? | Null, nillable: true)]
    property customer : String? | Null
    ...
    @[NASON::Field(key: "three_d_secure", type: String?, nillable: true)]
    ...
    def initialize(*, @address_line1_check : String? | Null = nil, @address_zip_check : String? | Null = nil, @authenticated : Bool? | Null = nil, @brand : String? | Null = nil, @card : String? | Null = nil, @country : String? | Null = nil, @customer : String? | Null = nil, @cvc_check : String? | Null = nil, @dynamic_last4 : String? | Null = nil, @exp_month : Int64? | Null = nil, @exp_year : Int64? | Null = nil, @fingerprint : String? = nil, @funding : String? | Null = nil, @last4 : String? | Null = nil, @name : String? | Null = nil, @three_d_secure : String? = nil, @tokenization_method : String? | Null = nil)
    end
    ...
    def hash
      [address_line1_check, address_zip_check, authenticated, brand, card, country, customer, cvc_check, dynamic_last4, exp_month, exp_year, fingerprint, funding, last4, name, three_d_secure, tokenization_method].hash
    end
