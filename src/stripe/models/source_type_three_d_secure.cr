...
module Stripe
  ...
  class SourceTypeThreeDSecure
    ...
    def_hash(@address_line1_check, @address_zip_check, @authenticated, @brand, @card, @country, @customer, @cvc_check, @description, @dynamic_last4, @exp_month, @exp_year, @fingerprint, @funding, @iin, @issuer, @last4, @name, @three_d_secure, @tokenization_method)
  end
end
