...
module Stripe
  class ForwardingRequestList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::ForwardingRequest)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::ForwardingRequest)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::ForwardingRequest)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(new_value : Array(Stripe::ForwardingRequest)?)
