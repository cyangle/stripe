...
module Stripe
  ...
  class IssuingCardholderSpendingControls
    include JSON::Serializable
    include JSON::Serializable::Unmapped

    # Required properties
    # Array of strings containing [categories](https://stripe.com/docs/api#issuing_authorization_object-merchant_data-category) of authorizations to allow. All other categories will be blocked. Cannot be set with `blocked_categories`.
    @[JSON::Field(key: "allowed_categories", type: Array(String), presence: true, ignore_serialize: allowed_categories.nil? && !allowed_categories_present?)]
    ...
    @[JSON::Field(key: "blocked_categories", type: Array(String), presence: true, ignore_serialize: blocked_categories.nil? && !blocked_categories_present?)]
    ...
    @[JSON::Field(key: "spending_limits", type: Array(IssuingCardholderSpendingLimit), presence: true, ignore_serialize: spending_limits.nil? && !spending_limits_present?)]
    property spending_limits : Array(IssuingCardholderSpendingLimit)

    @[JSON::Field(ignore: true)]
    property? spending_limits_present : Bool = false

    # Currency of the amounts within `spending_limits`.
    @[JSON::Field(key: "spending_limits_currency", type: String, presence: true, ignore_serialize: spending_limits_currency.nil? && !spending_limits_currency_present?)]
    ...
    def initialize(*, @allowed_categories : Array(String)?, @blocked_categories : Array(String)?, @spending_limits : Array(IssuingCardholderSpendingLimit)?, @spending_limits_currency : String?)
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
        allowed_categories == o.allowed_categories &&
        blocked_categories == o.blocked_categories &&
        spending_limits == o.spending_limits &&
        spending_limits_currency == o.spending_limits_currency
    end
    ...
    def_hash(@allowed_categories, @blocked_categories, @spending_limits, @spending_limits_currency)
  end
end
