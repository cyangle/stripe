...
module Stripe
  class SourceTypeSofort
    ...
    def initialize(*, @bank_code : String? | Null = nil, @bank_name : String? | Null = nil, @bic : String? | Null = nil, @country : String? | Null = nil, @iban_last4 : String? | Null = nil, @preferred_language : String? | Null = nil, @statement_descriptor : String? | Null = nil)
    end
    ...
    def hash
      [bank_code, bank_name, bic, country, iban_last4, preferred_language, statement_descriptor].hash
    end
