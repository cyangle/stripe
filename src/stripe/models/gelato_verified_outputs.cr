...
module Stripe
  class GelatoVerifiedOutputs
    ...
    @[NASON::Field(key: "dob", type: GelatoDataVerifiedOutputsDate? | Null, nillable: true)]
    property dob : GelatoDataVerifiedOutputsDate? | Null
    ...
    def initialize(*, @address : Address? | Null = nil, @dob : GelatoDataVerifiedOutputsDate? | Null = nil, @first_name : String? | Null = nil, @id_number : String? | Null = nil, @id_number_type : String? | Null = nil, @last_name : String? | Null = nil)
    end
    ...
    def hash
      [address, dob, first_name, id_number, id_number_type, last_name].hash
    end
