...
module Stripe
  ...
  class Person
    ...
    @[JSON::Field(key: "additional_tos_acceptances", type: Stripe::PersonAdditionalTosAcceptances?, default: nil, required: false, nullable: false, emit_null: false)]
    getter additional_tos_acceptances : Stripe::PersonAdditionalTosAcceptances? = nil
    ...
    def additional_tos_acceptances=(new_value : Stripe::PersonAdditionalTosAcceptances?)
      unless new_value.nil?
