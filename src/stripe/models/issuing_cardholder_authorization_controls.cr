  ...
  class IssuingCardholderAuthorizationControls
    ...
    def initialize(
      *,
      ...
      @spending_limits : Array(Stripe::IssuingCardholderSpendingLimit)? = nil,
    ...
    def list_invalid_properties : Array(String)
      ...
      if _allowed_categories = @allowed_categories
        invalid_properties.push(OpenApi::EnumValidator.error_message("allowed_categories", VALID_VALUES_FOR_ALLOWED_CATEGORIES)) unless OpenApi::EnumValidator.valid?(_allowed_categories, VALID_VALUES_FOR_ALLOWED_CATEGORIES)
      end
      if _blocked_categories = @blocked_categories
        invalid_properties.push(OpenApi::EnumValidator.error_message("blocked_categories", VALID_VALUES_FOR_BLOCKED_CATEGORIES)) unless OpenApi::EnumValidator.valid?(_blocked_categories, VALID_VALUES_FOR_BLOCKED_CATEGORIES)
      end
      if _spending_limits = @spending_limits
        invalid_properties.concat(OpenApi::ArrayValidator.list_invalid_properties_for(key: "spending_limits", array: _spending_limits)) if _spending_limits.is_a?(Array)
      end
    ...
    def valid? : Bool
      ...
      if _spending_limits = @spending_limits
        return false if _spending_limits.is_a?(Array) && !OpenApi::ArrayValidator.valid?(array: _spending_limits)
      end
    ...
    def spending_limits=(spending_limits : Array(Stripe::IssuingCardholderSpendingLimit)?)
      if spending_limits.nil?
        return @spending_limits = nil
      end
      _spending_limits = spending_limits.not_nil!
      OpenApi::ArrayValidator.validate(array: _spending_limits) if _spending_limits.is_a?(Array)
