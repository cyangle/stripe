...
module Stripe
  class RadarReviewResourceLocation
    ...
    def initialize(*, @city : String? | Null = nil, @country : String? | Null = nil, @latitude : Float64? | Null = nil, @longitude : Float64? | Null = nil, @region : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@region.nil? && !@region.null? && @region.to_s.size > 5000
    ...
    def valid?
      ...
      return false if !@region.nil? && !@region.null? && @region.to_s.size > 5000
      true
    end
    ...
    def hash
      [city, country, latitude, longitude, region].hash
    end
