...
module Stripe
  class TaxIdVerification
    ...
    # Optional properties
    # Verified address.
    @[NASON::Field(key: "verified_address", type: String? | Null, nillable: true)]
    property verified_address : String? | Null
    ...
    def initialize(*, @status : String, @verified_address : String? | Null = nil, @verified_name : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@verified_address.nil? && !@verified_address.null? && @verified_address.to_s.size > 5000
    ...
    def valid?
      status_validator = EnumAttributeValidator.new("String", ["pending", "unavailable", "unverified", "verified"])
      return false unless status_validator.valid?(@status)
      return false if !@verified_address.nil? && !@verified_address.null? && @verified_address.to_s.size > 5000
    ...
    def status=(status)
      validator = EnumAttributeValidator.new("String", ["pending", "unavailable", "unverified", "verified"])
    ...
    def hash
      [status, verified_address, verified_name].hash
    end
