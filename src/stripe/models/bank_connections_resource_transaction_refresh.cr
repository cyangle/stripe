...
module Stripe
  ...
  class BankConnectionsResourceTransactionRefresh
    ...
    @[JSON::Field(key: "next_refresh_available_at", type: Int64?, default: nil, required: true, nullable: true, emit_null: true)]
    getter next_refresh_available_at : Int64? = nil
    ...
    def initialize(
      *,
      ...
      @next_refresh_available_at : Int64? = nil,
      @status : String? = nil
    )
    end
    ...
    def last_attempted_at=(new_value : Int64?)
      raise ArgumentError.new("\"last_attempted_at\" is required and cannot be null") if new_value.nil?

      @last_attempted_at = new_value
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] next_refresh_available_at Object to be assigned
    def next_refresh_available_at=(new_value : Int64?)
      @next_refresh_available_at = new_value
    end
    ...
    def_equals_and_hash(@id, @last_attempted_at, @next_refresh_available_at, @status)
  end
end
