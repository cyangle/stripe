...
module Stripe
  class IssuingPersonalizationDesignList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::IssuingPersonalizationDesign)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::IssuingPersonalizationDesign)? = nil
    ...
    PATTERN_FOR_URL    = /^\/v1\/issuing\/personalization_designs/
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::IssuingPersonalizationDesign)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(new_value : Array(Stripe::IssuingPersonalizationDesign)?)
