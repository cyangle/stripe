...
module Stripe
  ...
  class PaymentMethodOptionsParam21SepaDebit
    ...
    def self.openapi_any_of
      [
        Stripe::PaymentIntentPaymentMethodOptionsParam7,
        String,
      ]
    end
    ...
    def initialize(*, @mandate_options : JSON::Any = nil, @setup_future_usage : String? = nil)
    end
    ...
    def_hash(@mandate_options, @setup_future_usage)
  end
end
