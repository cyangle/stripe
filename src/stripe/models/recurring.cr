...
module Stripe
  class Recurring
    ...
    def initialize(*, @interval : String, @interval_count : Int64, @usage_type : String, @aggregate_usage : String? | Null = nil)
    end
    ...
    def hash
      [aggregate_usage, interval, interval_count, usage_type].hash
    end
