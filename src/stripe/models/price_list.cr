...
module Stripe
  class PriceList
    ...
    @[NASON::Field(key: "data", type: Array(Price))]
    property data : Array(Price)
    ...
    def initialize(*, @data : Array(Price), @has_more : Bool, @object : String, @url : String)
    end
