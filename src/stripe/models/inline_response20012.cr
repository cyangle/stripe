...
module Stripe
  class InlineResponse20012
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(::File))]
    property data : Array(::File)
    ...
    def initialize(*, @data : Array(::File), @has_more : Bool, @object : String, @url : String)
    end
