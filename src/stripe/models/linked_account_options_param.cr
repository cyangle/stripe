...
require "./linked_account_options_filters_param"
...
module Stripe
  class LinkedAccountOptionsParam
    ...
    @[JSON::Field(key: "filters", type: Stripe::LinkedAccountOptionsFiltersParam?, default: nil, required: false, nullable: false, emit_null: false)]
    getter filters : Stripe::LinkedAccountOptionsFiltersParam? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @filters : Stripe::LinkedAccountOptionsFiltersParam? = nil,
    ...
    def filters=(new_value : Stripe::LinkedAccountOptionsFiltersParam?)
    ...
    def_equals_and_hash(@filters, @permissions, @prefetch, @return_url)
  end
end
