...
module Stripe
  ...
  class PromotionCodesResourceRestrictions
    ...
    getter minimum_amount_currency : String?
    ...
    def_equals_and_hash(@first_time_transaction, @minimum_amount, @minimum_amount_present, @minimum_amount_currency, @minimum_amount_currency_present)
  end
end
