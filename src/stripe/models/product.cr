...
module Stripe
  ...
  class Product
    ...
    getter marketing_features : Array(Stripe::ProductMarketingFeature)? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"marketing_features\" is required and cannot be null") if @marketing_features.nil?
    ...
    def valid? : Bool
      ...
      return false if @marketing_features.nil?
      unless (_marketing_features = @marketing_features).nil?
    ...
    def marketing_features=(new_value : Array(Stripe::ProductMarketingFeature)?)
      raise ArgumentError.new("\"marketing_features\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
    ...
    def_equals_and_hash(@active, @created, @description, @id, @images, @livemode, @marketing_features, @metadata, @name, @object, @package_dimensions, @shippable, @tax_code, @_type, @updated, @url, @default_price, @default_price_present, @statement_descriptor, @statement_descriptor_present, @unit_label, @unit_label_present)
  end
end
