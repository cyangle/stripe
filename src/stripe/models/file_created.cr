...
module Stripe
  ...
  class FileCreated
    ...
    @[JSON::Field(key: "object", type: Stripe::File?, default: nil, required: true, nullable: false, emit_null: false)]
    getter object : Stripe::File? = nil
    ...
    def object=(new_value : Stripe::File?)
