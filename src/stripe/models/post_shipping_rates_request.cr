...
module Stripe
  ...
  class PostShippingRatesRequest
    ...
    def_equals_and_hash(@display_name, @delivery_estimate, @delivery_estimate_present, @expand, @expand_present, @fixed_amount, @fixed_amount_present, @metadata, @metadata_present, @tax_behavior, @tax_behavior_present, @tax_code, @tax_code_present, @_type, @_type_present)
  end
end
