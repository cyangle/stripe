...
module Stripe
  class PostFinancialConnectionsAccountsAccountRefreshRequest
    ...
    ERROR_MESSAGE_FOR_FEATURES = "invalid value for \"features\", must be one of [balance, ownership, transactions]."
    VALID_VALUES_FOR_FEATURES  = String.static_array("balance", "ownership", "transactions")
