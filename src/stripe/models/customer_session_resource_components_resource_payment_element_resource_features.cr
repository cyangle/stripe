...
module Stripe
  ...
  class CustomerSessionResourceComponentsResourcePaymentElementResourceFeatures
    ...
    @[JSON::Field(key: "payment_method_allow_redisplay_filters", type: Array(String)?, default: nil, required: true, nullable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "payment_method_redisplay", type: String?, default: nil, required: true, nullable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "payment_method_redisplay_limit", type: Int64?, default: nil, required: true, nullable: true, emit_null: true)]
    ...
    @[JSON::Field(key: "payment_method_remove", type: String?, default: nil, required: true, nullable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "payment_method_save", type: String?, default: nil, required: true, nullable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "payment_method_save_usage", type: String?, default: nil, required: true, nullable: true, emit_null: true)]
    ...
    def list_invalid_properties : Array(String)
      ...
      invalid_properties.push("\"payment_method_allow_redisplay_filters\" is required and cannot be null") if @payment_method_allow_redisplay_filters.nil?
      ...
      invalid_properties.push("\"payment_method_redisplay\" is required and cannot be null") if @payment_method_redisplay.nil?
      ...
      invalid_properties.push("\"payment_method_remove\" is required and cannot be null") if @payment_method_remove.nil?
      ...
      invalid_properties.push("\"payment_method_save\" is required and cannot be null") if @payment_method_save.nil?
    ...
    def valid? : Bool
      return false if @payment_method_allow_redisplay_filters.nil?
      unless (_payment_method_allow_redisplay_filters = @payment_method_allow_redisplay_filters).nil?
    ...
    def payment_method_allow_redisplay_filters=(new_value : Array(String)?)
      raise ArgumentError.new("\"payment_method_allow_redisplay_filters\" is required and cannot be null") if new_value.nil?
    ...
    def payment_method_redisplay=(new_value : String?)
      raise ArgumentError.new("\"payment_method_redisplay\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
    ...
    def payment_method_remove=(new_value : String?)
      raise ArgumentError.new("\"payment_method_remove\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
    ...
    def payment_method_save=(new_value : String?)
      raise ArgumentError.new("\"payment_method_save\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
