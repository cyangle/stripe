...
module Stripe
  ...
  class GetDisputes200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::Dispute)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::Dispute)? = nil
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::Dispute
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/disputes/
      end
    ...
    def data=(data : Array(Stripe::Dispute)?)
      if data.nil?
