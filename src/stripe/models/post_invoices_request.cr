...
module Stripe
  class PostInvoicesRequest
    ...
    @[JSON::Field(key: "shipping_cost", type: Stripe::ShippingCost?, default: nil, required: false, nullable: false, emit_null: false)]
    getter shipping_cost : Stripe::ShippingCost? = nil

    @[JSON::Field(key: "shipping_details", type: Stripe::RecipientShippingWithOptionalFieldsAddress?, default: nil, required: false, nullable: false, emit_null: false)]
    getter shipping_details : Stripe::RecipientShippingWithOptionalFieldsAddress? = nil
    ...
    def custom_fields=(new_value : Stripe::PostInvoicesRequestCustomFields?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def discounts=(new_value : Stripe::PostInvoicesRequestDiscounts?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def from_invoice=(new_value : Stripe::FromInvoice?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def pending_invoice_items_behavior=(new_value : String?)
      unless new_value.nil?
        OpenApi::EnumValidator.validate("pending_invoice_items_behavior", new_value, VALID_VALUES_FOR_PENDING_INVOICE_ITEMS_BEHAVIOR)
      end

      @pending_invoice_items_behavior = new_value
    end
    ...
    def shipping_cost=(new_value : Stripe::ShippingCost?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def shipping_details=(new_value : Stripe::RecipientShippingWithOptionalFieldsAddress?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
