...
module Stripe
  class PaymentFlowsPaymentMethodList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::PaymentMethod)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::PaymentMethod)? = nil
    ...
    PATTERN_FOR_URL    = /^\/v1\/payment_methods/
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::PaymentMethod)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(data : Array(Stripe::PaymentMethod)?)
      if data.nil?
