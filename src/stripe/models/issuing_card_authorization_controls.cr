...
module Stripe
  ...
  class IssuingCardAuthorizationControls
    ...
    @[JSON::Field(key: "spending_limits", type: Array(Stripe::IssuingCardSpendingLimit)?, default: nil, required: false, nullable: true, emit_null: true, presence: true, ignore_serialize: spending_limits.nil? && !spending_limits_present?)]
    getter spending_limits : Array(Stripe::IssuingCardSpendingLimit)? = nil
    ...
    def initialize(
      *,
      ...
      @spending_limits : Array(Stripe::IssuingCardSpendingLimit)? = nil,
