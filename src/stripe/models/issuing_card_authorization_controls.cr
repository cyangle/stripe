...
module Stripe
  ...
  class IssuingCardAuthorizationControls
    ...
    @[JSON::Field(key: "spending_limits", type: Array(IssuingCardSpendingLimit)?, presence: true, ignore_serialize: spending_limits.nil? && !spending_limits_present?)]
    property spending_limits : Array(IssuingCardSpendingLimit)?
    ...
    def initialize(*, @allowed_categories : Array(String)?, @blocked_categories : Array(String)?, @spending_limits : Array(IssuingCardSpendingLimit)?, @spending_limits_currency : String?)
    end
