...
module Stripe
  class PaymentMethodDetailsCardWallet
    ...
    @[NASON::Field(key: "masterpass", type: PaymentMethodDetailsCardWalletMasterpass?, nillable: true)]
    ...
    @[NASON::Field(key: "visa_checkout", type: PaymentMethodDetailsCardWalletVisaCheckout?, nillable: true)]
    ...
    def initialize(*, @_type : String, @amex_express_checkout : NASON::Any? = nil, @apple_pay : NASON::Any? = nil, @dynamic_last4 : String? | Null = nil, @google_pay : NASON::Any? = nil, @masterpass : PaymentMethodDetailsCardWalletMasterpass? = nil, @samsung_pay : NASON::Any? = nil, @visa_checkout : PaymentMethodDetailsCardWalletVisaCheckout? = nil)
    end
