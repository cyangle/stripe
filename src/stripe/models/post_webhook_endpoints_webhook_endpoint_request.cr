...
module Stripe
  ...
  class PostWebhookEndpointsWebhookEndpointRequest
    ...
    def initialize(*, @description : String? = nil, @disabled : Bool? = nil, @enabled_events : Array(String)? = nil, @expand : Array(String)? = nil, @metadata : IndividualSpecsMetadata? = nil, @url : String? = nil)
    end
    ...
    def_hash(@description, @disabled, @enabled_events, @expand, @metadata, @url)
  end
end
