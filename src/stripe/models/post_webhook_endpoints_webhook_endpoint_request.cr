...
module Stripe
  ...
  class PostWebhookEndpointsWebhookEndpointRequest
    ...
    def_equals_and_hash(@description, @description_present, @disabled, @disabled_present, @enabled_events, @enabled_events_present, @expand, @expand_present, @metadata, @metadata_present, @url, @url_present)
  end
end
