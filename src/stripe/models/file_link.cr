...
module Stripe
  ...
  class FileLink
    ...
    @[NASON::Field(key: "expired", type: Bool)]
    property expired : Bool

    # The file object this link points to.
    @[NASON::Field(key: "file", type: String | File | Null, nillable: false)]
    property file : String | File | Null
    ...
    def initialize(*, @created : Int64, @expired : Bool, @file : String | File | Null, @id : String, @livemode : Bool, @metadata : Hash(String, String), @object : String, @expires_at : Int64? | Null = nil, @url : String? | Null = nil)
    end
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new("String", ["file_link"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["file_link"])
    ...
    def hash
      [created, expired, expires_at, file, id, livemode, metadata, object, url].hash
    end
