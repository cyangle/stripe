...
module Stripe
  ...
  class PostPaymentIntentsRequest
    ...
    def_equals_and_hash(@amount, @currency, @application_fee_amount, @application_fee_amount_present, @automatic_payment_methods, @automatic_payment_methods_present, @capture_method, @capture_method_present, @confirm, @confirm_present, @confirmation_method, @confirmation_method_present, @customer, @customer_present, @description, @description_present, @error_on_requires_action, @error_on_requires_action_present, @expand, @expand_present, @mandate, @mandate_present, @mandate_data, @mandate_data_present, @metadata, @metadata_present, @off_session, @off_session_present, @on_behalf_of, @on_behalf_of_present, @payment_method, @payment_method_present, @payment_method_data, @payment_method_data_present, @payment_method_options, @payment_method_options_present, @payment_method_types, @payment_method_types_present, @radar_options, @radar_options_present, @receipt_email, @receipt_email_present, @return_url, @return_url_present, @setup_future_usage, @setup_future_usage_present, @shipping, @shipping_present, @statement_descriptor, @statement_descriptor_present, @statement_descriptor_suffix, @statement_descriptor_suffix_present, @transfer_data, @transfer_data_present, @transfer_group, @transfer_group_present, @use_stripe_sdk, @use_stripe_sdk_present)
  end
end
