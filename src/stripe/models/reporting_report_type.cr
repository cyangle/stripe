...
module Stripe
  ...
  class ReportingReportType
    ...
    @[NASON::Field(key: "data_available_end", type: Int64)]
    property data_available_end : Int64

    # Earliest time for which this Report Type is available. Measured in seconds since the Unix epoch.
    @[NASON::Field(key: "data_available_start", type: Int64)]
    ...
    @[NASON::Field(key: "version", type: Int64)]
    property version : Int64

    # Optional properties
    # List of column names that are included by default when this Report Type gets run. (If the Report Type doesn't support the `columns` parameter, this will be null.)
    @[NASON::Field(key: "default_columns", type: Array(String)? | Null, nillable: true)]
    property default_columns : Array(String)? | Null
    ...
    def initialize(*, @data_available_end : Int64, @data_available_start : Int64, @id : String, @livemode : Bool, @name : String, @object : String, @updated : Int64, @version : Int64, @default_columns : Array(String)? | Null = nil)
    end
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new("String", ["reporting.report_type"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["reporting.report_type"])
    ...
    def hash
      [data_available_end, data_available_start, default_columns, id, livemode, name, object, updated, version].hash
    end
