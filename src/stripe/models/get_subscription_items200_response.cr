...
module Stripe
  #
  class GetSubscriptionItems200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::SubscriptionItem)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::SubscriptionItem)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::SubscriptionItem)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::SubscriptionItem
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/subscription_items/
      end
    ...
    def data=(data : Array(Stripe::SubscriptionItem)?)
      if data.nil?
