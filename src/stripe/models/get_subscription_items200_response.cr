...
module Stripe
  ...
  class GetSubscriptionItems200Response
    ...
    # Required properties
    @[JSON::Field(key: "data", type: Array(SubscriptionItem))]
    property data : Array(SubscriptionItem)
    ...
    def initialize(*, @data : Array(SubscriptionItem), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/subscription_items/
      true
    end
