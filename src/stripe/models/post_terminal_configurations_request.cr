...
module Stripe
  class PostTerminalConfigurationsRequest
    ...
    @[JSON::Field(key: "reboot_window", type: Stripe::RebootWindow?, default: nil, required: false, nullable: false, emit_null: false)]
    getter reboot_window : Stripe::RebootWindow? = nil

    @[JSON::Field(key: "stripe_s700", type: Stripe::StripeS700?, default: nil, required: false, nullable: false, emit_null: false)]
    getter stripe_s700 : Stripe::StripeS700? = nil
    ...
    def reboot_window=(new_value : Stripe::RebootWindow?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def stripe_s700=(new_value : Stripe::StripeS700?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
