...
module Stripe
  class PaymentMethodDetailsCard
    ...
    @[NASON::Field(key: "checks", type: PaymentMethodDetailsCardChecks? | Null, nillable: true)]
    property checks : PaymentMethodDetailsCardChecks? | Null
    ...
    @[NASON::Field(key: "installments", type: PaymentMethodDetailsCardInstallments? | Null, nillable: true)]
    property installments : PaymentMethodDetailsCardInstallments? | Null
    ...
    @[NASON::Field(key: "three_d_secure", type: ThreeDSecureDetails? | Null, nillable: true)]
    property three_d_secure : ThreeDSecureDetails? | Null

    # If this Card is part of a card wallet, this contains the details of the card wallet.
    @[NASON::Field(key: "wallet", type: PaymentMethodDetailsCardWallet? | Null, nillable: true)]
    property wallet : PaymentMethodDetailsCardWallet? | Null

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @exp_month : Int64, @exp_year : Int64, @brand : String? | Null = nil, @checks : PaymentMethodDetailsCardChecks? | Null = nil, @country : String? | Null = nil, @fingerprint : String? | Null = nil, @funding : String? | Null = nil, @installments : PaymentMethodDetailsCardInstallments? | Null = nil, @last4 : String? | Null = nil, @network : String? | Null = nil, @three_d_secure : ThreeDSecureDetails? | Null = nil, @wallet : PaymentMethodDetailsCardWallet? | Null = nil)
    end
    ...
    def hash
      [brand, checks, country, exp_month, exp_year, fingerprint, funding, installments, last4, network, three_d_secure, wallet].hash
    end
