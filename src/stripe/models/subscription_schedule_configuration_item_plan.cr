...
module Stripe
  ...
  class SubscriptionScheduleConfigurationItemPlan
    ...
    def_hash(@active, @aggregate_usage, @amount, @amount_decimal, @billing_scheme, @created, @currency, @id, @interval, @interval_count, @livemode, @metadata, @nickname, @object, @product, @tiers, @tiers_mode, @transform_usage, @trial_period_days, @usage_type, @deleted)
  end
end
