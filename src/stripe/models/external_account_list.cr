...
module Stripe
  class ExternalAccountList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::ExternalAccount)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::ExternalAccount)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::ExternalAccount)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(new_value : Array(Stripe::ExternalAccount)?)
