...
module Stripe
  ...
  class ConnectAccountReference
    ...
    @[JSON::Field(key: "account", type: Stripe::ConnectAccountReferenceAccount?, default: nil, required: false, nullable: false, emit_null: false)]
    getter account : Stripe::ConnectAccountReferenceAccount? = nil
    ...
    def initialize(
      *,
      ...
      @_type : String? = nil,
      # Optional properties
      @account : Stripe::ConnectAccountReferenceAccount? = nil
    )
    end
    ...
    def account=(new_value : Stripe::ConnectAccountReferenceAccount?)
      unless new_value.nil?
    ...
    def_equals_and_hash(@_type, @account)
  end
end
