...
module Stripe
  ...
  class Transfer
    ...
    def_equals_and_hash(@amount, @amount_reversed, @created, @currency, @id, @livemode, @metadata, @object, @reversals, @reversed, @balance_transaction, @balance_transaction_present, @description, @description_present, @destination, @destination_present, @destination_payment, @destination_payment_present, @source_transaction, @source_transaction_present, @source_type, @source_type_present, @transfer_group, @transfer_group_present)
  end
end
