...
module Stripe
  ...
  class MandateUpdated
    ...
    @[JSON::Field(key: "object", type: Stripe::Mandate?, default: nil, required: true, nullable: false, emit_null: false)]
    getter object : Stripe::Mandate? = nil
    ...
    def object=(new_value : Stripe::Mandate?)
