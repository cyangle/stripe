...
module Stripe
  class PortalFeatures
    ...
    # Required properties
    @[NASON::Field(key: "customer_update", type: PortalCustomerUpdate)]
    property customer_update : PortalCustomerUpdate

    @[NASON::Field(key: "invoice_history", type: PortalInvoiceList)]
    property invoice_history : PortalInvoiceList

    @[NASON::Field(key: "payment_method_update", type: PortalPaymentMethodUpdate)]
    property payment_method_update : PortalPaymentMethodUpdate

    @[NASON::Field(key: "subscription_cancel", type: PortalSubscriptionCancel)]
    property subscription_cancel : PortalSubscriptionCancel

    @[NASON::Field(key: "subscription_pause", type: PortalSubscriptionPause)]
    property subscription_pause : PortalSubscriptionPause

    @[NASON::Field(key: "subscription_update", type: PortalSubscriptionUpdate)]
    ...
    def hash
      [customer_update, invoice_history, payment_method_update, subscription_cancel, subscription_pause, subscription_update].hash
    end
