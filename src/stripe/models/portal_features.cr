...
require "./portal_customer_update"
require "./portal_invoice_list"
require "./portal_payment_method_update"
require "./portal_subscription_cancel"
require "./portal_subscription_update"
