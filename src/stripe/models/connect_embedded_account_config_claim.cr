...
require "./connect_embedded_account_features_claim"
...
module Stripe
  ...
  class ConnectEmbeddedAccountConfigClaim
    ...
    @[JSON::Field(key: "features", type: Stripe::ConnectEmbeddedAccountFeaturesClaim?, default: nil, required: true, nullable: false, emit_null: false)]
    getter features : Stripe::ConnectEmbeddedAccountFeaturesClaim? = nil
    ...
    def initialize(
      *,
      # Required properties
      @enabled : Bool? = nil,
      @features : Stripe::ConnectEmbeddedAccountFeaturesClaim? = nil
    )
    end
    ...
    def features=(new_value : Stripe::ConnectEmbeddedAccountFeaturesClaim?)
