...
module Stripe
  ...
  class ApplicationFeeRefunded
    ...
    @[JSON::Field(key: "object", type: Stripe::ApplicationFee?, default: nil, required: true, nullable: false, emit_null: false)]
    getter object : Stripe::ApplicationFee? = nil
    ...
    def initialize(
      *,
      # Required properties
      @object : Stripe::ApplicationFee? = nil
    )
    end
    ...
    def object=(new_value : Stripe::ApplicationFee?)
