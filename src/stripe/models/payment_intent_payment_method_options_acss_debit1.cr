...
module Stripe
  ...
  class PaymentIntentPaymentMethodOptionsAcssDebit1
    ...
    @[JSON::Field(key: "mandate_options", type: PaymentIntentPaymentMethodOptionsMandateOptionsAcssDebit?, presence: true, ignore_serialize: mandate_options.nil? && !mandate_options_present?)]
    ...
    def initialize(
      *,
      # Optional properties
      @mandate_options : PaymentIntentPaymentMethodOptionsMandateOptionsAcssDebit? = nil,
    ...
    def_equals_and_hash(@mandate_options, @setup_future_usage, @verification_method, @capture_method)
  end
end
