...
module Stripe
  class EntitlementsResourceProductFeatureList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::ProductFeature)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::ProductFeature)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::ProductFeature)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(new_value : Array(Stripe::ProductFeature)?)
