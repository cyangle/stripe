...
module Stripe
  ...
  class CreditNoteLinesList1
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::CreditNoteLineItem)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::CreditNoteLineItem)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::CreditNoteLineItem)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::CreditNoteLineItem
    ...
    def data=(data : Array(Stripe::CreditNoteLineItem)?)
      if data.nil?
