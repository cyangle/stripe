...
require "./post_terminal_configurations_configuration_request_bbpos_wisepos_e"
require "./post_terminal_configurations_configuration_request_reboot_window"
require "./post_terminal_configurations_configuration_request_stripe_s700"
require "./post_terminal_configurations_configuration_request_verifone_p400"
require "./post_terminal_configurations_request_offline"
require "./post_terminal_configurations_request_tipping"
...
module Stripe
  class PostTerminalConfigurationsConfigurationRequest
    ...
    @[JSON::Field(key: "offline", type: Stripe::PostTerminalConfigurationsRequestOffline?, default: nil, required: false, nullable: false, emit_null: false)]
    getter offline : Stripe::PostTerminalConfigurationsRequestOffline? = nil

    @[JSON::Field(key: "reboot_window", type: Stripe::PostTerminalConfigurationsConfigurationRequestRebootWindow?, default: nil, required: false, nullable: false, emit_null: false)]
    getter reboot_window : Stripe::PostTerminalConfigurationsConfigurationRequestRebootWindow? = nil

    @[JSON::Field(key: "stripe_s700", type: Stripe::PostTerminalConfigurationsConfigurationRequestStripeS700?, default: nil, required: false, nullable: false, emit_null: false)]
    getter stripe_s700 : Stripe::PostTerminalConfigurationsConfigurationRequestStripeS700? = nil
    ...
    def bbpos_wisepos_e=(new_value : Stripe::PostTerminalConfigurationsConfigurationRequestBbposWiseposE?)
    ...
    def offline=(new_value : Stripe::PostTerminalConfigurationsRequestOffline?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def reboot_window=(new_value : Stripe::PostTerminalConfigurationsConfigurationRequestRebootWindow?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def stripe_s700=(new_value : Stripe::PostTerminalConfigurationsConfigurationRequestStripeS700?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def verifone_p400=(new_value : Stripe::PostTerminalConfigurationsConfigurationRequestVerifoneP400?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def_equals_and_hash(@bbpos_wisepos_e, @expand, @name, @offline, @reboot_window, @stripe_s700, @tipping, @verifone_p400)
  end
end
