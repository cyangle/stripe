...
module Stripe
  ...
  class PostTerminalConfigurationsConfigurationRequest
    ...
    def initialize(*, @bbpos_wisepos_e : PostTerminalConfigurationsConfigurationRequestBbposWiseposE? = nil, @expand : Array(String)? = nil, @tipping : PostTerminalConfigurationsRequestTipping? = nil, @verifone_p400 : PostTerminalConfigurationsConfigurationRequestVerifoneP400? = nil)
    end
