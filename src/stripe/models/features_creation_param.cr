...
module Stripe
  ...
  class FeaturesCreationParam
    ...
    property customer_update : CustomerUpdateCreationParam?
    ...
    @[JSON::Field(key: "subscription_cancel", type: SubscriptionCancelCreationParam?, presence: true, ignore_serialize: subscription_cancel.nil? && !subscription_cancel_present?)]
    property subscription_cancel : SubscriptionCancelCreationParam?
    ...
    @[JSON::Field(key: "subscription_update", type: SubscriptionUpdateCreationParam?, presence: true, ignore_serialize: subscription_update.nil? && !subscription_update_present?)]
    property subscription_update : SubscriptionUpdateCreationParam?
