...
module Stripe
  class PaymentMethodDetailsSepaDebit
    ...
    @[NASON::Field(key: "branch_code", type: String? | Null, nillable: true)]
    property branch_code : String? | Null
    ...
    @[NASON::Field(key: "mandate", type: String? | Null, nillable: true)]
    property mandate : String? | Null

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @bank_code : String? | Null = nil, @branch_code : String? | Null = nil, @country : String? | Null = nil, @fingerprint : String? | Null = nil, @last4 : String? | Null = nil, @mandate : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@branch_code.nil? && !@branch_code.null? && @branch_code.to_s.size > 5000
      ...
      if !@mandate.nil? && !@mandate.null? && @mandate.to_s.size > 5000
    ...
    def valid?
      ...
      return false if !@branch_code.nil? && !@branch_code.null? && @branch_code.to_s.size > 5000
      ...
      return false if !@mandate.nil? && !@mandate.null? && @mandate.to_s.size > 5000
      true
    end
    ...
    def hash
      [bank_code, branch_code, country, fingerprint, last4, mandate].hash
    end
