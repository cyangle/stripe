...
module Stripe
  ...
  class QuotesResourceTransferData
    ...
    @[JSON::Field(key: "amount_percent", type: Float64?, default: nil, required: true, nullable: true, emit_null: true)]
    ...
    def_equals_and_hash(@amount, @amount_percent, @destination)
  end
end
