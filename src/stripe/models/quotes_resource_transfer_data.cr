...
module Stripe
  class QuotesResourceTransferData
    ...
    @[NASON::Field(key: "amount_percent", type: Float64? | Null, nillable: true)]
    property amount_percent : Float64? | Null

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @destination : String | Account | Null, @amount : Int64? | Null = nil, @amount_percent : Float64? | Null = nil)
    end
    ...
    def hash
      [amount, amount_percent, destination].hash
    end
