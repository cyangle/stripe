...
module Stripe
  ...
  class ApmsSourcesSourceList
    ...
    @[JSON::Field(key: "data", type: Array(PaymentSource))]
    property data : Array(PaymentSource)
    ...
    def initialize(*, @data : Array(PaymentSource), @has_more : Bool, @object : String, @url : String)
    end
