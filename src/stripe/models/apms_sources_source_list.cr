...
module Stripe
  class ApmsSourcesSourceList
    ...
    @[NASON::Field(key: "data", type: Array(AlipayAccount | BankAccount | BitcoinReceiver | Card | Source))]
    property data : Array(AlipayAccount | BankAccount | BitcoinReceiver | Card | Source)
    ...
    def initialize(*, @data : Array(AlipayAccount | BankAccount | BitcoinReceiver | Card | Source), @has_more : Bool, @object : String, @url : String)
    end
