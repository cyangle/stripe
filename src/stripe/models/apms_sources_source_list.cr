...
module Stripe
  class ApmsSourcesSourceList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::PaymentSource)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::PaymentSource)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::PaymentSource)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(new_value : Array(Stripe::PaymentSource)?)
