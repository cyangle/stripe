...
require "./evidence_param_canceled"
require "./evidence_param_duplicate"
require "./evidence_param_fraudulent"
require "./evidence_param_merchandise_not_as_described"
require "./evidence_param_no_valid_authorization"
require "./evidence_param_not_received"
require "./evidence_param_other"
require "./evidence_param_service_not_as_described"
...
module Stripe
  class EvidenceParam
    ...
    @[JSON::Field(key: "no_valid_authorization", type: Stripe::EvidenceParamNoValidAuthorization?, default: nil, required: false, nullable: false, emit_null: false)]
    getter no_valid_authorization : Stripe::EvidenceParamNoValidAuthorization? = nil
    ...
    def no_valid_authorization=(new_value : Stripe::EvidenceParamNoValidAuthorization?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def_equals_and_hash(@canceled, @duplicate, @fraudulent, @merchandise_not_as_described, @no_valid_authorization, @not_received, @other, @reason, @service_not_as_described)
  end
end
