...
module Stripe
  ...
  class TaxIDsList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::TaxId)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::TaxId)? = nil
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::TaxId
    ...
    def data=(data : Array(Stripe::TaxId)?)
      if data.nil?
