...
module Stripe
  ...
  class PaymentIntentPaymentMethodOptionsCustomerBalance
    ...
    @[JSON::Field(key: "bank_transfer", type: PaymentMethodOptionsCustomerBalanceBankTransfer?, presence: true, ignore_serialize: bank_transfer.nil? && !bank_transfer_present?)]
    property bank_transfer : PaymentMethodOptionsCustomerBalanceBankTransfer?
    ...
    def self.openapi_any_of
      [
        ...
        Stripe::PaymentMethodOptionsCustomerBalance,
      ]
    end
    ...
    def initialize(
      *,
      # Optional properties
      @bank_transfer : PaymentMethodOptionsCustomerBalanceBankTransfer? = nil,
    ...
    def_equals_and_hash(@bank_transfer, @funding_type, @setup_future_usage, @capture_method, @verification_method)
  end
end
