...
module Stripe
  class CreditNoteLineItemParams
    ...
    def initialize(*, @_type : String, @amount : Int64? = nil, @description : String? = nil, @invoice_line_item : String? = nil, @quantity : Int64? = nil, @tax_rates : Array(String)? | Null = nil, @unit_amount : Int64? = nil, @unit_amount_decimal : String? = nil)
    end
    ...
    def hash
      [amount, description, invoice_line_item, quantity, tax_rates, _type, unit_amount, unit_amount_decimal].hash
    end
