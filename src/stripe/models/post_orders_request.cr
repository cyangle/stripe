...
module Stripe
  ...
  class PostOrdersRequest
    ...
    def_equals_and_hash(@currency, @line_items, @automatic_tax, @automatic_tax_present, @billing_details, @billing_details_present, @customer, @customer_present, @description, @description_present, @discounts, @discounts_present, @expand, @expand_present, @ip_address, @ip_address_present, @metadata, @metadata_present, @payment, @payment_present, @shipping_cost, @shipping_cost_present, @shipping_details, @shipping_details_present, @tax_details, @tax_details_present)
  end
end
