...
module Stripe
  ...
  class TaxId
    ...
    def initialize(*, @country : String?, @created : Int64, @customer : TaxIdCustomer?, @id : String, @livemode : Bool, @object : String, @_type : String, @value : String, @verification : TaxIdVerification1?)
    end
    ...
    def_hash(@country, @created, @customer, @id, @livemode, @object, @_type, @value, @verification)
  end
end
