...
module Stripe
  ...
  class TaxId
    ...
    @[JSON::Field(key: "owner", type: Stripe::TaxIDsOwner?, default: nil, required: true, nullable: true, emit_null: true)]
    ...
    @[JSON::Field(key: "verification", type: Stripe::TaxIdVerification?, default: nil, required: true, nullable: true, emit_null: true)]
