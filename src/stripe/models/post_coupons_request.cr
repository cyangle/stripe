...
module Stripe
  ...
  class PostCouponsRequest
    ...
    def_equals_and_hash(@amount_off, @amount_off_present, @applies_to, @applies_to_present, @currency, @currency_present, @duration, @duration_present, @duration_in_months, @duration_in_months_present, @expand, @expand_present, @id, @id_present, @max_redemptions, @max_redemptions_present, @metadata, @metadata_present, @name, @name_present, @percent_off, @percent_off_present, @redeem_by, @redeem_by_present)
  end
end
