...
module Stripe
  ...
  class TreasuryInboundTransfer
    ...
    def list_invalid_properties
      ...
      # This is a model linked_flows : Stripe::TreasuryInboundTransfersResourceInboundTransferResourceLinkedFlows?
      ...
      # This is a model status_transitions : Stripe::TreasuryInboundTransfersResourceInboundTransferResourceStatusTransitions?
      if _description = @description
        if _description.to_s.size > 5000
          invalid_properties.push("invalid value for \"description\", the character length must be smaller than or equal to 5000.")
        end
      end
      # This is a model failure_details : Stripe::TreasuryInboundTransferFailureDetails?
      ...
      # This is a model origin_payment_method_details : Stripe::TreasuryInboundTransferOriginPaymentMethodDetails?
