...
module Stripe
  class EphemeralKey
    ...
    @[NASON::Field(key: "expires", type: Int64)]
    ...
    def initialize(*, @created : Int64, @expires : Int64, @id : String, @livemode : Bool, @object : String, @secret : String? = nil)
    end
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new("String", ["ephemeral_key"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["ephemeral_key"])
    ...
    def hash
      [created, expires, id, livemode, object, secret].hash
    end
