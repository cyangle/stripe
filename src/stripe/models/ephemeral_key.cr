...
module Stripe
  ...
  class EphemeralKey
    ...
    @[JSON::Field(key: "expires", type: Int64)]
    ...
    ENUM_VALIDATOR_FOR_OBJECT = EnumValidator.new("object", "String", ["ephemeral_key"])
    ...
    def_hash(@created, @expires, @id, @livemode, @object, @secret)
  end
end
