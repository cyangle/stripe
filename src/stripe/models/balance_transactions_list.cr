...
module Stripe
  class BalanceTransactionsList
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(BalanceTransaction))]
    property data : Array(BalanceTransaction)
    ...
    def initialize(*, @data : Array(BalanceTransaction), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/balance_transactions/
      true
    end
