...
module Stripe
  class BalanceTransactionsList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::BalanceTransaction)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::BalanceTransaction)? = nil
    ...
    PATTERN_FOR_URL    = /^\/v1\/balance_transactions/
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::BalanceTransaction)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(data : Array(Stripe::BalanceTransaction)?)
      if data.nil?
