...
module Stripe
  ...
  class ShippingSpecs
    ...
    property? service_present : Bool = false
    ...
    def service=(service : String?)
      ENUM_VALIDATOR_FOR_SERVICE.valid!(service)
      @service = service
    end
    ...
    def_equals_and_hash(@address, @name, @service, @service_present, @_type, @_type_present)
  end
end
