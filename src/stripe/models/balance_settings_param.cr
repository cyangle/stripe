...
module Stripe
  class BalanceSettingsParam
    ...
    ERROR_MESSAGE_FOR_RECONCILIATION_MODE = "invalid value for \"reconciliation_mode\", must be one of [automatic, manual, merchant_default]."
    VALID_VALUES_FOR_RECONCILIATION_MODE  = String.static_array("automatic", "manual", "merchant_default")
