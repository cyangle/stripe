...
module Stripe
  #
  class GetRecipients200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::Recipient)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::Recipient)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::Recipient)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::Recipient
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/recipients/
      end
    ...
    def data=(data : Array(Stripe::Recipient)?)
      if data.nil?
