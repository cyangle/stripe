...
module Stripe
  ...
  class TreasuryFinancialAccountsResourceOutboundTransfers
    ...
    @[JSON::Field(key: "us_domestic_wire", type: Stripe::TreasuryFinancialAccountsResourceToggleSettings?, default: nil, required: false, nullable: false, emit_null: false)]
    getter us_domestic_wire : Stripe::TreasuryFinancialAccountsResourceToggleSettings? = nil
    ...
    def initialize(
      *,
      ...
      @us_domestic_wire : Stripe::TreasuryFinancialAccountsResourceToggleSettings? = nil
    )
    end
    ...
    def list_invalid_properties
      ...
      # This is a model ach : Stripe::TreasuryFinancialAccountsResourceToggleSettings?
      # This is a model us_domestic_wire : Stripe::TreasuryFinancialAccountsResourceToggleSettings?
    ...
    def us_domestic_wire=(us_domestic_wire : Stripe::TreasuryFinancialAccountsResourceToggleSettings?)
