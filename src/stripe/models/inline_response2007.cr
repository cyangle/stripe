...
module Stripe
  class InlineResponse2007
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(Coupon))]
    property data : Array(Coupon)
    ...
    def initialize(*, @data : Array(Coupon), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/coupons/
      true
    end
