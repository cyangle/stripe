...
module Stripe
  ...
  class PlanCreated
    ...
    @[JSON::Field(key: "object", type: Stripe::Plan?, default: nil, required: true, nullable: false, emit_null: false)]
    getter object : Stripe::Plan? = nil
    ...
    def object=(new_value : Stripe::Plan?)
