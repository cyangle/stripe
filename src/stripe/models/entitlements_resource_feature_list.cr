...
module Stripe
  class EntitlementsResourceFeatureList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::EntitlementsFeature)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::EntitlementsFeature)? = nil
    ...
    PATTERN_FOR_URL    = /^\/v1\/entitlements\/features/
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::EntitlementsFeature)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(new_value : Array(Stripe::EntitlementsFeature)?)
