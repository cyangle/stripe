...
module Stripe
  class PostChargesRequest
    ...
    @[JSON::Field(key: "destination", type: Stripe::DestinationSpecs?, default: nil, required: false, nullable: false, emit_null: false)]
    getter destination : Stripe::DestinationSpecs? = nil
    ...
    def destination=(new_value : Stripe::DestinationSpecs?)
      unless new_value.nil?
    ...
    def_equals_and_hash(@amount, @application_fee, @application_fee_amount, @capture, @currency, @customer, @description, @destination, @expand, @metadata, @on_behalf_of, @radar_options, @receipt_email, @shipping, @source, @statement_descriptor, @statement_descriptor_suffix, @transfer_data, @transfer_group)
  end
end
