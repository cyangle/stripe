...
require "./received_payment_method_details_financial_account"
require "./treasury_shared_resource_billing_details"
require "./treasury_shared_resource_initiating_payment_method_details_us_bank_account"
...
module Stripe
  ...
  class TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails
    ...
    def balance=(new_value : String?)
      unless new_value.nil?
        OpenApi::EnumValidator.validate("balance", new_value, VALID_VALUES_FOR_BALANCE)
      end
    ...
    def financial_account=(new_value : Stripe::ReceivedPaymentMethodDetailsFinancialAccount?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def issuing_card=(new_value : String?)
      unless new_value.nil?
        OpenApi::PrimitiveValidator.validate_max_length("issuing_card", new_value.to_s.size, MAX_LENGTH_FOR_ISSUING_CARD)
      end
    ...
    def us_bank_account=(new_value : Stripe::TreasurySharedResourceInitiatingPaymentMethodDetailsUsBankAccount?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
