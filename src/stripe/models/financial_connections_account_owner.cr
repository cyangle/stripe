...
module Stripe
  ...
  class FinancialConnectionsAccountOwner
    ...
    @[JSON::Field(key: "raw_address", type: String?, default: nil, required: true, nullable: true, emit_null: true)]
    getter raw_address : String? = nil
    MAX_LENGTH_FOR_RAW_ADDRESS = 5000

    # The timestamp of the refresh that updated this owner.
    @[JSON::Field(key: "refreshed_at", type: Int64?, default: nil, required: true, nullable: true, emit_null: true)]
    ...
    def_equals_and_hash(@email, @id, @name, @object, @ownership, @phone, @raw_address, @refreshed_at)
  end
end
