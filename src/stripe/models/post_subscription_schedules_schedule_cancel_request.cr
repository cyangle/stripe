...
module Stripe
  ...
  class PostSubscriptionSchedulesScheduleCancelRequest
    ...
    def initialize(*, @expand : Array(String)? = nil, @invoice_now : Bool? = nil, @prorate : Bool? = nil)
    end
    ...
    def_hash(@expand, @invoice_now, @prorate)
  end
end
