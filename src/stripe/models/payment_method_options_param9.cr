...
module Stripe
  class PaymentMethodOptionsParam9
    ...
    ENUM_VALIDATOR_FOR_VERIFICATION_METHOD = OpenApi::EnumValidator.new("verification_method", "String", ["automatic", "instant"])
    ...
    def financial_connections=(financial_connections : Stripe::LinkedAccountOptionsParam?)
