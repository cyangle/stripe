  ...
  class InvoiceItemPreviewParams
    ...
    def list_invalid_properties
      ...
      if _invoiceitem = @invoiceitem
        if _invoiceitem.to_s.size > 5000
      ...
      # This is a model period : Stripe::Period2?
      if _price = @price
      ...
      # This is a model price_data : Stripe::OneTimePriceData?
    ...
    def valid?
      ...
      if _invoiceitem = @invoiceitem
        return false if _invoiceitem.to_s.size > 5000
      end
      if _price = @price
