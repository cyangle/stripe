...
module Stripe
  class InvoiceItemPreviewParams
    ...
    @[JSON::Field(key: "tax_code", type: Stripe::BbposWisePoseSplashscreen?, default: nil, required: false, nullable: false, emit_null: false)]
    getter tax_code : Stripe::BbposWisePoseSplashscreen? = nil
    ...
    def initialize(
      *,
      ...
      @tax_code : Stripe::BbposWisePoseSplashscreen? = nil,
    ...
    def discounts=(new_value : Stripe::GetInvoicesUpcomingDiscountsParameter?)
      unless new_value.nil?
    ...
    def tax_code=(new_value : Stripe::BbposWisePoseSplashscreen?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
