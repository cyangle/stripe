...
module Stripe
  ...
  class FinancialReportingFinanceReportTypeList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::ReportingReportType)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::ReportingReportType)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::ReportingReportType)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::ReportingReportType
    ...
    def data=(data : Array(Stripe::ReportingReportType)?)
      if data.nil?
