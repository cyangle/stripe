...
module Stripe
  class FinancialReportingFinanceReportTypeList
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(ReportingReportType))]
    property data : Array(ReportingReportType)
    ...
    def initialize(*, @data : Array(ReportingReportType), @has_more : Bool, @object : String, @url : String)
    end
