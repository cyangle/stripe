...
module Stripe
  ...
  class IssuingPersonalizationDesignRejectionReasons
    ...
    @[JSON::Field(key: "card_logo", type: Array(String)?, default: nil, required: true, nullable: true, emit_null: true)]
    ...
    @[JSON::Field(key: "carrier_text", type: Array(String)?, default: nil, required: true, nullable: true, emit_null: true)]
