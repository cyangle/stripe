...
module Stripe
  #
  class GetIssuingTransactions200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::IssuingTransaction)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::IssuingTransaction)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::IssuingTransaction)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::IssuingTransaction
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/issuing\/transactions/
      end
    ...
    def data=(data : Array(Stripe::IssuingTransaction)?)
      if data.nil?
