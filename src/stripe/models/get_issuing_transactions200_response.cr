...
module Stripe
  ...
  class GetIssuingTransactions200Response
    ...
    # Required properties
    @[JSON::Field(key: "data", type: Array(IssuingTransaction))]
    property data : Array(IssuingTransaction)
    ...
    def initialize(*, @data : Array(IssuingTransaction), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/issuing\/transactions/
      true
    end
