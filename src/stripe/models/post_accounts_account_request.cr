...
module Stripe
  ...
  class PostAccountsAccountRequest
    ...
    @[JSON::Field(key: "settings", type: SettingsSpecsUpdate?, presence: true, ignore_serialize: settings.nil? && !settings_present?)]
    property settings : SettingsSpecsUpdate?
    ...
    def initialize(*, @account_token : String? = nil, @business_profile : BusinessProfileSpecs? = nil, @business_type : String? = nil, @capabilities : CapabilitiesParam? = nil, @company : CompanySpecs? = nil, @default_currency : String? = nil, @documents : DocumentsSpecs? = nil, @email : String? = nil, @expand : Array(String)? = nil, @external_account : String? = nil, @individual : IndividualSpecs? = nil, @metadata : IndividualSpecsMetadata? = nil, @settings : SettingsSpecsUpdate? = nil, @tos_acceptance : TosAcceptanceSpecs? = nil)
    end
    ...
    def_hash(@account_token, @business_profile, @business_type, @capabilities, @company, @default_currency, @documents, @email, @expand, @external_account, @individual, @metadata, @settings, @tos_acceptance)
  end
end
