...
module Stripe
  ...
  class UfaResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails
    ...
    def_equals_and_hash(@billing_details, @_type, @balance, @balance_present, @financial_account, @financial_account_present, @issuing_card, @issuing_card_present, @us_bank_account, @us_bank_account_present)
  end
end
