...
require "./issuing_transaction_flight_data_leg"
...
module Stripe
  ...
  class IssuingTransactionFlightData
    ...
    @[JSON::Field(key: "departure_at", type: Int64?, default: nil, required: true, nullable: true, emit_null: true)]
    getter departure_at : Int64? = nil

    # The name of the passenger.
    @[JSON::Field(key: "passenger_name", type: String?, default: nil, required: true, nullable: true, emit_null: true)]
    getter passenger_name : String? = nil
    MAX_LENGTH_FOR_PASSENGER_NAME = 5000

    # Whether the ticket is refundable.
    @[JSON::Field(key: "refundable", type: Bool?, default: nil, required: true, nullable: true, emit_null: true)]
    getter refundable : Bool? = nil

    # The legs of the trip.
    @[JSON::Field(key: "segments", type: Array(Stripe::IssuingTransactionFlightDataLeg)?, default: nil, required: true, nullable: true, emit_null: true)]
    getter segments : Array(Stripe::IssuingTransactionFlightDataLeg)? = nil

    # The travel agency that issued the ticket.
    @[JSON::Field(key: "travel_agency", type: String?, default: nil, required: true, nullable: true, emit_null: true)]
