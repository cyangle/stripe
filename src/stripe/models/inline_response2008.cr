...
module Stripe
  class InlineResponse2008
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(Customer))]
    property data : Array(Customer)
    ...
    def initialize(*, @data : Array(Customer), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/customers/
      true
    end
