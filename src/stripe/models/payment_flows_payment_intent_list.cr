...
module Stripe
  class PaymentFlowsPaymentIntentList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::PaymentIntent)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::PaymentIntent)? = nil
    ...
    PATTERN_FOR_URL    = /^\/v1\/payment_intents/
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::PaymentIntent)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(data : Array(Stripe::PaymentIntent)?)
      if data.nil?
