...
module Stripe
  class PaymentFlowsPaymentIntentList
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(PaymentIntent))]
    ...
    def initialize(*, @data : Array(PaymentIntent), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/payment_intents/
      true
    end
