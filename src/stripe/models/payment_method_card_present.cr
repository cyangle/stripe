...
module Stripe
  ...
  class PaymentMethodCardPresent
    ...
    def_equals_and_hash(@brand, @brand_product, @cardholder_name, @country, @exp_month, @exp_year, @fingerprint, @funding, @last4, @networks, @offline, @preferred_locales, @read_method, @description, @description_present, @iin, @iin_present, @issuer, @issuer_present, @wallet)
  end
end
