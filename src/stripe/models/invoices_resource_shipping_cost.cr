...
module Stripe
  ...
  class InvoicesResourceShippingCost
    ...
    @[JSON::Field(key: "shipping_rate", type: Stripe::InvoicesResourceShippingCostShippingRate?, default: nil, required: true, nullable: true, emit_null: true)]
    getter shipping_rate : Stripe::InvoicesResourceShippingCostShippingRate? = nil
    ...
    def initialize(
      *,
      ...
      @shipping_rate : Stripe::InvoicesResourceShippingCostShippingRate? = nil,
      # Optional properties
    ...
    def shipping_rate=(new_value : Stripe::InvoicesResourceShippingCostShippingRate?)
