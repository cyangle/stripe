...
require "./connect_embedded_payments_features"
...
module Stripe
  ...
  class ConnectEmbeddedPaymentsConfigClaim
    ...
    @[JSON::Field(key: "features", type: Stripe::ConnectEmbeddedPaymentsFeatures?, default: nil, required: true, nullable: false, emit_null: false)]
    getter features : Stripe::ConnectEmbeddedPaymentsFeatures? = nil
    ...
    def initialize(
      *,
      # Required properties
      @enabled : Bool? = nil,
      @features : Stripe::ConnectEmbeddedPaymentsFeatures? = nil
    )
    end
    ...
    def features=(new_value : Stripe::ConnectEmbeddedPaymentsFeatures?)
