...
module Stripe
  ...
  class ListAccountCapability
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::Capability)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::Capability)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::Capability)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::Capability
    ...
    def data=(data : Array(Stripe::Capability)?)
      if data.nil?
