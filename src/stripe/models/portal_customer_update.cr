...
module Stripe
  ...
  class PortalCustomerUpdate
    ...
    ERROR_MESSAGE_FOR_ALLOWED_UPDATES = "invalid value for \"allowed_updates\", must be one of [address, email, name, phone, shipping, tax_id]."
    VALID_VALUES_FOR_ALLOWED_UPDATES  = String.static_array("address", "email", "name", "phone", "shipping", "tax_id")
