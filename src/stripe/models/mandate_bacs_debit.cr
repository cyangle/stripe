...
module Stripe
  class MandateBacsDebit
    ...
    @[NASON::Field(key: "network_status", type: String)]
    property network_status : String

    # The unique reference identifying the mandate on the Bacs network.
    @[NASON::Field(key: "reference", type: String)]
    ...
    def initialize(*, @network_status : String, @reference : String, @url : String)
    end
    ...
    def valid?
      network_status_validator = EnumAttributeValidator.new("String", ["accepted", "pending", "refused", "revoked"])
    ...
    def network_status=(network_status)
      validator = EnumAttributeValidator.new("String", ["accepted", "pending", "refused", "revoked"])
      unless validator.valid?(network_status)
        raise ArgumentError.new("invalid value for \"network_status\", must be one of #{validator.allowable_values}.")
      end
    ...
    def hash
      [network_status, reference, url].hash
    end
