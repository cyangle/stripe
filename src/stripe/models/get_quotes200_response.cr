...
module Stripe
  ...
  class GetQuotes200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::Quote)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::Quote)? = nil
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::Quote
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/quotes/
      end
    ...
    def data=(data : Array(Stripe::Quote)?)
      if data.nil?
