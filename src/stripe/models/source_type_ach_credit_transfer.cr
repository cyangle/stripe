...
module Stripe
  ...
  class SourceTypeAchCreditTransfer
    ...
    def initialize(*, @account_number : String? = nil, @bank_name : String? = nil, @fingerprint : String? = nil, @refund_account_holder_name : String? = nil, @refund_account_holder_type : String? = nil, @refund_routing_number : String? = nil, @routing_number : String? = nil, @swift_code : String? = nil)
    end
    ...
    def_hash(@account_number, @bank_name, @fingerprint, @refund_account_holder_name, @refund_account_holder_type, @refund_routing_number, @routing_number, @swift_code)
  end
end
