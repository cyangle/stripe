...
module Stripe
  ...
  class PostInvoiceitemsInvoiceitemRequest
    ...
    @[JSON::Field(key: "discounts", type: PostInvoiceitemsInvoiceitemRequestDiscounts?, presence: true, ignore_serialize: discounts.nil? && !discounts_present?)]
    property discounts : PostInvoiceitemsInvoiceitemRequestDiscounts?
    ...
    @[JSON::Field(key: "tax_rates", type: PostInvoiceitemsInvoiceitemRequestTaxRates?, presence: true, ignore_serialize: tax_rates.nil? && !tax_rates_present?)]
    property tax_rates : PostInvoiceitemsInvoiceitemRequestTaxRates?
