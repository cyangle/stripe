...
module Stripe
  class CheckoutAcssDebitMandateOptions
    ...
    @[NASON::Field(key: "custom_mandate_url", type: String?, nillable: true)]
    property custom_mandate_url : String?
    ...
    @[NASON::Field(key: "payment_schedule", type: String? | Null, nillable: true)]
    property payment_schedule : String? | Null

    # Transaction type of the mandate.
    @[NASON::Field(key: "transaction_type", type: String? | Null, nillable: true)]
    property transaction_type : String? | Null
    ...
    def initialize(*, @custom_mandate_url : String? = nil, @default_for : Array(String)? = nil, @interval_description : String? | Null = nil, @payment_schedule : String? | Null = nil, @transaction_type : String? | Null = nil)
    end
    ...
    def hash
      [custom_mandate_url, default_for, interval_description, payment_schedule, transaction_type].hash
    end
