...
module Stripe
  ...
  class SubscriptionUpdateUpdatingParam
    ...
    @[JSON::Field(key: "products", type: SubscriptionUpdateCreationParamProducts?, presence: true, ignore_serialize: products.nil? && !products_present?)]
    ...
    def_equals_and_hash(@default_allowed_updates, @default_allowed_updates_present, @enabled, @enabled_present, @products, @products_present, @proration_behavior, @proration_behavior_present)
  end
end
