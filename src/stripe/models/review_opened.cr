...
module Stripe
  ...
  class ReviewOpened
    ...
    @[JSON::Field(key: "object", type: Stripe::Review?, default: nil, required: true, nullable: false, emit_null: false)]
    getter object : Stripe::Review? = nil
    ...
    def object=(new_value : Stripe::Review?)
