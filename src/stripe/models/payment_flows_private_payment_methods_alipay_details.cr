...
module Stripe
  class PaymentFlowsPrivatePaymentMethodsAlipayDetails
    ...
    @[NASON::Field(key: "buyer_id", type: String?, nillable: true)]
    ...
    def initialize(*, @buyer_id : String? = nil, @fingerprint : String? | Null = nil, @transaction_id : String? | Null = nil)
    end
    ...
    def hash
      [buyer_id, fingerprint, transaction_id].hash
    end
