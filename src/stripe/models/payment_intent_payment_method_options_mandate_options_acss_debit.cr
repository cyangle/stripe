...
module Stripe
  class PaymentIntentPaymentMethodOptionsMandateOptionsAcssDebit
    ...
    def initialize(*, @custom_mandate_url : String? = nil, @interval_description : String? | Null = nil, @payment_schedule : String? | Null = nil, @transaction_type : String? | Null = nil)
    end
    ...
    def hash
      [custom_mandate_url, interval_description, payment_schedule, transaction_type].hash
    end
