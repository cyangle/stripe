...
module Stripe
  ...
  class TransferReversed
    ...
    @[JSON::Field(key: "object", type: Stripe::Transfer?, default: nil, required: true, nullable: false, emit_null: false)]
    getter object : Stripe::Transfer? = nil
    ...
    def object=(new_value : Stripe::Transfer?)
