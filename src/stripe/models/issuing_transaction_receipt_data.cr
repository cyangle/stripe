...
module Stripe
  ...
  class IssuingTransactionReceiptData
    ...
    @[JSON::Field(key: "quantity", type: Float64?, default: nil, required: true, nullable: true, emit_null: true)]
    getter quantity : Float64? = nil

    # The total for this line item in cents.
    @[JSON::Field(key: "total", type: Int64?, default: nil, required: true, nullable: true, emit_null: true)]
