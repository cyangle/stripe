...
module Stripe
  class PostOrdersIdRequestPaymentSettings
    ...
    @[JSON::Field(key: "application_fee_amount", type: Stripe::PostOrdersIdRequestPaymentSettingsApplicationFeeAmount?, default: nil, required: false, nullable: false, emit_null: false)]
    getter application_fee_amount : Stripe::PostOrdersIdRequestPaymentSettingsApplicationFeeAmount? = nil

    @[JSON::Field(key: "payment_method_options", type: Stripe::PostOrdersIdRequestPaymentSettingsPaymentMethodOptions?, default: nil, required: false, nullable: false, emit_null: false)]
    getter payment_method_options : Stripe::PostOrdersIdRequestPaymentSettingsPaymentMethodOptions? = nil
    ...
    @[JSON::Field(key: "return_url", type: Stripe::PostOrdersIdRequestPaymentSettingsReturnUrl?, default: nil, required: false, nullable: false, emit_null: false)]
    getter return_url : Stripe::PostOrdersIdRequestPaymentSettingsReturnUrl? = nil
    ...
    @[JSON::Field(key: "transfer_data", type: Stripe::PostOrdersIdRequestPaymentSettingsTransferData?, default: nil, required: false, nullable: false, emit_null: false)]
    getter transfer_data : Stripe::PostOrdersIdRequestPaymentSettingsTransferData? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @application_fee_amount : Stripe::PostOrdersIdRequestPaymentSettingsApplicationFeeAmount? = nil,
      @payment_method_options : Stripe::PostOrdersIdRequestPaymentSettingsPaymentMethodOptions? = nil,
      @payment_method_types : Array(String)? = nil,
      @return_url : Stripe::PostOrdersIdRequestPaymentSettingsReturnUrl? = nil,
      @statement_descriptor : String? = nil,
      @statement_descriptor_suffix : String? = nil,
      @transfer_data : Stripe::PostOrdersIdRequestPaymentSettingsTransferData? = nil
    )
    end
    ...
    def application_fee_amount=(application_fee_amount : Stripe::PostOrdersIdRequestPaymentSettingsApplicationFeeAmount?)
    ...
    def payment_method_options=(payment_method_options : Stripe::PostOrdersIdRequestPaymentSettingsPaymentMethodOptions?)
    ...
    def return_url=(return_url : Stripe::PostOrdersIdRequestPaymentSettingsReturnUrl?)
      if return_url.nil?
    ...
    def transfer_data=(transfer_data : Stripe::PostOrdersIdRequestPaymentSettingsTransferData?)
