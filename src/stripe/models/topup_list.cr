...
module Stripe
  ...
  class TopupList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::Topup)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::Topup)? = nil
    ...
    def data=(data : Array(Stripe::Topup)?)
      if data.nil?
