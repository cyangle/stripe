...
module Stripe
  class TopupList
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(Topup))]
    property data : Array(Topup)
    ...
    def initialize(*, @data : Array(Topup), @has_more : Bool, @object : String, @url : String)
    end
