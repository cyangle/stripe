...
require "./tax_transaction_line_item"
...
module Stripe
  class TaxProductResourceTaxTransactionLineItemList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::TaxTransactionLineItem)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::TaxTransactionLineItem)? = nil
    ...
    PATTERN_FOR_URL    = /^\/v1\/tax\/transactions\/[^\/]+\/line_items/
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::TaxTransactionLineItem)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(new_value : Array(Stripe::TaxTransactionLineItem)?)
