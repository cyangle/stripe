...
module Stripe
  class ExternalAccount
    ...
    def initialize(*, @country : String | Null, @currency : String | Null, @id : String, @last4 : String, @object : String, @status : String, @brand : String, @exp_month : Int64, @exp_year : Int64, @funding : String, @account : String | Account? | Null = nil, @account_holder_name : String? | Null = nil, @account_holder_type : String? | Null = nil, @account_type : String? | Null = nil, @available_payout_methods : Array(String)? | Null = nil, @bank_name : String? | Null = nil, @customer : String | Customer | Nil | Null = nil, @default_for_currency : Bool? | Null = nil, @fingerprint : String? | Null = nil, @metadata : Hash(String, String)? | Null = nil, @routing_number : String? | Null = nil, @address_city : String? | Null = nil, @address_country : String? | Null = nil, @address_line1 : String? | Null = nil, @address_line1_check : String? | Null = nil, @address_line2 : String? | Null = nil, @address_state : String? | Null = nil, @address_zip : String? | Null = nil, @address_zip_check : String? | Null = nil, @cvc_check : String? | Null = nil, @dynamic_last4 : String? | Null = nil, @name : String? | Null = nil, @recipient : String | Recipient? | Null = nil, @tokenization_method : String? | Null = nil)
    end
