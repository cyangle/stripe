...
module Stripe
  #
  class GetExchangeRates200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::ExchangeRate)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::ExchangeRate)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::ExchangeRate)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::ExchangeRate
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/exchange_rates/
      end
    ...
    def data=(data : Array(Stripe::ExchangeRate)?)
      if data.nil?
