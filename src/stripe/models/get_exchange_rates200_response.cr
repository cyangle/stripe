...
module Stripe
  ...
  class GetExchangeRates200Response
    ...
    # Required properties
    @[JSON::Field(key: "data", type: Array(ExchangeRate))]
    property data : Array(ExchangeRate)
    ...
    def initialize(*, @data : Array(ExchangeRate), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/exchange_rates/
      true
    end
