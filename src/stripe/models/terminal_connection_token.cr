...
module Stripe
  ...
  class TerminalConnectionToken
    ...
    @[NASON::Field(key: "secret", type: String)]
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new("String", ["terminal.connection_token"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["terminal.connection_token"])
