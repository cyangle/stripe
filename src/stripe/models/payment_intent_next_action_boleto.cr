...
module Stripe
  class PaymentIntentNextActionBoleto
    ...
    @[NASON::Field(key: "hosted_voucher_url", type: String? | Null, nillable: true)]
    property hosted_voucher_url : String? | Null
    ...
    @[NASON::Field(key: "pdf", type: String? | Null, nillable: true)]
    property pdf : String? | Null

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @expires_at : Int64? | Null = nil, @hosted_voucher_url : String? | Null = nil, @number : String? | Null = nil, @pdf : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@hosted_voucher_url.nil? && !@hosted_voucher_url.null? && @hosted_voucher_url.to_s.size > 5000
      ...
      if !@pdf.nil? && !@pdf.null? && @pdf.to_s.size > 5000
    ...
    def valid?
      return false if !@hosted_voucher_url.nil? && !@hosted_voucher_url.null? && @hosted_voucher_url.to_s.size > 5000
      return false if !@number.nil? && !@number.null? && @number.to_s.size > 5000
      return false if !@pdf.nil? && !@pdf.null? && @pdf.to_s.size > 5000
      true
    end
    ...
    def hash
      [expires_at, hosted_voucher_url, number, pdf].hash
    end
