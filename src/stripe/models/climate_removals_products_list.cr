...
module Stripe
  class ClimateRemovalsProductsList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::ClimateProduct)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::ClimateProduct)? = nil
    ...
    PATTERN_FOR_URL    = /^\/v1\/climate\/products/
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::ClimateProduct)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(new_value : Array(Stripe::ClimateProduct)?)
