...
module Stripe
  class TransferList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::Transfer)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::Transfer)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::Transfer)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(data : Array(Stripe::Transfer)?)
      if data.nil?
