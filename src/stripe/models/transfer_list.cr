...
module Stripe
  class TransferList
    ...
    @[NASON::Field(key: "data", type: Array(Transfer))]
    property data : Array(Transfer)
    ...
    def initialize(*, @data : Array(Transfer), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/transfers/
      true
    end
