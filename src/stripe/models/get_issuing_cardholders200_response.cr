...
module Stripe
  ...
  class GetIssuingCardholders200Response
    ...
    # Required properties
    @[JSON::Field(key: "data", type: Array(IssuingCardholder))]
    property data : Array(IssuingCardholder)
    ...
    def initialize(*, @data : Array(IssuingCardholder), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/issuing\/cardholders/
      true
    end
