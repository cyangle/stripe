...
module Stripe
  #
  class GetIssuingCardholders200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::IssuingCardholder)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::IssuingCardholder)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::IssuingCardholder)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::IssuingCardholder
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/issuing\/cardholders/
      end
    ...
    def data=(data : Array(Stripe::IssuingCardholder)?)
      if data.nil?
