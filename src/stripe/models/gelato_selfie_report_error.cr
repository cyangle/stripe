...
module Stripe
  class GelatoSelfieReportError
    ...
    @[NASON::Field(key: "code", type: String? | Null, nillable: true)]
    ...
    def initialize(*, @code : String? | Null = nil, @reason : String? | Null = nil)
    end
    ...
    def valid?
      code_validator = EnumAttributeValidator.new("String", ["selfie_document_missing_photo", "selfie_face_mismatch", "selfie_manipulated", "selfie_unverified_other"])
    ...
    def code=(code)
      validator = EnumAttributeValidator.new("String", ["selfie_document_missing_photo", "selfie_face_mismatch", "selfie_manipulated", "selfie_unverified_other"])
