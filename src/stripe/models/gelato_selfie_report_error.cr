...
module Stripe
  ...
  class GelatoSelfieReportError
    ...
    ENUM_VALIDATOR_FOR_CODE = OpenApi::EnumValidator.new("code", "String", ["selfie_document_missing_photo", "selfie_face_mismatch", "selfie_manipulated", "selfie_unverified_other"])
