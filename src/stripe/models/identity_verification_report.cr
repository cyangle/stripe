...
module Stripe
  ...
  class IdentityVerificationReport
    ...
    @[NASON::Field(key: "options", type: GelatoVerificationReportOptions)]
    ...
    # Optional properties
    @[NASON::Field(key: "document", type: GelatoDocumentReport?, nillable: true)]
    property document : GelatoDocumentReport?

    @[NASON::Field(key: "id_number", type: GelatoIdNumberReport?, nillable: true)]
    property id_number : GelatoIdNumberReport?

    @[NASON::Field(key: "selfie", type: GelatoSelfieReport?, nillable: true)]
    property selfie : GelatoSelfieReport?

    # ID of the VerificationSession that created this report.
    @[NASON::Field(key: "verification_session", type: String? | Null, nillable: true)]
    property verification_session : String? | Null
    ...
    def initialize(*, @created : Int64, @id : String, @livemode : Bool, @object : String, @options : GelatoVerificationReportOptions, @_type : String, @document : GelatoDocumentReport? = nil, @id_number : GelatoIdNumberReport? = nil, @selfie : GelatoSelfieReport? = nil, @verification_session : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@verification_session.nil? && !@verification_session.null? && @verification_session.to_s.size > 5000
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new("String", ["identity.verification_report"])
      ...
      return false if !@verification_session.nil? && !@verification_session.null? && @verification_session.to_s.size > 5000
      true
    end
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["identity.verification_report"])
    ...
    def hash
      [created, document, id, id_number, livemode, object, options, selfie, _type, verification_session].hash
    end
