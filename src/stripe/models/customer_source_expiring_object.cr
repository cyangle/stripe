...
module Stripe
  class CustomerSourceExpiringObject
    ...
    def_equals_and_hash(@address_city, @address_country, @address_line1, @address_line1_check, @address_line2, @address_state, @address_zip, @address_zip_check, @brand, @country, @currency, @cvc_check, @dynamic_last4, @exp_month, @exp_year, @funding, @id, @last4, @metadata, @name, @object, @status, @tokenization_method, @amount, @client_secret, @created, @flow, @livemode, @owner, @statement_descriptor, @_type, @usage, @account, @account_present, @available_payout_methods, @available_payout_methods_present, @customer, @default_for_currency, @default_for_currency_present, @description, @fingerprint, @fingerprint_present, @iin, @issuer, @networks, @ach_credit_transfer, @ach_debit, @acss_debit, @alipay, @au_becs_debit, @bancontact, @card, @card_present2, @code_verification, @eps, @giropay, @ideal, @klarna, @multibanco, @p24, @receiver, @redirect, @sepa_credit_transfer, @sepa_debit, @sofort, @source_order, @three_d_secure, @wechat)
  end
end
