...
module Stripe
  ...
  class SubscriptionsResourcePaymentMethodOptionsCard
    ...
    # Optional properties
    @[JSON::Field(key: "mandate_options", type: InvoiceMandateOptionsCard?, presence: true, ignore_serialize: mandate_options.nil? && !mandate_options_present?)]
    ...
    def initialize(*, @request_three_d_secure : String?, @mandate_options : InvoiceMandateOptionsCard? = nil)
    end
