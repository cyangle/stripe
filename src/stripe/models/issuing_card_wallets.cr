...
module Stripe
  class IssuingCardWallets
    ...
    # Required properties
    @[NASON::Field(key: "apple_pay", type: IssuingCardApplePay)]
    property apple_pay : IssuingCardApplePay

    @[NASON::Field(key: "google_pay", type: IssuingCardGooglePay)]
    property google_pay : IssuingCardGooglePay

    # Optional properties
    # Unique identifier for a card used with digital wallets
    @[NASON::Field(key: "primary_account_identifier", type: String? | Null, nillable: true)]
    property primary_account_identifier : String? | Null

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @apple_pay : IssuingCardApplePay, @google_pay : IssuingCardGooglePay, @primary_account_identifier : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@primary_account_identifier.nil? && !@primary_account_identifier.null? && @primary_account_identifier.to_s.size > 5000
    ...
    def valid?
      return false if !@primary_account_identifier.nil? && !@primary_account_identifier.null? && @primary_account_identifier.to_s.size > 5000
      true
    end
    ...
    def hash
      [apple_pay, google_pay, primary_account_identifier].hash
    end
