...
require "./terms_acceptance_param"
...
module Stripe
  class CardIssuingParam
    ...
    @[JSON::Field(key: "user_terms_acceptance", type: Stripe::TermsAcceptanceParam?, default: nil, required: false, nullable: false, emit_null: false)]
    getter user_terms_acceptance : Stripe::TermsAcceptanceParam? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @user_terms_acceptance : Stripe::TermsAcceptanceParam? = nil
    )
    end
    ...
    def user_terms_acceptance=(new_value : Stripe::TermsAcceptanceParam?)
