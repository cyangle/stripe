...
require "./payment_flows_private_payment_methods_us_bank_account_linked_account_options_filters"
...
module Stripe
  ...
  class LinkedAccountOptionsUsBankAccount
    ...
    @[JSON::Field(key: "filters", type: Stripe::PaymentFlowsPrivatePaymentMethodsUsBankAccountLinkedAccountOptionsFilters?, default: nil, required: false, nullable: false, emit_null: false)]
    getter filters : Stripe::PaymentFlowsPrivatePaymentMethodsUsBankAccountLinkedAccountOptionsFilters? = nil
    ...
    def initialize(
      *,
      ...
      # Optional properties
      @filters : Stripe::PaymentFlowsPrivatePaymentMethodsUsBankAccountLinkedAccountOptionsFilters? = nil,
    ...
    def filters=(new_value : Stripe::PaymentFlowsPrivatePaymentMethodsUsBankAccountLinkedAccountOptionsFilters?)
      unless new_value.nil?
    ...
    def_equals_and_hash(@prefetch, @filters, @permissions, @return_url)
  end
end
