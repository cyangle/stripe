...
module Stripe
  ...
  class CreditCardSpecs
    ...
    def_equals_and_hash(@exp_month, @exp_year, @number, @address_city, @address_city_present, @address_country, @address_country_present, @address_line1, @address_line1_present, @address_line2, @address_line2_present, @address_state, @address_state_present, @address_zip, @address_zip_present, @currency, @currency_present, @cvc, @cvc_present, @name, @name_present)
  end
end
