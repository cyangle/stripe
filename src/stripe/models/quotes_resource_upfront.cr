...
module Stripe
  class QuotesResourceUpfront
    ...
    # Optional properties
    @[NASON::Field(key: "line_items", type: QuotesResourceListLineItems2?, nillable: true)]
    property line_items : QuotesResourceListLineItems2?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @amount_subtotal : Int64, @amount_total : Int64, @total_details : QuotesResourceTotalDetails, @line_items : QuotesResourceListLineItems2? = nil)
    end
    ...
    def hash
      [amount_subtotal, amount_total, line_items, total_details].hash
    end
