...
module Stripe
  ...
  class TransferReversalList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::TransferReversal)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::TransferReversal)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::TransferReversal)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::TransferReversal
