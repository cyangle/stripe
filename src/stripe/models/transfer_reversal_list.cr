...
module Stripe
  class TransferReversalList
    ...
    @[NASON::Field(key: "data", type: Array(TransferReversal))]
    property data : Array(TransferReversal)
    ...
    def initialize(*, @data : Array(TransferReversal), @has_more : Bool, @object : String, @url : String)
    end
