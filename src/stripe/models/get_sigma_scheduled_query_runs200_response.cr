...
module Stripe
  #
  class GetSigmaScheduledQueryRuns200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::ScheduledQueryRun)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::ScheduledQueryRun)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::ScheduledQueryRun)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::ScheduledQueryRun
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/sigma\/scheduled_query_runs/
      end
    ...
    def data=(data : Array(Stripe::ScheduledQueryRun)?)
      if data.nil?
