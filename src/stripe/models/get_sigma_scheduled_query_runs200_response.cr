...
module Stripe
  ...
  class GetSigmaScheduledQueryRuns200Response
    ...
    # Required properties
    @[JSON::Field(key: "data", type: Array(ScheduledQueryRun))]
    property data : Array(ScheduledQueryRun)
    ...
    def initialize(*, @data : Array(ScheduledQueryRun), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/sigma\/scheduled_query_runs/
      true
    end
