...
module Stripe
  ...
  class SettingsSpecs
    ...
    def initialize(*, @branding : BrandingSettingsSpecs? = nil, @card_issuing : CardIssuingSettingsSpecs? = nil, @card_payments : CardPaymentsSettingsSpecs? = nil, @payments : PaymentsSettingsSpecs? = nil, @payouts : PayoutSettingsSpecs? = nil)
    end
    ...
    def_hash(@branding, @card_issuing, @card_payments, @payments, @payouts)
  end
end
