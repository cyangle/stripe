...
module Stripe
  ...
  class SettingsSpecs
    ...
    def_equals_and_hash(@branding, @branding_present, @card_issuing, @card_issuing_present, @card_payments, @card_payments_present, @payments, @payments_present, @payouts, @payouts_present)
  end
end
