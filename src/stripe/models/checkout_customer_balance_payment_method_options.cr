...
require "./checkout_customer_balance_bank_transfer_payment_method_options"
...
module Stripe
  ...
  class CheckoutCustomerBalancePaymentMethodOptions
    ...
    def bank_transfer=(new_value : Stripe::CheckoutCustomerBalanceBankTransferPaymentMethodOptions?)
      unless new_value.nil?
    ...
    def_equals_and_hash(@funding_type, @bank_transfer, @setup_future_usage)
  end
end
