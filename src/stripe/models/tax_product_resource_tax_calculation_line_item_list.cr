...
require "./tax_calculation_line_item"
...
module Stripe
  class TaxProductResourceTaxCalculationLineItemList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::TaxCalculationLineItem)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::TaxCalculationLineItem)? = nil
    ...
    PATTERN_FOR_URL    = /^\/v1\/tax\/calculations\/[^\/]+\/line_items/
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::TaxCalculationLineItem)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(new_value : Array(Stripe::TaxCalculationLineItem)?)
