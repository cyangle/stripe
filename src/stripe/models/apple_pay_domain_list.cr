...
module Stripe
  ...
  class ApplePayDomainList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::ApplePayDomain)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::ApplePayDomain)? = nil
    ...
    PATTERN_FOR_URL    = /^\/v1\/apple_pay\/domains/
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::ApplePayDomain)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(data : Array(Stripe::ApplePayDomain)?)
      if data.nil?
