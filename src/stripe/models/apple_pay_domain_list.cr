...
module Stripe
  class ApplePayDomainList
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(ApplePayDomain))]
    property data : Array(ApplePayDomain)
    ...
    def initialize(*, @data : Array(ApplePayDomain), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/apple_pay\/domains/
      true
    end
