...
module Stripe
  ...
  class TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig
    ...
    def initialize(
      *,
      # Optional properties
      @splashscreen : Stripe::TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfigSplashscreen? = nil
    )
    end
    ...
    def list_invalid_properties
      ...
      # This is a model splashscreen : Stripe::TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfigSplashscreen?
