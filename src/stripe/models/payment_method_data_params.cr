...
module Stripe
  ...
  class PaymentMethodDataParams
    ...
    def initialize(*, @_type : String, @acss_debit : PaymentMethodParam? = nil, @affirm : JSON::Any = nil, @afterpay_clearpay : JSON::Any = nil, @alipay : JSON::Any = nil, @au_becs_debit : Param? = nil, @bacs_debit : Param1? = nil, @bancontact : JSON::Any = nil, @billing_details : BillingDetailsInnerParams? = nil, @boleto : Param2? = nil, @customer_balance : JSON::Any = nil, @eps : Param3? = nil, @fpx : Param4? = nil, @giropay : JSON::Any = nil, @grabpay : JSON::Any = nil, @ideal : Param5? = nil, @interac_present : JSON::Any = nil, @klarna : Param6? = nil, @konbini : JSON::Any = nil, @link : JSON::Any = nil, @metadata : Hash(String, String)? = nil, @oxxo : JSON::Any = nil, @p24 : Param7? = nil, @paynow : JSON::Any = nil, @radar_options : RadarOptions? = nil, @sepa_debit : Param8? = nil, @sofort : Param9? = nil, @us_bank_account : PaymentMethodParam1? = nil, @wechat_pay : JSON::Any = nil)
    end
    ...
    def_hash(@acss_debit, @affirm, @afterpay_clearpay, @alipay, @au_becs_debit, @bacs_debit, @bancontact, @billing_details, @boleto, @customer_balance, @eps, @fpx, @giropay, @grabpay, @ideal, @interac_present, @klarna, @konbini, @link, @metadata, @oxxo, @p24, @paynow, @radar_options, @sepa_debit, @sofort, @_type, @us_bank_account, @wechat_pay)
  end
end
