...
module Stripe
  class ReserveTransaction
    ...
    def initialize(*, @amount : Int64, @currency : String, @id : String, @object : String, @description : String? | Null = nil)
    end
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new("String", ["reserve_transaction"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["reserve_transaction"])
    ...
    def hash
      [amount, currency, description, id, object].hash
    end
