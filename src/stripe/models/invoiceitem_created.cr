...
module Stripe
  ...
  class InvoiceitemCreated
    ...
    @[JSON::Field(key: "object", type: Stripe::Invoiceitem?, default: nil, required: true, nullable: false, emit_null: false)]
    getter object : Stripe::Invoiceitem? = nil
    ...
    def object=(new_value : Stripe::Invoiceitem?)
