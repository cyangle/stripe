...
module Stripe
  class InlineResponse20027
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(Recipient))]
    property data : Array(Recipient)
    ...
    def initialize(*, @data : Array(Recipient), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/recipients/
      true
    end
