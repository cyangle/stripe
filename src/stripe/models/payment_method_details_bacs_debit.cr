...
module Stripe
  class PaymentMethodDetailsBacsDebit
    ...
    @[NASON::Field(key: "sort_code", type: String? | Null, nillable: true)]
    property sort_code : String? | Null

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @fingerprint : String? | Null = nil, @last4 : String? | Null = nil, @mandate : String? | Null = nil, @sort_code : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@sort_code.nil? && !@sort_code.null? && @sort_code.to_s.size > 5000
    ...
    def valid?
      ...
      return false if !@sort_code.nil? && !@sort_code.null? && @sort_code.to_s.size > 5000
      true
    end
    ...
    def hash
      [fingerprint, last4, mandate, sort_code].hash
    end
