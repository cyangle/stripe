...
module Stripe
  ...
  class GelatoIdNumberReport
    ...
    # Optional properties
    # Date of birth.
    @[NASON::Field(key: "dob", type: GelatoDataIdNumberReportDate? | Null, nillable: true)]
    property dob : GelatoDataIdNumberReportDate? | Null

    # Details on the verification error. Present when status is `unverified`.
    @[NASON::Field(key: "error", type: GelatoIdNumberReportError? | Null, nillable: true)]
    property error : GelatoIdNumberReportError? | Null
    ...
    # ID number.
    @[NASON::Field(key: "id_number", type: String? | Null, nillable: true)]
    property id_number : String? | Null

    # Type of ID number.
    @[NASON::Field(key: "id_number_type", type: String? | Null, nillable: true)]
    property id_number_type : String? | Null
    ...
    def initialize(*, @status : String, @dob : GelatoDataIdNumberReportDate? | Null = nil, @error : GelatoIdNumberReportError? | Null = nil, @first_name : String? | Null = nil, @id_number : String? | Null = nil, @id_number_type : String? | Null = nil, @last_name : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@id_number.nil? && !@id_number.null? && @id_number.to_s.size > 5000
    ...
    def valid?
      ...
      return false if !@id_number.nil? && !@id_number.null? && @id_number.to_s.size > 5000
      id_number_type_validator = EnumAttributeValidator.new("String", ["br_cpf", "sg_nric", "us_ssn"])
      return false unless id_number_type_validator.valid?(@id_number_type)
    ...
    def id_number_type=(id_number_type)
      validator = EnumAttributeValidator.new("String", ["br_cpf", "sg_nric", "us_ssn"])
      unless validator.valid?(id_number_type)
        raise ArgumentError.new("invalid value for \"id_number_type\", must be one of #{validator.allowable_values}.")
      end
    ...
    def hash
      [dob, error, first_name, id_number, id_number_type, last_name, status].hash
    end
