...
module Stripe
  ...
  class PostAccountsAccountExternalAccountsIdRequest
    ...
    def initialize(*, @account_holder_name : String? = nil, @account_holder_type : String? = nil, @account_type : String? = nil, @address_city : String? = nil, @address_country : String? = nil, @address_line1 : String? = nil, @address_line2 : String? = nil, @address_state : String? = nil, @address_zip : String? = nil, @default_for_currency : Bool? = nil, @exp_month : String? = nil, @exp_year : String? = nil, @expand : Array(String)? = nil, @metadata : IndividualSpecsMetadata? = nil, @name : String? = nil)
    end
    ...
    def_hash(@account_holder_name, @account_holder_type, @account_type, @address_city, @address_country, @address_line1, @address_line2, @address_state, @address_zip, @default_for_currency, @exp_month, @exp_year, @expand, @metadata, @name)
  end
end
