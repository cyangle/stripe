...
require "./external_account_documents_param"
...
module Stripe
  class PostAccountsAccountExternalAccountsIdRequest
    ...
    @[JSON::Field(key: "documents", type: Stripe::ExternalAccountDocumentsParam?, default: nil, required: false, nullable: false, emit_null: false)]
    getter documents : Stripe::ExternalAccountDocumentsParam? = nil
    ...
    def documents=(new_value : Stripe::ExternalAccountDocumentsParam?)
      unless new_value.nil?
    ...
    def_equals_and_hash(@account_holder_name, @account_holder_type, @account_type, @address_city, @address_country, @address_line1, @address_line2, @address_state, @address_zip, @default_for_currency, @documents, @exp_month, @exp_year, @expand, @metadata, @name)
  end
end
