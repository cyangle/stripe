...
module Stripe
  ...
  class IssuingTransactionFlightDataLeg
    ...
    @[JSON::Field(key: "arrival_airport_code", type: String?, default: nil, required: true, nullable: true, emit_null: true)]
    ...
    @[JSON::Field(key: "departure_airport_code", type: String?, default: nil, required: true, nullable: true, emit_null: true)]
    getter departure_airport_code : String? = nil
    MAX_LENGTH_FOR_DEPARTURE_AIRPORT_CODE = 5000

    # The flight number.
    @[JSON::Field(key: "flight_number", type: String?, default: nil, required: true, nullable: true, emit_null: true)]
    getter flight_number : String? = nil
    MAX_LENGTH_FOR_FLIGHT_NUMBER = 5000

    # The flight's service class.
    @[JSON::Field(key: "service_class", type: String?, default: nil, required: true, nullable: true, emit_null: true)]
    getter service_class : String? = nil
    MAX_LENGTH_FOR_SERVICE_CLASS = 5000

    # Whether a stopover is allowed on this flight.
    @[JSON::Field(key: "stopover_allowed", type: Bool?, default: nil, required: true, nullable: true, emit_null: true)]
