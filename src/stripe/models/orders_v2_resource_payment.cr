...
module Stripe
  ...
  class OrdersV2ResourcePayment
    ...
    VALID_VALUES_FOR_STATUS  = String.static_array("canceled", "complete", "not_required", "processing", "requires_action", "requires_capture", "requires_confirmation", "requires_payment_method")
