...
module Stripe
  ...
  class UsageRecord
    ...
    @[NASON::Field(key: "timestamp", type: Int64)]
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new("String", ["usage_record"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["usage_record"])
    ...
    def hash
      [id, livemode, object, quantity, subscription_item, timestamp].hash
    end
