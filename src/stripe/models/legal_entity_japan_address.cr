...
module Stripe
  ...
  class LegalEntityJapanAddress
    ...
    @[JSON::Field(key: "line1", type: String?, default: nil, required: true, nullable: true, emit_null: true)]
    getter line1 : String? = nil
    MAX_LENGTH_FOR_LINE1 = 5000

    # Building details.
    @[JSON::Field(key: "line2", type: String?, default: nil, required: true, nullable: true, emit_null: true)]
    ...
    # Town/cho-me.
    @[JSON::Field(key: "town", type: String?, default: nil, required: true, nullable: true, emit_null: true)]
    ...
    def town=(new_value : String?)
      unless new_value.nil?
        OpenApi::PrimitiveValidator.validate_max_length("town", new_value.to_s.size, MAX_LENGTH_FOR_TOWN)
      end
