...
module Stripe
  class LegalEntityJapanAddress
    ...
    @[NASON::Field(key: "line1", type: String? | Null, nillable: true)]
    property line1 : String? | Null

    # Building details.
    @[NASON::Field(key: "line2", type: String? | Null, nillable: true)]
    property line2 : String? | Null
    ...
    # Town/cho-me.
    @[NASON::Field(key: "town", type: String? | Null, nillable: true)]
    property town : String? | Null

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @city : String? | Null = nil, @country : String? | Null = nil, @line1 : String? | Null = nil, @line2 : String? | Null = nil, @postal_code : String? | Null = nil, @state : String? | Null = nil, @town : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@town.nil? && !@town.null? && @town.to_s.size > 5000
    ...
    def valid?
      ...
      return false if !@line1.nil? && !@line1.null? && @line1.to_s.size > 5000
      return false if !@line2.nil? && !@line2.null? && @line2.to_s.size > 5000
      ...
      return false if !@town.nil? && !@town.null? && @town.to_s.size > 5000
      true
    end
    ...
    def hash
      [city, country, line1, line2, postal_code, state, town].hash
    end
