...
module Stripe
  class IssuingDisputeEvidence
    ...
    # Optional properties
    @[NASON::Field(key: "canceled", type: IssuingDisputeCanceledEvidence?, nillable: true)]
    property canceled : IssuingDisputeCanceledEvidence?

    @[NASON::Field(key: "duplicate", type: IssuingDisputeDuplicateEvidence?, nillable: true)]
    property duplicate : IssuingDisputeDuplicateEvidence?

    @[NASON::Field(key: "fraudulent", type: IssuingDisputeFraudulentEvidence?, nillable: true)]
    property fraudulent : IssuingDisputeFraudulentEvidence?

    @[NASON::Field(key: "merchandise_not_as_described", type: IssuingDisputeMerchandiseNotAsDescribedEvidence?, nillable: true)]
    property merchandise_not_as_described : IssuingDisputeMerchandiseNotAsDescribedEvidence?

    @[NASON::Field(key: "not_received", type: IssuingDisputeNotReceivedEvidence?, nillable: true)]
    property not_received : IssuingDisputeNotReceivedEvidence?

    @[NASON::Field(key: "other", type: IssuingDisputeOtherEvidence?, nillable: true)]
    property other : IssuingDisputeOtherEvidence?

    @[NASON::Field(key: "service_not_as_described", type: IssuingDisputeServiceNotAsDescribedEvidence?, nillable: true)]
    ...
    def valid?
      reason_validator = EnumAttributeValidator.new("String", ["canceled", "duplicate", "fraudulent", "merchandise_not_as_described", "not_received", "other", "service_not_as_described"])
    ...
    def reason=(reason)
      validator = EnumAttributeValidator.new("String", ["canceled", "duplicate", "fraudulent", "merchandise_not_as_described", "not_received", "other", "service_not_as_described"])
    ...
    def hash
      [canceled, duplicate, fraudulent, merchandise_not_as_described, not_received, other, reason, service_not_as_described].hash
    end
