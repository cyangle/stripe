...
require "./payouts_features_param"
...
module Stripe
  class PayoutsConfigParam
    ...
    @[JSON::Field(key: "features", type: Stripe::PayoutsFeaturesParam?, default: nil, required: false, nullable: false, emit_null: false)]
    getter features : Stripe::PayoutsFeaturesParam? = nil
    ...
    def initialize(
      *,
      ...
      @enabled : Bool? = nil,
      # Optional properties
      @features : Stripe::PayoutsFeaturesParam? = nil
    )
    end
    ...
    def features=(new_value : Stripe::PayoutsFeaturesParam?)
