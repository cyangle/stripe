...
module Stripe
  ...
  class PaymentMethodOptionsParam21CustomerBalance
    ...
    def self.openapi_any_of
      [
        Stripe::PaymentIntentPaymentMethodOptionsParam5,
        String,
      ]
    end
    ...
    def initialize(*, @bank_transfer : BankTransferParam1? = nil, @funding_type : String? = nil, @setup_future_usage : String? = nil)
    end
