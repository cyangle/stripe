...
module Stripe
  ...
  class SetupIntentPaymentMethodOptionsCard
    ...
    def initialize(*, @mandate_options : SetupIntentPaymentMethodOptionsCardMandateOptions1?, @network : String?, @request_three_d_secure : String?)
    end
    ...
    def_hash(@mandate_options, @network, @request_three_d_secure)
  end
end
