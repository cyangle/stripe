...
module Stripe
  ...
  class PaymentIntentCreated
    ...
    @[JSON::Field(key: "object", type: Stripe::PaymentIntent?, default: nil, required: true, nullable: false, emit_null: false)]
    getter object : Stripe::PaymentIntent? = nil
    ...
    def initialize(
      *,
      # Required properties
      @object : Stripe::PaymentIntent? = nil
    )
    end
    ...
    def object=(new_value : Stripe::PaymentIntent?)
