...
module Stripe
  class TaxDeductedAtSource
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new("String", ["tax_deducted_at_source"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["tax_deducted_at_source"])
    ...
    def hash
      [id, object, period_end, period_start, tax_deduction_account_number].hash
    end
