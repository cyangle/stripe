...
module Stripe
  ...
  class PostIdentityVerificationSessionsSessionRequest
    ...
    def initialize(*, @expand : Array(String)? = nil, @metadata : Hash(String, String)? = nil, @options : SessionOptionsParam? = nil, @_type : String? = nil)
    end
    ...
    def_hash(@expand, @metadata, @options, @_type)
  end
end
