...
module Stripe
  ...
  class GetIdentityVerificationSessions200Response
    include JSON::Serializable
    include JSON::Serializable::Unmapped

    # Required properties
    @[JSON::Field(key: "data", type: Array(IdentityVerificationSession))]
    property data : Array(IdentityVerificationSession)
    ...
    def initialize(*, @data : Array(IdentityVerificationSession), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/identity\/verification_sessions/
      true
    end
