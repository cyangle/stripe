...
module Stripe
  ...
  class PriceDataWithOptionalProduct
    ...
    def_equals_and_hash(@currency, @currency_present, @product, @product_present, @tax_behavior, @tax_behavior_present, @unit_amount, @unit_amount_present, @unit_amount_decimal, @unit_amount_decimal_present)
  end
end
