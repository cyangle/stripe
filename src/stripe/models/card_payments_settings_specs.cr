...
module Stripe
  ...
  class CardPaymentsSettingsSpecs
    ...
    def list_invalid_properties
      ...
      if !@statement_descriptor_prefix.nil? && @statement_descriptor_prefix.to_s.size > 10
    ...
    def_equals_and_hash(@decline_on, @decline_on_present, @statement_descriptor_prefix, @statement_descriptor_prefix_present)
  end
end
