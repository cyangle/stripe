...
module Stripe
  ...
  class PaymentIntentNextActionWechatPayDisplayQrCode
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_image_data_url = @image_data_url).nil?
    ...
    def image_data_url=(new_value : String?)
      raise ArgumentError.new("\"image_data_url\" is required and cannot be null") if new_value.nil?
      unless new_value.nil?
        OpenApi::PrimitiveValidator.validate_max_length("image_data_url", new_value.to_s.size, MAX_LENGTH_FOR_IMAGE_DATA_URL)
      end

      @image_data_url = new_value
    end
    ...
    def_equals_and_hash(@data, @hosted_instructions_url, @image_data_url, @image_url_png, @image_url_svg)
  end
end
