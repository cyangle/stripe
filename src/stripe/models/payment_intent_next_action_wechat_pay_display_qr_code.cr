...
module Stripe
  class PaymentIntentNextActionWechatPayDisplayQrCode
    ...
    @[NASON::Field(key: "data", type: String)]
    property data : String

    # The base64 image data for a pre-generated QR code
    @[NASON::Field(key: "image_data_url", type: String)]
    property image_data_url : String

    # The image_url_png string used to render QR code, can be used as <img src=\"…\" />
    @[NASON::Field(key: "image_url_png", type: String)]
    property image_url_png : String

    # The image_url_svg string used to render QR code, can be used as <img src=\"…\" />
    @[NASON::Field(key: "image_url_svg", type: String)]
    property image_url_svg : String
    ...
    def hash
      [data, image_data_url, image_url_png, image_url_svg].hash
    end
