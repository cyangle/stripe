...
module Stripe
  ...
  class PaymentIntentTypeSpecificPaymentMethodOptionsClient
    ...
    def initialize(*, @capture_method : String? = nil, @setup_future_usage : String? = nil, @verification_method : String? = nil)
    end
    ...
    def_hash(@capture_method, @setup_future_usage, @verification_method)
  end
end
