...
module Stripe
  ...
  class PaymentIntentPaymentMethodOptionsUsBankAccount
    ...
    def initialize(*, @financial_connections : LinkedAccountOptionsUsBankAccount? = nil, @setup_future_usage : String? = nil, @verification_method : String? = nil)
    end
    ...
    def_hash(@financial_connections, @setup_future_usage, @verification_method)
  end
end
