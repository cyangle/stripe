...
module Stripe
  class PaymentMethodSepaDebit
    ...
    @[NASON::Field(key: "generated_from", type: SepaDebitGeneratedFrom? | Null, nillable: true)]
    property generated_from : SepaDebitGeneratedFrom? | Null
    ...
    def initialize(*, @bank_code : String? | Null = nil, @branch_code : String? | Null = nil, @country : String? | Null = nil, @fingerprint : String? | Null = nil, @generated_from : SepaDebitGeneratedFrom? | Null = nil, @last4 : String? | Null = nil)
    end
    ...
    def hash
      [bank_code, branch_code, country, fingerprint, generated_from, last4].hash
    end
