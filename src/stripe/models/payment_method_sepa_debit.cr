...
module Stripe
  ...
  class PaymentMethodSepaDebit
    ...
    @[JSON::Field(key: "generated_from", type: PaymentMethodSepaDebitGeneratedFrom?, presence: true, ignore_serialize: generated_from.nil? && !generated_from_present?)]
    property generated_from : PaymentMethodSepaDebitGeneratedFrom?
