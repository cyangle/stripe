...
module Stripe
  ...
  class PostTransfersIdReversalsRequest
    ...
    def_equals_and_hash(@amount, @amount_present, @description, @description_present, @expand, @expand_present, @metadata, @metadata_present, @refund_application_fee, @refund_application_fee_present)
  end
end
