...
module Stripe
  ...
  class PostTransfersIdReversalsRequest
    ...
    def initialize(*, @amount : Int64? = nil, @description : String? = nil, @expand : Array(String)? = nil, @metadata : IndividualSpecsMetadata? = nil, @refund_application_fee : Bool? = nil)
    end
    ...
    def_hash(@amount, @description, @expand, @metadata, @refund_application_fee)
  end
end
