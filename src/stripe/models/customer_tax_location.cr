...
module Stripe
  class CustomerTaxLocation
    ...
    def initialize(*, @country : String, @source : String, @state : String? | Null = nil)
    end
    ...
    def valid?
      ...
      source_validator = EnumAttributeValidator.new("String", ["billing_address", "ip_address", "payment_method", "shipping_destination"])
    ...
    def source=(source)
      validator = EnumAttributeValidator.new("String", ["billing_address", "ip_address", "payment_method", "shipping_destination"])
