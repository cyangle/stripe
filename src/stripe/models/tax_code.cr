...
module Stripe
  ...
  class TaxCode
    ...
    def initialize(*, @description : String, @id : String, @name : String, @object : String)
    end
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new("String", ["tax_code"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["tax_code"])
    ...
    def hash
      [description, id, name, object].hash
    end
