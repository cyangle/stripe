  ...
  class InvoiceQuote
    ...
    def initialize(
      *,
      ...
      @automatic_tax : QuotesResourceAutomaticTax? = nil,
      @collection_method : String? = nil,
      @computed : QuotesResourceComputed? = nil,
      @created : Int64? = nil,
      ...
      @object : String? = nil,
      @status : String? = nil,
      @status_transitions : QuotesResourceStatusTransitions? = nil,
      @subscription_data : QuotesResourceSubscriptionData? = nil,
