...
module Stripe
  class PostAccountsRequest
    ...
    @[JSON::Field(key: "controller", type: Stripe::ControllerSpecs?, default: nil, required: false, nullable: false, emit_null: false)]
    getter controller : Stripe::ControllerSpecs? = nil
    ...
    def controller=(new_value : Stripe::ControllerSpecs?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def settings=(new_value : Stripe::SettingsSpecs?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def_equals_and_hash(@account_token, @business_profile, @business_type, @capabilities, @company, @controller, @country, @default_currency, @documents, @email, @expand, @external_account, @individual, @metadata, @settings, @tos_acceptance, @_type)
  end
end
