...
module Stripe
  ...
  class PostAccountsRequest
    ...
    def_equals_and_hash(@account_token, @account_token_present, @bank_account, @bank_account_present, @business_profile, @business_profile_present, @business_type, @business_type_present, @capabilities, @capabilities_present, @company, @company_present, @country, @country_present, @default_currency, @default_currency_present, @documents, @documents_present, @email, @email_present, @expand, @expand_present, @external_account, @external_account_present, @individual, @individual_present, @metadata, @metadata_present, @settings, @settings_present, @tos_acceptance, @tos_acceptance_present, @_type, @_type_present)
  end
end
