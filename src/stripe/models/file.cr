...
module Stripe
  ...
  class File
    ...
    @[NASON::Field(key: "purpose", type: String)]
    property purpose : String

    # The size in bytes of the file object.
    @[NASON::Field(key: "size", type: Int64)]
    property size : Int64
    ...
    @[NASON::Field(key: "filename", type: String? | Null, nillable: true)]
    property filename : String? | Null

    @[NASON::Field(key: "links", type: FileFileLinkList? | Null, nillable: true)]
    property links : FileFileLinkList? | Null

    # A user friendly title for the document.
    @[NASON::Field(key: "title", type: String? | Null, nillable: true)]
    ...
    def initialize(*, @created : Int64, @id : String, @object : String, @purpose : String, @size : Int64, @expires_at : Int64? | Null = nil, @filename : String? | Null = nil, @links : FileFileLinkList? | Null = nil, @title : String? | Null = nil, @_type : String? | Null = nil, @url : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@filename.nil? && !@filename.null? && @filename.to_s.size > 5000
    ...
    def valid?
      return false if !@filename.nil? && !@filename.null? && @filename.to_s.size > 5000
      return false if @id.to_s.size > 5000
      object_validator = EnumAttributeValidator.new("String", ["file"])
      return false unless object_validator.valid?(@object)
      purpose_validator = EnumAttributeValidator.new("String", ["account_requirement", "additional_verification", "business_icon", "business_logo", "customer_signature", "dispute_evidence", "document_provider_identity_document", "finance_report_run", "identity_document", "identity_document_downloadable", "pci_document", "selfie", "sigma_scheduled_query", "tax_document_user_upload"])
      return false unless purpose_validator.valid?(@purpose)
      return false if !@title.nil? && !@title.null? && @title.to_s.size > 5000
      return false if !@_type.nil? && !@_type.null? && @_type.to_s.size > 5000
    ...
    def purpose=(purpose)
      validator = EnumAttributeValidator.new("String", ["account_requirement", "additional_verification", "business_icon", "business_logo", "customer_signature", "dispute_evidence", "document_provider_identity_document", "finance_report_run", "identity_document", "identity_document_downloadable", "pci_document", "selfie", "sigma_scheduled_query", "tax_document_user_upload"])
    ...
    def hash
      [created, expires_at, filename, id, links, object, purpose, size, title, _type, url].hash
    end
