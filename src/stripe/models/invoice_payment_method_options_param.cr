...
module Stripe
  class InvoicePaymentMethodOptionsParam
    ...
    @[JSON::Field(key: "mandate_options", type: Stripe::MandateOptionsParam1?, default: nil, required: false, nullable: false, emit_null: false)]
    getter mandate_options : Stripe::MandateOptionsParam1? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @mandate_options : Stripe::MandateOptionsParam1? = nil,
    ...
    def list_invalid_properties
      ...
      # This is a model mandate_options : Stripe::MandateOptionsParam1?
    ...
    def mandate_options=(mandate_options : Stripe::MandateOptionsParam1?)
