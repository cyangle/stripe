...
module Stripe
  ...
  class Event
    ...
    @[NASON::Field(key: "data", type: NotificationEventData)]
    ...
    @[NASON::Field(key: "pending_webhooks", type: Int64)]
    ...
    @[NASON::Field(key: "account", type: String?, nillable: true)]
    ...
    @[NASON::Field(key: "request", type: NotificationEventRequest? | Null, nillable: true)]
    property request : NotificationEventRequest? | Null
    ...
    def initialize(*, @created : Int64, @data : NotificationEventData, @id : String, @livemode : Bool, @object : String, @pending_webhooks : Int64, @_type : String, @account : String? = nil, @api_version : String? | Null = nil, @request : NotificationEventRequest? | Null = nil)
    end
    ...
    def hash
      [account, api_version, created, data, id, livemode, object, pending_webhooks, request, _type].hash
    end
