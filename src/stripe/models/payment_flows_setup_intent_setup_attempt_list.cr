...
module Stripe
  class PaymentFlowsSetupIntentSetupAttemptList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::SetupAttempt)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::SetupAttempt)? = nil
    ...
    PATTERN_FOR_URL    = /^\/v1\/setup_attempts/
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::SetupAttempt)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(data : Array(Stripe::SetupAttempt)?)
      if data.nil?
