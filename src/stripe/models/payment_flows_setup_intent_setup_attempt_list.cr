...
module Stripe
  class PaymentFlowsSetupIntentSetupAttemptList
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(SetupAttempt))]
    property data : Array(SetupAttempt)
    ...
    def initialize(*, @data : Array(SetupAttempt), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/setup_attempts/
      true
    end
