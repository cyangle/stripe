...
module Stripe
  ...
  class PaymentMethodOptionsParam21UsBankAccount
    ...
    def self.openapi_any_of
      [
        Stripe::PaymentIntentPaymentMethodOptionsParam10,
        String,
      ]
    end
    ...
    def initialize(*, @financial_connections : LinkedAccountOptionsParam1? = nil, @networks : NetworksOptionsParam? = nil, @setup_future_usage : String? = nil, @verification_method : String? = nil)
    end
    ...
    def_hash(@financial_connections, @networks, @setup_future_usage, @verification_method)
  end
end
