...
module Stripe
  ...
  class BusinessProfileSpecs
    ...
    @[JSON::Field(key: "support_address", type: AddressSpecs?, presence: true, ignore_serialize: support_address.nil? && !support_address_present?)]
    property support_address : AddressSpecs?
    ...
    @[JSON::Field(key: "support_url", type: BusinessProfileSpecsSupportUrl?, presence: true, ignore_serialize: support_url.nil? && !support_url_present?)]
    property support_url : BusinessProfileSpecsSupportUrl?
    ...
    def valid?
      return false if !@mcc.nil? && @mcc.to_s.size > 4
