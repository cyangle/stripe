...
require "./customer_source_expiring_object"
...
module Stripe
  ...
  class CustomerSourceExpiring
    ...
    @[JSON::Field(key: "object", type: Stripe::CustomerSourceExpiringObject?, default: nil, required: true, nullable: false, emit_null: false)]
    getter object : Stripe::CustomerSourceExpiringObject? = nil
    ...
    def initialize(
      *,
      # Required properties
      @object : Stripe::CustomerSourceExpiringObject? = nil
    )
    end
    ...
    def object=(new_value : Stripe::CustomerSourceExpiringObject?)
