...
module Stripe
  class SourceTypeAchDebit
    ...
    def initialize(*, @bank_name : String? | Null = nil, @country : String? | Null = nil, @fingerprint : String? | Null = nil, @last4 : String? | Null = nil, @routing_number : String? | Null = nil, @_type : String? | Null = nil)
    end
    ...
    def hash
      [bank_name, country, fingerprint, last4, routing_number, _type].hash
    end
