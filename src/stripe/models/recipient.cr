...
module Stripe
  ...
  class Recipient
    ...
    @[NASON::Field(key: "active_account", type: BankAccount? | Null, nillable: true)]
    property active_account : BankAccount? | Null

    @[NASON::Field(key: "cards", type: CardList1? | Null, nillable: true)]
    property cards : CardList1? | Null

    # The default card to use for creating transfers to this recipient.
    @[NASON::Field(key: "default_card", type: String | Card? | Null, nillable: true)]
    property default_card : String | Card? | Null
    ...
    @[NASON::Field(key: "migrated_to", type: String | Account? | Null, nillable: true)]
    property migrated_to : String | Account? | Null

    # Full, legal name of the recipient.
    @[NASON::Field(key: "name", type: String? | Null, nillable: true)]
    property name : String? | Null

    @[NASON::Field(key: "rolled_back_from", type: String | Account? | Null, nillable: true)]
    property rolled_back_from : String | Account? | Null
    ...
    def initialize(*, @created : Int64, @id : String, @livemode : Bool, @metadata : Hash(String, String), @object : String, @_type : String, @active_account : BankAccount? | Null = nil, @cards : CardList1? | Null = nil, @default_card : String | Card? | Null = nil, @description : String? | Null = nil, @email : String? | Null = nil, @migrated_to : String | Account? | Null = nil, @name : String? | Null = nil, @rolled_back_from : String | Account? | Null = nil)
    end
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new("String", ["recipient"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["recipient"])
    ...
    def hash
      [active_account, cards, created, default_card, description, email, id, livemode, metadata, migrated_to, name, object, rolled_back_from, _type].hash
    end
