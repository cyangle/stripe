...
module Stripe
  class PaymentLinksResourceCompletionBehaviorConfirmationPage
    ...
    @[NASON::Field(key: "custom_message", type: String? | Null, nillable: true)]
    property custom_message : String? | Null

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @custom_message : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@custom_message.nil? && !@custom_message.null? && @custom_message.to_s.size > 5000
    ...
    def valid?
      return false if !@custom_message.nil? && !@custom_message.null? && @custom_message.to_s.size > 5000
      true
    end
