...
module Stripe
  class Address
    ...
    def initialize(*, @city : String? | Null = nil, @country : String? | Null = nil, @line1 : String? | Null = nil, @line2 : String? | Null = nil, @postal_code : String? | Null = nil, @state : String? | Null = nil)
    end
