...
module Stripe
  ...
  class OutboundPaymentsResourceTreasuryReturnedStatusTransaction
    ...
    def initialize(
      *,
      # Required properties
      @amount : Int64? = nil,
      @balance_impact : TransactionsResourceBalanceImpact? = nil,
      @created : Int64? = nil,
      @currency : String? = nil,
      ...
      @object : String? = nil,
      @status : String? = nil,
      @status_transitions : TransactionsResourceAbstractTransactionResourceStatusTransitions? = nil,
      # Optional properties
    ...
    def_equals_and_hash(@amount, @balance_impact, @created, @currency, @description, @financial_account, @flow_type, @id, @livemode, @object, @status, @status_transitions, @entries, @flow, @flow_details)
  end
end
