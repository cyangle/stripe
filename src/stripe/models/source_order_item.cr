...
module Stripe
  class SourceOrderItem
    ...
    @[NASON::Field(key: "parent", type: String? | Null, nillable: true)]
    property parent : String? | Null
    ...
    def initialize(*, @amount : Int64? | Null = nil, @currency : String? | Null = nil, @description : String? | Null = nil, @parent : String? | Null = nil, @quantity : Int64? = nil, @_type : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@parent.nil? && !@parent.null? && @parent.to_s.size > 5000
    ...
    def valid?
      ...
      return false if !@parent.nil? && !@parent.null? && @parent.to_s.size > 5000
    ...
    def hash
      [amount, currency, description, parent, quantity, _type].hash
    end
