...
module Stripe
  class InlineResponse2009
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(Dispute))]
    property data : Array(Dispute)
    ...
    def initialize(*, @data : Array(Dispute), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/disputes/
      true
    end
