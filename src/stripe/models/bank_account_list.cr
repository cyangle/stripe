...
module Stripe
  ...
  class BankAccountList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::BankAccount)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::BankAccount)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::BankAccount)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::BankAccount
    ...
    def data=(data : Array(Stripe::BankAccount)?)
      if data.nil?
