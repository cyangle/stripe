...
module Stripe
  class BankAccountList
    ...
    @[NASON::Field(key: "data", type: Array(BankAccount))]
    property data : Array(BankAccount)
    ...
    def initialize(*, @data : Array(BankAccount), @has_more : Bool, @object : String, @url : String)
    end
