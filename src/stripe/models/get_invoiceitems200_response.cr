...
module Stripe
  #
  class GetInvoiceitems200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::Invoiceitem)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::Invoiceitem)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::Invoiceitem)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::Invoiceitem
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/invoiceitems/
      end
    ...
    def data=(data : Array(Stripe::Invoiceitem)?)
      if data.nil?
