...
module Stripe
  ...
  class GetInvoiceitems200Response
    ...
    # Required properties
    @[JSON::Field(key: "data", type: Array(Invoiceitem))]
    property data : Array(Invoiceitem)
    ...
    def initialize(*, @data : Array(Invoiceitem), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/invoiceitems/
      true
    end
