...
module Stripe
  ...
  class PhaseConfigurationParams1
    ...
    @[JSON::Field(key: "start_date", type: PhaseConfigurationParams1EndDate?, presence: true, ignore_serialize: start_date.nil? && !start_date_present?)]
    property start_date : PhaseConfigurationParams1EndDate?
    ...
    @[JSON::Field(key: "trial_end", type: PhaseConfigurationParams1EndDate?, presence: true, ignore_serialize: trial_end.nil? && !trial_end_present?)]
    property trial_end : PhaseConfigurationParams1EndDate?
