...
module Stripe
  ...
  class PhaseConfigurationParams1
    ...
    def_equals_and_hash(@items, @add_invoice_items, @application_fee_percent, @automatic_tax, @billing_cycle_anchor, @billing_thresholds, @collection_method, @coupon, @default_payment_method, @default_tax_rates, @end_date, @invoice_settings, @iterations, @metadata, @proration_behavior, @start_date, @transfer_data, @trial, @trial_end)
  end
end
