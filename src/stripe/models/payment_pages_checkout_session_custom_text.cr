...
module Stripe
  ...
  class PaymentPagesCheckoutSessionCustomText
    ...
    def shipping_address=(shipping_address : Stripe::PaymentPagesCheckoutSessionCustomTextShippingAddress?)
    ...
    def submit=(submit : Stripe::PaymentPagesCheckoutSessionCustomTextSubmit?)
      if submit.nil?
        return @submit = nil
      end
