...
module Stripe
  ...
  class PriceProduct
    ...
    def initialize(*, @active : Bool, @attributes : Array(String), @caption : String?, @created : Int64, @description : String?, @id : String, @images : Array(String), @livemode : Bool, @metadata : Hash(String, String), @name : String, @object : String, @package_dimensions : ProductPackageDimensions?, @shippable : Bool?, @statement_descriptor : String?, @tax_code : ProductTaxCode?, @_type : String, @unit_label : String?, @updated : Int64, @url : String?, @deleted : Bool, @deactivate_on : Array(String)? = nil, @default_price : ProductDefaultPrice? = nil)
    end
    ...
    def_hash(@active, @attributes, @caption, @created, @deactivate_on, @default_price, @description, @id, @images, @livemode, @metadata, @name, @object, @package_dimensions, @shippable, @statement_descriptor, @tax_code, @_type, @unit_label, @updated, @url, @deleted)
  end
end
