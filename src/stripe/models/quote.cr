...
module Stripe
  ...
  class Quote
    ...
    def_equals_and_hash(@amount_subtotal, @amount_total, @automatic_tax, @collection_method, @computed, @created, @discounts, @expires_at, @id, @livemode, @metadata, @object, @status, @status_transitions, @subscription_data, @total_details, @application, @application_present, @application_fee_amount, @application_fee_amount_present, @application_fee_percent, @application_fee_percent_present, @currency, @currency_present, @customer, @customer_present, @default_tax_rates, @default_tax_rates_present, @description, @description_present, @footer, @footer_present, @from_quote, @from_quote_present, @header, @header_present, @invoice, @invoice_present, @invoice_settings, @invoice_settings_present, @line_items, @line_items_present, @number, @number_present, @on_behalf_of, @on_behalf_of_present, @subscription, @subscription_present, @subscription_schedule, @subscription_schedule_present, @test_clock, @test_clock_present, @transfer_data, @transfer_data_present)
  end
end
