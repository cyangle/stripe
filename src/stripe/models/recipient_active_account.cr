...
module Stripe
  ...
  class RecipientActiveAccount
    ...
    def initialize(*, @account_holder_name : String?, @account_holder_type : String?, @account_type : String?, @bank_name : String?, @country : String, @currency : String, @fingerprint : String?, @id : String, @last4 : String, @object : String, @routing_number : String?, @status : String, @account : BankAccountAccount? = nil, @available_payout_methods : Array(String)? = nil, @customer : BankAccountCustomer? = nil, @default_for_currency : Bool? = nil, @metadata : Hash(String, String)? = nil)
    end
    ...
    def_hash(@account, @account_holder_name, @account_holder_type, @account_type, @available_payout_methods, @bank_name, @country, @currency, @customer, @default_for_currency, @fingerprint, @id, @last4, @metadata, @object, @routing_number, @status)
  end
end
