...
module Stripe
  ...
  class InvoiceLinesList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::LineItem)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::LineItem)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::LineItem)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::LineItem
    ...
    def data=(data : Array(Stripe::LineItem)?)
      if data.nil?
