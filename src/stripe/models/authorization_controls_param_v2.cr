...
module Stripe
  ...
  class AuthorizationControlsParamV2
    ...
    @[JSON::Field(key: "blocked_categories", type: Array(String)?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "spending_limits", type: Array(Stripe::SpendingLimitsParam)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter spending_limits : Array(Stripe::SpendingLimitsParam)? = nil

    @[JSON::Field(key: "spending_limits_currency", type: String?, default: nil, required: false, nullable: false, emit_null: false)]
    ...
    def initialize(
      *,
      ...
      @spending_limits : Array(Stripe::SpendingLimitsParam)? = nil,
    ...
    def spending_limits=(spending_limits : Array(Stripe::SpendingLimitsParam)?)
