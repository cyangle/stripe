...
module Stripe
  ...
  class CouponsResourceCouponList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::Coupon)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::Coupon)? = nil
    ...
    def data=(data : Array(Stripe::Coupon)?)
      if data.nil?
