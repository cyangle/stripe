...
module Stripe
  class PaymentMethodDomainResourcePaymentMethodDomainList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::PaymentMethodDomain)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::PaymentMethodDomain)? = nil
    ...
    PATTERN_FOR_URL    = /^\/v1\/payment_method_domains/
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::PaymentMethodDomain)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(new_value : Array(Stripe::PaymentMethodDomain)?)
