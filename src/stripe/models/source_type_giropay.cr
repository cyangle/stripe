...
module Stripe
  ...
  class SourceTypeGiropay
    ...
    def initialize(*, @bank_code : String? = nil, @bank_name : String? = nil, @bic : String? = nil, @statement_descriptor : String? = nil)
    end
    ...
    def_hash(@bank_code, @bank_name, @bic, @statement_descriptor)
  end
end
