...
module Stripe
  class SourceTypeGiropay
    ...
    def initialize(*, @bank_code : String? | Null = nil, @bank_name : String? | Null = nil, @bic : String? | Null = nil, @statement_descriptor : String? | Null = nil)
    end
    ...
    def hash
      [bank_code, bank_name, bic, statement_descriptor].hash
    end
