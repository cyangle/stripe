...
module Stripe
  ...
  class PersonTokenSpecs
    ...
    def initialize(*, @address : AddressSpecs4? = nil, @address_kana : JapanAddressKanaSpecs2? = nil, @address_kanji : JapanAddressKanjiSpecs2? = nil, @dob : PostAccountsAccountPersonsRequestDob? = nil, @documents : PersonDocumentsSpecs? = nil, @email : String? = nil, @first_name : String? = nil, @first_name_kana : String? = nil, @first_name_kanji : String? = nil, @full_name_aliases : PostAccountsAccountPersonsRequestFullNameAliases? = nil, @gender : String? = nil, @id_number : String? = nil, @id_number_secondary : String? = nil, @last_name : String? = nil, @last_name_kana : String? = nil, @last_name_kanji : String? = nil, @maiden_name : String? = nil, @metadata : IndividualSpecsMetadata? = nil, @nationality : String? = nil, @phone : String? = nil, @political_exposure : String? = nil, @registered_address : AddressSpecs5? = nil, @relationship : RelationshipSpecs? = nil, @ssn_last_4 : String? = nil, @verification : PersonVerificationSpecs1? = nil)
    end
