...
module Stripe
  class UpdateParams
    ...
    @[JSON::Field(key: "settings", type: Stripe::UpdateParamsSettings?, default: nil, required: true, nullable: false, emit_null: false)]
    getter settings : Stripe::UpdateParamsSettings? = nil
    ...
    def initialize(
      *,
      # Required properties
      @settings : Stripe::UpdateParamsSettings? = nil
    )
    end
    ...
    def settings=(settings : Stripe::UpdateParamsSettings?)
      if settings.nil?
