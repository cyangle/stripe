...
require "./payment_method_reuse_agreement_params"
...
module Stripe
  class ConsentCollectionParams
    ...
    @[JSON::Field(key: "payment_method_reuse_agreement", type: Stripe::PaymentMethodReuseAgreementParams?, default: nil, required: false, nullable: false, emit_null: false)]
    getter payment_method_reuse_agreement : Stripe::PaymentMethodReuseAgreementParams? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @payment_method_reuse_agreement : Stripe::PaymentMethodReuseAgreementParams? = nil,
    ...
    def payment_method_reuse_agreement=(new_value : Stripe::PaymentMethodReuseAgreementParams?)
