...
module Stripe
  class PaymentMethodDetailsCardInstallmentsPlan
    ...
    @[NASON::Field(key: "count", type: Int64? | Null, nillable: true)]
    property count : Int64? | Null

    # For `fixed_count` installment plans, this is the interval between installment payments your customer will make to their credit card. One of `month`.
    @[NASON::Field(key: "interval", type: String? | Null, nillable: true)]
    property interval : String? | Null
    ...
    def initialize(*, @_type : String, @count : Int64? | Null = nil, @interval : String? | Null = nil)
    end
    ...
    def valid?
      ...
      _type_validator = EnumAttributeValidator.new("String", ["fixed_count"])
    ...
    def _type=(_type)
      validator = EnumAttributeValidator.new("String", ["fixed_count"])
