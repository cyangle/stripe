...
module Stripe
  ...
  class DiscountsResourceDiscountAmountDiscount
    ...
    def initialize(*, @checkout_session : String?, @coupon : Coupon, @customer : DeletedDiscountCustomer?, @_end : Int64?, @id : String, @invoice : String?, @invoice_item : String?, @object : String, @promotion_code : DeletedDiscountPromotionCode?, @start : Int64, @subscription : String?, @deleted : Bool)
    end
    ...
    def_hash(@checkout_session, @coupon, @customer, @_end, @id, @invoice, @invoice_item, @object, @promotion_code, @start, @subscription, @deleted)
  end
end
