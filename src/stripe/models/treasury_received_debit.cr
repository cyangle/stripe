...
module Stripe
  ...
  class TreasuryReceivedDebit
    ...
    def_equals_and_hash(@amount, @created, @currency, @description, @id, @linked_flows, @livemode, @network, @object, @status, @failure_code, @failure_code_present, @financial_account, @financial_account_present, @initiating_payment_method_details, @initiating_payment_method_details_present, @transaction, @transaction_present)
  end
end
