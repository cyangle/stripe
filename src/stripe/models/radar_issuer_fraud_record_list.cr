...
module Stripe
  #
  class RadarIssuerFraudRecordList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::IssuerFraudRecord)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::IssuerFraudRecord)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::IssuerFraudRecord)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::IssuerFraudRecord
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/issuer_fraud_records/
      end
    ...
    def data=(data : Array(Stripe::IssuerFraudRecord)?)
      if data.nil?
