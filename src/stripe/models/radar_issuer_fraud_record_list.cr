...
module Stripe
  class RadarIssuerFraudRecordList
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(IssuerFraudRecord))]
    property data : Array(IssuerFraudRecord)
    ...
    def initialize(*, @data : Array(IssuerFraudRecord), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/issuer_fraud_records/
      true
    end
