...
module Stripe
  class AccountTosAcceptance
    ...
    @[NASON::Field(key: "date", type: Int64? | Null, nillable: true)]
    property date : Int64? | Null

    # The IP address from which the account representative accepted their service agreement
    @[NASON::Field(key: "ip", type: String? | Null, nillable: true)]
    property ip : String? | Null

    # The user's service agreement type
    @[NASON::Field(key: "service_agreement", type: String?, nillable: true)]
    property service_agreement : String?

    # The user agent of the browser from which the account representative accepted their service agreement
    @[NASON::Field(key: "user_agent", type: String? | Null, nillable: true)]
    property user_agent : String? | Null

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @date : Int64? | Null = nil, @ip : String? | Null = nil, @service_agreement : String? = nil, @user_agent : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@ip.nil? && !@ip.null? && @ip.to_s.size > 5000
      ...
      if !@user_agent.nil? && !@user_agent.null? && @user_agent.to_s.size > 5000
    ...
    def valid?
      return false if !@ip.nil? && !@ip.null? && @ip.to_s.size > 5000
      return false if !@service_agreement.nil? && @service_agreement.to_s.size > 5000
      return false if !@user_agent.nil? && !@user_agent.null? && @user_agent.to_s.size > 5000
      true
    end
    ...
    def hash
      [date, ip, service_agreement, user_agent].hash
    end
