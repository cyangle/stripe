...
module Stripe
  ...
  class AccountTosAcceptance
    ...
    def list_invalid_properties : Array(String)
      ...
      if _ip = @ip
        if max_length_error = OpenApi::PrimitiveValidator.max_length_error("ip", _ip.to_s.size, 5000)
    ...
    def service_agreement=(service_agreement : String?)
      if service_agreement.nil?
    ...
    def_equals_and_hash(@date, @date_present, @ip, @ip_present, @service_agreement, @user_agent, @user_agent_present)
  end
end
