...
module Stripe
  class InlineResponse20036
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(Subscription))]
    ...
    def initialize(*, @data : Array(Subscription), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/subscriptions/
      true
    end
