...
module Stripe
  ...
  class NotificationEventList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::Event)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::Event)? = nil
    ...
    def data=(data : Array(Stripe::Event)?)
      if data.nil?
