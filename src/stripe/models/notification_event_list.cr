...
module Stripe
  class NotificationEventList
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(Event))]
    property data : Array(Event)
    ...
    def initialize(*, @data : Array(Event), @has_more : Bool, @object : String, @url : String)
    end
