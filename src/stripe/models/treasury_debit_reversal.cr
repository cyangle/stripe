...
module Stripe
  ...
  class TreasuryDebitReversal
    ...
    def_equals_and_hash(@amount, @currency, @id, @livemode, @metadata, @network, @object, @received_debit, @status, @status_transitions, @financial_account, @financial_account_present, @hosted_regulatory_receipt_url, @hosted_regulatory_receipt_url_present, @linked_flows, @linked_flows_present, @transaction, @transaction_present)
  end
end
