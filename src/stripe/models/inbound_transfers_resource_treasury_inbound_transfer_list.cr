...
module Stripe
  #
  class InboundTransfersResourceTreasuryInboundTransferList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::TreasuryInboundTransfer)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::TreasuryInboundTransfer)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::TreasuryInboundTransfer)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::TreasuryInboundTransfer
    ...
    def data=(data : Array(Stripe::TreasuryInboundTransfer)?)
      if data.nil?
