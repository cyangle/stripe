...
module Stripe
  ...
  class InboundTransfersResourceTreasuryInboundTransferList
    ...
    @[JSON::Field(key: "data", type: Array(TreasuryInboundTransfer))]
    property data : Array(TreasuryInboundTransfer)
    ...
    def initialize(*, @data : Array(TreasuryInboundTransfer), @has_more : Bool, @object : String, @url : String)
    end
