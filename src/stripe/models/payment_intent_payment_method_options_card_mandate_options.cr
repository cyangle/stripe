...
module Stripe
  ...
  class PaymentIntentPaymentMethodOptionsCardMandateOptions
    ...
    def initialize(*, @amount : Int64, @amount_type : String, @description : String?, @end_date : Int64?, @interval : String, @interval_count : Int64?, @reference : String, @start_date : Int64, @supported_types : Array(String)?)
    end
    ...
    def_hash(@amount, @amount_type, @description, @end_date, @interval, @interval_count, @reference, @start_date, @supported_types)
  end
end
