...
module Stripe
  class InlineResponse20028
    ...
    # Required properties
    @[NASON::Field(key: "data", type: Array(Refund))]
    property data : Array(Refund)
    ...
    def initialize(*, @data : Array(Refund), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/refunds/
      true
    end
