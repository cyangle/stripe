...
module Stripe
  ...
  class TaxProductResourceTaxCodeList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::TaxCode)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::TaxCode)? = nil
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::TaxCode
    ...
    def data=(data : Array(Stripe::TaxCode)?)
      if data.nil?
