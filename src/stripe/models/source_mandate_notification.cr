...
require "./source"
require "./source_mandate_notification_acss_debit_data"
require "./source_mandate_notification_bacs_debit_data"
require "./source_mandate_notification_sepa_debit_data"
...
module Stripe
  ...
  class SourceMandateNotification
    ...
    def_equals_and_hash(@amount, @created, @id, @livemode, @object, @reason, @source, @status, @_type, @acss_debit, @bacs_debit, @sepa_debit)
  end
end
