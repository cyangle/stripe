...
module Stripe
  ...
  class SourceMandateNotification
    ...
    # Optional properties
    @[NASON::Field(key: "acss_debit", type: SourceMandateNotificationAcssDebitData?, nillable: true)]
    ...
    @[NASON::Field(key: "bacs_debit", type: SourceMandateNotificationBacsDebitData?, nillable: true)]
    property bacs_debit : SourceMandateNotificationBacsDebitData?

    @[NASON::Field(key: "sepa_debit", type: SourceMandateNotificationSepaDebitData?, nillable: true)]
    ...
    def initialize(*, @created : Int64, @id : String, @livemode : Bool, @object : String, @reason : String, @source : Source, @status : String, @_type : String, @acss_debit : SourceMandateNotificationAcssDebitData? = nil, @amount : Int64? | Null = nil, @bacs_debit : SourceMandateNotificationBacsDebitData? = nil, @sepa_debit : SourceMandateNotificationSepaDebitData? = nil)
    end
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new("String", ["source_mandate_notification"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["source_mandate_notification"])
    ...
    def hash
      [acss_debit, amount, bacs_debit, created, id, livemode, object, reason, sepa_debit, source, status, _type].hash
    end
