...
module Stripe
  class PlanList
    ...
    @[NASON::Field(key: "data", type: Array(Plan))]
    property data : Array(Plan)
    ...
    def initialize(*, @data : Array(Plan), @has_more : Bool, @object : String, @url : String)
    end
