...
module Stripe
  ...
  class PlanList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::Plan)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::Plan)? = nil
    ...
    def data=(data : Array(Stripe::Plan)?)
      if data.nil?
