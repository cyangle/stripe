...
module Stripe
  #
  class GetSubscriptionSchedules200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::SubscriptionSchedule)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::SubscriptionSchedule)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::SubscriptionSchedule)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::SubscriptionSchedule
    ...
    def valid?
      ...
      if _url = @url
        ...
        return false if _url !~ /^\/v1\/subscription_schedules/
      end
    ...
    def data=(data : Array(Stripe::SubscriptionSchedule)?)
      if data.nil?
