...
module Stripe
  ...
  class GetSubscriptionSchedules200Response
    ...
    # Required properties
    @[JSON::Field(key: "data", type: Array(SubscriptionSchedule))]
    property data : Array(SubscriptionSchedule)
    ...
    def initialize(*, @data : Array(SubscriptionSchedule), @has_more : Bool, @object : String, @url : String)
    end
    ...
    def valid?
      ...
      return false if @url !~ /^\/v1\/subscription_schedules/
      true
    end
