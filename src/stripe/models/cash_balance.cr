...
module Stripe
  ...
  class CashBalance
    ...
    @[JSON::Field(key: "available", type: Hash(String, Int32)?, default: nil, required: true, nullable: true, emit_null: true)]
    ...
    def_equals_and_hash(@available, @customer, @livemode, @object, @settings)
  end
end
