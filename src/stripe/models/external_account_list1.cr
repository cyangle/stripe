...
module Stripe
  ...
  class ExternalAccountList1
    ...
    @[JSON::Field(key: "data", type: Array(ExternalAccount))]
    property data : Array(ExternalAccount)
    ...
    def initialize(*, @data : Array(ExternalAccount), @has_more : Bool, @object : String, @url : String)
    end
