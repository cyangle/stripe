...
module Stripe
  ...
  class ExternalAccountList1
    ...
    @[NASON::Field(key: "data", type: Array(BankAccount | Card))]
    property data : Array(BankAccount | Card)
    ...
    def initialize(*, @data : Array(BankAccount | Card), @has_more : Bool, @object : String, @url : String)
    end
