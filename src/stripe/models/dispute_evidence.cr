...
module Stripe
  ...
  class DisputeEvidence
    ...
    @[JSON::Field(key: "cancellation_policy", type: DisputeEvidenceCancellationPolicy?, presence: true, ignore_serialize: cancellation_policy.nil? && !cancellation_policy_present?)]
    property cancellation_policy : DisputeEvidenceCancellationPolicy?
    ...
    @[JSON::Field(key: "customer_communication", type: DisputeEvidenceCustomerCommunication?, presence: true, ignore_serialize: customer_communication.nil? && !customer_communication_present?)]
    property customer_communication : DisputeEvidenceCustomerCommunication?
    ...
    @[JSON::Field(key: "customer_signature", type: DisputeEvidenceCustomerSignature?, presence: true, ignore_serialize: customer_signature.nil? && !customer_signature_present?)]
    property customer_signature : DisputeEvidenceCustomerSignature?

    @[JSON::Field(ignore: true)]
    property? customer_signature_present : Bool = false

    @[JSON::Field(key: "duplicate_charge_documentation", type: DisputeEvidenceDuplicateChargeDocumentation?, presence: true, ignore_serialize: duplicate_charge_documentation.nil? && !duplicate_charge_documentation_present?)]
    property duplicate_charge_documentation : DisputeEvidenceDuplicateChargeDocumentation?
    ...
    @[JSON::Field(key: "receipt", type: DisputeEvidenceReceipt?, presence: true, ignore_serialize: receipt.nil? && !receipt_present?)]
    property receipt : DisputeEvidenceReceipt?

    @[JSON::Field(ignore: true)]
    property? receipt_present : Bool = false

    @[JSON::Field(key: "refund_policy", type: DisputeEvidenceRefundPolicy?, presence: true, ignore_serialize: refund_policy.nil? && !refund_policy_present?)]
    property refund_policy : DisputeEvidenceRefundPolicy?
    ...
    @[JSON::Field(key: "service_documentation", type: DisputeEvidenceServiceDocumentation?, presence: true, ignore_serialize: service_documentation.nil? && !service_documentation_present?)]
    property service_documentation : DisputeEvidenceServiceDocumentation?
    ...
    @[JSON::Field(key: "shipping_documentation", type: DisputeEvidenceShippingDocumentation?, presence: true, ignore_serialize: shipping_documentation.nil? && !shipping_documentation_present?)]
    property shipping_documentation : DisputeEvidenceShippingDocumentation?
    ...
    @[JSON::Field(key: "uncategorized_file", type: DisputeEvidenceUncategorizedFile?, presence: true, ignore_serialize: uncategorized_file.nil? && !uncategorized_file_present?)]
    property uncategorized_file : DisputeEvidenceUncategorizedFile?
