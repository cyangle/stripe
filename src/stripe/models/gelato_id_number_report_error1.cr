...
module Stripe
  ...
  class GelatoIdNumberReportError1
    ...
    ENUM_VALIDATOR_FOR_CODE = EnumValidator.new("code", "String", ["id_number_insufficient_document_data", "id_number_mismatch", "id_number_unverified_other"])
