...
module Stripe
  class PostWebhookEndpointsRequest
    ...
    def api_version=(new_value : String?)
      unless new_value.nil?
        OpenApi::EnumValidator.validate("api_version", new_value, VALID_VALUES_FOR_API_VERSION)
      end
