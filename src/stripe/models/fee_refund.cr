...
module Stripe
  ...
  class FeeRefund
    ...
    def initialize(*, @amount : Int64, @created : Int64, @currency : String, @fee : String | ApplicationFee | Null, @id : String, @object : String, @balance_transaction : String | BalanceTransaction? | Null = nil, @metadata : Hash(String, String)? | Null = nil)
    end
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new("String", ["fee_refund"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["fee_refund"])
    ...
    def hash
      [amount, balance_transaction, created, currency, fee, id, metadata, object].hash
    end
