...
module Stripe
  ...
  class RecurringPriceData
    ...
    def_equals_and_hash(@currency, @product, @recurring, @tax_behavior, @tax_behavior_present, @unit_amount, @unit_amount_present, @unit_amount_decimal, @unit_amount_decimal_present)
  end
end
