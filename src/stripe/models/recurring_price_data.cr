...
module Stripe
  ...
  class RecurringPriceData
    ...
    @[NASON::Field(key: "product", type: String)]
    property product : String

    @[NASON::Field(key: "recurring", type: RecurringAdhoc)]
    property recurring : RecurringAdhoc

    # Optional properties
    # Specifies whether the price is considered inclusive of taxes or exclusive of taxes. One of `inclusive`, `exclusive`, or `unspecified`. Once specified as either `inclusive` or `exclusive`, it cannot be changed.
    @[NASON::Field(key: "tax_behavior", type: String?, nillable: true)]
    ...
    def initialize(*, @currency : String, @product : String, @recurring : RecurringAdhoc, @tax_behavior : String? = nil, @unit_amount : Int64? = nil, @unit_amount_decimal : String? = nil)
    end
    ...
    def hash
      [currency, product, recurring, tax_behavior, unit_amount, unit_amount_decimal].hash
    end
