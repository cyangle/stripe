...
module Stripe
  class ClimateRemovalsOrdersList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::ClimateOrder)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::ClimateOrder)? = nil
    ...
    PATTERN_FOR_URL    = /^\/v1\/climate\/orders/
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::ClimateOrder)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def data=(new_value : Array(Stripe::ClimateOrder)?)
