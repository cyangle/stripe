...
module Stripe
  ...
  class GetSubscriptionItemsSubscriptionItemUsageRecordSummaries200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::UsageRecordSummary)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::UsageRecordSummary)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::UsageRecordSummary)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::UsageRecordSummary
    ...
    def data=(data : Array(Stripe::UsageRecordSummary)?)
      if data.nil?
