...
module Stripe
  ...
  class MandateOptionsParam2
    ...
    def initialize(*, @amount : Int64, @amount_type : String, @interval : String, @reference : String, @start_date : Int64, @description : String? = nil, @end_date : Int64? = nil, @interval_count : Int64? = nil, @supported_types : Array(String)? = nil)
    end
