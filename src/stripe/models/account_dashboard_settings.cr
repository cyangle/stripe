...
module Stripe
  class AccountDashboardSettings
    ...
    @[NASON::Field(key: "timezone", type: String? | Null, nillable: true)]
    property timezone : String? | Null

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @display_name : String? | Null = nil, @timezone : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@timezone.nil? && !@timezone.null? && @timezone.to_s.size > 5000
    ...
    def valid?
      ...
      return false if !@timezone.nil? && !@timezone.null? && @timezone.to_s.size > 5000
      true
    end
