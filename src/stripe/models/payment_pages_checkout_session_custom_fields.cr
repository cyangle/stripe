...
require "./payment_pages_checkout_session_custom_fields_dropdown"
require "./payment_pages_checkout_session_custom_fields_label"
require "./payment_pages_checkout_session_custom_fields_numeric"
require "./payment_pages_checkout_session_custom_fields_text"
...
module Stripe
  ...
  class PaymentPagesCheckoutSessionCustomFields
    ...
    @[JSON::Field(key: "label", type: Stripe::PaymentPagesCheckoutSessionCustomFieldsLabel?, default: nil, required: true, nullable: false, emit_null: false)]
    getter label : Stripe::PaymentPagesCheckoutSessionCustomFieldsLabel? = nil
    ...
    @[JSON::Field(key: "dropdown", type: Stripe::PaymentPagesCheckoutSessionCustomFieldsDropdown?, default: nil, required: false, nullable: false, emit_null: false)]
    getter dropdown : Stripe::PaymentPagesCheckoutSessionCustomFieldsDropdown? = nil

    @[JSON::Field(key: "numeric", type: Stripe::PaymentPagesCheckoutSessionCustomFieldsNumeric?, default: nil, required: false, nullable: false, emit_null: false)]
    getter numeric : Stripe::PaymentPagesCheckoutSessionCustomFieldsNumeric? = nil

    @[JSON::Field(key: "text", type: Stripe::PaymentPagesCheckoutSessionCustomFieldsText?, default: nil, required: false, nullable: false, emit_null: false)]
    getter text : Stripe::PaymentPagesCheckoutSessionCustomFieldsText? = nil
    ...
    def initialize(
      *,
      # Required properties
      @key : String? = nil,
      @label : Stripe::PaymentPagesCheckoutSessionCustomFieldsLabel? = nil,
      @optional : Bool? = nil,
      @_type : String? = nil,
      # Optional properties
      @dropdown : Stripe::PaymentPagesCheckoutSessionCustomFieldsDropdown? = nil,
      @numeric : Stripe::PaymentPagesCheckoutSessionCustomFieldsNumeric? = nil,
      @text : Stripe::PaymentPagesCheckoutSessionCustomFieldsText? = nil
    )
    end
    ...
    def label=(new_value : Stripe::PaymentPagesCheckoutSessionCustomFieldsLabel?)
    ...
    def dropdown=(new_value : Stripe::PaymentPagesCheckoutSessionCustomFieldsDropdown?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def numeric=(new_value : Stripe::PaymentPagesCheckoutSessionCustomFieldsNumeric?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def text=(new_value : Stripe::PaymentPagesCheckoutSessionCustomFieldsText?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
