...
module Stripe
  ...
  class TransactionsResourceTreasuryTransactionList
    ...
    @[JSON::Field(key: "data", type: Array(TreasuryTransaction))]
    property data : Array(TreasuryTransaction)
    ...
    def initialize(*, @data : Array(TreasuryTransaction), @has_more : Bool, @object : String, @url : String)
    end
