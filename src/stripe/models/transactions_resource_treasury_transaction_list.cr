...
module Stripe
  #
  class TransactionsResourceTreasuryTransactionList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::TreasuryTransaction)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::TreasuryTransaction)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::TreasuryTransaction)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::TreasuryTransaction
    ...
    def data=(data : Array(Stripe::TreasuryTransaction)?)
      if data.nil?
