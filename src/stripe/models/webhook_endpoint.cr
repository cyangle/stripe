...
module Stripe
  ...
  class WebhookEndpoint
    ...
    @[NASON::Field(key: "enabled_events", type: Array(String))]
    ...
    @[NASON::Field(key: "secret", type: String?, nillable: true)]
    ...
    def initialize(*, @created : Int64, @enabled_events : Array(String), @id : String, @livemode : Bool, @metadata : Hash(String, String), @object : String, @status : String, @url : String, @api_version : String? | Null = nil, @application : String? | Null = nil, @description : String? | Null = nil, @secret : String? = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@api_version.nil? && !@api_version.null? && @api_version.to_s.size > 5000
    ...
    def valid?
      return false if !@api_version.nil? && !@api_version.null? && @api_version.to_s.size > 5000
      ...
      object_validator = EnumAttributeValidator.new("String", ["webhook_endpoint"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["webhook_endpoint"])
    ...
    def hash
      [api_version, application, created, description, enabled_events, id, livemode, metadata, object, secret, status, url].hash
    end
