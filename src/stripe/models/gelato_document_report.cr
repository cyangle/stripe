...
module Stripe
  ...
  class GelatoDocumentReport
    ...
    @[NASON::Field(key: "dob", type: GelatoDataDocumentReportDateOfBirth? | Null, nillable: true)]
    property dob : GelatoDataDocumentReportDateOfBirth? | Null

    # Details on the verification error. Present when status is `unverified`.
    @[NASON::Field(key: "error", type: GelatoDocumentReportError? | Null, nillable: true)]
    property error : GelatoDocumentReportError? | Null

    # Expiration date of the document.
    @[NASON::Field(key: "expiration_date", type: GelatoDataDocumentReportExpirationDate? | Null, nillable: true)]
    property expiration_date : GelatoDataDocumentReportExpirationDate? | Null

    # Array of [File](https://stripe.com/docs/api/files) ids containing images for this document.
    @[NASON::Field(key: "files", type: Array(String)? | Null, nillable: true)]
    property files : Array(String)? | Null
    ...
    @[NASON::Field(key: "issued_date", type: GelatoDataDocumentReportIssuedDate? | Null, nillable: true)]
    property issued_date : GelatoDataDocumentReportIssuedDate? | Null

    # Issuing country of the document.
    @[NASON::Field(key: "issuing_country", type: String? | Null, nillable: true)]
    property issuing_country : String? | Null
    ...
    def initialize(*, @status : String, @address : Address? | Null = nil, @dob : GelatoDataDocumentReportDateOfBirth? | Null = nil, @error : GelatoDocumentReportError? | Null = nil, @expiration_date : GelatoDataDocumentReportExpirationDate? | Null = nil, @files : Array(String)? | Null = nil, @first_name : String? | Null = nil, @issued_date : GelatoDataDocumentReportIssuedDate? | Null = nil, @issuing_country : String? | Null = nil, @last_name : String? | Null = nil, @number : String? | Null = nil, @_type : String? | Null = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@issuing_country.nil? && !@issuing_country.null? && @issuing_country.to_s.size > 5000
    ...
    def valid?
      ...
      return false if !@issuing_country.nil? && !@issuing_country.null? && @issuing_country.to_s.size > 5000
      ...
      _type_validator = EnumAttributeValidator.new("String", ["driving_license", "id_card", "passport"])
    ...
    def _type=(_type)
      validator = EnumAttributeValidator.new("String", ["driving_license", "id_card", "passport"])
    ...
    def hash
      [address, dob, error, expiration_date, files, first_name, issued_date, issuing_country, last_name, number, status, _type].hash
    end
