...
module Stripe
  ...
  class LegalEntityCompanyAddressKanji
    ...
    def initialize(*, @city : String?, @country : String?, @line1 : String?, @line2 : String?, @postal_code : String?, @state : String?, @town : String?)
    end
    ...
    def valid?
      ...
      return false if @town.to_s.size > 5000
      _any_of_found = false
