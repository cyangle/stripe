...
module Stripe
  ...
  class BankConnectionsResourceOwnerList1
    ...
    @[JSON::Field(key: "data", type: Array(FinancialConnectionsAccountOwner))]
    property data : Array(FinancialConnectionsAccountOwner)
    ...
    def initialize(*, @data : Array(FinancialConnectionsAccountOwner), @has_more : Bool, @object : String, @url : String)
    end
