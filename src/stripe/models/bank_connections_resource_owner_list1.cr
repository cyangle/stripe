...
module Stripe
  ...
  class BankConnectionsResourceOwnerList1
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::FinancialConnectionsAccountOwner)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::FinancialConnectionsAccountOwner)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::FinancialConnectionsAccountOwner)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::FinancialConnectionsAccountOwner
    ...
    def data=(data : Array(Stripe::FinancialConnectionsAccountOwner)?)
      if data.nil?
