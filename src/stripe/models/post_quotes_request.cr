...
require "./from_quote_params"
require "./line_item_create_params"
require "./post_quotes_request_application_fee_amount"
require "./post_quotes_request_application_fee_percent"
require "./post_quotes_request_default_tax_rates"
require "./post_quotes_request_discounts"
require "./post_quotes_request_transfer_data"
require "./quote_param"
require "./subscription_data_create_params"
  ...
  class PostQuotesRequest
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_footer = @footer).nil?
        invalid_properties.push(ERROR_MESSAGE_FOR_FOOTER) unless OpenApi::EnumValidator.valid?(_footer, VALID_VALUES_FOR_FOOTER)
      end
      ...
      unless (_header = @header).nil?
        invalid_properties.push(ERROR_MESSAGE_FOR_HEADER) unless OpenApi::EnumValidator.valid?(_header, VALID_VALUES_FOR_HEADER)
      end
    ...
    def valid? : Bool
      ...
      unless (_footer = @footer).nil?
        return false unless OpenApi::EnumValidator.valid?(_footer, VALID_VALUES_FOR_FOOTER)
      end
      ...
      unless (_header = @header).nil?
        return false unless OpenApi::EnumValidator.valid?(_header, VALID_VALUES_FOR_HEADER)
      end
    ...
    def footer=(new_value : String?)
      unless new_value.nil?
        OpenApi::EnumValidator.validate("footer", new_value, VALID_VALUES_FOR_FOOTER)
      end
    ...
    def from_quote=(new_value : Stripe::FromQuoteParams?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def header=(new_value : String?)
      unless new_value.nil?
        OpenApi::EnumValidator.validate("header", new_value, VALID_VALUES_FOR_HEADER)
      end
    ...
    def line_items=(new_value : Array(Stripe::LineItemCreateParams)?)
      unless new_value.nil?
    ...
    def subscription_data=(new_value : Stripe::SubscriptionDataCreateParams?)
      unless new_value.nil?
        new_value.validate if new_value.is_a?(OpenApi::Validatable)
      end
    ...
    def test_clock=(new_value : String?)
      unless new_value.nil?
        OpenApi::PrimitiveValidator.validate_max_length("test_clock", new_value.to_s.size, MAX_LENGTH_FOR_TEST_CLOCK)
      end
