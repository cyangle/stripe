...
module Stripe
  ...
  class PostQuotesRequest
    ...
    @[JSON::Field(key: "from_quote", type: FromQuoteParams?, presence: true, ignore_serialize: from_quote.nil? && !from_quote_present?)]
    property from_quote : FromQuoteParams?
    ...
    @[JSON::Field(key: "line_items", type: Array(LineItemCreateParams)?, presence: true, ignore_serialize: line_items.nil? && !line_items_present?)]
    property line_items : Array(LineItemCreateParams)?
    ...
    @[JSON::Field(key: "subscription_data", type: SubscriptionDataCreateParams?, presence: true, ignore_serialize: subscription_data.nil? && !subscription_data_present?)]
    property subscription_data : SubscriptionDataCreateParams?
    ...
    def_hash(@application_fee_amount, @application_fee_percent, @automatic_tax, @collection_method, @customer, @default_tax_rates, @description, @discounts, @expand, @expires_at, @footer, @from_quote, @header, @invoice_settings, @line_items, @metadata, @on_behalf_of, @subscription_data, @test_clock, @transfer_data)
  end
end
