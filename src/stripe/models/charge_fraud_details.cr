...
module Stripe
  class ChargeFraudDetails
    ...
    @[NASON::Field(key: "stripe_report", type: String?, nillable: true)]
    property stripe_report : String?

    # Assessments reported by you. If set, possible values of are `safe` and `fraudulent`.
    @[NASON::Field(key: "user_report", type: String?, nillable: true)]
    property user_report : String?
    ...
    def hash
      [stripe_report, user_report].hash
    end
