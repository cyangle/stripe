...
module Stripe
  class IssuingDisputeOtherEvidence
    ...
    def initialize(*, @additional_documentation : String | File? | Null = nil, @explanation : String? | Null = nil, @product_description : String? | Null = nil, @product_type : String? | Null = nil)
    end
    ...
    def hash
      [additional_documentation, explanation, product_description, product_type].hash
    end
