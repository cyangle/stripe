...
module Stripe
  class SourceTransactionAchCreditTransferData
    ...
    @[NASON::Field(key: "customer_data", type: String?, nillable: true)]
    property customer_data : String?
    ...
    @[NASON::Field(key: "routing_number", type: String?, nillable: true)]
    ...
    def hash
      [customer_data, fingerprint, last4, routing_number].hash
    end
