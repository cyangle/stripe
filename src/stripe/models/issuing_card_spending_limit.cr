  ...
  class IssuingCardSpendingLimit
    ...
    def list_invalid_properties : Array(String)
      ...
      if _categories = @categories
        invalid_properties.push(OpenApi::EnumValidator.error_message("categories", VALID_VALUES_FOR_CATEGORIES)) unless OpenApi::EnumValidator.valid?(_categories, VALID_VALUES_FOR_CATEGORIES)
      end
      invalid_properties
    end
