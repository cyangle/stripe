...
module Stripe
  #
  class GetAccountPeople200Response
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::Person)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::Person)? = nil
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::Person
    ...
    def data=(data : Array(Stripe::Person)?)
      if data.nil?
