...
module Stripe
  #
  class OutboundTransfersResourceTreasuryOutboundTransferList
    ...
    @[JSON::Field(key: "data", type: Array(Stripe::TreasuryOutboundTransfer)?, default: nil, required: true, nullable: false, emit_null: false)]
    getter data : Array(Stripe::TreasuryOutboundTransfer)? = nil
    ...
    def initialize(
      *,
      # Required properties
      @data : Array(Stripe::TreasuryOutboundTransfer)? = nil,
      @has_more : Bool? = nil,
      @object : String? = nil,
      @url : String? = nil
    )
    ...
    def list_invalid_properties
      ...
      # Container data array has values of Stripe::TreasuryOutboundTransfer
    ...
    def data=(data : Array(Stripe::TreasuryOutboundTransfer)?)
      if data.nil?
