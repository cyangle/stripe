...
module Stripe
  ...
  class OutboundTransfersResourceTreasuryOutboundTransferList
    ...
    @[JSON::Field(key: "data", type: Array(TreasuryOutboundTransfer))]
    property data : Array(TreasuryOutboundTransfer)
    ...
    def initialize(*, @data : Array(TreasuryOutboundTransfer), @has_more : Bool, @object : String, @url : String)
    end
