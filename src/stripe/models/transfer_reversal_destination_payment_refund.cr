...
module Stripe
  ...
  class TransferReversalDestinationPaymentRefund
    ...
    def initialize(*, @amount : Int64, @balance_transaction : FeeRefundBalanceTransaction?, @charge : RefundCharge?, @created : Int64, @currency : String, @id : String, @metadata : Hash(String, String)?, @object : String, @payment_intent : RefundPaymentIntent?, @reason : String?, @receipt_number : String?, @source_transfer_reversal : RefundSourceTransferReversal?, @status : String?, @transfer_reversal : RefundTransferReversal?, @description : String? = nil, @failure_balance_transaction : RefundFailureBalanceTransaction? = nil, @failure_reason : String? = nil, @instructions_email : String? = nil, @next_action : RefundNextAction? = nil)
    end
    ...
    def_hash(@amount, @balance_transaction, @charge, @created, @currency, @description, @failure_balance_transaction, @failure_reason, @id, @instructions_email, @metadata, @next_action, @object, @payment_intent, @reason, @receipt_number, @source_transfer_reversal, @status, @transfer_reversal)
  end
end
