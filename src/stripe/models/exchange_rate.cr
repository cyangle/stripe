...
module Stripe
  ...
  class ExchangeRate
    ...
    @[NASON::Field(key: "rates", type: Hash(String, Float64))]
    ...
    def initialize(*, @id : String, @object : String, @rates : Hash(String, Float64))
    end
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new("String", ["exchange_rate"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new("String", ["exchange_rate"])
