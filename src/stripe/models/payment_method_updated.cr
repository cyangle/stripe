...
module Stripe
  ...
  class PaymentMethodUpdated
    ...
    @[JSON::Field(key: "object", type: Stripe::PaymentMethod?, default: nil, required: true, nullable: false, emit_null: false)]
    getter object : Stripe::PaymentMethod? = nil
    ...
    def initialize(
      *,
      # Required properties
      @object : Stripe::PaymentMethod? = nil
    )
    end
    ...
    def object=(new_value : Stripe::PaymentMethod?)
