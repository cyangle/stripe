...
require "./subscription_schedule_default_settings_param_account_tax_ids"
...
module Stripe
  class SubscriptionScheduleDefaultSettingsParam
    ...
    @[JSON::Field(key: "account_tax_ids", type: Stripe::SubscriptionScheduleDefaultSettingsParamAccountTaxIds?, default: nil, required: false, nullable: false, emit_null: false)]
    getter account_tax_ids : Stripe::SubscriptionScheduleDefaultSettingsParamAccountTaxIds? = nil
    ...
    def initialize(
      *,
      # Optional properties
      @account_tax_ids : Stripe::SubscriptionScheduleDefaultSettingsParamAccountTaxIds? = nil,
    ...
    def account_tax_ids=(new_value : Stripe::SubscriptionScheduleDefaultSettingsParamAccountTaxIds?)
    ...
    def_equals_and_hash(@account_tax_ids, @days_until_due, @issuer)
  end
end
